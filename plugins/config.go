...
type processConfig struct {
	LoggingConfig
	loopRegistrationFn func(loopId string, loopStaticCfg LoggingConfig) *RegisteredLoop
}
...
func NewRegistrarConfig(lc LoggingConfig, loopRegistrationFn func(loopId string, loopStaticCfg LoggingConfig) *RegisteredLoop) RegistrarConfig {
