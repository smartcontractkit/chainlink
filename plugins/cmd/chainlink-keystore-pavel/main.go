...
func (p *Plugin) ListKeys(ctx context.Context, tags []string) ([][]byte, error) {
	//TODO implement me
	panic("implement me")
}

func (p *Plugin) ImportKey(ctx context.Context, keyType string, data []byte, tags []string) ([]byte, error) {
	//TODO implement me
	panic("implement me")
}

func (p *Plugin) ExportKey(ctx context.Context, keyID []byte) ([]byte, error) {
	//TODO implement me
	panic("implement me")
}

func (p *Plugin) CreateKey(ctx context.Context, keyType string, tags []string) ([]byte, error) {
	//TODO implement me
	panic("implement me")
}

func (p *Plugin) DeleteKey(ctx context.Context, keyID []byte) error {
	//TODO implement me
	panic("implement me")
}
