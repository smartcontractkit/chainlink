...
func ExecuteBasicLogPollerTest(t *testing.T, testConfig *tc.TestConfig) {
...
func ExecuteLogPollerReplay(t *testing.T, testConfig *tc.TestConfig, consistencyTimeout string) {
	l := logging.GetTestLogger(t)
	coreLogger := core_logger.TestLogger(t) //needed by ORM ¯\_(ツ)_/¯
