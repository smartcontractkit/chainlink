...
import (
	...
	"github.com/smartcontractkit/chainlink-ccip/chains/evm/gobindings/generated/v1_6_0/mock_lbtc_token_pool"
...
type LatestPool struct {
	...
	MockLBTCPool    *mock_lbtc_token_pool.MockE2ELBTCTokenPool
}
