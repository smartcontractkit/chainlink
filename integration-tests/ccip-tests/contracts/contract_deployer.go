...
func (e *CCIPContractsDeployer) NewUSDCTokenPoolContract(addr common.Address) (
	*TokenPool,
	...
	switch version {
	case Latest:
		pool, err := usdc_token_pool_1_5_1.NewUSDCTokenPool(addr, wrappers.MustNewWrappedContractBackend(e.evmClient, nil))
	...
	*TokenPool,
	...
	case Latest:
		address, _, _, err := e.evmClient.DeployContract("USDC Token Pool", func(
			...
			return usdc_token_pool_1_5_1.DeployUSDCTokenPool(
				auth,
