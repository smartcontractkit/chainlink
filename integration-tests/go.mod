...
require (
	...
	github.com/smartcontractkit/chainlink-relay v0.1.7-0.20230307225120-1d975a1042ea // indirect
	github.com/smartcontractkit/chainlink-solana v1.0.3-0.20230308005925-40130bbb18f5 // indirect
