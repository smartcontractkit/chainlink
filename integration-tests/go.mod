...
require (
	...
	github.com/aws/constructs-go/constructs/v10 v10.1.314 // indirect
	...
	github.com/cdk8s-team/cdk8s-core-go/cdk8s/v2 v2.7.70 // indirect
	...
	k8s.io/apiextensions-apiserver v0.25.10 // indirect
