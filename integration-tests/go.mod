...
require (
	github.com/smartcontractkit/chainlink/deployment v0.0.0-20250221161645-4c8b48da7f04
	github.com/smartcontractkit/chainlink/v2 v2.0.0-20250221161645-4c8b48da7f04
)
