...
require (
	...
	github.com/smartcontractkit/chainlink-ccip v0.0.0-20250106155433-3131bccb4ed6
...
require (
	...
	github.com/smartcontractkit/chainlink-testing-framework/framework v0.4.1 // indirect
