...
require (
	...
	github.com/smartcontractkit/chainlink-ton v0.0.0-20250910174956-fe0f498d4212
...
require (
	...
	github.com/smartcontractkit/chainlink-ton/integration-tests v0.0.0-20250910174956-fe0f498d4212 // indirect
