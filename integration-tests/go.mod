...
require (
	...
	github.com/smartcontractkit/chainlink-aptos v0.0.0-20260513150556-d9b0fd9569fd
...
require (
	...
	github.com/smartcontractkit/chainlink-solana v1.1.2-0.20260513123719-d347eaf314e1 // indirect
