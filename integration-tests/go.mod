...
require (
	...
	github.com/smartcontractkit/chainlink-ton v0.0.0-20250912184756-bba3789ac096
...
require (
	...
	github.com/smartcontractkit/chainlink-ton/integration-tests v0.0.0-20250912184756-bba3789ac096 // indirect
