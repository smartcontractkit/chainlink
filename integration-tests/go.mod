...
require (
	...
	github.com/smartcontractkit/chainlink-relay v0.1.7-0.20230308154539-3e696293b689 // indirect
	github.com/smartcontractkit/chainlink-solana v1.0.3-0.20230308161703-4f4ea97d436e // indirect
