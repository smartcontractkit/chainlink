...
require (
	...
	github.com/smartcontractkit/chainlink-data-streams v0.1.1 // indirect
	...
	github.com/smartcontractkit/chainlink/system-tests/lib v0.0.0-20250723171554-731ffd2fc410 // indirect
