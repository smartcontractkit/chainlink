...
require (
	...
	github.com/smartcontractkit/chainlink-protos/cre/go v0.0.0-20260603162809-d3f4a3c7b58a // indirect
	...
	github.com/smartcontractkit/chainlink-solana v1.3.1-0.20260603183901-cb1823142783 // indirect
