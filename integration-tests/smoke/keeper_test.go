...
var _ = PDescribe("Keeper v1.1 basic smoke test @keeper @simulated", getKeeperSuite(ethereum.RegistryVersion_1_1, defaultRegistryConfig, BasicCounter, BasicSmokeTest, big.NewInt(defaultLinkFunds)))
var _ = PDescribe("Keeper v1.2 basic smoke test @keeper @simulated", getKeeperSuite(ethereum.RegistryVersion_1_2, defaultRegistryConfig, BasicCounter, BasicSmokeTest, big.NewInt(defaultLinkFunds)))
var _ = PDescribe("Keeper v1.1 BCPT test @keeper @simulated", getKeeperSuite(ethereum.RegistryVersion_1_1, highBCPTRegistryConfig, BasicCounter, BcptTest, big.NewInt(defaultLinkFunds)))
var _ = PDescribe("Keeper v1.2 BCPT test @keeper @simulated", getKeeperSuite(ethereum.RegistryVersion_1_2, highBCPTRegistryConfig, BasicCounter, BcptTest, big.NewInt(defaultLinkFunds)))
var _ = PDescribe("Keeper v1.2 Perform simulation test @keeper @simulated", getKeeperSuite(ethereum.RegistryVersion_1_2, defaultRegistryConfig, PerformanceCounter, PerformSimulationTest, big.NewInt(defaultLinkFunds)))
var _ = PDescribe("Keeper v1.2 Check/Perform Gas limit test @keeper @simulated", getKeeperSuite(ethereum.RegistryVersion_1_2, defaultRegistryConfig, PerformanceCounter, CheckPerformGasLimitTest, big.NewInt(defaultLinkFunds)))
var _ = PDescribe("Keeper v1.1 Register upkeep test @keeper @simulated", getKeeperSuite(ethereum.RegistryVersion_1_1, defaultRegistryConfig, BasicCounter, RegisterUpkeepTest, big.NewInt(defaultLinkFunds)))
var _ = PDescribe("Keeper v1.2 Register upkeep test @keeper @simulated", getKeeperSuite(ethereum.RegistryVersion_1_2, defaultRegistryConfig, BasicCounter, RegisterUpkeepTest, big.NewInt(defaultLinkFunds)))
var _ = PDescribe("Keeper v1.1 Add funds to upkeep test @keeper @simulated", getKeeperSuite(ethereum.RegistryVersion_1_1, defaultRegistryConfig, BasicCounter, AddFundsToUpkeepTest, big.NewInt(1)))
var _ = PDescribe("Keeper v1.2 Add funds to upkeep test @keeper @simulated", getKeeperSuite(ethereum.RegistryVersion_1_2, defaultRegistryConfig, BasicCounter, AddFundsToUpkeepTest, big.NewInt(1)))
var _ = PDescribe("Keeper v1.1 Removing one keeper test @keeper @simulated", getKeeperSuite(ethereum.RegistryVersion_1_1, defaultRegistryConfig, BasicCounter, RemovingKeeperTest, big.NewInt(defaultLinkFunds)))
var _ = PDescribe("Keeper v1.2 Removing one keeper test @keeper @simulated", getKeeperSuite(ethereum.RegistryVersion_1_2, defaultRegistryConfig, BasicCounter, RemovingKeeperTest, big.NewInt(defaultLinkFunds)))
var _ = PDescribe("Keeper v1.2 Pause registry test @keeper @simulated", getKeeperSuite(ethereum.RegistryVersion_1_2, defaultRegistryConfig, BasicCounter, PauseRegistryTest, big.NewInt(defaultLinkFunds)))
