...
var _ = Describe("Keeper Suite @keeper", func() {
	var (
		...
		runSpecificTest = func(registryVersion ethereum.KeeperRegistryVersion, registryConfig contracts.KeeperRegistrySettings,
	...
	DescribeTable("Keeper Suite on different EVM networks", func(registryVersion ethereum.KeeperRegistryVersion,
		registryConfig contracts.KeeperRegistrySettings, consumerContract KeeperConsumerContracts, testToRun KeeperTests, linkFundsForEachUpkeep *big.Int) {
		...
		runSpecificTest(registryVersion, registryConfig, consumerContract, testToRun, linkFundsForEachUpkeep)
	},
		testScenarios,
	)
