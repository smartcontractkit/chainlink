...
func TestVRFv2PlusWithLinkBilling(t *testing.T) {
	var isNativeBilling = false

	t.Parallel()
	l := utils.GetTestLogger(t)

	env, vrfv2PlusContracts, subID, job, err := vrfv2plus.SetupVRFV2PlusEnvironment(isNativeBilling)
...
func TestVRFv2PlusWithNativeBilling(t *testing.T) {
