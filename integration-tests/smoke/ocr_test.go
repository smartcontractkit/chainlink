...
func TestOCRZKSync(t *testing.T) {
	zkClient, err := zksync.Setup(os.Getenv("ZK_SYNC_GOERLI_HTTP_URLS"), os.Getenv("PRIVATE_KEY"))
	...
	err = zkClient.DeployContracts(chainClient, "2000", "10", "102829", "600", "3000", "0", "100000", "8", "ETH/USD", "1", "35s", "17s", "30s", "12s", "1h", "10000000", "60s", "6", "1,2,2,2")
