...
func NewContractDeployer(bcClient blockchain.EVMClient, logger zerolog.Logger) (ContractDeployer, error) {
	...
	case *blockchain.MantleSepoliaClient:
		return &MantleSepoliaClientDeployer{NewEthereumContractDeployer(clientImpl, logger)}, nil
	}
...
type MantleSepoliaClientDeployer struct {
	*EthereumContractDeployer
}
