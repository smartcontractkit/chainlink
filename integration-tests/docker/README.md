...
After the tests are complete, the coverage report will be generated in HTML format. Example: `~/Downloads/go-coverage/<test_name>-chain-reader/coverage.html`
```
    log.go:43: 16:29:46.73 INF Chainlink node coverage html report saved filePath=~/Downloads/go-coverage/<test_name>-chain-reader/coverage.html
```
