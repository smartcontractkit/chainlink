...
flowchart LR
  ...
  class chains,products group
	...
	chainlink/v2 --> chainlink/v2/tools/test
	...
	class chainlink-repo,chainlink-ccip-repo,chainlink-common-repo,chainlink-evm-repo,chainlink-framework-repo,chainlink-protos-repo,cre-sdk-go-repo,tdh2-repo outline
```
## All modules
```mermaid
flowchart LR
