...
flowchart LR
  ...
  class chains,products group
	...
	class chainlink-ccip-repo,chainlink-common-repo,chainlink-evm-repo,chainlink-framework-repo,chainlink-protos-repo,tdh2-repo outline
```
## All modules
```mermaid
flowchart LR
  ...
  class chains,products group
	...
	chainlink/core/scripts --> cre-sdk-go/capabilities/scheduler/cron
