...
MetricViewsAttributeDenylist = ['event_id'] # Default
```
...
### MetricViewsAttributeDenylist
```toml
MetricViewsAttributeDenylist = ['event_id'] # Default
```
MetricViewsAttributeDenylist lists attribute keys dropped before export (e.g. event_id).
