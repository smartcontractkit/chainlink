...
Chainlink's implementation of this is to set a large fee cap and modify the tip cap to control confirmation speed of transactions. So, when in EIP1559 mode, the tip cap takes the place of gas price roughly speaking.

This should help to save gas on spikes: Chainlink will react faster on the upleg and avoid overpaying on the downleg.
