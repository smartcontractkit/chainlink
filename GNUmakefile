...
.PHONY: generate
generate: abigen codecgen mockery protoc operator-ui ## Execute all go:generate commands.
	cd ./contracts && ./scripts/native_solc_compile_all
	cd ./core/gethwrappers && go generate ./go_generate.go
