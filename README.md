...
You will need `cosign` in order to do this verification. [Follow the instruction here to install cosign](https://docs.sigstore.dev/cosign/system_config/installation/).
