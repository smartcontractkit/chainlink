...
@chainlink/belt/0.0.1-beta linux-x64 node-v10.16.3
$ belt --help [COMMAND]
USAGE
  $ belt COMMAND
...
...
_See code: [src/src/commands/box.ts](https://github.com/smartcontractkit/chainlink/blob/v0.0.1-beta/src/src/commands/box.ts)_
...
_See code: [src/src/commands/compile.ts](https://github.com/smartcontractkit/chainlink/blob/v0.0.1-beta/src/src/commands/compile.ts)_
