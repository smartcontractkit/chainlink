...
func TestAssignmentSpec_ConvertToJobSpec(t *testing.T) {
	...
	tests := []struct {
		...
		{"with endAt as ISO-8601",
			...
			`{"initiators":[{"type":"web"}],"tasks":[{"type":"noop","confirmations":0,"foo":"bar"}],"endAt":"2006-01-02T15:04:05.000Z"}`},
		{"with endAt as unix timestamp",
			`{"assignment":{"subtasks":[{"adapterType":"noop","adapterParams":{"foo":"bar"}}]},"schedule":{"endAt":"1522099336"}}`,
			`{"initiators":[{"type":"web"}],"tasks":[{"type":"noop","confirmations":0,"foo":"bar"}],"endAt":"2018-03-26T21:22:16.000Z"}`},
		{"with runAt as ISO-8601",
			...
			`{"initiators":[{"type":"web"},{"type":"runAt","time":"2016-01-02T15:04:05.000Z"},{"type":"runAt","time":"2026-01-02T15:04:05.000Z"}],"tasks":[{"type":"noop","confirmations":0,"foo":"bar"}],"endAt":"2222-01-02T15:04:05.000Z"}`},
		{"with runAt as unix timestamp",
			...
			`{"initiators":[{"type":"web"},{"type":"runAt","time":"2018-03-26T21:22:16.000Z"},{"type":"runAt","time":"2018-03-27T00:08:56.000Z"}],"tasks":[{"type":"noop","confirmations":0,"foo":"bar"}],"endAt":"2222-01-02T15:04:05.000Z"}`},
		{"with cron minute",
			`{"assignment":{"subtasks":[{"adapterType":"noop","adapterParams":{"foo":"bar"}}]},"schedule":{"endAt":"2006-01-02T15:04:05.000Z","minute":"1"}}`,
			`{"initiators":[{"type":"web"},{"type":"cron","schedule":"0 1 * * * *"}],"tasks":[{"type":"noop","confirmations":0,"foo":"bar"}],"endAt":"2006-01-02T15:04:05.000Z"}`},
		{"with cron hour",
			`{"assignment":{"subtasks":[{"adapterType":"noop","adapterParams":{"foo":"bar"}}]},"schedule":{"endAt":"2006-01-02T15:04:05.000Z","hour":"2"}}`,
			`{"initiators":[{"type":"web"},{"type":"cron","schedule":"0 * 2 * * *"}],"tasks":[{"type":"noop","confirmations":0,"foo":"bar"}],"endAt":"2006-01-02T15:04:05.000Z"}`},
		{"with cron day of month",
			...
			`{"initiators":[{"type":"web"},{"type":"cron","schedule":"0 * * 3 * *"}],"tasks":[{"type":"noop","confirmations":0,"foo":"bar"}],"endAt":"2006-01-02T15:04:05.000Z"}`},
		{"with cron month of year",
			...
			`{"initiators":[{"type":"web"},{"type":"cron","schedule":"0 * * * 4 *"}],"tasks":[{"type":"noop","confirmations":0,"foo":"bar"}],"endAt":"2006-01-02T15:04:05.000Z"}`},
		{"with cron day of week",
			...
			`{"initiators":[{"type":"web"},{"type":"cron","schedule":"0 * * * * 5"}],"tasks":[{"type":"noop","confirmations":0,"foo":"bar"}],"endAt":"2006-01-02T15:04:05.000Z"}`},
	}
...
func TestAssignmentSpec_ConvertToAssignment(t *testing.T) {
	...
	tests := []struct {
		...
		{"with endAt as ISO-8601",
			...
			`{"assignment":{"subtasks":[{"adapterType":"noop","adapterParams":{"foo":"bar","confirmations":0}}]},"schedule":{"endAt":"2006-01-02T15:04:05.000Z"}}`},
		{"with endAt as unix timestamp",
			`{"initiators":[{"type":"web"}],"tasks":[{"type":"noop","foo":"bar"}],"endAt":"2018-03-26T21:22:16.000Z"}`,
			`{"assignment":{"subtasks":[{"adapterType":"noop","adapterParams":{"foo":"bar","confirmations":0}}]},"schedule":{"endAt":"1522099336"}}`},
		{"with runAt as ISO-8601",
			...
			`{"assignment":{"subtasks":[{"adapterType":"noop","adapterParams":{"foo":"bar","confirmations":0}}]},"schedule":{"endAt":"2222-01-02T15:04:05.000Z","runAt":["2016-01-02T15:04:05.000Z","2026-01-02T15:04:05.000Z"]}}`},
		{"with runAt as unix timestamp",
			...
			`{"assignment":{"subtasks":[{"adapterType":"noop","adapterParams":{"foo":"bar","confirmations":0}}]},"schedule":{"endAt":"2222-01-02T15:04:05.000Z","runAt":["1522099336","1522109336"]}}`},
		{"with cron minute",
			`{"initiators":[{"type":"web"},{"type":"cron","schedule":"0 1 * * * *"}],"tasks":[{"type":"noop","foo":"bar"}],"endAt":"2006-01-02T15:04:05.000Z"}`,
			`{"assignment":{"subtasks":[{"adapterType":"noop","adapterParams":{"foo":"bar","confirmations":0}}]},"schedule":{"endAt":"2006-01-02T15:04:05.000Z","minute":"1"}}`},
		{"with cron hour",
			`{"initiators":[{"type":"web"},{"type":"cron","schedule":"0 * 2 * * *"}],"tasks":[{"type":"noop","foo":"bar"}],"endAt":"2006-01-02T15:04:05.000Z"}`,
			`{"assignment":{"subtasks":[{"adapterType":"noop","adapterParams":{"foo":"bar","confirmations":0}}]},"schedule":{"endAt":"2006-01-02T15:04:05.000Z","hour":"2"}}`},
		{"with cron day of month",
			`{"initiators":[{"type":"web"},{"type":"cron","schedule":"0 * * 3 * *"}],"tasks":[{"type":"noop","foo":"bar"}],"endAt":"2006-01-02T15:04:05.000Z"}`,
			`{"assignment":{"subtasks":[{"adapterType":"noop","adapterParams":{"foo":"bar","confirmations":0}}]},"schedule":{"endAt":"2006-01-02T15:04:05.000Z","dayOfMonth":"3"}}`},
		{"with cron month of year",
			`{"initiators":[{"type":"web"},{"type":"cron","schedule":"0 * * * 4 *"}],"tasks":[{"type":"noop","foo":"bar"}],"endAt":"2006-01-02T15:04:05.000Z"}`,
			`{"assignment":{"subtasks":[{"adapterType":"noop","adapterParams":{"foo":"bar","confirmations":0}}]},"schedule":{"endAt":"2006-01-02T15:04:05.000Z","monthOfYear":"4"}}`},
		{"with cron day of week",
			`{"initiators":[{"type":"web"},{"type":"cron","schedule":"0 * * * * 5"}],"tasks":[{"type":"noop","foo":"bar"}],"endAt":"2006-01-02T15:04:05.000Z"}`,
			`{"assignment":{"subtasks":[{"adapterType":"noop","adapterParams":{"foo":"bar","confirmations":0}}]},"schedule":{"endAt":"2006-01-02T15:04:05.000Z","dayOfWeek":"5"}}`,
		},
	}
