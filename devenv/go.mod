...
require (
	...
	github.com/smartcontractkit/chainlink-testing-framework/framework v0.14.2
	github.com/smartcontractkit/chainlink-testing-framework/framework/components/fake v0.14.2
