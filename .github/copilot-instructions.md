...
### 1. Keep Go Version in Mind

Before commenting on whether a standard library function exists, ensure you read from the appropriate `go.mod` file and have the proper Go version in mind.
