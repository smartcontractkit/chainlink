...
- Function arguments are named like this: `argumentName`. No leading or trailing underscores necessary.
  - Some exceptions can be made when a function argument shadows a function with the same name
...
// Good
function getNum() external view returns (uint64) {
  return 4;
}
...
- Golf your code. Make it cheap, within reason.
  ...
  - Check the [Solidity guild page](https://www.notion.so/Solidity-Guild-642cfdcfdb0a403c9a8fdb5015ff8244?pvs=21) for recordings on gas golfing
