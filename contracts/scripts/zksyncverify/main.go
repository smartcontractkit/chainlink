...
func main() {
	...
	// Zksync contracts are deployed using a special transaction format that calls create method in a system contract with some additional params
	// So we need to exclude function signature & the other params to get the constructor arguments
