...
describe('SimpleWriteAccessController', () => {
  ...
  describe('#addAccess', () => {
    describe('when called by a non-owner', () => {
      it('reverts', async () => {
        await expect(
          controller.connect(personas.Eddy).addAccess(await personas.Eddy.getAddress())).to.be.revertedWith(
    ...
    describe('when called by the owner', () => {
      ...
      it('announces the change via a log', async () => {
        expect(tx).to.emit(controller, 'AddedAccess').withArgs(
  ...
  describe('#removeAccess', () => {
    ...
    describe('when called by the owner', () => {
      ...
      it('announces the change via a log', async () => {
        expect(tx).to.emit(controller, 'RemovedAccess').withArgs(
          await personas.Eddy.getAddress()
        )
      })
    })
