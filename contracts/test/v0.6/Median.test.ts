  ...
  describe("testing various lists", () => {
    const tests = [
      ...
      },
      {
        name: "really long",
        responses: [
          56, 2, 31, 33, 55, 38, 35, 12, 41, 47, 21, 22, 40, 39, 10, 32, 49, 3, 54, 45, 53, 14, 20, 59, 1, 30, 24, 6, 5,
          37, 58, 51, 46, 17, 29, 7, 27, 9, 43, 8, 34, 42, 28, 23, 57, 0, 11, 48, 52, 50, 15, 16, 26, 25, 4, 36, 19, 44,
          18, 13,
        ],
        want: 29,
      },
