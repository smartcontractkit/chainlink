...
let functionsDONFactory: ContractFactory
...
before(async () => {
  ...
  functionsDONFactory = await ethers.getContractFactory(
    'src/v0.8/tests/FunctionsDONHelper.sol:FunctionsDONHelper',
...
describe('FunctionsDON', () => {
  ...
  beforeEach(async () => {
    ...
    oracle = await functionsDONFactory.connect(roles.defaultAccount).deploy()
  ...
  describe('Fulfilling requests', () => {
    ...
    it('#fulfillRequest emits DONResponse', async () => {
