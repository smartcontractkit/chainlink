...
// @ts-ignore
import { abi as optimismSequencerStatusRecorderAbi } from '../../../artifacts/src/v0.8/dev/l2ep/OptimismSequencerUptimeFeed.sol/OptimismSequencerUptimeFeed.json'
// @ts-ignore
...
describe('OptimismValidator', () => {
  ...
  beforeEach(async () => {
    ...
    optimismUptimeFeedFactory = await ethers.getContractFactory(
      'src/v0.8/dev/l2ep/OptimismSequencerUptimeFeed.sol:OptimismSequencerUptimeFeed',
      deployer,
    )
    ...
    const optimismValidatorFactory = await ethers.getContractFactory(
      'src/v0.8/dev/l2ep/OptimismValidator.sol:OptimismValidator',
      deployer,
    )
