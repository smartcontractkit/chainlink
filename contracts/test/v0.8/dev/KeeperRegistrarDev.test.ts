...
import { KeeperRegistrarDev } from '../../../typechain/KeeperRegistrarDev'
import { KeeperRegistrarDev__factory as KeeperRegistrarDevFactory } from '../../../typechain/factories/KeeperRegistrarDev__factory'
...
let keeperRegistrar: KeeperRegistrarDevFactory
...
describe('KeeperRegistrarDev', () => {
  ...
  let registry: KeeperRegistryDev
  let mock: UpkeepMock
  let registrar: KeeperRegistrarDev
  ...
  beforeEach(async () => {
    ...
    registry = await keeperRegistryDevFactory
      .connect(owner)
      .deploy(
        0,
        registryGasOverhead,
