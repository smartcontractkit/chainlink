...
before(async () => {
  ...
  forwarderFactory = await ethers.getContractFactory(
    'src/v0.8/l2ep/dev/scroll/ScrollCrossDomainForwarder.sol:ScrollCrossDomainForwarder',
    owner,
  )
...
describe('ScrollCrossDomainForwarder', () => {
  beforeEach(async () => {
  ...
  describe('#constructor', () => {
    ...
    it('should set the typeAndVersion correctly', async () => {
      ...
      assert.equal(response, 'ScrollCrossDomainForwarder 1.0.0')
    })
  })
