...
contract VRFCoordinatorV2Plus_Migration is BaseTest {
  ...
  function registerProvingKey() public {
    ...
    v1Coordinator.registerProvingKey(OWNER, uncompressedKeyParts, GAS_LANE_MAX_GAS);
    v1Coordinator_noLink.registerProvingKey(OWNER, uncompressedKeyParts, GAS_LANE_MAX_GAS);
  }
