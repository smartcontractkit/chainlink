    ...
    function test_revertsIfNoVerifierConfigured() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                VerifierProxy.VerifierNotFound.selector,
                bytes32("corrupt-digest")
            )
        );
...
contract VerifierVerifySingleConfigDigestTest is VerifierVerifyTest {
    ...
    function test_revertsIfMismatchedSignatureLength() public {
        ...
        bytes memory signedReport = abi.encode(
            s_reportContext,
            abi.encode(s_testReportOne),
            rs,
            ss,
            rawVs
        );
    ...
    function test_revertsIfWrongNumberOfSigners() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                Verifier.IncorrectSignatureCount.selector,
                10,
                FAULT_TOLERANCE + 1
            )
        );
...
contract VerifierVerifyMultipleConfigDigestTest is VerifierVerifyTest {
    ...
    function test_revertsIfAReportIsVerifiedWithAnExistingButIncorrectDigest()
        public
    {
