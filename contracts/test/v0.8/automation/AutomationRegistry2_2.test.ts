...
let optimismModuleV2: OptimismModuleV2
...
describe('AutomationRegistry2_2', () => {
  ...
  const setup = async () => {
    ...
    optimismModuleV2 = await optimismModuleV2Factory.connect(owner).deploy()
    ...
    opConfig = { ...config }
    opConfig.chainModule = optimismModuleV2.address
  ...
  describe('#getMaxPaymentForGas', () => {
    ...
    itMaybe(
      'calculates the max fee appropriately for Optimism with 100% L1 fee',
      async () => {
        await verifyMaxPayment(
          opRegistry,
          optimismModuleV2,
    ...
    itMaybe(
      'calculates the max fee appropriately for Optimism with L1 fee coefficient being 80',
      async () => {
        await optimismModuleV2.connect(owner).setL1FeeCalculation(80)
        // max payment calculation does not consider the coefficient
        await verifyMaxPayment(
          opRegistry,
          optimismModuleV2,
          maxl1CostWeiOptWithoutMultiplier,
