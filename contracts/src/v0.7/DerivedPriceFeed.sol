...
/**
 * Example for creating LINK/FTM Feed
...
contract DerivedPriceFeed is AggregatorV2V3Interface {
    ...
    function description() external pure override returns (string memory) {
        return "@chainlink/contracts/src/v0.7/DerivedPriceFeed.sol";
    }
    ...
    )
    {
        return (
        uint80(0),
        getDerivedPrice(base, quote, decimals),
        block.timestamp,
        block.timestamp,
        uint80(0)
        );
    ...
    // Taken from https://docs.chain.link/docs/get-the-latest-price/#getting-a-different-price-denomination
