...
abstract contract ZKSyncAutomationRegistryBase2_3 is ConfirmedOwner {
  ...
  // the variables result in accurate estimation
  uint256 public ACCOUNTING_FIXED_GAS_OVERHEAD = 51_000; // Fixed overhead per tx
  uint256 public ACCOUNTING_PER_UPKEEP_GAS_OVERHEAD = 20_000; // Overhead per upkeep performed in batch
