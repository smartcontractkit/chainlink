...
interface IKeeperRegistryMaster {
  ...
  function checkUpkeep(
    uint256 id,
    KeeperRegistryBase2_1.ChainConfig memory cfg
  )
    external
    view
    returns (bool upkeepNeeded, bytes memory performData, uint8 upkeepFailureReason, uint256 gasUsed, uint256 gasLimit);
  ...
  function getMinBalance(uint256 id, KeeperRegistryBase2_1.ChainConfig memory cfg) external view returns (uint96);
