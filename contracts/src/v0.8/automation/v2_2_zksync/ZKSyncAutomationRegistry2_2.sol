...
import {ZKSyncAutomationRegistryLogicB2_2} from "./../v2_2_zksync/ZKSyncAutomationRegistryLogicB2_2.sol";
...
contract ZKSyncAutomationRegistry2_2 is ZKSyncAutomationRegistryBase2_2, OCR2Abstract, Chainable, IERC677Receiver {
   ...
   */
  string public constant override typeAndVersion = "ZKSyncAutomationRegistry 2.2.0";
