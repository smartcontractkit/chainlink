...
abstract contract AutomationRegistryBase2_3 is ConfirmedOwner {
  ...
  uint256 internal constant REGISTRY_LOG_OVERHEAD = 115_000; // Fixed gas overhead for log upkeeps
  ...
  // the variables result in accurate estimation
  uint256 internal constant ACCOUNTING_FIXED_GAS_OVERHEAD = 49_000; // Fixed overhead per tx
