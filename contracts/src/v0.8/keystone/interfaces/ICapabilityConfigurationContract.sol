...
interface ICapabilityConfigurationContract {
  /// @notice Emitted when a capability configuration is set.
  /// @param configurationDigest The digest of the configuration.
  event CapabilityConfigurationSet(bytes32 indexed configurationDigest);
