...
contract KeystoneForwarder_SetConfigTest is BaseTest {
  ...
  function test_RevertWhen_FaultToleranceIsZero() public {
    ...
    s_forwarder.setConfig(DON_ID, CONFIG_VERSION, 0, CONFIG_VERSION, _getSignerAddresses());
  }
  ...
  function test_RevertWhen_InsufficientSigners() public {
    ...
    s_forwarder.setConfig(DON_ID, CONFIG_VERSION, F, CONFIG_VERSION, signers);
  }
  ...
  function test_SetConfig_WhenSignersAreRemoved() public {
    ...
    s_forwarder.setConfig(DON_ID, CONFIG_VERSION, F, CONFIG_VERSION, _getSignerAddresses(16));
  }
}
