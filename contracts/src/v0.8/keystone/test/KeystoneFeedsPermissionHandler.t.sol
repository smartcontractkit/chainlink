...
contract KeystoneFeedsPermissionHandlerTestSetup is Test {
    ...
    bytes2 constant REPORT_NAME_2 = "02";
    ...
    function _createPermissions() internal pure returns (KeystoneFeedsPermissionHandler.Permission[] memory) {
        ...
        permissions[0] = KeystoneFeedsPermissionHandler.Permission(FORWARDER_1, WORKFLOW_NAME_1, REPORT_NAME_1, WORKFLOW_OWNER_1, true);
        permissions[1] = KeystoneFeedsPermissionHandler.Permission(FORWARDER_2, WORKFLOW_NAME_2, REPORT_NAME_2, WORKFLOW_OWNER_2, true);
        return permissions;
    }
...
contract KeystoneFeeds_validatePermissions is KeystoneFeedsPermissionHandlerTestSetup {
    ...
    function test__validatePermissions_InvalidForwarder_Reverts() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(
            KeystoneFeedsPermissionHandler.Unauthorized.selector,
            UNKNOWN_ADDRESS,
            permissions[0].workflowOwner,
            permissions[0].workflowName,
            permissions[0].reportName
