...
contract BurnMintTokenPoolSetup is BurnMintSetup {
  ...
  function setUp() public virtual override {
    ...
    s_pool = new BurnMintTokenPool(s_burnMintERC20, DEFAULT_TOKEN_DECIMALS, new address[](0), address(s_mockRMN), address(s_sourceRouter));
...
contract BurnMintTokenPool_lockOrBurn is BurnMintTokenPoolSetup {
  function test_Setup_Success() public view {
    ...
    assertEq("BurnMintTokenPool 1.7.0-dev", s_pool.typeAndVersion());
  }
