...
interface IKeeperRegistryMaster {
    ...
    function getMaxPaymentForGas(uint32 gasLimit)
        external
        view
    ...
    function getSignerInfo(address query)
        external
        view
        returns (bool active, uint8 index);
