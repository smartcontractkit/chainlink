...
interface IKeeperRegistryMaster {
  ...
  ) external returns (bool success, uint256 gasUsed, uint256 gasLimit);
  ...
  function validateTriggerConfig(uint8 triggerType, bytes memory triggerConfig) external;
  ...
  function getCronTriggerConfig(
    uint256 upkeepId
  ) external view returns (KeeperRegistryBase2_1.CronTriggerConfig memory);
