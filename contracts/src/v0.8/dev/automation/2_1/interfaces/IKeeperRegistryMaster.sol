...
interface IKeeperRegistryMaster {
  ...
  event CancelledUpkeepReport(uint256 indexed id, KeeperRegistryBase2_1.TriggerData trigger);
  event ConfigSet(
  ...
  event InsufficientFundsUpkeepReport(uint256 indexed id, KeeperRegistryBase2_1.TriggerData trigger);
  ...
  event ReorgedUpkeepReport(uint256 indexed id, KeeperRegistryBase2_1.TriggerData trigger);
  event StaleUpkeepReport(uint256 indexed id, KeeperRegistryBase2_1.TriggerData trigger);
  ...
  event UpkeepPerformed(
    ...
    uint256 gasUsed,
    uint256 gasOverhead,
    KeeperRegistryBase2_1.TriggerData trigger
  );
