...
interface OCR2DRRegistryInterface {
   ...
   * @param rawCommitment the bytes representation of the commitment preimage
   ...
   */
  function getCommitmentHash(bytes32 requestId) external view returns (bytes32 commitmentHash);
}
