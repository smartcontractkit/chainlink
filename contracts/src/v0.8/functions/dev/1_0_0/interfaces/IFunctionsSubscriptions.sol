...
interface IFunctionsSubscriptions {
  ...
  // @notice Retrieve details about multiple subscriptions.
  // @param subscriptionIdStart - the ID of the subscription to start the range at
  // @param subscriptionIdEnd - the ID of the subscription to end the range at, must be greater than subscriptionIdStart
