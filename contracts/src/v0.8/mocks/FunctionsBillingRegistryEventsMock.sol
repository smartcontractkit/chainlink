...
contract FunctionsBillingRegistryEventsMock {
  ...
  function emitSubscriptionCanceled(
    uint64 subscriptionId,
    address to,
    uint256 amount
  ) public {
  ...
  function emitSubscriptionFunded(
    uint64 subscriptionId,
    uint256 oldBalance,
    uint256 newBalance
  ) public {
  ...
  function emitSubscriptionOwnerTransferRequested(
    uint64 subscriptionId,
    address from,
    address to
  ) public {
  ...
  function emitSubscriptionOwnerTransferred(
    uint64 subscriptionId,
    address from,
    address to
  ) public {
