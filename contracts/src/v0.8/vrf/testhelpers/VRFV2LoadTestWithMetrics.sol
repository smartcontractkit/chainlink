...
contract VRFV2LoadTestWithMetrics is VRFConsumerBaseV2, ConfirmedOwner {
    ...
    function fulfillRandomWords(uint256 reqId, uint256[] memory) internal override {
        ...
        s_averageFulfillmentInMillions = s_responseCount > 0 ? (s_averageFulfillmentInMillions * s_responseCount + requestDelayInMillions) / (s_responseCount + 1) : requestDelayInMillions;
