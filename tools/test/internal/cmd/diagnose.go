...
prepends "go test -json -count=1" for each iteration (duplicate -json / -count in your
arguments are ignored). With --shuffle-seed, a per-iteration -shuffle=<seed> is appended.`,
