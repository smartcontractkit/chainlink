...
contract UniswapConfig {
  ...
  bool internal immutable reporterInvalidated00;
  bool internal immutable reporterInvalidated01;
  bool internal immutable reporterInvalidated02;
  bool internal immutable reporterInvalidated03;
  bool internal immutable reporterInvalidated04;
  bool internal immutable reporterInvalidated05;
  bool internal immutable reporterInvalidated06;
  bool internal immutable reporterInvalidated07;
  bool internal immutable reporterInvalidated08;
  bool internal immutable reporterInvalidated09;
  bool internal immutable reporterInvalidated10;
  bool internal immutable reporterInvalidated11;
  bool internal immutable reporterInvalidated12;
  bool internal immutable reporterInvalidated13;
  bool internal immutable reporterInvalidated14;
  bool internal immutable reporterInvalidated15;
  bool internal immutable reporterInvalidated16;
  bool internal immutable reporterInvalidated17;
  bool internal immutable reporterInvalidated18;
  bool internal immutable reporterInvalidated19;
  bool internal immutable reporterInvalidated20;
  bool internal immutable reporterInvalidated21;
  bool internal immutable reporterInvalidated22;
  bool internal immutable reporterInvalidated23;
  bool internal immutable reporterInvalidated24;
  bool internal immutable reporterInvalidated25;
  bool internal immutable reporterInvalidated26;
  bool internal immutable reporterInvalidated27;
  bool internal immutable reporterInvalidated28;
  bool internal immutable reporterInvalidated29;
  ...
  constructor(
    ...
    reporterInvalidated00 = get(configs, 0).reporterInvalidated;
    reporterInvalidated01 = get(configs, 1).reporterInvalidated;
    reporterInvalidated02 = get(configs, 2).reporterInvalidated;
    reporterInvalidated03 = get(configs, 3).reporterInvalidated;
    reporterInvalidated04 = get(configs, 4).reporterInvalidated;
    reporterInvalidated05 = get(configs, 5).reporterInvalidated;
    reporterInvalidated06 = get(configs, 6).reporterInvalidated;
    reporterInvalidated07 = get(configs, 7).reporterInvalidated;
    reporterInvalidated08 = get(configs, 8).reporterInvalidated;
    reporterInvalidated09 = get(configs, 9).reporterInvalidated;
    reporterInvalidated10 = get(configs, 10).reporterInvalidated;
    reporterInvalidated11 = get(configs, 11).reporterInvalidated;
    reporterInvalidated12 = get(configs, 12).reporterInvalidated;
    reporterInvalidated13 = get(configs, 13).reporterInvalidated;
    reporterInvalidated14 = get(configs, 14).reporterInvalidated;
    reporterInvalidated15 = get(configs, 15).reporterInvalidated;
    reporterInvalidated16 = get(configs, 16).reporterInvalidated;
    reporterInvalidated17 = get(configs, 17).reporterInvalidated;
    reporterInvalidated18 = get(configs, 18).reporterInvalidated;
    reporterInvalidated19 = get(configs, 19).reporterInvalidated;
    reporterInvalidated20 = get(configs, 20).reporterInvalidated;
    reporterInvalidated21 = get(configs, 21).reporterInvalidated;
    reporterInvalidated22 = get(configs, 22).reporterInvalidated;
    reporterInvalidated23 = get(configs, 23).reporterInvalidated;
    reporterInvalidated24 = get(configs, 24).reporterInvalidated;
    reporterInvalidated25 = get(configs, 25).reporterInvalidated;
    reporterInvalidated26 = get(configs, 26).reporterInvalidated;
    reporterInvalidated27 = get(configs, 27).reporterInvalidated;
    reporterInvalidated28 = get(configs, 28).reporterInvalidated;
    reporterInvalidated29 = get(configs, 29).reporterInvalidated;
    ...
    )
  {
    ...
    if (i == 0) return TokenConfig({cToken: cToken00, underlying: underlying00, symbolHash: symbolHash00, baseUnit: baseUnit00, priceSource: priceSource00, fixedPrice: fixedPrice00, uniswapMarket: uniswapMarket00, reporter: reporter00, reporterInvalidated: reporterInvalidated00, isUniswapReversed: isUniswapReversed00});
    if (i == 1) return TokenConfig({cToken: cToken01, underlying: underlying01, symbolHash: symbolHash01, baseUnit: baseUnit01, priceSource: priceSource01, fixedPrice: fixedPrice01, uniswapMarket: uniswapMarket01, reporter: reporter01, reporterInvalidated: reporterInvalidated01, isUniswapReversed: isUniswapReversed01});
    if (i == 2) return TokenConfig({cToken: cToken02, underlying: underlying02, symbolHash: symbolHash02, baseUnit: baseUnit02, priceSource: priceSource02, fixedPrice: fixedPrice02, uniswapMarket: uniswapMarket02, reporter: reporter02, reporterInvalidated: reporterInvalidated02, isUniswapReversed: isUniswapReversed02});
    if (i == 3) return TokenConfig({cToken: cToken03, underlying: underlying03, symbolHash: symbolHash03, baseUnit: baseUnit03, priceSource: priceSource03, fixedPrice: fixedPrice03, uniswapMarket: uniswapMarket03, reporter: reporter03, reporterInvalidated: reporterInvalidated03, isUniswapReversed: isUniswapReversed03});
    if (i == 4) return TokenConfig({cToken: cToken04, underlying: underlying04, symbolHash: symbolHash04, baseUnit: baseUnit04, priceSource: priceSource04, fixedPrice: fixedPrice04, uniswapMarket: uniswapMarket04, reporter: reporter04, reporterInvalidated: reporterInvalidated04, isUniswapReversed: isUniswapReversed04});
    if (i == 5) return TokenConfig({cToken: cToken05, underlying: underlying05, symbolHash: symbolHash05, baseUnit: baseUnit05, priceSource: priceSource05, fixedPrice: fixedPrice05, uniswapMarket: uniswapMarket05, reporter: reporter05, reporterInvalidated: reporterInvalidated05, isUniswapReversed: isUniswapReversed05});
    if (i == 6) return TokenConfig({cToken: cToken06, underlying: underlying06, symbolHash: symbolHash06, baseUnit: baseUnit06, priceSource: priceSource06, fixedPrice: fixedPrice06, uniswapMarket: uniswapMarket06, reporter: reporter06, reporterInvalidated: reporterInvalidated06, isUniswapReversed: isUniswapReversed06});
    if (i == 7) return TokenConfig({cToken: cToken07, underlying: underlying07, symbolHash: symbolHash07, baseUnit: baseUnit07, priceSource: priceSource07, fixedPrice: fixedPrice07, uniswapMarket: uniswapMarket07, reporter: reporter07, reporterInvalidated: reporterInvalidated07, isUniswapReversed: isUniswapReversed07});
    if (i == 8) return TokenConfig({cToken: cToken08, underlying: underlying08, symbolHash: symbolHash08, baseUnit: baseUnit08, priceSource: priceSource08, fixedPrice: fixedPrice08, uniswapMarket: uniswapMarket08, reporter: reporter08, reporterInvalidated: reporterInvalidated08, isUniswapReversed: isUniswapReversed08});
    if (i == 9) return TokenConfig({cToken: cToken09, underlying: underlying09, symbolHash: symbolHash09, baseUnit: baseUnit09, priceSource: priceSource09, fixedPrice: fixedPrice09, uniswapMarket: uniswapMarket09, reporter: reporter09, reporterInvalidated: reporterInvalidated09, isUniswapReversed: isUniswapReversed09});

    if (i == 10) return TokenConfig({cToken: cToken10, underlying: underlying10, symbolHash: symbolHash10, baseUnit: baseUnit10, priceSource: priceSource10, fixedPrice: fixedPrice10, uniswapMarket: uniswapMarket10, reporter: reporter10, reporterInvalidated: reporterInvalidated10, isUniswapReversed: isUniswapReversed10});
    if (i == 11) return TokenConfig({cToken: cToken11, underlying: underlying11, symbolHash: symbolHash11, baseUnit: baseUnit11, priceSource: priceSource11, fixedPrice: fixedPrice11, uniswapMarket: uniswapMarket11, reporter: reporter11, reporterInvalidated: reporterInvalidated11, isUniswapReversed: isUniswapReversed11});
    if (i == 12) return TokenConfig({cToken: cToken12, underlying: underlying12, symbolHash: symbolHash12, baseUnit: baseUnit12, priceSource: priceSource12, fixedPrice: fixedPrice12, uniswapMarket: uniswapMarket12, reporter: reporter12, reporterInvalidated: reporterInvalidated12, isUniswapReversed: isUniswapReversed12});
    if (i == 13) return TokenConfig({cToken: cToken13, underlying: underlying13, symbolHash: symbolHash13, baseUnit: baseUnit13, priceSource: priceSource13, fixedPrice: fixedPrice13, uniswapMarket: uniswapMarket13, reporter: reporter13, reporterInvalidated: reporterInvalidated13, isUniswapReversed: isUniswapReversed13});
    if (i == 14) return TokenConfig({cToken: cToken14, underlying: underlying14, symbolHash: symbolHash14, baseUnit: baseUnit14, priceSource: priceSource14, fixedPrice: fixedPrice14, uniswapMarket: uniswapMarket14, reporter: reporter14, reporterInvalidated: reporterInvalidated14, isUniswapReversed: isUniswapReversed14});
    if (i == 15) return TokenConfig({cToken: cToken15, underlying: underlying15, symbolHash: symbolHash15, baseUnit: baseUnit15, priceSource: priceSource15, fixedPrice: fixedPrice15, uniswapMarket: uniswapMarket15, reporter: reporter15, reporterInvalidated: reporterInvalidated15, isUniswapReversed: isUniswapReversed15});
    if (i == 16) return TokenConfig({cToken: cToken16, underlying: underlying16, symbolHash: symbolHash16, baseUnit: baseUnit16, priceSource: priceSource16, fixedPrice: fixedPrice16, uniswapMarket: uniswapMarket16, reporter: reporter16, reporterInvalidated: reporterInvalidated16, isUniswapReversed: isUniswapReversed16});
    if (i == 17) return TokenConfig({cToken: cToken17, underlying: underlying17, symbolHash: symbolHash17, baseUnit: baseUnit17, priceSource: priceSource17, fixedPrice: fixedPrice17, uniswapMarket: uniswapMarket17, reporter: reporter17, reporterInvalidated: reporterInvalidated17, isUniswapReversed: isUniswapReversed17});
    if (i == 18) return TokenConfig({cToken: cToken18, underlying: underlying18, symbolHash: symbolHash18, baseUnit: baseUnit18, priceSource: priceSource18, fixedPrice: fixedPrice18, uniswapMarket: uniswapMarket18, reporter: reporter18, reporterInvalidated: reporterInvalidated18, isUniswapReversed: isUniswapReversed18});
    if (i == 19) return TokenConfig({cToken: cToken19, underlying: underlying19, symbolHash: symbolHash19, baseUnit: baseUnit19, priceSource: priceSource19, fixedPrice: fixedPrice19, uniswapMarket: uniswapMarket19, reporter: reporter19, reporterInvalidated: reporterInvalidated19, isUniswapReversed: isUniswapReversed19});

    if (i == 20) return TokenConfig({cToken: cToken20, underlying: underlying20, symbolHash: symbolHash20, baseUnit: baseUnit20, priceSource: priceSource20, fixedPrice: fixedPrice20, uniswapMarket: uniswapMarket20, reporter: reporter20, reporterInvalidated: reporterInvalidated20, isUniswapReversed: isUniswapReversed20});
    if (i == 21) return TokenConfig({cToken: cToken21, underlying: underlying21, symbolHash: symbolHash21, baseUnit: baseUnit21, priceSource: priceSource21, fixedPrice: fixedPrice21, uniswapMarket: uniswapMarket21, reporter: reporter21, reporterInvalidated: reporterInvalidated21, isUniswapReversed: isUniswapReversed21});
    if (i == 22) return TokenConfig({cToken: cToken22, underlying: underlying22, symbolHash: symbolHash22, baseUnit: baseUnit22, priceSource: priceSource22, fixedPrice: fixedPrice22, uniswapMarket: uniswapMarket22, reporter: reporter22, reporterInvalidated: reporterInvalidated22, isUniswapReversed: isUniswapReversed22});
    if (i == 23) return TokenConfig({cToken: cToken23, underlying: underlying23, symbolHash: symbolHash23, baseUnit: baseUnit23, priceSource: priceSource23, fixedPrice: fixedPrice23, uniswapMarket: uniswapMarket23, reporter: reporter23, reporterInvalidated: reporterInvalidated23, isUniswapReversed: isUniswapReversed23});
    if (i == 24) return TokenConfig({cToken: cToken24, underlying: underlying24, symbolHash: symbolHash24, baseUnit: baseUnit24, priceSource: priceSource24, fixedPrice: fixedPrice24, uniswapMarket: uniswapMarket24, reporter: reporter24, reporterInvalidated: reporterInvalidated24, isUniswapReversed: isUniswapReversed24});
    if (i == 25) return TokenConfig({cToken: cToken25, underlying: underlying25, symbolHash: symbolHash25, baseUnit: baseUnit25, priceSource: priceSource25, fixedPrice: fixedPrice25, uniswapMarket: uniswapMarket25, reporter: reporter25, reporterInvalidated: reporterInvalidated25, isUniswapReversed: isUniswapReversed25});
    if (i == 26) return TokenConfig({cToken: cToken26, underlying: underlying26, symbolHash: symbolHash26, baseUnit: baseUnit26, priceSource: priceSource26, fixedPrice: fixedPrice26, uniswapMarket: uniswapMarket26, reporter: reporter26, reporterInvalidated: reporterInvalidated26, isUniswapReversed: isUniswapReversed26});
    if (i == 27) return TokenConfig({cToken: cToken27, underlying: underlying27, symbolHash: symbolHash27, baseUnit: baseUnit27, priceSource: priceSource27, fixedPrice: fixedPrice27, uniswapMarket: uniswapMarket27, reporter: reporter27, reporterInvalidated: reporterInvalidated27, isUniswapReversed: isUniswapReversed27});
    if (i == 28) return TokenConfig({cToken: cToken28, underlying: underlying28, symbolHash: symbolHash28, baseUnit: baseUnit28, priceSource: priceSource28, fixedPrice: fixedPrice28, uniswapMarket: uniswapMarket28, reporter: reporter28, reporterInvalidated: reporterInvalidated28, isUniswapReversed: isUniswapReversed28});
    if (i == 29) return TokenConfig({cToken: cToken29, underlying: underlying29, symbolHash: symbolHash29, baseUnit: baseUnit29, priceSource: priceSource29, fixedPrice: fixedPrice29, uniswapMarket: uniswapMarket29, reporter: reporter29, reporterInvalidated: reporterInvalidated29, isUniswapReversed: isUniswapReversed29});
  }
