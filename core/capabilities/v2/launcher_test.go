...
import (
	...
	registrysyncer "github.com/smartcontractkit/chainlink/v2/core/services/registrysyncer/v2"
)
...
func TestLauncher(t *testing.T) {
	t.Run("OK-wires_up_external_capabilities", func(t *testing.T) {
		...
		missingTargetCapID := "missing-target@6.6.6"
		dID := uint32(1)
		...
		state := &registrysyncer.LocalRegistry{
			...
			IDsToNodes: map[p2ptypes.PeerID]capabilities_registry_v2.INodeInfoProviderNodeInfo{
				nodes[0]: {
					NodeOperatorId:      1,
					Signer:              RandomUTF8BytesWord(),
					P2pId:               nodes[0],
					EncryptionPublicKey: RandomUTF8BytesWord(),
					CapabilityIds:       []string{fullTriggerCapID, fullTargetID, missingTargetCapID},
				},
				nodes[1]: {
					NodeOperatorId:      1,
					Signer:              RandomUTF8BytesWord(),
		...
		state := &registrysyncer.LocalRegistry{
			...
			IDsToNodes: map[p2ptypes.PeerID]capabilities_registry_v2.INodeInfoProviderNodeInfo{
				nodes[0]: {
					...
					P2pId:               nodes[0],
					EncryptionPublicKey: RandomUTF8BytesWord(),
					CapabilityIds:       []string{fullTriggerCapID},
				},
				nodes[1]: {
					NodeOperatorId:      1,
					Signer:              RandomUTF8BytesWord(),
		...
		state := &registrysyncer.LocalRegistry{
			...
			IDsToNodes: map[p2ptypes.PeerID]capabilities_registry_v2.INodeInfoProviderNodeInfo{
				nodes[0]: {
					...
					P2pId:               nodes[0],
					EncryptionPublicKey: RandomUTF8BytesWord(),
					CapabilityIds:       []string{fullTargetID},
				},
				nodes[1]: {
					NodeOperatorId:      1,
					Signer:              RandomUTF8BytesWord(),
	...
	state := &registrysyncer.LocalRegistry{
		...
		IDsToNodes: map[p2ptypes.PeerID]capabilities_registry_v2.INodeInfoProviderNodeInfo{
			capabilityDonNodes[0]: {
				...
				EncryptionPublicKey: RandomUTF8BytesWord(),
				CapabilityIds:       []string{fullTriggerCapID, fullTargetID},
			},
	...
	state := &registrysyncer.LocalRegistry{
		...
		IDsToNodes: map[p2ptypes.PeerID]capabilities_registry_v2.INodeInfoProviderNodeInfo{
			nodes[0]: {
				...
				P2pId:               nodes[0],
				EncryptionPublicKey: RandomUTF8BytesWord(),
				CapabilityIds:       []string{triggerID, targetID},
			},
			nodes[1]: {
				NodeOperatorId:      1,
				Signer:              RandomUTF8BytesWord(),
