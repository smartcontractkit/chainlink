...
var (
	file_core_capabilities_remote_types_messages_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
	file_core_capabilities_remote_types_messages_proto_msgTypes  = make([]protoimpl.MessageInfo, 4)
	file_core_capabilities_remote_types_messages_proto_goTypes   = []any{
