...
func (_m *Receiver) Receive(ctx context.Context, msg *MessageBody) {
	_m.Called(ctx, msg)
}
...
func (_c *Receiver_Receive_Call) Run(run func(ctx context.Context, msg *MessageBody)) *Receiver_Receive_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*MessageBody))
	})
	return _c
}
...
func (_c *Receiver_Receive_Call) RunAndReturn(run func(context.Context, *MessageBody)) *Receiver_Receive_Call {
	_c.Call.Return(run)
	return _c
}
