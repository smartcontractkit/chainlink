...
// Dispatcher_Name_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'String'
...
func (_e *Dispatcher_Expecter) Name() *Dispatcher_Name_Call {
	return &Dispatcher_Name_Call{Call: _e.mock.On("String")}
}
