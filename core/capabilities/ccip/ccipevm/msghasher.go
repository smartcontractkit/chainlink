...
import (
	...
	types2 "github.com/smartcontractkit/chainlink/v2/core/capabilities/ccip/types"
...
type MessageHasherV1 struct {
	lggr           logger.Logger
	extraDataCodec types2.ExtraDataCodec
}

func NewMessageHasherV1(lggr logger.Logger, extraDataCodec types2.ExtraDataCodec) *MessageHasherV1 {
