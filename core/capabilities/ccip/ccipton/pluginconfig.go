...
import (
	...
	"github.com/smartcontractkit/chainlink-ton/cciplib/ccip/codec" //nolint:depguard // ccipton is a TON LOOPP plugin and requires the chainlink-ton SDK
...
func InitializePluginConfig(lggr logger.Logger, extraDataCodec ccipocr3.ExtraDataCodecBundle) ccipcommon.PluginConfig {
	return ccipcommon.PluginConfig{
		...
		// TODO(EVM2TON): this is a temp fix for nil msgHasher access, should be using CCIPProvider msgHasher instead, https://smartcontract-it.atlassian.net/browse/NONEVM-2778
