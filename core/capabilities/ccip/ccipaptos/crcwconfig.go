...
import (
	...
	aptosloop "github.com/smartcontractkit/chainlink-aptos/codec/loop" //nolint:depguard // ccipaptos is an Aptos LOOPP plugin and requires the chainlink-aptos SDK
