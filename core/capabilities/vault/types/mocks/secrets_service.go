...
import (
	...
	types "github.com/smartcontractkit/chainlink/v2/core/capabilities/vault/types"
...
func (_m *SecretsService) CreateSecrets(ctx context.Context, request *vault.CreateSecretsRequest) (*types.Response, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *vault.CreateSecretsRequest) (*types.Response, error)); ok {
		return rf(ctx, request)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *vault.CreateSecretsRequest) *types.Response); ok {
		r0 = rf(ctx, request)
	} else {
		if ret.Get(0) != nil {
...
func (_c *SecretsService_CreateSecrets_Call) Return(_a0 *types.Response, _a1 error) *SecretsService_CreateSecrets_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *SecretsService_CreateSecrets_Call) RunAndReturn(run func(context.Context, *vault.CreateSecretsRequest) (*types.Response, error)) *SecretsService_CreateSecrets_Call {
	_c.Call.Return(run)
	return _c
}

// DeleteSecrets provides a mock function with given fields: ctx, request
func (_m *SecretsService) DeleteSecrets(ctx context.Context, request *vault.DeleteSecretsRequest) (*types.Response, error) {
	ret := _m.Called(ctx, request)
	...
	var r0 *types.Response
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *vault.DeleteSecretsRequest) (*types.Response, error)); ok {
		return rf(ctx, request)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *vault.DeleteSecretsRequest) *types.Response); ok {
		r0 = rf(ctx, request)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*types.Response)
...
func (_c *SecretsService_DeleteSecrets_Call) Return(_a0 *types.Response, _a1 error) *SecretsService_DeleteSecrets_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *SecretsService_DeleteSecrets_Call) RunAndReturn(run func(context.Context, *vault.DeleteSecretsRequest) (*types.Response, error)) *SecretsService_DeleteSecrets_Call {
	_c.Call.Return(run)
	return _c
}

// GetSecrets provides a mock function with given fields: ctx, requestID, request
func (_m *SecretsService) GetSecrets(ctx context.Context, requestID string, request *vault.GetSecretsRequest) (*types.Response, error) {
	...
	var r0 *types.Response
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, *vault.GetSecretsRequest) (*types.Response, error)); ok {
		return rf(ctx, requestID, request)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, *vault.GetSecretsRequest) *types.Response); ok {
...
func (_c *SecretsService_GetSecrets_Call) Return(_a0 *types.Response, _a1 error) *SecretsService_GetSecrets_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *SecretsService_GetSecrets_Call) RunAndReturn(run func(context.Context, string, *vault.GetSecretsRequest) (*types.Response, error)) *SecretsService_GetSecrets_Call {
	_c.Call.Return(run)
	return _c
}

// ListSecretIdentifiers provides a mock function with given fields: ctx, request
func (_m *SecretsService) ListSecretIdentifiers(ctx context.Context, request *vault.ListSecretIdentifiersRequest) (*types.Response, error) {
	ret := _m.Called(ctx, request)
	...
	var r0 *types.Response
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *vault.ListSecretIdentifiersRequest) (*types.Response, error)); ok {
		return rf(ctx, request)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *vault.ListSecretIdentifiersRequest) *types.Response); ok {
		r0 = rf(ctx, request)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*types.Response)
...
func (_c *SecretsService_ListSecretIdentifiers_Call) Return(_a0 *types.Response, _a1 error) *SecretsService_ListSecretIdentifiers_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *SecretsService_ListSecretIdentifiers_Call) RunAndReturn(run func(context.Context, *vault.ListSecretIdentifiersRequest) (*types.Response, error)) *SecretsService_ListSecretIdentifiers_Call {
	_c.Call.Return(run)
	return _c
}

// UpdateSecrets provides a mock function with given fields: ctx, request
func (_m *SecretsService) UpdateSecrets(ctx context.Context, request *vault.UpdateSecretsRequest) (*types.Response, error) {
	ret := _m.Called(ctx, request)
	...
	var r0 *types.Response
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *vault.UpdateSecretsRequest) (*types.Response, error)); ok {
		return rf(ctx, request)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *vault.UpdateSecretsRequest) *types.Response); ok {
		r0 = rf(ctx, request)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*types.Response)
...
func (_c *SecretsService_UpdateSecrets_Call) Return(_a0 *types.Response, _a1 error) *SecretsService_UpdateSecrets_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *SecretsService_UpdateSecrets_Call) RunAndReturn(run func(context.Context, *vault.UpdateSecretsRequest) (*types.Response, error)) *SecretsService_UpdateSecrets_Call {
	_c.Call.Return(run)
	return _c
}
