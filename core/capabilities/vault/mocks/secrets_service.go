...
import (
	...
	capabilitiesvault "github.com/smartcontractkit/chainlink/v2/core/capabilities/vault"
...
func (_m *SecretsService) CreateSecrets(ctx context.Context, request *vault.CreateSecretsRequest) (*capabilitiesvault.Response, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *vault.CreateSecretsRequest) (*capabilitiesvault.Response, error)); ok {
		return rf(ctx, request)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *vault.CreateSecretsRequest) *capabilitiesvault.Response); ok {
		r0 = rf(ctx, request)
	} else {
		if ret.Get(0) != nil {
...
func (_c *SecretsService_CreateSecrets_Call) Return(_a0 *capabilitiesvault.Response, _a1 error) *SecretsService_CreateSecrets_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *SecretsService_CreateSecrets_Call) RunAndReturn(run func(context.Context, *vault.CreateSecretsRequest) (*capabilitiesvault.Response, error)) *SecretsService_CreateSecrets_Call {
	_c.Call.Return(run)
	return _c
}

// DeleteSecrets provides a mock function with given fields: ctx, request
func (_m *SecretsService) DeleteSecrets(ctx context.Context, request *vault.DeleteSecretsRequest) (*capabilitiesvault.Response, error) {
	ret := _m.Called(ctx, request)
	...
	var r0 *capabilitiesvault.Response
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *vault.DeleteSecretsRequest) (*capabilitiesvault.Response, error)); ok {
		return rf(ctx, request)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *vault.DeleteSecretsRequest) *capabilitiesvault.Response); ok {
		r0 = rf(ctx, request)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*capabilitiesvault.Response)
...
func (_c *SecretsService_DeleteSecrets_Call) Return(_a0 *capabilitiesvault.Response, _a1 error) *SecretsService_DeleteSecrets_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *SecretsService_DeleteSecrets_Call) RunAndReturn(run func(context.Context, *vault.DeleteSecretsRequest) (*capabilitiesvault.Response, error)) *SecretsService_DeleteSecrets_Call {
	_c.Call.Return(run)
	return _c
}

// GetSecrets provides a mock function with given fields: ctx, requestID, request
func (_m *SecretsService) GetSecrets(ctx context.Context, requestID string, request *vault.GetSecretsRequest) (*capabilitiesvault.Response, error) {
	...
	var r0 *capabilitiesvault.Response
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, *vault.GetSecretsRequest) (*capabilitiesvault.Response, error)); ok {
		return rf(ctx, requestID, request)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, *vault.GetSecretsRequest) *capabilitiesvault.Response); ok {
...
func (_c *SecretsService_GetSecrets_Call) Return(_a0 *capabilitiesvault.Response, _a1 error) *SecretsService_GetSecrets_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *SecretsService_GetSecrets_Call) RunAndReturn(run func(context.Context, string, *vault.GetSecretsRequest) (*capabilitiesvault.Response, error)) *SecretsService_GetSecrets_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *SecretsService) UpdateSecrets(ctx context.Context, request *vault.UpdateSecretsRequest) (*capabilitiesvault.Response, error) {
	...
	var r0 *capabilitiesvault.Response
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *vault.UpdateSecretsRequest) (*capabilitiesvault.Response, error)); ok {
		return rf(ctx, request)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *vault.UpdateSecretsRequest) *capabilitiesvault.Response); ok {
		r0 = rf(ctx, request)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*capabilitiesvault.Response)
...
func (_c *SecretsService_UpdateSecrets_Call) Return(_a0 *capabilitiesvault.Response, _a1 error) *SecretsService_UpdateSecrets_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *SecretsService_UpdateSecrets_Call) RunAndReturn(run func(context.Context, *vault.UpdateSecretsRequest) (*capabilitiesvault.Response, error)) *SecretsService_UpdateSecrets_Call {
	_c.Call.Return(run)
	return _c
}
