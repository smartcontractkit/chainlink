...
func (_m *SecretsService) ListSecretIdentifiers(ctx context.Context, request *vault.ListSecretIdentifiersRequest) (*pluginsvault.Response, error) {
	ret := _m.Called(ctx, request)
	...
	var r0 *pluginsvault.Response
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *vault.ListSecretIdentifiersRequest) (*pluginsvault.Response, error)); ok {
		return rf(ctx, request)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *vault.ListSecretIdentifiersRequest) *pluginsvault.Response); ok {
		r0 = rf(ctx, request)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*pluginsvault.Response)
...
func (_c *SecretsService_ListSecretIdentifiers_Call) Return(_a0 *pluginsvault.Response, _a1 error) *SecretsService_ListSecretIdentifiers_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *SecretsService_ListSecretIdentifiers_Call) RunAndReturn(run func(context.Context, *vault.ListSecretIdentifiersRequest) (*pluginsvault.Response, error)) *SecretsService_ListSecretIdentifiers_Call {
	_c.Call.Return(run)
	return _c
}
