...
// 		return nil, err
// 	}
// 	if err := capRegistry.Add(ctx, trigger.TriggerCapability); err != nil {
// 		return nil, err
// 	}
//
// 	return trigger, nil
...
// }
//
// func (o *MockTriggerService) RegisterTrigger(ctx context.Context, req capabilities.CapabilityRequest) (<-chan capabilities.TriggerResponse, error) {
...
//
// func NewMockDataProducer(trigger *MockTriggerService, meta datastreams.Metadata, signers []*ecdsa.PrivateKey, feedIDs []string, lggr logger.Logger) *mockDataProducer {
