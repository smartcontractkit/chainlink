...
// ReplaySequence provides a mock function with given fields: ctx, contractName, key, blockID
func (_m *ChainReader) ReplaySequence(ctx context.Context, contractName string, key string, blockID string) error {
	ret := _m.Called(ctx, contractName, key, blockID)

	if len(ret) == 0 {
		panic("no return value specified for ReplaySequence")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, string) error); ok {
		r0 = rf(ctx, contractName, key, blockID)
	} else {
		r0 = ret.Error(0)
	}
...
// ChainReader_ReplaySequence_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ReplaySequence'
type ChainReader_ReplaySequence_Call struct {
	*mock.Call
}

// ReplaySequence is a helper method to define mock.On call
//   - ctx context.Context
//   - contractName string
//   - key string
//   - blockID string
func (_e *ChainReader_Expecter) ReplaySequence(ctx interface{}, contractName interface{}, key interface{}, blockID interface{}) *ChainReader_ReplaySequence_Call {
	return &ChainReader_ReplaySequence_Call{Call: _e.mock.On("ReplaySequence", ctx, contractName, key, blockID)}
}

func (_c *ChainReader_ReplaySequence_Call) Run(run func(ctx context.Context, contractName string, key string, blockID string)) *ChainReader_ReplaySequence_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *ChainReader_ReplaySequence_Call) Return(_a0 error) *ChainReader_ReplaySequence_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *ChainReader_ReplaySequence_Call) RunAndReturn(run func(context.Context, string, string, string) error) *ChainReader_ReplaySequence_Call {
	_c.Call.Return(run)
	return _c
}
