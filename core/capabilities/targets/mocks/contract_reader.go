...
func (_m *ContractReader) mustEmbedUnimplementedContractReaderServer() {
	_m.Called()
}

// ContractReader_mustEmbedUnimplementedContractReaderServer_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'mustEmbedUnimplementedContractReaderServer'
type ContractReader_mustEmbedUnimplementedContractReaderServer_Call struct {
	*mock.Call
}

// mustEmbedUnimplementedContractReaderServer is a helper method to define mock.On call
func (_e *ContractReader_Expecter) mustEmbedUnimplementedContractReaderServer() *ContractReader_mustEmbedUnimplementedContractReaderServer_Call {
	return &ContractReader_mustEmbedUnimplementedContractReaderServer_Call{Call: _e.mock.On("mustEmbedUnimplementedContractReaderServer")}
}

func (_c *ContractReader_mustEmbedUnimplementedContractReaderServer_Call) Run(run func()) *ContractReader_mustEmbedUnimplementedContractReaderServer_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *ContractReader_mustEmbedUnimplementedContractReaderServer_Call) Return() *ContractReader_mustEmbedUnimplementedContractReaderServer_Call {
	_c.Call.Return()
	return _c
}

func (_c *ContractReader_mustEmbedUnimplementedContractReaderServer_Call) RunAndReturn(run func()) *ContractReader_mustEmbedUnimplementedContractReaderServer_Call {
	_c.Call.Return(run)
	return _c
}
