...
// testEnclaveConfig satisfies chainlink-common's validateEnclaveConfig (PRIV-458).
// Required on CapabilityRequestParams and SecretsRequestParams so Hash() succeeds when signing responses.
