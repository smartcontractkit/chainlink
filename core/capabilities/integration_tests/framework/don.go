...
func CreateDonContextWithWorkflowRegistry(ctx context.Context, t *testing.T, syncerFetcherFunc wftypes.FetcherFunc) DonContext {
...
func NewDON(ctx context.Context, t *testing.T, lggr logger.Logger, donConfig DonConfiguration,
	...
	for i, member := range donConfig.Members {
		...
		capabilityRegistry := registry.NewRegistry(lggr)
...
func startNewNode(ctx context.Context,
	...
	localCapabilities *registry.Registry,
