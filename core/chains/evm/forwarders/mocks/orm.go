...
func (_m *ORM) DeleteForwarder(ctx context.Context, id int64, cleanup func(sqlutil.Queryer, int64, common.Address) error) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, int64, func(sqlutil.Queryer, int64, common.Address) error) error); ok {
