...
func (_m *ORM) CreateForwarder(ctx context.Context, addr common.Address, evmChainId big.Big) (Forwarder, error) {
	...
	var r0 Forwarder
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, common.Address, big.Big) (Forwarder, error)); ok {
		return rf(ctx, addr, evmChainId)
	}
	if rf, ok := ret.Get(0).(func(context.Context, common.Address, big.Big) Forwarder); ok {
		r0 = rf(ctx, addr, evmChainId)
	} else {
		r0 = ret.Get(0).(Forwarder)
	}
...
func (_c *ORM_CreateForwarder_Call) Return(fwd Forwarder, err error) *ORM_CreateForwarder_Call {
	_c.Call.Return(fwd, err)
	return _c
}

func (_c *ORM_CreateForwarder_Call) RunAndReturn(run func(context.Context, common.Address, big.Big) (Forwarder, error)) *ORM_CreateForwarder_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *ORM) FindForwarders(ctx context.Context, offset int, limit int) ([]Forwarder, int, error) {
	...
	var r1 int
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, int, int) ([]Forwarder, int, error)); ok {
		return rf(ctx, offset, limit)
	}
	if rf, ok := ret.Get(0).(func(context.Context, int, int) []Forwarder); ok {
...
func (_c *ORM_FindForwarders_Call) Return(_a0 []Forwarder, _a1 int, _a2 error) *ORM_FindForwarders_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *ORM_FindForwarders_Call) RunAndReturn(run func(context.Context, int, int) ([]Forwarder, int, error)) *ORM_FindForwarders_Call {
	_c.Call.Return(run)
	return _c
}

// FindForwardersByChain provides a mock function with given fields: ctx, evmChainId
func (_m *ORM) FindForwardersByChain(ctx context.Context, evmChainId big.Big) ([]Forwarder, error) {
	...
	var r0 []Forwarder
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, big.Big) ([]Forwarder, error)); ok {
		return rf(ctx, evmChainId)
	}
	if rf, ok := ret.Get(0).(func(context.Context, big.Big) []Forwarder); ok {
...
func (_c *ORM_FindForwardersByChain_Call) Return(_a0 []Forwarder, _a1 error) *ORM_FindForwardersByChain_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *ORM_FindForwardersByChain_Call) RunAndReturn(run func(context.Context, big.Big) ([]Forwarder, error)) *ORM_FindForwardersByChain_Call {
	_c.Call.Return(run)
	return _c
}

// FindForwardersInListByChain provides a mock function with given fields: ctx, evmChainId, addrs
func (_m *ORM) FindForwardersInListByChain(ctx context.Context, evmChainId big.Big, addrs []common.Address) ([]Forwarder, error) {
	...
	var r0 []Forwarder
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, big.Big, []common.Address) ([]Forwarder, error)); ok {
		return rf(ctx, evmChainId, addrs)
	}
	if rf, ok := ret.Get(0).(func(context.Context, big.Big, []common.Address) []Forwarder); ok {
...
func (_c *ORM_FindForwardersInListByChain_Call) Return(_a0 []Forwarder, _a1 error) *ORM_FindForwardersInListByChain_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *ORM_FindForwardersInListByChain_Call) RunAndReturn(run func(context.Context, big.Big, []common.Address) ([]Forwarder, error)) *ORM_FindForwardersInListByChain_Call {
	_c.Call.Return(run)
	return _c
}
