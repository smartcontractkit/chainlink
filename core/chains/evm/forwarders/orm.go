...
type ORM interface {
	CreateForwarder(addr common.Address, evmChainId utils.Big, qopts ...pg.QOpt) (fwd EVMForwarder, err error)
	FindForwarders(offset, limit int) ([]EVMForwarder, int, error)
	DeleteForwarder(id int32, qopts ...pg.QOpt) error
}
...
func (o *orm) CreateForwarder(addr common.Address, evmChainId utils.Big, qopts ...pg.QOpt) (fwd EVMForwarder, err error) {
...
func (o *orm) DeleteForwarder(id int32, qopts ...pg.QOpt) error {
