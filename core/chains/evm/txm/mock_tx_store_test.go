...
func (_m *mockTxStore) FindNextNonce(_a0 context.Context, _a1 common.Address, _a2 *big.Int) (uint64, error) {
	ret := _m.Called(_a0, _a1, _a2)
...
// mockTxStore_FindNextNonce_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'FindNextNonce'
type mockTxStore_FindNextNonce_Call struct {
	*mock.Call
}
...
//   - _a1 common.Address
//   - _a2 *big.Int
func (_e *mockTxStore_Expecter) FindNextNonce(_a0 interface{}, _a1 interface{}, _a2 interface{}) *mockTxStore_FindNextNonce_Call {
	return &mockTxStore_FindNextNonce_Call{Call: _e.mock.On("FindNextNonce", _a0, _a1, _a2)}
}

func (_c *mockTxStore_FindNextNonce_Call) Run(run func(_a0 context.Context, _a1 common.Address, _a2 *big.Int)) *mockTxStore_FindNextNonce_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *mockTxStore_FindNextNonce_Call) Return(_a0 uint64, _a1 error) *mockTxStore_FindNextNonce_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *mockTxStore_FindNextNonce_Call) RunAndReturn(run func(context.Context, common.Address, *big.Int) (uint64, error)) *mockTxStore_FindNextNonce_Call {
	_c.Call.Return(run)
	return _c
}
