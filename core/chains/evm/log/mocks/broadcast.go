...
// NewBroadcast creates a new instance of Broadcast. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewBroadcast(t testing.TB) *Broadcast {
	mock := &Broadcast{}
	mock.Mock.Test(t)
