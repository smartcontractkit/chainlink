...
func (_m *Broadcaster) MarkConsumed(ctx context.Context, ds sqlutil.DataSource, lb Broadcast) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, sqlutil.DataSource, Broadcast) error); ok {
		r0 = rf(ctx, ds, lb)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *Broadcaster_MarkConsumed_Call) Run(run func(ctx context.Context, ds sqlutil.DataSource, lb Broadcast)) *Broadcaster_MarkConsumed_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(sqlutil.DataSource), args[2].(Broadcast))
	})
	return _c
}
...
func (_c *Broadcaster_MarkConsumed_Call) RunAndReturn(run func(context.Context, sqlutil.DataSource, Broadcast) error) *Broadcaster_MarkConsumed_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Broadcaster) Register(listener Listener, opts ListenerOpts) func() {
	...
	var r0 func()
	if rf, ok := ret.Get(0).(func(Listener, ListenerOpts) func()); ok {
		r0 = rf(listener, opts)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(func())
...
func (_c *Broadcaster_Register_Call) Run(run func(listener Listener, opts ListenerOpts)) *Broadcaster_Register_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(Listener), args[1].(ListenerOpts))
	})
	return _c
}
...
func (_c *Broadcaster_Register_Call) RunAndReturn(run func(Listener, ListenerOpts) func()) *Broadcaster_Register_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Broadcaster) WasAlreadyConsumed(ctx context.Context, lb Broadcast) (bool, error) {
	...
	var r0 bool
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, Broadcast) (bool, error)); ok {
		return rf(ctx, lb)
	}
	if rf, ok := ret.Get(0).(func(context.Context, Broadcast) bool); ok {
		r0 = rf(ctx, lb)
	} else {
		r0 = ret.Get(0).(bool)
	}

	if rf, ok := ret.Get(1).(func(context.Context, Broadcast) error); ok {
		r1 = rf(ctx, lb)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *Broadcaster_WasAlreadyConsumed_Call) Run(run func(ctx context.Context, lb Broadcast)) *Broadcaster_WasAlreadyConsumed_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(Broadcast))
	})
	return _c
}
...
func (_c *Broadcaster_WasAlreadyConsumed_Call) RunAndReturn(run func(context.Context, Broadcast) (bool, error)) *Broadcaster_WasAlreadyConsumed_Call {
	_c.Call.Return(run)
	return _c
}
