...
// NewBroadcaster creates a new instance of Broadcaster. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewBroadcaster(t testing.TB) *Broadcaster {
	mock := &Broadcaster{}
	mock.Mock.Test(t)
