...
// Broadcaster_Name_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'String'
...
func (_e *Broadcaster_Expecter) Name() *Broadcaster_Name_Call {
	return &Broadcaster_Name_Call{Call: _e.mock.On("String")}
}
