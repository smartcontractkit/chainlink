...
func (_m *mockILogPool) getAndDeleteAll() ([]logsOnBlock, int64, int64) {
	...
	var r1 int64
	var r2 int64
	if rf, ok := ret.Get(0).(func() ([]logsOnBlock, int64, int64)); ok {
		return rf()
	}
...
func (_m *mockILogPool) getLogsToSend(latestBlockNum int64) ([]logsOnBlock, int64) {
	...
	var r0 []logsOnBlock
	var r1 int64
	if rf, ok := ret.Get(0).(func(int64) ([]logsOnBlock, int64)); ok {
		return rf(latestBlockNum)
	}
...
type mockConstructorTestingTnewMockILogPool interface {
	mock.TestingT
	Cleanup(func())
}

// newMockILogPool creates a new instance of mockILogPool. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func newMockILogPool(t mockConstructorTestingTnewMockILogPool) *mockILogPool {
	mock := &mockILogPool{}
	mock.Mock.Test(t)
