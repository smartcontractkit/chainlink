...
type mockConstructorTestingTNewLegacyChainContainer interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewLegacyChainContainer(t mockConstructorTestingTNewLegacyChainContainer) *LegacyChainContainer {
