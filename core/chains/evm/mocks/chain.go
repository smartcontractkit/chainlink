...
func (_m *Chain) TxManager() txmgr.TxManager[*evmtypes.Address, *evmtypes.hash, *evmtypes.hash] {
	ret := _m.Called()

	var r0 txmgr.TxManager[*evmtypes.Address, *evmtypes.hash, *evmtypes.hash]
	if rf, ok := ret.Get(0).(func() txmgr.TxManager[*evmtypes.Address, *evmtypes.hash, *evmtypes.hash]); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(txmgr.TxManager[*evmtypes.Address, *evmtypes.hash, *evmtypes.hash])
		}
	}
