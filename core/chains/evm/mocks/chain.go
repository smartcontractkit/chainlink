...
func (_m *Chain) HeadBroadcaster() services.HeadBroadcaster {
	ret := _m.Called()

	var r0 services.HeadBroadcaster
	if rf, ok := ret.Get(0).(func() services.HeadBroadcaster); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(services.HeadBroadcaster)
		}
	}
...
func (_m *Chain) HeadTracker() services.Tracker {
	ret := _m.Called()

	var r0 services.Tracker
	if rf, ok := ret.Get(0).(func() services.Tracker); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(services.Tracker)
		}
	}
