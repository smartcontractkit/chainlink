...
// MockChainClientRPC is an autogenerated mock type for the ChainClientRPC type
type MockChainClientRPC struct {
	mock.Mock
}

// BalanceAt provides a mock function with given fields: ctx, accountAddress, blockNumber
func (_m *MockChainClientRPC) BalanceAt(ctx context.Context, accountAddress common.Address, blockNumber *big.Int) (*big.Int, error) {
...
func (_m *MockChainClientRPC) BatchCallContext(ctx context.Context, b []rpc.BatchElem) error {
	ret := _m.Called(ctx, b)
...
func (_m *MockChainClientRPC) BlockByHash(ctx context.Context, hash common.Hash) (*types.Head, error) {
...
func (_m *MockChainClientRPC) BlockByHashGeth(ctx context.Context, hash common.Hash) (*coretypes.Block, error) {
	ret := _m.Called(ctx, hash)
...
func (_m *MockChainClientRPC) BlockByNumber(ctx context.Context, number *big.Int) (*types.Head, error) {
...
func (_m *MockChainClientRPC) BlockByNumberGeth(ctx context.Context, number *big.Int) (*coretypes.Block, error) {
	ret := _m.Called(ctx, number)
...
func (_m *MockChainClientRPC) CallContext(ctx context.Context, result interface{}, method string, args ...interface{}) error {
	var _ca []interface{}
...
func (_m *MockChainClientRPC) CallContract(ctx context.Context, msg interface{}, blockNumber *big.Int) ([]byte, error) {
...
func (_m *MockChainClientRPC) ChainID(ctx context.Context) (*big.Int, error) {
	ret := _m.Called(ctx)
...
func (_m *MockChainClientRPC) ClientVersion(_a0 context.Context) (string, error) {
	ret := _m.Called(_a0)
...
func (_m *MockChainClientRPC) Close() {
	_m.Called()
}

// CodeAt provides a mock function with given fields: ctx, account, blockNumber
func (_m *MockChainClientRPC) CodeAt(ctx context.Context, account common.Address, blockNumber *big.Int) ([]byte, error) {
...
func (_m *MockChainClientRPC) Dial(ctx context.Context) error {
	ret := _m.Called(ctx)
...
func (_m *MockChainClientRPC) DialHTTP() error {
	ret := _m.Called()
...
func (_m *MockChainClientRPC) DisconnectAll() {
	_m.Called()
}

// EstimateGas provides a mock function with given fields: ctx, call
func (_m *MockChainClientRPC) EstimateGas(ctx context.Context, call interface{}) (uint64, error) {
...
func (_m *MockChainClientRPC) FilterEvents(ctx context.Context, query ethereum.FilterQuery) ([]coretypes.Log, error) {
...
func (_m *MockChainClientRPC) HeaderByHash(ctx context.Context, h common.Hash) (*coretypes.Header, error) {
	ret := _m.Called(ctx, h)
...
func (_m *MockChainClientRPC) HeaderByNumber(ctx context.Context, n *big.Int) (*coretypes.Header, error) {
	ret := _m.Called(ctx, n)
...
func (_m *MockChainClientRPC) IsSyncing(ctx context.Context) (bool, error) {
	ret := _m.Called(ctx)
...
func (_m *MockChainClientRPC) LINKBalance(ctx context.Context, accountAddress common.Address, linkAddress common.Address) (*assets.Link, error) {
...
func (_m *MockChainClientRPC) LatestBlockHeight(_a0 context.Context) (*big.Int, error) {
	ret := _m.Called(_a0)
...
func (_m *MockChainClientRPC) LatestFinalizedBlock(ctx context.Context) (*types.Head, error) {
	ret := _m.Called(ctx)
...
func (_m *MockChainClientRPC) PendingCallContract(ctx context.Context, msg interface{}) ([]byte, error) {
...
func (_m *MockChainClientRPC) PendingCodeAt(ctx context.Context, account common.Address) ([]byte, error) {
...
func (_m *MockChainClientRPC) PendingSequenceAt(ctx context.Context, addr common.Address) (types.Nonce, error) {
...
func (_m *MockChainClientRPC) Ping(_a0 context.Context) error {
	ret := _m.Called(_a0)
...
func (_m *MockChainClientRPC) SendEmptyTransaction(ctx context.Context, newTxAttempt func(types.Nonce, uint32, *evmassets.Wei, common.Address) (interface{}, error), seq types.Nonce, gasLimit uint32, fee *evmassets.Wei, fromAddress common.Address) (string, error) {
...
func (_m *MockChainClientRPC) SendTransaction(ctx context.Context, tx *coretypes.Transaction) error {
...
func (_m *MockChainClientRPC) SequenceAt(ctx context.Context, accountAddress common.Address, blockNumber *big.Int) (types.Nonce, error) {
	ret := _m.Called(ctx, accountAddress, blockNumber)
...
func (_m *MockChainClientRPC) SetAliveLoopSub(_a0 commontypes.Subscription) {
	_m.Called(_a0)
}

// SimulateTransaction provides a mock function with given fields: ctx, tx
func (_m *MockChainClientRPC) SimulateTransaction(ctx context.Context, tx *coretypes.Transaction) error {
	ret := _m.Called(ctx, tx)
...
func (_m *MockChainClientRPC) SubscribeFilterLogs(ctx context.Context, q ethereum.FilterQuery, ch chan<- coretypes.Log) (ethereum.Subscription, error) {
...
func (_m *MockChainClientRPC) SubscribeToFinalizedHeads(ctx context.Context) (<-chan *types.Head, commontypes.Subscription, error) {
	ret := _m.Called(ctx)
...
func (_m *MockChainClientRPC) SubscribeToHeads(ctx context.Context) (<-chan *types.Head, commontypes.Subscription, error) {
	ret := _m.Called(ctx)
...
func (_m *MockChainClientRPC) SubscribersCount() int32 {
	ret := _m.Called()
...
func (_m *MockChainClientRPC) SuggestGasPrice(ctx context.Context) (*big.Int, error) {
	ret := _m.Called(ctx)
...
func (_m *MockChainClientRPC) SuggestGasTipCap(ctx context.Context) (*big.Int, error) {
	ret := _m.Called(ctx)
...
func (_m *MockChainClientRPC) TokenBalance(ctx context.Context, accountAddress common.Address, tokenAddress common.Address) (*big.Int, error) {
...
func (_m *MockChainClientRPC) TransactionByHash(ctx context.Context, txHash common.Hash) (*coretypes.Transaction, error) {
...
func (_m *MockChainClientRPC) TransactionReceipt(ctx context.Context, txHash common.Hash) (*coretypes.Receipt, error) {
	ret := _m.Called(ctx, txHash)
...
func (_m *MockChainClientRPC) TransactionReceiptGeth(ctx context.Context, txHash common.Hash) (*coretypes.Receipt, error) {
	ret := _m.Called(ctx, txHash)
...
func (_m *MockChainClientRPC) UnsubscribeAllExcept(subs ...commontypes.Subscription) {
...
func (_m *MockChainClientRPC) UnsubscribeAllExceptAliveLoop() {
	_m.Called()
}

// NewMockChainClientRPC creates a new instance of MockChainClientRPC. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMockChainClientRPC(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockChainClientRPC {
	mock := &MockChainClientRPC{}
	mock.Mock.Test(t)
