...
func (_m *Client) CheckTxValidity(ctx context.Context, from common.Address, to common.Address, data []byte) *SendError {
	...
	var r0 *SendError
	if rf, ok := ret.Get(0).(func(context.Context, common.Address, common.Address, []byte) *SendError); ok {
		r0 = rf(ctx, from, to, data)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*SendError)
		}
	}
...
func (_c *Client_CheckTxValidity_Call) Return(_a0 *SendError) *Client_CheckTxValidity_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Client_CheckTxValidity_Call) RunAndReturn(run func(context.Context, common.Address, common.Address, []byte) *SendError) *Client_CheckTxValidity_Call {
	_c.Call.Return(run)
	return _c
}
