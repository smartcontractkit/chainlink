...
// MockEvmRpcClient is an autogenerated mock type for the EvmRpcClient type
type MockEvmRpcClient struct {
	mock.Mock
}

// BalanceAt provides a mock function with given fields: ctx, accountAddress, blockNumber
func (_m *MockEvmRpcClient) BalanceAt(ctx context.Context, accountAddress common.Address, blockNumber *big.Int) (*big.Int, error) {
...
func (_m *MockEvmRpcClient) BatchCallContext(ctx context.Context, b []rpc.BatchElem) error {
	ret := _m.Called(ctx, b)
...
func (_m *MockEvmRpcClient) BlockByHash(ctx context.Context, hash common.Hash) (*types.Head, error) {
...
func (_m *MockEvmRpcClient) BlockByHashGeth(ctx context.Context, hash common.Hash) (*coretypes.Block, error) {
	ret := _m.Called(ctx, hash)
...
func (_m *MockEvmRpcClient) BlockByNumber(ctx context.Context, number *big.Int) (*types.Head, error) {
...
func (_m *MockEvmRpcClient) BlockByNumberGeth(ctx context.Context, number *big.Int) (*coretypes.Block, error) {
	ret := _m.Called(ctx, number)
...
func (_m *MockEvmRpcClient) CallContext(ctx context.Context, result interface{}, method string, args ...interface{}) error {
	var _ca []interface{}
...
func (_m *MockEvmRpcClient) CallContract(ctx context.Context, msg interface{}, blockNumber *big.Int) ([]byte, error) {
...
func (_m *MockEvmRpcClient) ChainID(ctx context.Context) (*big.Int, error) {
	ret := _m.Called(ctx)
...
func (_m *MockEvmRpcClient) ClientVersion(_a0 context.Context) (string, error) {
	ret := _m.Called(_a0)
...
func (_m *MockEvmRpcClient) Close() {
	_m.Called()
}

// CodeAt provides a mock function with given fields: ctx, account, blockNumber
func (_m *MockEvmRpcClient) CodeAt(ctx context.Context, account common.Address, blockNumber *big.Int) ([]byte, error) {
...
func (_m *MockEvmRpcClient) Dial(ctx context.Context) error {
	ret := _m.Called(ctx)
...
func (_m *MockEvmRpcClient) DialHTTP() error {
	ret := _m.Called()
...
func (_m *MockEvmRpcClient) DisconnectAll() {
	_m.Called()
}

// EstimateGas provides a mock function with given fields: ctx, call
func (_m *MockEvmRpcClient) EstimateGas(ctx context.Context, call interface{}) (uint64, error) {
...
func (_m *MockEvmRpcClient) FilterEvents(ctx context.Context, query ethereum.FilterQuery) ([]coretypes.Log, error) {
...
func (_m *MockEvmRpcClient) HeaderByHash(ctx context.Context, h common.Hash) (*coretypes.Header, error) {
	ret := _m.Called(ctx, h)
...
func (_m *MockEvmRpcClient) HeaderByNumber(ctx context.Context, n *big.Int) (*coretypes.Header, error) {
	ret := _m.Called(ctx, n)
...
func (_m *MockEvmRpcClient) IsSyncing(ctx context.Context) (bool, error) {
	ret := _m.Called(ctx)
...
func (_m *MockEvmRpcClient) LINKBalance(ctx context.Context, accountAddress common.Address, linkAddress common.Address) (*assets.Link, error) {
...
func (_m *MockEvmRpcClient) LatestBlockHeight(_a0 context.Context) (*big.Int, error) {
	ret := _m.Called(_a0)
...
func (_m *MockEvmRpcClient) LatestFinalizedBlock(ctx context.Context) (*types.Head, error) {
	ret := _m.Called(ctx)
...
func (_m *MockEvmRpcClient) PendingCallContract(ctx context.Context, msg interface{}) ([]byte, error) {
...
func (_m *MockEvmRpcClient) PendingCodeAt(ctx context.Context, account common.Address) ([]byte, error) {
...
func (_m *MockEvmRpcClient) PendingSequenceAt(ctx context.Context, addr common.Address) (types.Nonce, error) {
...
func (_m *MockEvmRpcClient) Ping(_a0 context.Context) error {
	ret := _m.Called(_a0)
...
func (_m *MockEvmRpcClient) SendEmptyTransaction(ctx context.Context, newTxAttempt func(types.Nonce, uint32, *evmassets.Wei, common.Address) (interface{}, error), seq types.Nonce, gasLimit uint32, fee *evmassets.Wei, fromAddress common.Address) (string, error) {
...
func (_m *MockEvmRpcClient) SendTransaction(ctx context.Context, tx *coretypes.Transaction) error {
...
func (_m *MockEvmRpcClient) SequenceAt(ctx context.Context, accountAddress common.Address, blockNumber *big.Int) (types.Nonce, error) {
	ret := _m.Called(ctx, accountAddress, blockNumber)
...
func (_m *MockEvmRpcClient) SetAliveLoopSub(_a0 commontypes.Subscription) {
	_m.Called(_a0)
}

// SimulateTransaction provides a mock function with given fields: ctx, tx
func (_m *MockEvmRpcClient) SimulateTransaction(ctx context.Context, tx *coretypes.Transaction) error {
	ret := _m.Called(ctx, tx)
...
func (_m *MockEvmRpcClient) SubscribeToFinalizedHeads(ctx context.Context) (<-chan *types.Head, commontypes.Subscription, error) {
	ret := _m.Called(ctx)
...
func (_m *MockEvmRpcClient) SubscribeToHeads(ctx context.Context) (<-chan *types.Head, commontypes.Subscription, error) {
	ret := _m.Called(ctx)
...
func (_m *MockEvmRpcClient) SubscribersCount() int32 {
	ret := _m.Called()
...
func (_m *MockEvmRpcClient) SuggestGasPrice(ctx context.Context) (*big.Int, error) {
	ret := _m.Called(ctx)
...
func (_m *MockEvmRpcClient) SuggestGasTipCap(ctx context.Context) (*big.Int, error) {
	ret := _m.Called(ctx)
...
func (_m *MockEvmRpcClient) TokenBalance(ctx context.Context, accountAddress common.Address, tokenAddress common.Address) (*big.Int, error) {
...
func (_m *MockEvmRpcClient) TransactionByHash(ctx context.Context, txHash common.Hash) (*coretypes.Transaction, error) {
...
func (_m *MockEvmRpcClient) TransactionReceipt(ctx context.Context, txHash common.Hash) (*coretypes.Receipt, error) {
	ret := _m.Called(ctx, txHash)
...
func (_m *MockEvmRpcClient) TransactionReceiptGeth(ctx context.Context, txHash common.Hash) (*coretypes.Receipt, error) {
	ret := _m.Called(ctx, txHash)
...
func (_m *MockEvmRpcClient) UnsubscribeAllExcept(subs ...commontypes.Subscription) {
...
func (_m *MockEvmRpcClient) UnsubscribeAllExceptAliveLoop() {
	_m.Called()
}

// NewMockEvmRpcClient creates a new instance of MockEvmRpcClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMockEvmRpcClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockEvmRpcClient {
	mock := &MockEvmRpcClient{}
	mock.Mock.Test(t)
