...
var _ heads.Saver[*evmtypes.Head, common.Hash] = (*headSaver)(nil)

func NewHeadSaver(lggr logger.Logger, orm ORM, config heads.ChainConfig, htConfig heads.TrackerConfig) httypes.HeadSaver {
	return &headSaver{
		orm:      orm,
		config:   config,
		htConfig: htConfig,
