...
func (_m *Tracker) Backfill(ctx context.Context, headWithChain *types.Head, depth uint) error {
...
func (_m *Tracker) HealthReport() map[string]error {
	ret := _m.Called()
...
func (_m *Tracker) LatestChain() *types.Head {
	ret := _m.Called()
...
func (_m *Tracker) Start(_a0 context.Context) error {
	ret := _m.Called(_a0)
