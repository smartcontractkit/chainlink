...
// TODO: Implement and make sure it logs if override is set
...
// TODO: Use logger interface instead of *zap.SugaredLogger
...
func NewChainScopedConfig(db *gorm.DB, lggr *logger.Logger, gcfg config.GeneralConfig, chain evmtypes.Chain) ChainScopedConfig {
	...
	css := chainScopedConfig{gcfg, lggr, orm, chain.Cfg, defaultSet, chain.ID.ToInt(), sync.RWMutex{}, make(map[string]struct{}), sync.RWMutex{}}
	return &css
}
...
func (c *chainScopedConfig) logOverrideOnce(name string, envVal interface{}) {
	c.onceMapMu.RLock()
	if _, ok := c.onceMap[name]; ok {
		c.onceMapMu.RUnlock()
		return
	}
	c.onceMapMu.RUnlock()
	...
	c.logger.Warnf("Global ENV var set %s=%v, overriding chain-specific value for %s", config.TryEnvVarName(name), envVal, name)
	c.onceMap[name] = struct{}{}
}
...
func (c *chainScopedConfig) EvmGasBumpThreshold() uint64 {
	...
	if ok {
		c.logOverrideOnce("EvmGasBumpThreshold", val)
		return val
	}
...
func (c *chainScopedConfig) EvmGasBumpWei() *big.Int {
	...
	if ok {
		c.logOverrideOnce("EvmGasBumpWei", val)
		return val
	}
...
func (c *chainScopedConfig) EvmMaxInFlightTransactions() uint32 {
	...
	if ok {
		c.logOverrideOnce("EvmMaxInFlightTransactions", val)
		return val
	}
...
func (c *chainScopedConfig) EvmMaxGasPriceWei() *big.Int {
	...
	if ok {
		c.logOverrideOnce("EvmMaxGasPriceWei", val)
		return val
	}
...
func (c *chainScopedConfig) EvmMinGasPriceWei() *big.Int {
	...
	if ok {
		c.logOverrideOnce("EvmMinGasPriceWei", val)
		return val
	}
...
func (c *chainScopedConfig) EvmGasLimitDefault() uint64 {
	...
	if ok {
		c.logOverrideOnce("EvmGasLimitDefault", val)
		return val
	}
...
func (c *chainScopedConfig) EvmGasLimitTransfer() uint64 {
	...
	if ok {
		c.logOverrideOnce("EvmGasLimitTransfer", val)
		return val
	}
...
func (c *chainScopedConfig) EvmGasPriceDefault() *big.Int {
	...
	if ok {
		c.logOverrideOnce("EvmGasPriceDefault", val)
		return val
	}
	c.persistMu.RLock()
...
func (c *chainScopedConfig) EvmFinalityDepth() uint32 {
	...
	if ok {
		c.logOverrideOnce("EvmFinalityDepth", val)
		return val
	}
...
func (c *chainScopedConfig) EvmHeadTrackerHistoryDepth() uint32 {
	...
	if ok {
		c.logOverrideOnce("EvmHeadTrackerHistoryDepth", val)
		return val
	}
...
func (c *chainScopedConfig) EvmHeadTrackerSamplingInterval() time.Duration {
	...
	if ok {
		c.logOverrideOnce("EvmHeadTrackerSamplingInterval", val)
		return val
	}
...
func (c *chainScopedConfig) BlockEmissionIdleWarningThreshold() time.Duration {
	...
	if ok {
		c.logOverrideOnce("BlockEmissionIdleWarningThreshold", val)
		return val
	}
...
func (c *chainScopedConfig) EthTxResendAfterThreshold() time.Duration {
	...
	if ok {
		c.logOverrideOnce("EthTxResendAfterThreshold", val)
		return val
	}
...
func (c *chainScopedConfig) BlockHistoryEstimatorBatchSize() uint32 {
	val, ok := c.GeneralConfig.GlobalBlockHistoryEstimatorBatchSize()
	if ok {
		c.logOverrideOnce("BlockHistoryEstimatorBatchSize", val)
		return val
	}
...
func (c *chainScopedConfig) BlockHistoryEstimatorBlockDelay() uint16 {
	...
	if ok {
		c.logOverrideOnce("BlockHistoryEstimatorBlockDelay", val)
		return val
	}
...
func (c *chainScopedConfig) BlockHistoryEstimatorBlockHistorySize() uint16 {
	...
	if ok {
		c.logOverrideOnce("BlockHistoryEstimatorBlockHistorySize", val)
		return val
	}
...
func (c *chainScopedConfig) BlockHistoryEstimatorTransactionPercentile() uint16 {
	...
	if ok {
		c.logOverrideOnce("BlockHistoryEstimatorTransactionPercentile", val)
		return val
	}
...
func (c *chainScopedConfig) GasEstimatorMode() string {
	...
	if ok {
		c.logOverrideOnce("GasEstimatorMode", val)
		return val
	}
...
func (c *chainScopedConfig) LinkContractAddress() string {
	...
	if ok {
		c.logOverrideOnce("LinkContractAddress", val)
		return val
	}
...
func (c *chainScopedConfig) OCRContractConfirmations(override uint16) uint16 {
	...
	if ok {
		c.logOverrideOnce("OCRContractConfirmations", val)
		return val
	}
...
func (c *chainScopedConfig) MinIncomingConfirmations() uint32 {
	...
	if ok {
		c.logOverrideOnce("MinIncomingConfirmations", val)
		return val
	}
...
func (c *chainScopedConfig) MinRequiredOutgoingConfirmations() uint64 {
	...
	if ok {
		c.logOverrideOnce("MinRequiredOutgoingConfirmations", val)
		return val
	}
...
func (c *chainScopedConfig) MinimumContractPayment() *assets.Link {
	...
	if ok {
		c.logOverrideOnce("MinimumContractPayment", val)
		return val
	}
...
func (c *chainScopedConfig) EvmGasBumpTxDepth() uint16 {
	...
	if ok {
		c.logOverrideOnce("EvmGasBumpTxDepth", val)
		return val
	}
...
func (c *chainScopedConfig) EvmDefaultBatchSize() uint32 {
	...
	if ok {
		c.logOverrideOnce("EvmDefaultBatchSize", val)
		return val
	}
...
func (c *chainScopedConfig) EvmGasBumpPercent() uint16 {
	...
	if ok {
		c.logOverrideOnce("EvmGasBumpPercent", val)
		return val
	}
...
func (c *chainScopedConfig) EvmNonceAutoSync() bool {
	...
	if ok {
		c.logOverrideOnce("EvmNonceAutoSync", val)
		return val
	}
...
func (c *chainScopedConfig) EvmGasLimitMultiplier() float32 {
	...
	if ok {
		c.logOverrideOnce("EvmGasLimitMultiplier", val)
		return val
	}
...
func (c *chainScopedConfig) EvmHeadTrackerMaxBufferSize() uint32 {
	...
	if ok {
		c.logOverrideOnce("EvmHeadTrackerMaxBufferSize", val)
		return val
	}
...
func (c *chainScopedConfig) EthTxReaperInterval() time.Duration {
	...
	if ok {
		c.logOverrideOnce("EthTxReaperInterval", val)
		return val
	}
...
func (c *chainScopedConfig) EthTxReaperThreshold() time.Duration {
	...
	if ok {
		c.logOverrideOnce("EthTxReaperThreshold", val)
		return val
	}
...
func (c *chainScopedConfig) EvmLogBackfillBatchSize() uint32 {
	...
	if ok {
		c.logOverrideOnce("EvmLogBackfillBatchSize", val)
		return val
	}
...
func (c *chainScopedConfig) EvmRPCDefaultBatchSize() uint32 {
	...
	if ok {
		c.logOverrideOnce("EvmRPCDefaultBatchSize", val)
		return val
	}
...
func (c *chainScopedConfig) FlagsContractAddress() string {
	...
	if ok {
		c.logOverrideOnce("FlagsContractAddress", val)
		return val
	}
...
func (c *chainScopedConfig) BalanceMonitorEnabled() bool {
	...
	if ok {
		c.logOverrideOnce("BalanceMonitorEnabled", val)
		return val
	}
