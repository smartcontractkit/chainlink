...
// CacheTimeout provides a mock function with given fields:
func (_m *GasEstimator) CacheTimeout() time.Duration {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for CacheTimeout")
	}
...
// GasEstimator_CacheTimeout_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CacheTimeout'
type GasEstimator_CacheTimeout_Call struct {
	*mock.Call
}

// CacheTimeout is a helper method to define mock.On call
func (_e *GasEstimator_Expecter) CacheTimeout() *GasEstimator_CacheTimeout_Call {
	return &GasEstimator_CacheTimeout_Call{Call: _e.mock.On("CacheTimeout")}
}

func (_c *GasEstimator_CacheTimeout_Call) Run(run func()) *GasEstimator_CacheTimeout_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *GasEstimator_CacheTimeout_Call) Return(_a0 time.Duration) *GasEstimator_CacheTimeout_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *GasEstimator_CacheTimeout_Call) RunAndReturn(run func() time.Duration) *GasEstimator_CacheTimeout_Call {
	_c.Call.Return(run)
	return _c
}
