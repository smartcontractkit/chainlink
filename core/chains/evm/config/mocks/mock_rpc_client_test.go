...
func (_m *GasEstimator) BlockHistory() BlockHistory {
	ret := _m.Called()
	...
	var r0 BlockHistory
	if rf, ok := ret.Get(0).(func() BlockHistory); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(BlockHistory)
		}
	}
...
func (_c *GasEstimator_BlockHistory_Call) Return(_a0 BlockHistory) *GasEstimator_BlockHistory_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *GasEstimator_BlockHistory_Call) RunAndReturn(run func() BlockHistory) *GasEstimator_BlockHistory_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *GasEstimator) LimitJobType() LimitJobType {
	ret := _m.Called()
	...
	var r0 LimitJobType
	if rf, ok := ret.Get(0).(func() LimitJobType); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(LimitJobType)
		}
	}
...
func (_c *GasEstimator_LimitJobType_Call) Return(_a0 LimitJobType) *GasEstimator_LimitJobType_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *GasEstimator_LimitJobType_Call) RunAndReturn(run func() LimitJobType) *GasEstimator_LimitJobType_Call {
	_c.Call.Return(run)
	return _c
}
