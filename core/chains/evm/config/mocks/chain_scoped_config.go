...
func (_m *ChainScopedConfig) OCRBlockchainTimeout(override time.Duration) time.Duration {
...
func (_m *ChainScopedConfig) OCRContractConfirmations(override uint16) uint16 {
	ret := _m.Called(override)
...
func (_m *ChainScopedConfig) OCRContractPollInterval(override time.Duration) time.Duration {
	ret := _m.Called(override)
...
func (_m *ChainScopedConfig) OCRContractSubscribeInterval(override time.Duration) time.Duration {
	ret := _m.Called(override)
...
// OCRKeyBundleID provides a mock function with given fields: override
func (_m *ChainScopedConfig) OCRKeyBundleID(override *models.Sha256Hash) (models.Sha256Hash, error) {
	ret := _m.Called(override)

	var r0 models.Sha256Hash
	if rf, ok := ret.Get(0).(func(*models.Sha256Hash) models.Sha256Hash); ok {
		r0 = rf(override)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(models.Sha256Hash)
		}
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(*models.Sha256Hash) error); ok {
		r1 = rf(override)
	} else {
		r1 = ret.Error(1)
	}
...
// OCRMonitoringEndpoint provides a mock function with given fields: override
func (_m *ChainScopedConfig) OCRMonitoringEndpoint(override string) string {
	ret := _m.Called(override)
...
func (_m *ChainScopedConfig) OCRObservationTimeout(override time.Duration) time.Duration {
	ret := _m.Called(override)
...
// OCRTransmitterAddress provides a mock function with given fields: override
func (_m *ChainScopedConfig) OCRTransmitterAddress(override *ethkey.EIP55Address) (ethkey.EIP55Address, error) {
	ret := _m.Called(override)

	var r0 ethkey.EIP55Address
	if rf, ok := ret.Get(0).(func(*ethkey.EIP55Address) ethkey.EIP55Address); ok {
		r0 = rf(override)
	} else {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(*ethkey.EIP55Address) error); ok {
		r1 = rf(override)
	} else {
		r1 = ret.Error(1)
	}
...
// P2PBootstrapPeers provides a mock function with given fields: override
func (_m *ChainScopedConfig) P2PBootstrapPeers(override []string) ([]string, error) {
	ret := _m.Called(override)
...
// P2PPeerID provides a mock function with given fields: override
func (_m *ChainScopedConfig) P2PPeerID(override *p2pkey.PeerID) (p2pkey.PeerID, error) {
	ret := _m.Called(override)

	var r0 p2pkey.PeerID
	if rf, ok := ret.Get(0).(func(*p2pkey.PeerID) p2pkey.PeerID); ok {
		r0 = rf(override)
	} else {
