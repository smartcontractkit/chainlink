...
func v2Defaults(set chainSpecificConfigDefaultSet) v2.Chain {
	c := v2.Chain{
		...
		GasBumpThreshold:                      utils.NewBig(new(big.Int).SetUint64(set.gasBumpThreshold)),
		GasBumpTxDepth:                        ptr(set.gasBumpTxDepth),
		GasBumpWei:                            utils.NewBig(&set.gasBumpWei),
		GasEstimatorMode:                      ptr(set.gasEstimatorMode),
		GasFeeCapDefault:                      utils.NewBig(&set.gasFeeCapDefault),
		...
		GasPriceDefault:                       utils.NewBig(&set.gasPriceDefault),
		GasTipCapDefault:                      utils.NewBig(&set.gasTipCapDefault),
		GasTipCapMinimum:                      utils.NewBig(&set.gasTipCapMinimum),
