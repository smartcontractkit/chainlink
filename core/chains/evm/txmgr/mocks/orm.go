...
func (_m *ORM) FindNextUnstartedTransactionFromAddress(etx *txmgr.EthTx, fromAddress common.Address, chainID big.Int, qopts ...pg.QOpt) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*txmgr.EthTx, common.Address, big.Int, ...pg.QOpt) error); ok {
...
func (_m *ORM) GetEthTxInProgress(fromAddress common.Address, qopts ...pg.QOpt) (*txmgr.EthTx, error) {
	...
	var r0 *txmgr.EthTx
	var r1 error
	if rf, ok := ret.Get(0).(func(common.Address, ...pg.QOpt) (*txmgr.EthTx, error)); ok {
		return rf(fromAddress, qopts...)
	}
	if rf, ok := ret.Get(0).(func(common.Address, ...pg.QOpt) *txmgr.EthTx); ok {
...
func (_m *ORM) UpdateEthTxAttemptInProgressToBroadcast(etx *txmgr.EthTx, attempt txmgr.EthTxAttempt, NewAttemptState txmgr.EthTxAttemptState, incrNextNonceCallback func(pg.Queryer) error, qopts ...pg.QOpt) error {
	_va := make([]interface{}, len(qopts))
	for _i := range qopts {
		_va[_i] = qopts[_i]
	}
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*txmgr.EthTx, txmgr.EthTxAttempt, txmgr.EthTxAttemptState, func(pg.Queryer) error, ...pg.QOpt) error); ok {
...
func (_m *ORM) UpdateEthTxUnstartedToInProgress(etx *txmgr.EthTx, attempt *txmgr.EthTxAttempt, qopts ...pg.QOpt) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*txmgr.EthTx, *txmgr.EthTxAttempt, ...pg.QOpt) error); ok {
