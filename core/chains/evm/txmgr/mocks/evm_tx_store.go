...
func (_m *EvmTxStore) FindTxesPendingCallback(ctx context.Context, chainID *big.Int) ([]types.ReceiptPlus[*evmtypes.Receipt], error) {
	ret := _m.Called(ctx, chainID)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *big.Int) ([]types.ReceiptPlus[*evmtypes.Receipt], error)); ok {
		return rf(ctx, chainID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *big.Int) []types.ReceiptPlus[*evmtypes.Receipt]); ok {
		r0 = rf(ctx, chainID)
	} else {
		if ret.Get(0) != nil {
...
//   - ctx context.Context
//   - chainID *big.Int
func (_e *EvmTxStore_Expecter) FindTxesPendingCallback(ctx interface{}, chainID interface{}) *EvmTxStore_FindTxesPendingCallback_Call {
	return &EvmTxStore_FindTxesPendingCallback_Call{Call: _e.mock.On("FindTxesPendingCallback", ctx, chainID)}
}

func (_c *EvmTxStore_FindTxesPendingCallback_Call) Run(run func(ctx context.Context, chainID *big.Int)) *EvmTxStore_FindTxesPendingCallback_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*big.Int))
	})
	return _c
