...
func (_m *TxManager) GetGasEstimator() types.FeeEstimator[types.Head, gas.EvmFee, *assets.Wei, common.Hash] {
	ret := _m.Called()

	var r0 types.FeeEstimator[types.Head, gas.EvmFee, *assets.Wei, common.Hash]
	if rf, ok := ret.Get(0).(func() types.FeeEstimator[types.Head, gas.EvmFee, *assets.Wei, common.Hash]); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(types.FeeEstimator[types.Head, gas.EvmFee, *assets.Wei, common.Hash])
		}
	}
