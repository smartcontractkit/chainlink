...
type TxManager[CHAIN_ID types.Id, HEAD types.Head, ADDR commontypes.Hashable[ADDR], TX_HASH commontypes.Hashable[TX_HASH], BLOCK_HASH commontypes.Hashable[BLOCK_HASH]] struct {
	mock.Mock
}
...
func (_m *TxManager[CHAIN_ID, HEAD, ADDR, TX_HASH, BLOCK_HASH]) CreateEthTransaction(newTx txmgr.NewTx[ADDR], qopts ...pg.QOpt) (types.Transaction, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(txmgr.NewTx[ADDR], ...pg.QOpt) (types.Transaction, error)); ok {
		return rf(newTx, qopts...)
	}
	if rf, ok := ret.Get(0).(func(txmgr.NewTx[ADDR], ...pg.QOpt) types.Transaction); ok {
		r0 = rf(newTx, qopts...)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(txmgr.NewTx[ADDR], ...pg.QOpt) error); ok {
		r1 = rf(newTx, qopts...)
	} else {
		r1 = ret.Error(1)
	}
...
func NewTxManager[CHAIN_ID types.Id, HEAD types.Head, ADDR commontypes.Hashable[ADDR], TX_HASH commontypes.Hashable[TX_HASH], BLOCK_HASH commontypes.Hashable[BLOCK_HASH]](t mockConstructorTestingTNewTxManager) *TxManager[CHAIN_ID, HEAD, ADDR, TX_HASH, BLOCK_HASH] {
