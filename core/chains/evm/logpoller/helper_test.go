...
func SetupTH(t *testing.T, finalityDepth, backfillBatchSize, rpcBatchSize int64) TestHarness {
	...
	lp := NewLogPoller(o, NewEthClientFromSim(client.NewSimulatedBackendClient(t, ec, chainID)), lggr, 1*time.Hour, finalityDepth, backfillBatchSize, rpcBatchSize, 1000)
