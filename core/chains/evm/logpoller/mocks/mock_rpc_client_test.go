...
func (_m *LogPoller) FilteredLogs(ctx context.Context, filter query.KeyFilter, limitAndSort query.LimitAndSort, queryName string) ([]Log, error) {
	...
	var r0 []Log
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, query.KeyFilter, query.LimitAndSort, string) ([]Log, error)); ok {
		return rf(ctx, filter, limitAndSort, queryName)
	}
	if rf, ok := ret.Get(0).(func(context.Context, query.KeyFilter, query.LimitAndSort, string) []Log); ok {
...
func (_c *LogPoller_FilteredLogs_Call) Return(_a0 []Log, _a1 error) *LogPoller_FilteredLogs_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *LogPoller_FilteredLogs_Call) RunAndReturn(run func(context.Context, query.KeyFilter, query.LimitAndSort, string) ([]Log, error)) *LogPoller_FilteredLogs_Call {
	_c.Call.Return(run)
	return _c
}

// FindLCA provides a mock function with given fields: ctx
func (_m *LogPoller) FindLCA(ctx context.Context) (*LogPollerBlock, error) {
	ret := _m.Called(ctx)
	...
	var r0 *LogPollerBlock
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) (*LogPollerBlock, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(context.Context) *LogPollerBlock); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*LogPollerBlock)
		}
	}
...
func (_c *LogPoller_FindLCA_Call) Return(_a0 *LogPollerBlock, _a1 error) *LogPoller_FindLCA_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *LogPoller_FindLCA_Call) RunAndReturn(run func(context.Context) (*LogPollerBlock, error)) *LogPoller_FindLCA_Call {
	_c.Call.Return(run)
	return _c
}

// GetBlocksRange provides a mock function with given fields: ctx, numbers
func (_m *LogPoller) GetBlocksRange(ctx context.Context, numbers []uint64) ([]LogPollerBlock, error) {
	...
	var r0 []LogPollerBlock
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []uint64) ([]LogPollerBlock, error)); ok {
		return rf(ctx, numbers)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []uint64) []LogPollerBlock); ok {
		r0 = rf(ctx, numbers)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]LogPollerBlock)
...
func (_c *LogPoller_GetBlocksRange_Call) Return(_a0 []LogPollerBlock, _a1 error) *LogPoller_GetBlocksRange_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *LogPoller_GetBlocksRange_Call) RunAndReturn(run func(context.Context, []uint64) ([]LogPollerBlock, error)) *LogPoller_GetBlocksRange_Call {
	_c.Call.Return(run)
	return _c
}

// GetFilters provides a mock function with given fields:
func (_m *LogPoller) GetFilters() map[string]Filter {
	ret := _m.Called()
...
func (_c *LogPoller_GetFilters_Call) Return(_a0 map[string]Filter) *LogPoller_GetFilters_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *LogPoller_GetFilters_Call) RunAndReturn(run func() map[string]Filter) *LogPoller_GetFilters_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *LogPoller) IndexedLogs(ctx context.Context, eventSig common.Hash, address common.Address, topicIndex int, topicValues []common.Hash, confs types.Confirmations) ([]Log, error) {
	...
	var r0 []Log
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, common.Hash, common.Address, int, []common.Hash, types.Confirmations) ([]Log, error)); ok {
		return rf(ctx, eventSig, address, topicIndex, topicValues, confs)
	}
	if rf, ok := ret.Get(0).(func(context.Context, common.Hash, common.Address, int, []common.Hash, types.Confirmations) []Log); ok {
...
func (_c *LogPoller_IndexedLogs_Call) Return(_a0 []Log, _a1 error) *LogPoller_IndexedLogs_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *LogPoller_IndexedLogs_Call) RunAndReturn(run func(context.Context, common.Hash, common.Address, int, []common.Hash, types.Confirmations) ([]Log, error)) *LogPoller_IndexedLogs_Call {
	_c.Call.Return(run)
	return _c
}

// IndexedLogsByBlockRange provides a mock function with given fields: ctx, start, end, eventSig, address, topicIndex, topicValues
func (_m *LogPoller) IndexedLogsByBlockRange(ctx context.Context, start int64, end int64, eventSig common.Hash, address common.Address, topicIndex int, topicValues []common.Hash) ([]Log, error) {
	...
	var r0 []Log
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int64, int64, common.Hash, common.Address, int, []common.Hash) ([]Log, error)); ok {
		return rf(ctx, start, end, eventSig, address, topicIndex, topicValues)
	}
	if rf, ok := ret.Get(0).(func(context.Context, int64, int64, common.Hash, common.Address, int, []common.Hash) []Log); ok {
...
func (_c *LogPoller_IndexedLogsByBlockRange_Call) Return(_a0 []Log, _a1 error) *LogPoller_IndexedLogsByBlockRange_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *LogPoller_IndexedLogsByBlockRange_Call) RunAndReturn(run func(context.Context, int64, int64, common.Hash, common.Address, int, []common.Hash) ([]Log, error)) *LogPoller_IndexedLogsByBlockRange_Call {
	_c.Call.Return(run)
	return _c
}

// IndexedLogsByTxHash provides a mock function with given fields: ctx, eventSig, address, txHash
func (_m *LogPoller) IndexedLogsByTxHash(ctx context.Context, eventSig common.Hash, address common.Address, txHash common.Hash) ([]Log, error) {
	...
	var r0 []Log
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, common.Hash, common.Address, common.Hash) ([]Log, error)); ok {
		return rf(ctx, eventSig, address, txHash)
	}
	if rf, ok := ret.Get(0).(func(context.Context, common.Hash, common.Address, common.Hash) []Log); ok {
...
func (_c *LogPoller_IndexedLogsByTxHash_Call) Return(_a0 []Log, _a1 error) *LogPoller_IndexedLogsByTxHash_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *LogPoller_IndexedLogsByTxHash_Call) RunAndReturn(run func(context.Context, common.Hash, common.Address, common.Hash) ([]Log, error)) *LogPoller_IndexedLogsByTxHash_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *LogPoller) IndexedLogsCreatedAfter(ctx context.Context, eventSig common.Hash, address common.Address, topicIndex int, topicValues []common.Hash, after time.Time, confs types.Confirmations) ([]Log, error) {
	...
	var r0 []Log
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, common.Hash, common.Address, int, []common.Hash, time.Time, types.Confirmations) ([]Log, error)); ok {
		return rf(ctx, eventSig, address, topicIndex, topicValues, after, confs)
	}
	if rf, ok := ret.Get(0).(func(context.Context, common.Hash, common.Address, int, []common.Hash, time.Time, types.Confirmations) []Log); ok {
...
func (_c *LogPoller_IndexedLogsCreatedAfter_Call) Return(_a0 []Log, _a1 error) *LogPoller_IndexedLogsCreatedAfter_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *LogPoller_IndexedLogsCreatedAfter_Call) RunAndReturn(run func(context.Context, common.Hash, common.Address, int, []common.Hash, time.Time, types.Confirmations) ([]Log, error)) *LogPoller_IndexedLogsCreatedAfter_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *LogPoller) IndexedLogsTopicGreaterThan(ctx context.Context, eventSig common.Hash, address common.Address, topicIndex int, topicValueMin common.Hash, confs types.Confirmations) ([]Log, error) {
...
func (_c *LogPoller_IndexedLogsTopicGreaterThan_Call) Return(_a0 []Log, _a1 error) *LogPoller_IndexedLogsTopicGreaterThan_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *LogPoller_IndexedLogsTopicGreaterThan_Call) RunAndReturn(run func(context.Context, common.Hash, common.Address, int, common.Hash, types.Confirmations) ([]Log, error)) *LogPoller_IndexedLogsTopicGreaterThan_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *LogPoller) IndexedLogsTopicRange(ctx context.Context, eventSig common.Hash, address common.Address, topicIndex int, topicValueMin common.Hash, topicValueMax common.Hash, confs types.Confirmations) ([]Log, error) {
	...
	var r0 []Log
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, common.Hash, common.Address, int, common.Hash, common.Hash, types.Confirmations) ([]Log, error)); ok {
		return rf(ctx, eventSig, address, topicIndex, topicValueMin, topicValueMax, confs)
	}
	if rf, ok := ret.Get(0).(func(context.Context, common.Hash, common.Address, int, common.Hash, common.Hash, types.Confirmations) []Log); ok {
...
func (_c *LogPoller_IndexedLogsTopicRange_Call) Return(_a0 []Log, _a1 error) *LogPoller_IndexedLogsTopicRange_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *LogPoller_IndexedLogsTopicRange_Call) RunAndReturn(run func(context.Context, common.Hash, common.Address, int, common.Hash, common.Hash, types.Confirmations) ([]Log, error)) *LogPoller_IndexedLogsTopicRange_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *LogPoller) IndexedLogsWithSigsExcluding(ctx context.Context, address common.Address, eventSigA common.Hash, eventSigB common.Hash, topicIndex int, fromBlock int64, toBlock int64, confs types.Confirmations) ([]Log, error) {
	...
	var r0 []Log
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, common.Address, common.Hash, common.Hash, int, int64, int64, types.Confirmations) ([]Log, error)); ok {
		return rf(ctx, address, eventSigA, eventSigB, topicIndex, fromBlock, toBlock, confs)
	}
	if rf, ok := ret.Get(0).(func(context.Context, common.Address, common.Hash, common.Hash, int, int64, int64, types.Confirmations) []Log); ok {
...
func (_c *LogPoller_IndexedLogsWithSigsExcluding_Call) Return(_a0 []Log, _a1 error) *LogPoller_IndexedLogsWithSigsExcluding_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *LogPoller_IndexedLogsWithSigsExcluding_Call) RunAndReturn(run func(context.Context, common.Address, common.Hash, common.Hash, int, int64, int64, types.Confirmations) ([]Log, error)) *LogPoller_IndexedLogsWithSigsExcluding_Call {
	_c.Call.Return(run)
	return _c
}

// LatestBlock provides a mock function with given fields: ctx
func (_m *LogPoller) LatestBlock(ctx context.Context) (LogPollerBlock, error) {
	ret := _m.Called(ctx)
...
func (_c *LogPoller_LatestBlock_Call) Return(_a0 LogPollerBlock, _a1 error) *LogPoller_LatestBlock_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *LogPoller_LatestBlock_Call) RunAndReturn(run func(context.Context) (LogPollerBlock, error)) *LogPoller_LatestBlock_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *LogPoller) LatestLogByEventSigWithConfs(ctx context.Context, eventSig common.Hash, address common.Address, confs types.Confirmations) (*Log, error) {
...
func (_c *LogPoller_LatestLogByEventSigWithConfs_Call) Return(_a0 *Log, _a1 error) *LogPoller_LatestLogByEventSigWithConfs_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *LogPoller_LatestLogByEventSigWithConfs_Call) RunAndReturn(run func(context.Context, common.Hash, common.Address, types.Confirmations) (*Log, error)) *LogPoller_LatestLogByEventSigWithConfs_Call {
	_c.Call.Return(run)
	return _c
}

// LatestLogEventSigsAddrsWithConfs provides a mock function with given fields: ctx, fromBlock, eventSigs, addresses, confs
func (_m *LogPoller) LatestLogEventSigsAddrsWithConfs(ctx context.Context, fromBlock int64, eventSigs []common.Hash, addresses []common.Address, confs types.Confirmations) ([]Log, error) {
	ret := _m.Called(ctx, fromBlock, eventSigs, addresses, confs)
	...
	var r0 []Log
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int64, []common.Hash, []common.Address, types.Confirmations) ([]Log, error)); ok {
		return rf(ctx, fromBlock, eventSigs, addresses, confs)
	}
	if rf, ok := ret.Get(0).(func(context.Context, int64, []common.Hash, []common.Address, types.Confirmations) []Log); ok {
		r0 = rf(ctx, fromBlock, eventSigs, addresses, confs)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]Log)
...
func (_c *LogPoller_LatestLogEventSigsAddrsWithConfs_Call) Return(_a0 []Log, _a1 error) *LogPoller_LatestLogEventSigsAddrsWithConfs_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *LogPoller_LatestLogEventSigsAddrsWithConfs_Call) RunAndReturn(run func(context.Context, int64, []common.Hash, []common.Address, types.Confirmations) ([]Log, error)) *LogPoller_LatestLogEventSigsAddrsWithConfs_Call {
	_c.Call.Return(run)
	return _c
}

// Logs provides a mock function with given fields: ctx, start, end, eventSig, address
func (_m *LogPoller) Logs(ctx context.Context, start int64, end int64, eventSig common.Hash, address common.Address) ([]Log, error) {
	...
	var r0 []Log
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int64, int64, common.Hash, common.Address) ([]Log, error)); ok {
		return rf(ctx, start, end, eventSig, address)
	}
	if rf, ok := ret.Get(0).(func(context.Context, int64, int64, common.Hash, common.Address) []Log); ok {
...
func (_c *LogPoller_Logs_Call) Return(_a0 []Log, _a1 error) *LogPoller_Logs_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *LogPoller_Logs_Call) RunAndReturn(run func(context.Context, int64, int64, common.Hash, common.Address) ([]Log, error)) *LogPoller_Logs_Call {
	_c.Call.Return(run)
	return _c
}

// LogsCreatedAfter provides a mock function with given fields: ctx, eventSig, address, _a3, confs
func (_m *LogPoller) LogsCreatedAfter(ctx context.Context, eventSig common.Hash, address common.Address, _a3 time.Time, confs types.Confirmations) ([]Log, error) {
	...
	var r0 []Log
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, common.Hash, common.Address, time.Time, types.Confirmations) ([]Log, error)); ok {
		return rf(ctx, eventSig, address, _a3, confs)
	}
	if rf, ok := ret.Get(0).(func(context.Context, common.Hash, common.Address, time.Time, types.Confirmations) []Log); ok {
...
func (_c *LogPoller_LogsCreatedAfter_Call) Return(_a0 []Log, _a1 error) *LogPoller_LogsCreatedAfter_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *LogPoller_LogsCreatedAfter_Call) RunAndReturn(run func(context.Context, common.Hash, common.Address, time.Time, types.Confirmations) ([]Log, error)) *LogPoller_LogsCreatedAfter_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *LogPoller) LogsDataWordBetween(ctx context.Context, eventSig common.Hash, address common.Address, wordIndexMin int, wordIndexMax int, wordValue common.Hash, confs types.Confirmations) ([]Log, error) {
	...
	var r0 []Log
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, common.Hash, common.Address, int, int, common.Hash, types.Confirmations) ([]Log, error)); ok {
		return rf(ctx, eventSig, address, wordIndexMin, wordIndexMax, wordValue, confs)
	}
	if rf, ok := ret.Get(0).(func(context.Context, common.Hash, common.Address, int, int, common.Hash, types.Confirmations) []Log); ok {
...
func (_c *LogPoller_LogsDataWordBetween_Call) Return(_a0 []Log, _a1 error) *LogPoller_LogsDataWordBetween_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *LogPoller_LogsDataWordBetween_Call) RunAndReturn(run func(context.Context, common.Hash, common.Address, int, int, common.Hash, types.Confirmations) ([]Log, error)) *LogPoller_LogsDataWordBetween_Call {
	_c.Call.Return(run)
	return _c
}

// LogsDataWordGreaterThan provides a mock function with given fields: ctx, eventSig, address, wordIndex, wordValueMin, confs
func (_m *LogPoller) LogsDataWordGreaterThan(ctx context.Context, eventSig common.Hash, address common.Address, wordIndex int, wordValueMin common.Hash, confs types.Confirmations) ([]Log, error) {
...
func (_c *LogPoller_LogsDataWordGreaterThan_Call) Return(_a0 []Log, _a1 error) *LogPoller_LogsDataWordGreaterThan_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *LogPoller_LogsDataWordGreaterThan_Call) RunAndReturn(run func(context.Context, common.Hash, common.Address, int, common.Hash, types.Confirmations) ([]Log, error)) *LogPoller_LogsDataWordGreaterThan_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *LogPoller) LogsDataWordRange(ctx context.Context, eventSig common.Hash, address common.Address, wordIndex int, wordValueMin common.Hash, wordValueMax common.Hash, confs types.Confirmations) ([]Log, error) {
...
func (_c *LogPoller_LogsDataWordRange_Call) Return(_a0 []Log, _a1 error) *LogPoller_LogsDataWordRange_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *LogPoller_LogsDataWordRange_Call) RunAndReturn(run func(context.Context, common.Hash, common.Address, int, common.Hash, common.Hash, types.Confirmations) ([]Log, error)) *LogPoller_LogsDataWordRange_Call {
	_c.Call.Return(run)
	return _c
}

// LogsWithSigs provides a mock function with given fields: ctx, start, end, eventSigs, address
func (_m *LogPoller) LogsWithSigs(ctx context.Context, start int64, end int64, eventSigs []common.Hash, address common.Address) ([]Log, error) {
...
func (_c *LogPoller_LogsWithSigs_Call) Return(_a0 []Log, _a1 error) *LogPoller_LogsWithSigs_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *LogPoller_LogsWithSigs_Call) RunAndReturn(run func(context.Context, int64, int64, []common.Hash, common.Address) ([]Log, error)) *LogPoller_LogsWithSigs_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *LogPoller) RegisterFilter(ctx context.Context, filter Filter) error {
...
func (_c *LogPoller_RegisterFilter_Call) Run(run func(ctx context.Context, filter Filter)) *LogPoller_RegisterFilter_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *LogPoller_RegisterFilter_Call) RunAndReturn(run func(context.Context, Filter) error) *LogPoller_RegisterFilter_Call {
	_c.Call.Return(run)
	return _c
}
