...
// LogPoller_Name_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'String'
...
func (_e *LogPoller_Expecter) Name() *LogPoller_Name_Call {
	return &LogPoller_Name_Call{Call: _e.mock.On("String")}
}
