...
// L1Oracle_Name_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'String'
...
func (_e *L1Oracle_Expecter) Name() *L1Oracle_Name_Call {
	return &L1Oracle_Name_Call{Call: _e.mock.On("String")}
}
