...
// GetChainType provides a mock function with given fields: ctx
func (_m *L1Oracle) GetChainType(ctx context.Context) chaintype.ChainType {
	ret := _m.Called(ctx)

	if len(ret) == 0 {
		panic("no return value specified for GetChainType")
	}
...
// L1Oracle_GetChainType_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetChainType'
type L1Oracle_GetChainType_Call struct {
	*mock.Call
}

// GetChainType is a helper method to define mock.On call
//   - ctx context.Context
func (_e *L1Oracle_Expecter) GetChainType(ctx interface{}) *L1Oracle_GetChainType_Call {
	return &L1Oracle_GetChainType_Call{Call: _e.mock.On("GetChainType", ctx)}
}

func (_c *L1Oracle_GetChainType_Call) Run(run func(ctx context.Context)) *L1Oracle_GetChainType_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context))
	})
	return _c
...
func (_c *L1Oracle_GetChainType_Call) Return(_a0 chaintype.ChainType) *L1Oracle_GetChainType_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *L1Oracle_GetChainType_Call) RunAndReturn(run func(context.Context) chaintype.ChainType) *L1Oracle_GetChainType_Call {
	_c.Call.Return(run)
	return _c
}
