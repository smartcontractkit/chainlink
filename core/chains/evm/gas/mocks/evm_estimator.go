...
type EvmEstimator[H types.Head] struct {
	mock.Mock
}

// BumpDynamicFee provides a mock function with given fields: ctx, original, gasLimit, maxGasPriceWei, attempts
func (_m *EvmEstimator[H]) BumpDynamicFee(ctx context.Context, original gas.DynamicFee, gasLimit uint32, maxGasPriceWei *assets.Wei, attempts []gas.EvmPriorAttempt) (gas.DynamicFee, uint32, error) {
...
func (_m *EvmEstimator[H]) BumpLegacyGas(ctx context.Context, originalGasPrice *assets.Wei, gasLimit uint32, maxGasPriceWei *assets.Wei, attempts []gas.EvmPriorAttempt) (*assets.Wei, uint32, error) {
...
func (_m *EvmEstimator[H]) Close() error {
	ret := _m.Called()
...
func (_m *EvmEstimator[H]) GetDynamicFee(ctx context.Context, gasLimit uint32, maxGasPriceWei *assets.Wei) (gas.DynamicFee, uint32, error) {
...
func (_m *EvmEstimator[H]) GetLegacyGas(ctx context.Context, calldata []byte, gasLimit uint32, maxGasPriceWei *assets.Wei, opts ...types.Opt) (*assets.Wei, uint32, error) {
...
func (_m *EvmEstimator[H]) OnNewLongestChain(_a0 context.Context, _a1 H) {
	_m.Called(_a0, _a1)
}

// Start provides a mock function with given fields: _a0
func (_m *EvmEstimator[H]) Start(_a0 context.Context) error {
	ret := _m.Called(_a0)
...
func NewEvmEstimator[H types.Head](t mockConstructorTestingTNewEvmEstimator) *EvmEstimator[H] {
	mock := &EvmEstimator[H]{}
	mock.Mock.Test(t)
