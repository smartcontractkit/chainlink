...
func (_m *LegacyChainContainer) Get(id string) (Chain, error) {
	ret := _m.Called(id)
	...
	var r0 Chain
	var r1 error
	if rf, ok := ret.Get(0).(func(string) (Chain, error)); ok {
		return rf(id)
	}
	if rf, ok := ret.Get(0).(func(string) Chain); ok {
		r0 = rf(id)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(Chain)
...
func (_c *LegacyChainContainer_Get_Call) Return(_a0 Chain, _a1 error) *LegacyChainContainer_Get_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *LegacyChainContainer_Get_Call) RunAndReturn(run func(string) (Chain, error)) *LegacyChainContainer_Get_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *LegacyChainContainer) List(ids ...string) ([]Chain, error) {
...
func (_c *LegacyChainContainer_List_Call) Return(_a0 []Chain, _a1 error) *LegacyChainContainer_List_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *LegacyChainContainer_List_Call) RunAndReturn(run func(...string) ([]Chain, error)) *LegacyChainContainer_List_Call {
	_c.Call.Return(run)
	return _c
}

// Slice provides a mock function with given fields:
func (_m *LegacyChainContainer) Slice() []Chain {
	ret := _m.Called()
	...
	var r0 []Chain
	if rf, ok := ret.Get(0).(func() []Chain); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]Chain)
...
func (_c *LegacyChainContainer_Slice_Call) Return(_a0 []Chain) *LegacyChainContainer_Slice_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *LegacyChainContainer_Slice_Call) RunAndReturn(run func() []Chain) *LegacyChainContainer_Slice_Call {
	_c.Call.Return(run)
	return _c
}
