...
func newEvmTxm(
	...
	chainIDToClientMap map[string]rollups.EVMClient,
) (txm txmgr.TxManager,
	...
	if opts.GenGasEstimator == nil {
		if estimator, err = gas.NewEstimator(lggr, client, cfg.ChainType(), cfg.GasEstimator(), chainIDToClientMap); err != nil {
