...
func (noa *NoOp) Perform(input models.RunResult, _ *store.Store) models.RunOutput {
...
func (noa *NoOpPend) Perform(input models.RunResult, _ *store.Store) models.RunOutput {
