...
2. [CONFIG.md](/docs/CONFIG.md) is _generated_ from (1) by `config.GenerateDocs()` via [cmd/generate/main.go](cmd/generate/main.go). *Do not edit this file. Run `make config-docs` from the root of the repo*.
