...
func TestConfigSchema(t *testing.T) {
	items := map[string]string{
		...
		"OCRJobGasLimit":                                 "OCR_JOB_GAS_LIMIT",
		"DRJobGasLimit":                                  "DR_JOB_GAS_LIMIT",
		"VRFJobGasLimit":                                 "VRF_JOB_GAS_LIMIT",
		"FMJobGasLimit":                                  "FM_JOB_GAS_LIMIT",
		"KeeperJobGasLimit":                              "KEEPER_JOB_GAS_LIMIT",
