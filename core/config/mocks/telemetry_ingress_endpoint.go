...
type mockConstructorTestingTNewTelemetryIngressEndpoint interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewTelemetryIngressEndpoint(t mockConstructorTestingTNewTelemetryIngressEndpoint) *TelemetryIngressEndpoint {
