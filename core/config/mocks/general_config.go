...
func (_m *GeneralConfig) SetLogLevel(ctx context.Context, lvl zapcore.Level) error {
...
func (_m *GeneralConfig) SetLogSQLStatements(ctx context.Context, sqlEnabled bool) error {
