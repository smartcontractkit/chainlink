...
require (
	...
	github.com/smartcontractkit/chainlink-common v0.1.7-0.20240113002736-5cb9c701ff47
...
require (
	...
	github.com/smartcontractkit/chainlink-feeds v0.0.0-20240113002834-dfa2a0db2f6d // indirect
