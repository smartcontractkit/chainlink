...
require (
	...
	github.com/smartcontractkit/chainlink-common v0.10.1-0.20260316095747-797bb17a67b3
...
require (
	...
	github.com/smartcontractkit/chainlink-aptos v0.0.0-20260316095935-edd0f6cbcd5b // indirect
