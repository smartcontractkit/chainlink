...
require (
	...
	github.com/smartcontractkit/chainlink-common v0.2.2-0.20240815135306-ee568c3a0fda
...
require (
	...
	github.com/smartcontractkit/chainlink-feeds v0.0.0-20240815140538-ad015771a863 // indirect
