...
require (
	...
	github.com/smartcontractkit/chainlink-common v0.11.2-0.20260709072946-259329372afb
...
require (
	...
	github.com/smartcontractkit/chainlink-protos/node-platform v0.0.0-20260708163852-d6d29967bf99 // indirect
