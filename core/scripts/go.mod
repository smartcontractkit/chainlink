...
require (
	github.com/smartcontractkit/chainlink/deployment v0.0.0-20260915193832-ea1ed53b9b16
...
require (
	...
	github.com/smartcontractkit/chainlink/core/scripts/cre/environment/examples/workflows/proof-of-reserve/cron-based v0.0.0-20260915193832-ea1ed53b9b16
	github.com/smartcontractkit/chainlink/system-tests/lib v0.0.0-20260915193832-ea1ed53b9b16
