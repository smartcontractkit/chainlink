...
require (
	...
	github.com/smartcontractkit/chainlink-common v0.11.2-0.20260515125558-1eb2e4fc64a1
	...
	github.com/smartcontractkit/chainlink-evm v0.3.4-0.20260515160120-19d36fcbdfbd
