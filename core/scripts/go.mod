...
require (
	...
	github.com/smartcontractkit/chainlink-ccip v0.0.0-20241223194433-f25773de7c0e // indirect
	github.com/smartcontractkit/chainlink-ccip/chains/solana v0.0.0-20241230201128-a91ea5187123 // indirect
