...
require (
	github.com/smartcontractkit/chainlink/deployment v0.0.0-20260911185619-f7009b94693d
...
require (
	...
	github.com/smartcontractkit/chainlink/core/scripts/cre/environment/examples/workflows/proof-of-reserve/cron-based v0.0.0-20260911185619-f7009b94693d
	github.com/smartcontractkit/chainlink/system-tests/lib v0.0.0-20260911185619-f7009b94693d
