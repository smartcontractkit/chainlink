...
require (
	...
	github.com/smartcontractkit/chain-selectors v1.0.88 // indirect
	...
	github.com/smartcontractkit/chainlink-framework/chains v0.0.0-20260114133625-907ef99f2a14 // indirect
