...
require (
	...
	github.com/smartcontractkit/chainlink-ccip v0.0.0-20240906123106-80dbf35db06a // indirect
	...
	github.com/smartcontractkit/chainlink-feeds v0.0.0-20240904165643-1c245a66f36c // indirect
