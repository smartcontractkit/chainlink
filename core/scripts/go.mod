...
require (
	...
	github.com/smartcontractkit/ocr2keepers v1.0.0-alpha.0.0.20230806135117-ebf0bea17cdb
...
require (
	...
	github.com/smartcontractkit/chainlink-relay v0.1.7-0.20230802190005-10db9909d256 // indirect
