...
require (
	...
	github.com/smartcontractkit/chainlink-common v0.7.1-0.20250630202505-317745609bac
	github.com/smartcontractkit/chainlink-common/pkg/values v0.0.0-20250630193947-e5537c1af16f
