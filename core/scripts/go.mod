...
require (
	github.com/smartcontractkit/chainlink/deployment v0.0.0-20260918203842-1c32ae3259c3
...
require (
	...
	github.com/smartcontractkit/chainlink/system-tests/lib v0.0.0-20260918203842-1c32ae3259c3
