...
require (
	...
	github.com/smartcontractkit/chainlink-testing-framework/framework v0.15.16-0.20260409111916-b33395a96a7c
...
require (
	...
	github.com/smartcontractkit/chainlink-ton v0.0.0-20260403084332-41521300fa9b // indirect
