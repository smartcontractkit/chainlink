...
require (
	...
	github.com/smartcontractkit/chainlink-stellar v0.0.3-0.20260727152034-bbe5793ebdb8 // indirect
	github.com/smartcontractkit/chainlink-stellar/bindings v0.0.0-20260727152034-bbe5793ebdb8 // indirect
