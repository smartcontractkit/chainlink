...
require (
	...
	github.com/smartcontractkit/chainlink-aptos v0.0.0-20260313161547-f901ef7b4d9d // indirect
	...
	github.com/smartcontractkit/cre-sdk-go v1.5.1-0.20260313102248-f2aadf4f1946 // indirect
