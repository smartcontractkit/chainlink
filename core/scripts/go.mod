...
require (
	github.com/smartcontractkit/chainlink/deployment v0.0.0-20250723171554-731ffd2fc410
...
require (
	...
	github.com/smartcontractkit/chainlink/system-tests/lib v0.0.0-20250723171554-731ffd2fc410
