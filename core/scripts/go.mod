...
require (
	...
	github.com/smartcontractkit/ocr2keepers v1.0.0-alpha.0.0.20230928010344-bba382c43e69
...
replace github.com/smartcontractkit/libocr => github.com/ferglor/libocr v0.0.0-20230928010246-16c7b750e1d4
