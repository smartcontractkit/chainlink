...
require (
	...
	github.com/smartcontractkit/chainlink-cosmos v0.4.1-0.20230822041428-9103056faf64 // indirect
	github.com/smartcontractkit/chainlink-relay v0.1.7-0.20230814221409-567a8f84b413 // indirect
