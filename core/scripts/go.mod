...
require (
	...
	github.com/smartcontractkit/chainlink-common v0.11.2-0.20260511010840-843865edbfdc
...
require (
	...
	github.com/smartcontractkit/chainlink-common/pkg/chipingress v0.0.11-0.20260511010840-843865edbfdc // indirect
