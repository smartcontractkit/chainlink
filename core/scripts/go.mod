...
require (
	...
	github.com/smartcontractkit/chainlink-aptos v0.0.0-20251126192703-f5c3b5908fa7 // indirect
	...
	github.com/smartcontractkit/chainlink-sui v0.0.0-20251128231234-4fdf15cd020c // indirect
