...
require (
	...
	github.com/smartcontractkit/chainlink-common v0.1.7-0.20240314160927-d249016146ba
...
require (
	...
	github.com/smartcontractkit/chainlink-feeds v0.0.0-20240305155412-a95c17c167c6 // indirect
