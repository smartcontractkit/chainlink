...
require (
	...
	github.com/smartcontractkit/chainlink-deployments-framework v0.43.0
...
require (
	...
	github.com/smartcontractkit/chainlink-ton/deployment v0.0.0-20250908172835-06d5969f3bc2 // indirect
