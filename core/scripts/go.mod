...
require (
	...
	github.com/smartcontractkit/ocr2keepers v1.0.0-alpha.0.0.20230929181735-f3ed4bf9d506
...
replace github.com/smartcontractkit/libocr => github.com/ferglor/libocr v0.0.0-20230929181642-ac1659583e14
