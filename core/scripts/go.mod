...
require (
	...
	github.com/smartcontractkit/chainlink-common v0.9.6-0.20260106003742-76174c987166
...
require (
	...
	github.com/smartcontractkit/chainlink-protos/workflows/go v0.0.0-20260105230139-d1920b684916 // indirect
