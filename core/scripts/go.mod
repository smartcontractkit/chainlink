...
require (
	...
	github.com/smartcontractkit/chainlink-framework/chains v0.0.0-20250428160515-094b39db9145 // indirect
	...
	github.com/smartcontractkit/chainlink-solana v1.1.2-0.20250501141515-aeb6e06f6b16 // indirect
