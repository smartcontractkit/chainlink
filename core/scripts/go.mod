...
require (
	...
	github.com/smartcontractkit/chainlink-ccv v0.0.0-20251118182721-6eaef64bdced // indirect
	...
	github.com/smartcontractkit/chainlink-protos/chainlink-ccv/go v0.0.0-20251118134523-5a74dc8189a8 // indirect
