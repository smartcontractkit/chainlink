...
require (
	...
	github.com/smartcontractkit/chainlink-stellar v0.0.3-0.20260714190042-cc29ff2c1be7 // indirect
	github.com/smartcontractkit/chainlink-stellar/bindings v0.0.0-20260714190042-cc29ff2c1be7 // indirect
