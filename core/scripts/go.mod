...
require (
	...
	github.com/smartcontractkit/chainlink-common v0.2.2-0.20240809193136-ac9bab33d23d
...
require (
	...
	github.com/smartcontractkit/chainlink-feeds v0.0.0-20240809193413-706cbc91605a // indirect
