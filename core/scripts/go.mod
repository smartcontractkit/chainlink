...
require (
	...
	github.com/smartcontractkit/chainlink-deployments-framework v0.12.0
...
require (
	...
	github.com/smartcontractkit/chainlink-ccip/chains/solana v0.0.0-20250602150832-c6cd4a526da4 // indirect
