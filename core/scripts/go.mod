...
require (
	...
	github.com/smartcontractkit/chainlink-automation v1.0.2-0.20231220020617-c2aa7f370a72
	github.com/smartcontractkit/chainlink-common v0.1.7-0.20231220015308-39e566841565
