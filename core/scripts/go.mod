...
require (
	...
	github.com/smartcontractkit/chainlink-framework/multinode v0.0.0-20250130135648-656181e15c23 // indirect
	...
	github.com/smartcontractkit/chainlink-solana v1.1.2-0.20250130153300-0be478bfc046 // indirect
