...
require (
	...
	github.com/smartcontractkit/chainlink-common v0.9.6-0.20260103041433-fdd5f602c8be
...
require (
	...
	github.com/smartcontractkit/chainlink-protos/workflows/go v0.0.0-20260105000621-18727d34657a // indirect
