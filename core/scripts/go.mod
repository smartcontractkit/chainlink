...
require (
	...
	github.com/smartcontractkit/chainlink-common v0.1.7-0.20240112202116-1506cb14ab03
...
require (
	...
	github.com/smartcontractkit/chainlink-feeds v0.0.0-20240112202351-82a72dd905a8 // indirect
