...
require (
	...
	github.com/smartcontractkit/chainlink-framework/multinode v0.0.0-20250121201406-2ec1a4182727 // indirect
	...
	github.com/smartcontractkit/chainlink-solana v1.1.1-0.20250121190222-468739154f87 // indirect
