...
require (
	...
	github.com/smartcontractkit/chainlink-automation v1.0.2-0.20240327010126-18c6a086beed
	github.com/smartcontractkit/chainlink-common v0.1.7-0.20240327003736-b5f6f5e99c70
