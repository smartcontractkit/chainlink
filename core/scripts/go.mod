...
require (
	...
	github.com/smartcontractkit/chainlink-integrations/evm v0.0.0-20250402140418-8a66d7f30673
...
require (
	...
	github.com/smartcontractkit/chainlink-framework/multinode v0.0.0-20250402134717-7279a709289d // indirect
