...
require (
	...
	github.com/smartcontractkit/chainlink-integrations/evm v0.0.0-20250221204032-fc1e82aaeef8
...
require (
	...
	github.com/smartcontractkit/chainlink-framework/chains v0.0.0-20250221183912-28742cefdd20 // indirect
