...
require (
	...
	github.com/smartcontractkit/chainlink-common v0.11.2-0.20260722055609-f2249b89ec57
...
require (
	...
	github.com/smartcontractkit/chainlink-common/pkg/chipingress v0.0.11-0.20260722055513-310a7b2afcea // indirect
