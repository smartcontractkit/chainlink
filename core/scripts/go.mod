...
require (
	...
	github.com/smartcontractkit/chainlink-ccip v0.1.1-solana.0.20251003202647-c11523969b61
	...
	github.com/smartcontractkit/chainlink-evm v0.3.4-0.20251003185510-17234095940f
