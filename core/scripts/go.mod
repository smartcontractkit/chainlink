...
require (
	...
	github.com/smartcontractkit/chainlink-ccip v0.0.0-20250512172541-23f36acc56bb
...
require (
	...
	github.com/smartcontractkit/chainlink-aptos v0.0.0-20250512161950-c68a88cbc570 // indirect
