...
require (
	...
	github.com/smartcontractkit/chainlink-common v0.1.7-0.20231218151928-7928dc9e0f4b // indirect
	...
	github.com/smartcontractkit/chainlink-feeds v0.0.0-20231213201055-bac4e2e090a3 // indirect
