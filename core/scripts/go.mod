...
require (
	...
	github.com/smartcontractkit/chainlink-common v0.11.2-0.20260512141139-2f33499231da
...
require (
	...
	github.com/smartcontractkit/chainlink-common/pkg/chipingress v0.0.11-0.20260512141139-2f33499231da // indirect
