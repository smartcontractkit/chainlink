...
replace github.com/smartcontractkit/chainlink-evm/gethwrappers => ../../../chainlink-evm/gethwrappers
...
require (
	...
	github.com/smartcontractkit/chainlink-evm/gethwrappers v0.0.0-20250908163340-462bedeaabd5
