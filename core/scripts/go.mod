...
require (
	...
	github.com/smartcontractkit/chainlink-common v0.11.2-0.20260515202004-a2567d3b1a3d
...
require (
	...
	github.com/smartcontractkit/chainlink-common/pkg/chipingress v0.0.11-0.20260515172105-f60f14be40ad // indirect
