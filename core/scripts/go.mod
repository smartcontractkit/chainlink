...
require (
	...
	github.com/smartcontractkit/chainlink-ton v1.0.4 // indirect
	github.com/smartcontractkit/chainlink-ton/deployment v0.0.0-20260424052336-89a3e1e5995d // indirect
