...
require (
	...
	github.com/smartcontractkit/chainlink-stellar v0.0.3-0.20260715110321-639a13f1a3c0 // indirect
	github.com/smartcontractkit/chainlink-stellar/bindings v0.0.0-20260715112751-7cee5805f4a2 // indirect
