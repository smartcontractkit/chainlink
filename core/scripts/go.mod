...
require (
	...
	github.com/smartcontractkit/chainlink-aptos v0.0.0-20250526145118-5fe6fab7c3b2 // indirect
	...
	github.com/smartcontractkit/chainlink-solana v1.1.2-0.20250526153105-8fdccfe1181b // indirect
