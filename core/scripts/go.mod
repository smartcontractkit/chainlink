...
require (
	...
	github.com/smartcontractkit/chainlink-evm v0.3.4-0.20260427083025-2a3a95391380
...
require (
	...
	github.com/smartcontractkit/chainlink-protos/svr v1.1.1-0.20260424155706-6549603cad5f // indirect
