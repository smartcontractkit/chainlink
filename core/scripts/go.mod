...
require (
	...
	github.com/smartcontractkit/chainlink-aptos v0.0.0-20250612232513-06beaec2289c // indirect
	...
	github.com/smartcontractkit/chainlink-ton v0.0.0-20250604103703-6183880c7d4a // indirect
