...
require (
	...
	github.com/smartcontractkit/chainlink/system-tests/lib v0.0.0-20250715014601-155615a8074c
...
require (
	...
	github.com/smartcontractkit/crib-sdk v0.0.0-20250622214554-fbaddd1c519b // indirect
