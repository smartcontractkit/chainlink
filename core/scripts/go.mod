...
require (
	...
	github.com/smartcontractkit/chainlink-common v0.11.2-0.20260716004442-8b34f201cc04
	...
	github.com/smartcontractkit/chainlink-evm/gethwrappers v0.0.0-20260715161014-611d8ac32364
