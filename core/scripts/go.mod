...
require (
	...
	github.com/smartcontractkit/chainlink-framework/multinode v0.0.0-20250120163354-0acb1421e4c5 // indirect
	...
	github.com/smartcontractkit/chainlink-solana v1.1.1-0.20250121184416-ea7a643c52e2 // indirect
