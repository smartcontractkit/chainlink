...
require (
	...
	github.com/smartcontractkit/chainlink-stellar v0.0.4-0.20260819152704-690e7d0eb1b9 // indirect
	github.com/smartcontractkit/chainlink-stellar/bindings v0.0.0-20260819152704-690e7d0eb1b9 // indirect
