...
require (
	...
	github.com/smartcontractkit/mcms v0.12.1 // indirect
...
replace (
	...
	github.com/smartcontractkit/chainlink-ccip/chains/solana => github.com/smartcontractkit/chainlink-ccip/chains/solana v0.0.0-20250214202341-4190f2db1c01
