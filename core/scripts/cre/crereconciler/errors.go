...
var ErrBreakpoint = errors.New("cre-reconciler: node config written — apply via Griddle and re-run")
...
var ErrStepDeclined = errors.New("cre-reconciler: step declined by operator")
