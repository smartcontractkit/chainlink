-- Provision the schema and table the DurableEmitter expects.
-- Mirrors core/store/migrate/migrations/0300_chip_durable_events.sql so the
-- driver can use the real PgDurableEventStore against this Postgres without
-- running the chainlink migration pipeline.
