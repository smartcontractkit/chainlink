...
func (k *Keeper) Debug(ctx context.Context, args []string) {
	...
	v2common, err := autov2common.NewIAutomationV2Common(registryAddress, k.client)
	if err != nil {
	...
	var upkeepInfo autov2common.IAutomationV2CommonUpkeepInfo
...
func getUpkeepInfoAndRunBasicChecks(keeperRegistry21 *autov2common.IAutomationV2Common, callOpts *bind.CallOpts, upkeepID *big.Int, chainID int64) autov2common.IAutomationV2CommonUpkeepInfo {
	// get upkeep info
