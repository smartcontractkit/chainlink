...
func main() {
	...
	case "coordinator-set-config":
		...
		flatFeeTier1 := cmd.Int64("flat-fee-tier-1", 250000, "flat fee tier 1")
		flatFeeTier2 := cmd.Int64("flat-fee-tier-2", 50000, "flat fee tier 2")
		flatFeeTier3 := cmd.Int64("flat-fee-tier-3", 25000, "flat fee tier 3")
		flatFeeTier4 := cmd.Int64("flat-fee-tier-4", 10000, "flat fee tier 4")
		flatFeeTier5 := cmd.Int64("flat-fee-tier-5", 5000, "flat fee tier 5")
		reqsForTier2 := cmd.Int64("reqs-for-tier-2", 100, "requests for tier 2")
		reqsForTier3 := cmd.Int64("reqs-for-tier-3", 10000, "requests for tier 3")
		reqsForTier4 := cmd.Int64("reqs-for-tier-4", 100000, "requests for tier 4")
		reqsForTier5 := cmd.Int64("reqs-for-tier-5", 1000000, "requests for tier 5")
