...
func getVRFSignature(e helpers.Environment, beaconAddress string, height, confDelay uint64) (proofG1X, proofG1Y *big.Int) {
	// get transmission logs from requested block to latest block
...
func verifyBeaconRandomness(e helpers.Environment, dkgAddress, beaconAddress string, height, confDelay uint64) bool {
	...
	proofG1X, proofG1Y := getVRFSignature(e, beaconAddress, height, confDelay)
