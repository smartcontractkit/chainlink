...
func TestFeeder(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expectedStoredMapBlocks: []uint64{150, 151, 152, 153, 154},
			getBatchSize:            1,
			storeBatchSize:          1,
			getBatchCallCount:       5,
		...
		},
		{
			...
			expectedStoredMapBlocks: []uint64{148, 149, 150, 151, 152, 153, 154},
			getBatchSize:            1,
			storeBatchSize:          1,
			getBatchCallCount:       7,
		...
		},
		{
			...
			expectedStoredMapBlocks: []uint64{151, 152, 153, 154},
			getBatchSize:            1,
			storeBatchSize:          1,
			getBatchCallCount:       4,
