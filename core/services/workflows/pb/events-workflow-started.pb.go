...
const file_events_workflow_started_proto_rawDesc = "" +
	"\n" +
	"\x1devents-workflow-started.proto\x12\x02pb\x1a\x15events-metadata.proto\"z\n" +
	...
	"\tTriggerID\x18\x03 \x01(\tR\tTriggerIDBCZAgithub.com/smartcontractkit/chainlink/core/services/workflows/pb/b\x06proto3"
...
var file_events_workflow_started_proto_goTypes = []any{
	(*WorkflowExecutionStarted)(nil), // 0: pb.WorkflowExecutionStarted
	(*WorkflowMetadata)(nil),         // 1: pb.WorkflowMetadata
}
var file_events_workflow_started_proto_depIdxs = []int32{
	1, // 0: pb.WorkflowExecutionStarted.m:type_name -> pb.WorkflowMetadata
