...
func (_m *mockBillingClient) ReserveCredits(ctx context.Context, req *billing.ReserveCreditsRequest) (*billing.ReserveCreditsResponse, error) {
	args := _m.Called(ctx, req)

	var a0 *billing.ReserveCreditsResponse
	if arg, ok := args.Get(0).(*billing.ReserveCreditsResponse); ok {
		a0 = arg
	}
