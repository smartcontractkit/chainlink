...
func (_m *OCRContractTrackerDB) WithDataSource(_a0 sqlutil.DataSource) OCRContractTrackerDB {
	ret := _m.Called(_a0)
	...
	var r0 OCRContractTrackerDB
	if rf, ok := ret.Get(0).(func(sqlutil.DataSource) OCRContractTrackerDB); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(OCRContractTrackerDB)
		}
	}
...
func (_c *OCRContractTrackerDB_WithDataSource_Call) Return(_a0 OCRContractTrackerDB) *OCRContractTrackerDB_WithDataSource_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *OCRContractTrackerDB_WithDataSource_Call) RunAndReturn(run func(sqlutil.DataSource) OCRContractTrackerDB) *OCRContractTrackerDB_WithDataSource_Call {
	_c.Call.Return(run)
	return _c
}
