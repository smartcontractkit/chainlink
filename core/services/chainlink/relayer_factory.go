...
func (r *RelayerFactory) NewLOOPRelayer(name string, network string, plugin env.Plugin, ks coretypes.Keystore, chainCfgs []*RawConfig) (map[types.RelayID]loop.Relayer, error) {
