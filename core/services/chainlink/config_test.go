	...
	full.EVM = []EVMConfig{
		{
			...
			Chain: evmcfg.Chain{
				...
				GasEstimator: &evmcfg.GasEstimator{
					...
					LimitOCRJobType:    ptr[uint64](1001),
					LimitDRJobType:     ptr[uint64](1002),
					LimitVRFJobType:    ptr[uint64](1003),
					LimitFMJobType:     ptr[uint64](1004),
					LimitKeeperJobType: ptr[uint64](1005),
