...
func TestConfig_Validate(t *testing.T) {
	...
	- EVM: 8 errors:
		...
		- 1: 6 errors:
			...
			- ChainType: invalid value (Foo): must be one of arbitrum, metis, xdai, optimismBedrock, celo, zksync or omitted
		...
		- 2: 5 errors:
			...
			- Nodes: missing: must have at least one node
			- ChainType: invalid value (Arbitrum): must be one of arbitrum, metis, xdai, optimismBedrock, celo, zksync or omitted
