...
func TestConfig_Validate(t *testing.T) {
	...
	- EVM: 9 errors:
		...
		- 2: 5 errors:
			...
			- Nodes: missing: must have at least one node
			- ChainType: invalid value (Arbitrum): must be one of arbitrum, astar, celo, gnosis, hedera, kroma, metis, mantle, optimismBedrock, scroll, wemix, xlayer, zkevm, zksync or omitted
