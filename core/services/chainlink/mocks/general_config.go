...
func (_m *GeneralConfig) LOOPP() config.LOOPP {
	...
	if len(ret) == 0 {
		panic("no return value specified for LOOPP")
	}

	var r0 config.LOOPP
	if rf, ok := ret.Get(0).(func() config.LOOPP); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(config.LOOPP)
		}
	}
...
// GeneralConfig_LOOPP_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'LOOPP'
type GeneralConfig_LOOPP_Call struct {
	*mock.Call
}

// LOOPP is a helper method to define mock.On call
func (_e *GeneralConfig_Expecter) LOOPP() *GeneralConfig_LOOPP_Call {
	return &GeneralConfig_LOOPP_Call{Call: _e.mock.On("LOOPP")}
}

func (_c *GeneralConfig_LOOPP_Call) Run(run func()) *GeneralConfig_LOOPP_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *GeneralConfig_LOOPP_Call) Return(_a0 config.LOOPP) *GeneralConfig_LOOPP_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *GeneralConfig_LOOPP_Call) RunAndReturn(run func() config.LOOPP) *GeneralConfig_LOOPP_Call {
	_c.Call.Return(run)
	return _c
}
...
// Sharding provides a mock function with no fields
func (_m *GeneralConfig) Sharding() config.Sharding {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for Sharding")
	}

	var r0 config.Sharding
	if rf, ok := ret.Get(0).(func() config.Sharding); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(config.Sharding)
		}
	}
...
// GeneralConfig_Sharding_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Sharding'
type GeneralConfig_Sharding_Call struct {
	*mock.Call
}

// Sharding is a helper method to define mock.On call
func (_e *GeneralConfig_Expecter) Sharding() *GeneralConfig_Sharding_Call {
	return &GeneralConfig_Sharding_Call{Call: _e.mock.On("Sharding")}
}

func (_c *GeneralConfig_Sharding_Call) Run(run func()) *GeneralConfig_Sharding_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *GeneralConfig_Sharding_Call) Return(_a0 config.Sharding) *GeneralConfig_Sharding_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *GeneralConfig_Sharding_Call) RunAndReturn(run func() config.Sharding) *GeneralConfig_Sharding_Call {
	_c.Call.Return(run)
	return _c
}
