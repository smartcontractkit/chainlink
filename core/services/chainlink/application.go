...
type Application interface {
	...
	RunWebhookJobV2(ctx context.Context, jobUUID uuid.UUID, requestBody string, meta json_serializable.JSONSerializable) (int64, error)
...
func (app *ChainlinkApplication) RunWebhookJobV2(ctx context.Context, jobUUID uuid.UUID, requestBody string, meta json_serializable.JSONSerializable) (int64, error) {
