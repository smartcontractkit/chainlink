...
// ClearGasPricesByDestChain provides a mock function with given fields: ctx, destChainSelector, to
func (_m *ORM) ClearGasPricesByDestChain(ctx context.Context, destChainSelector uint64, to time.Time) error {
	ret := _m.Called(ctx, destChainSelector, to)
	...
	if rf, ok := ret.Get(0).(func(context.Context, uint64, time.Time) error); ok {
		r0 = rf(ctx, destChainSelector, to)
	} else {
		r0 = ret.Error(0)
	}
...
// ClearTokenPricesByDestChain provides a mock function with given fields: ctx, destChainSelector, to
func (_m *ORM) ClearTokenPricesByDestChain(ctx context.Context, destChainSelector uint64, to time.Time) error {
	ret := _m.Called(ctx, destChainSelector, to)
