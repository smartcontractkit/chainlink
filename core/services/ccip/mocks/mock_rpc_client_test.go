...
func (_m *ORM) GetGasPricesByDestChain(ctx context.Context, destChainSelector uint64) ([]GasPrice, error) {
	...
	var r0 []GasPrice
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uint64) ([]GasPrice, error)); ok {
		return rf(ctx, destChainSelector)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uint64) []GasPrice); ok {
...
func (_c *ORM_GetGasPricesByDestChain_Call) Return(_a0 []GasPrice, _a1 error) *ORM_GetGasPricesByDestChain_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *ORM_GetGasPricesByDestChain_Call) RunAndReturn(run func(context.Context, uint64) ([]GasPrice, error)) *ORM_GetGasPricesByDestChain_Call {
	_c.Call.Return(run)
	return _c
}

// GetTokenPricesByDestChain provides a mock function with given fields: ctx, destChainSelector
func (_m *ORM) GetTokenPricesByDestChain(ctx context.Context, destChainSelector uint64) ([]TokenPrice, error) {
	ret := _m.Called(ctx, destChainSelector)
	...
	var r0 []TokenPrice
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uint64) ([]TokenPrice, error)); ok {
		return rf(ctx, destChainSelector)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uint64) []TokenPrice); ok {
		r0 = rf(ctx, destChainSelector)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]TokenPrice)
		}
	}
...
func (_c *ORM_GetTokenPricesByDestChain_Call) Return(_a0 []TokenPrice, _a1 error) *ORM_GetTokenPricesByDestChain_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *ORM_GetTokenPricesByDestChain_Call) RunAndReturn(run func(context.Context, uint64) ([]TokenPrice, error)) *ORM_GetTokenPricesByDestChain_Call {
	_c.Call.Return(run)
	return _c
}

// InsertGasPricesForDestChain provides a mock function with given fields: ctx, destChainSelector, jobId, gasPrices
func (_m *ORM) InsertGasPricesForDestChain(ctx context.Context, destChainSelector uint64, jobId int32, gasPrices []GasPriceUpdate) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, uint64, int32, []GasPriceUpdate) error); ok {
...
func (_c *ORM_InsertGasPricesForDestChain_Call) Run(run func(ctx context.Context, destChainSelector uint64, jobId int32, gasPrices []GasPriceUpdate)) *ORM_InsertGasPricesForDestChain_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(uint64), args[2].(int32), args[3].([]GasPriceUpdate))
	})
	return _c
}
...
func (_c *ORM_InsertGasPricesForDestChain_Call) RunAndReturn(run func(context.Context, uint64, int32, []GasPriceUpdate) error) *ORM_InsertGasPricesForDestChain_Call {
	_c.Call.Return(run)
	return _c
}

// InsertTokenPricesForDestChain provides a mock function with given fields: ctx, destChainSelector, jobId, tokenPrices
func (_m *ORM) InsertTokenPricesForDestChain(ctx context.Context, destChainSelector uint64, jobId int32, tokenPrices []TokenPriceUpdate) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, uint64, int32, []TokenPriceUpdate) error); ok {
...
func (_c *ORM_InsertTokenPricesForDestChain_Call) Run(run func(ctx context.Context, destChainSelector uint64, jobId int32, tokenPrices []TokenPriceUpdate)) *ORM_InsertTokenPricesForDestChain_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(uint64), args[2].(int32), args[3].([]TokenPriceUpdate))
	})
	return _c
}
...
func (_c *ORM_InsertTokenPricesForDestChain_Call) RunAndReturn(run func(context.Context, uint64, int32, []TokenPriceUpdate) error) *ORM_InsertTokenPricesForDestChain_Call {
	_c.Call.Return(run)
	return _c
}
