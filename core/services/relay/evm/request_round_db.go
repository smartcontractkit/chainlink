...
type RequestRoundDB interface {
	SaveLatestRoundRequested(ctx context.Context, tx sqlutil.DataSource, rr ocr2aggregator.OCR2AggregatorRoundRequested) error
	LoadLatestRoundRequested(ctx context.Context) (rr ocr2aggregator.OCR2AggregatorRoundRequested, err error)
}
...
func (d *requestRoundDB) SaveLatestRoundRequested(ctx context.Context, tx sqlutil.DataSource, rr ocr2aggregator.OCR2AggregatorRoundRequested) error {
