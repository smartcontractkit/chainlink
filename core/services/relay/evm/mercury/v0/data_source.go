...
var _ relaymercuryv0.DataSource = &datasource{}
...
func (ds *datasource) Observe(ctx context.Context, repts ocrtypes.ReportTimestamp, fetchMaxFinalizedBlockNum bool) (obs relaymercuryv0.Observation, err error) {
...
func (ds *datasource) setCurrentBlock(ctx context.Context, obs *relaymercuryv0.Observation) {
