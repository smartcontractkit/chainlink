...
var paos = []relaymercuryv0.ParsedAttributedObservation{
	relaymercuryv0.NewParsedAttributedObservation(42, commontypes.OracleID(49), big.NewInt(43), big.NewInt(44), big.NewInt(45), true, 248, hash, 123, true, 10, true),
	relaymercuryv0.NewParsedAttributedObservation(142, commontypes.OracleID(149), big.NewInt(143), big.NewInt(144), big.NewInt(145), true, 248, hash, 123, true, 11, true),
	relaymercuryv0.NewParsedAttributedObservation(242, commontypes.OracleID(249), big.NewInt(243), big.NewInt(244), big.NewInt(245), true, 248, hash, 123, true, 12, true),
	relaymercuryv0.NewParsedAttributedObservation(342, commontypes.OracleID(250), big.NewInt(343), big.NewInt(344), big.NewInt(345), true, 842, hash, 456, true, 13, true),
}
...
func Test_ReportCodec_BuildReport(t *testing.T) {
	...
	t.Run("BuildReport errors if observations are empty", func(t *testing.T) {
		paos := []relaymercuryv0.ParsedAttributedObservation{}
