...
type LatestReportResponse struct {
	...
	ConfigDigest          []byte     `protobuf:"bytes,5,opt,name=configDigest,proto3" json:"configDigest,omitempty"`
	...
	TransmittingOperator  []byte     `protobuf:"bytes,9,opt,name=transmittingOperator,proto3" json:"transmittingOperator,omitempty"`
	CreatedAt             *Timestamp `protobuf:"bytes,10,opt,name=createdAt,proto3" json:"createdAt,omitempty"`
}
...
func (x *LatestReportResponse) GetFeedId() []byte {
	if x != nil {
		return x.FeedId
	}
	return nil
...
func (x *LatestReportResponse) GetPrice() []byte {
	if x != nil {
		return x.Price
	}
	return nil
...
func (x *LatestReportResponse) GetPayload() []byte {
	if x != nil {
		return x.Payload
	}
	return nil
...
func (x *LatestReportResponse) GetBlockNumber() int64 {
	if x != nil {
...
func (x *LatestReportResponse) GetConfigDigest() []byte {
	if x != nil {
...
func (x *LatestReportResponse) GetEpoch() uint32 {
	if x != nil {
		return x.Epoch
	}
	return 0
...
func (x *LatestReportResponse) GetRound() uint32 {
	if x != nil {
		return x.Round
	}
	return 0
...
func (x *LatestReportResponse) GetObservationsTimestamp() int64 {
	if x != nil {
...
func (x *LatestReportResponse) GetTransmittingOperator() []byte {
	if x != nil {
...
func (x *LatestReportResponse) GetCreatedAt() *Timestamp {
	if x != nil {
		return x.CreatedAt
	}
	return nil
...
var file_mercury_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x06, 0x66, 0x65, 0x65, 0x64, 0x49, 0x64, 0x22, 0xe7, 0x02,
	0x0a, 0x14, 0x4c, 0x61, 0x74, 0x65, 0x73, 0x74, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x66, 0x65, 0x65, 0x64, 0x49, 0x64,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x06, 0x66, 0x65, 0x65, 0x64, 0x49, 0x64, 0x12, 0x14,
	0x0a, 0x05, 0x70, 0x72, 0x69, 0x63, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x05, 0x70,
	0x72, 0x69, 0x63, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x12, 0x20,
	...
	,
	...
	0x65, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0d, 0x2e,
	...
	0x69, 0x6e, 0x6b, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2f, 0x72, 0x65, 0x6c,
	0x61, 0x79, 0x2f, 0x65, 0x76, 0x6d, 0x2f, 0x6d, 0x65, 0x72, 0x63, 0x75, 0x72, 0x79, 0x2f, 0x77,
	0x73, 0x72, 0x70, 0x63, 0x2f, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_mercury_proto_depIdxs = []int32{
	4, // 0: pb.LatestReportResponse.createdAt:type_name -> pb.Timestamp
	0, // 1: pb.Mercury.Transmit:input_type -> pb.TransmitRequest
	2, // 2: pb.Mercury.LatestReport:input_type -> pb.LatestReportRequest
	1, // 3: pb.Mercury.Transmit:output_type -> pb.TransmitResponse
	3, // 4: pb.Mercury.LatestReport:output_type -> pb.LatestReportResponse
