...
// LogPollerWrapper_Name_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'String'
...
func (_e *LogPollerWrapper_Expecter) Name() *LogPollerWrapper_Name_Call {
	return &LogPollerWrapper_Name_Call{Call: _e.mock.On("String")}
}
