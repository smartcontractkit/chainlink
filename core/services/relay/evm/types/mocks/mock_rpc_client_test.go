...
func (_m *LogPollerWrapper) LatestEvents(ctx context.Context) ([]OracleRequest, []OracleResponse, error) {
	ret := _m.Called(ctx)
	...
	var r0 []OracleRequest
	var r1 []OracleResponse
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context) ([]OracleRequest, []OracleResponse, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(context.Context) []OracleRequest); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]OracleRequest)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context) []OracleResponse); ok {
		r1 = rf(ctx)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).([]OracleResponse)
		}
	}
...
func (_c *LogPollerWrapper_LatestEvents_Call) Return(_a0 []OracleRequest, _a1 []OracleResponse, _a2 error) *LogPollerWrapper_LatestEvents_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *LogPollerWrapper_LatestEvents_Call) RunAndReturn(run func(context.Context) ([]OracleRequest, []OracleResponse, error)) *LogPollerWrapper_LatestEvents_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *LogPollerWrapper) SubscribeToUpdates(ctx context.Context, name string, subscriber RouteUpdateSubscriber) {
...
//   - ctx context.Context
//   - name string
//   - subscriber RouteUpdateSubscriber
...
func (_c *LogPollerWrapper_SubscribeToUpdates_Call) Run(run func(ctx context.Context, name string, subscriber RouteUpdateSubscriber)) *LogPollerWrapper_SubscribeToUpdates_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(RouteUpdateSubscriber))
	})
	return _c
}
...
func (_c *LogPollerWrapper_SubscribeToUpdates_Call) RunAndReturn(run func(context.Context, string, RouteUpdateSubscriber)) *LogPollerWrapper_SubscribeToUpdates_Call {
	_c.Call.Return(run)
	return _c
}
