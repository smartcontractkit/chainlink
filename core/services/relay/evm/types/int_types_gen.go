...
func (i *uint24) Verify() error {
	...
	if !utils.FitsInNBitsSigned(24, bi) {
		return types.InvalidTypeError{}
	}
...
func (i *uint40) Verify() error {
	...
	if !utils.FitsInNBitsSigned(40, bi) {
		return types.InvalidTypeError{}
	}
...
func (i *uint48) Verify() error {
	...
	if !utils.FitsInNBitsSigned(48, bi) {
		return types.InvalidTypeError{}
	}
...
func (i *uint56) Verify() error {
	...
	if !utils.FitsInNBitsSigned(56, bi) {
		return types.InvalidTypeError{}
	}
...
func (i *uint72) Verify() error {
	...
	if !utils.FitsInNBitsSigned(72, bi) {
		return types.InvalidTypeError{}
	}
...
func (i *uint80) Verify() error {
	...
	if !utils.FitsInNBitsSigned(80, bi) {
		return types.InvalidTypeError{}
	}
...
func (i *uint88) Verify() error {
	...
	if !utils.FitsInNBitsSigned(88, bi) {
		return types.InvalidTypeError{}
	}
...
func (i *uint96) Verify() error {
	...
	if !utils.FitsInNBitsSigned(96, bi) {
		return types.InvalidTypeError{}
	}
...
func (i *uint104) Verify() error {
	...
	if !utils.FitsInNBitsSigned(104, bi) {
		return types.InvalidTypeError{}
	}
...
func (i *uint112) Verify() error {
	...
	if !utils.FitsInNBitsSigned(112, bi) {
		return types.InvalidTypeError{}
	}
...
func (i *uint120) Verify() error {
	...
	if !utils.FitsInNBitsSigned(120, bi) {
		return types.InvalidTypeError{}
	}
...
func (i *uint128) Verify() error {
	...
	if !utils.FitsInNBitsSigned(128, bi) {
		return types.InvalidTypeError{}
	}
...
func (i *uint136) Verify() error {
	...
	if !utils.FitsInNBitsSigned(136, bi) {
		return types.InvalidTypeError{}
	}
...
func (i *uint144) Verify() error {
	...
	if !utils.FitsInNBitsSigned(144, bi) {
		return types.InvalidTypeError{}
	}
...
func (i *uint152) Verify() error {
	...
	if !utils.FitsInNBitsSigned(152, bi) {
		return types.InvalidTypeError{}
	}
...
func (i *uint160) Verify() error {
	...
	if !utils.FitsInNBitsSigned(160, bi) {
		return types.InvalidTypeError{}
	}
...
func (i *uint168) Verify() error {
	...
	if !utils.FitsInNBitsSigned(168, bi) {
		return types.InvalidTypeError{}
	}
...
func (i *uint176) Verify() error {
	...
	if !utils.FitsInNBitsSigned(176, bi) {
		return types.InvalidTypeError{}
	}
...
func (i *uint184) Verify() error {
	...
	if !utils.FitsInNBitsSigned(184, bi) {
		return types.InvalidTypeError{}
	}
...
func (i *uint192) Verify() error {
	...
	if !utils.FitsInNBitsSigned(192, bi) {
		return types.InvalidTypeError{}
	}
...
func (i *uint200) Verify() error {
	...
	if !utils.FitsInNBitsSigned(200, bi) {
		return types.InvalidTypeError{}
	}
...
func (i *uint208) Verify() error {
	...
	if !utils.FitsInNBitsSigned(208, bi) {
		return types.InvalidTypeError{}
	}
...
func (i *uint216) Verify() error {
	...
	if !utils.FitsInNBitsSigned(216, bi) {
		return types.InvalidTypeError{}
	}
...
func (i *uint224) Verify() error {
	...
	if !utils.FitsInNBitsSigned(224, bi) {
		return types.InvalidTypeError{}
	}
...
func (i *uint232) Verify() error {
	...
	if !utils.FitsInNBitsSigned(232, bi) {
		return types.InvalidTypeError{}
	}
...
func (i *uint240) Verify() error {
	...
	if !utils.FitsInNBitsSigned(240, bi) {
		return types.InvalidTypeError{}
	}
...
func (i *uint248) Verify() error {
	...
	if !utils.FitsInNBitsSigned(248, bi) {
		return types.InvalidTypeError{}
	}
...
func (i *uint256) Verify() error {
	...
	if !utils.FitsInNBitsSigned(256, bi) {
		return types.InvalidTypeError{}
	}
