...
func (_m *BatchCaller) BatchCall(ctx context.Context, blockNumber uint64, batchRequests BatchCall) (BatchResult, error) {
	...
	var r0 BatchResult
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uint64, BatchCall) (BatchResult, error)); ok {
		return rf(ctx, blockNumber, batchRequests)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uint64, BatchCall) BatchResult); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, uint64, BatchCall) error); ok {
...
func (_c *BatchCaller_BatchCall_Call) Run(run func(ctx context.Context, blockNumber uint64, batchRequests BatchCall)) *BatchCaller_BatchCall_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(uint64), args[2].(BatchCall))
	})
	return _c
}

func (_c *BatchCaller_BatchCall_Call) Return(_a0 BatchResult, _a1 error) *BatchCaller_BatchCall_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *BatchCaller_BatchCall_Call) RunAndReturn(run func(context.Context, uint64, BatchCall) (BatchResult, error)) *BatchCaller_BatchCall_Call {
	_c.Call.Return(run)
	return _c
}
