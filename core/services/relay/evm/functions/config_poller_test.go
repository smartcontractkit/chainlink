...
var functionsPluginConfig = []byte{8, 144, 78, 16, 144, 78, 24, 144, 78, 32, 10, 48, 1, 58, 17, 8, 144, 78, 16, 144, 78, 24, 144, 78, 32, 100, 40, 160, 141, 6, 48, 1}
var thresholdPluginConfig = []byte{8, 144, 78, 16, 144, 78, 24, 144, 78, 32, 100, 40, 160, 141, 6, 48, 1}

func TestFunctionsFunctionsConfigPoller(t *testing.T) {
	// Run FunctionsConfigPoller tests for Threshold plugin
	//testHelper(t, functions.FunctionsPlugin, functionsPluginConfig)
	// Run FunctionsConfigPoller tests for Functions plugin
	testHelper(t, functions.ThresholdPlugin, thresholdPluginConfig)
}

func testHelper(t *testing.T, pluginType functions.FunctionsPluginType, expectedOffchainConfig []byte) {
	...
	// Set the config
	contractConfig := setFunctionsConfig(t, ocrContract, user)
	b.Commit()
...
func setFunctionsConfig(t *testing.T, ocrContract *ocr2aggregator.OCR2Aggregator, user *bind.TransactOpts) ocrtypes2.ContractConfig {
	t.Helper()
