...
//	http3 "github.com/smartcontractkit/chainlink/v2/core/services/relay/evm/ccip/tokendata/http"
...
//	observedHttpClient := http3.NewObservedIHttpClientWithMetric(&http3.HttpClient{}, histogram)
