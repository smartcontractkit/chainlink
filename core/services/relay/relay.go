...
func (r *relayerAdapter) NewFunctionsProvider(ctx context.Context, rargs types.RelayArgs, pargs types.PluginArgs, pluginType types.FunctionsPluginType) (types.FunctionsProvider, error) {
	return r.Relayer.NewFunctionsProvider(rargs, pargs, pluginType)
}
