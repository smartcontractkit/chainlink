...
// PeerWrapper_Name_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'String'
...
func (_e *PeerWrapper_Expecter) Name() *PeerWrapper_Name_Call {
	return &PeerWrapper_Name_Call{Call: _e.mock.On("String")}
}
