...
func (d *Delegate) newServicesVaultPlugin(
	...
	if gwerr := gwconnector.AddHandler(ctx, []string{vault_api.MethodSecretsCreate, vault_api.MethodSecretsUpdate, vault_api.MethodSecretsDelete}, handler); gwerr != nil {
