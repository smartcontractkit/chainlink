...
func (o *DROracle) GetServices() ([]job.ServiceCtx, error) {
	...
	oracle, err := functions_don.NewFunctionsDON(contractAddress, o.chain.Client())
	if err != nil {
		return nil, errors.Wrapf(err, "OCR2DirectRequest: failed to create an FunctionsDON wrapper for address: %v", contractAddress)
	}
	...
	logListener := functions.NewDRListener(oracle, o.jb, o.pipelineRunner, o.jobORM, o.pluginORM, o.pluginConfig, o.chain.LogBroadcaster(), svcLogger, o.mailMon)
