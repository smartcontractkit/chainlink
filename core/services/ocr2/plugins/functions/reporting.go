...
var _ types.ReportingPluginFactory = (*ReportingPluginFactory)(nil)
...
func (f ReportingPluginFactory) NewReportingPlugin(ctx context.Context, rpConfig types.ReportingPluginConfig) (types.ReportingPlugin, types.ReportingPluginInfo, error) {
