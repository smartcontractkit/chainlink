...
func (of *oracleFactory) NewOracle(ctx context.Context, args core.OracleArgs) (core.Oracle, error) {
	of.lggr.Debugw("Creating new oracle from oracle factory using config", "config", of.config, "capabilityID", of.capabilityID, "ocrConfigService", of.ocrConfigService)
