...
// GetUpkeepAdministrativeConfig provides a mock function with given fields: opts, upkeepId
func (_m *Registry) GetUpkeepAdministrativeConfig(opts *bind.CallOpts, upkeepId *big.Int) ([]byte, error) {
