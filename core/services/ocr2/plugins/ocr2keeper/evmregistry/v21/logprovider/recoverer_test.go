...
func TestLogRecoverer_GetRecoverables(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			"happy flow",
			[]ocr2keepers.UpkeepPayload{
				{WorkID: "1", UpkeepID: core2.GenUpkeepID(ocr2keepers.LogTrigger, "1")},
				{WorkID: "2", UpkeepID: core2.GenUpkeepID(ocr2keepers.LogTrigger, "2")},
			},
			[]ocr2keepers.UpkeepPayload{
				{WorkID: "1", UpkeepID: core2.GenUpkeepID(ocr2keepers.LogTrigger, "1")},
				{WorkID: "2", UpkeepID: core2.GenUpkeepID(ocr2keepers.LogTrigger, "2")},
		...
		},
		{
			...
			[]ocr2keepers.UpkeepPayload{
				{WorkID: "1", UpkeepID: core2.GenUpkeepID(ocr2keepers.LogTrigger, "1")},
				{WorkID: "2", UpkeepID: core2.GenUpkeepID(ocr2keepers.LogTrigger, "1")},
				{WorkID: "3", UpkeepID: core2.GenUpkeepID(ocr2keepers.LogTrigger, "1")},
				{WorkID: "4", UpkeepID: core2.GenUpkeepID(ocr2keepers.LogTrigger, "1")},
				{WorkID: "5", UpkeepID: core2.GenUpkeepID(ocr2keepers.LogTrigger, "1")},
				{WorkID: "6", UpkeepID: core2.GenUpkeepID(ocr2keepers.LogTrigger, "1")},
				{WorkID: "2", UpkeepID: core2.GenUpkeepID(ocr2keepers.LogTrigger, "2")},
			},
			[]ocr2keepers.UpkeepPayload{
				{WorkID: "1", UpkeepID: core2.GenUpkeepID(ocr2keepers.LogTrigger, "1")},
	...
	tests := []struct {
		...
		},
		{
			...
			[]ocr2keepers.UpkeepPayload{
				{WorkID: "1", UpkeepID: core2.GenUpkeepID(ocr2keepers.LogTrigger, "1")},
				{WorkID: "2", UpkeepID: core2.GenUpkeepID(ocr2keepers.LogTrigger, "2")},
				{WorkID: "3", UpkeepID: core2.GenUpkeepID(ocr2keepers.LogTrigger, "3")},
			},
			map[string]visitedRecord{
			...
			[]ocr2keepers.UpkeepPayload{
				{WorkID: "1", UpkeepID: core2.GenUpkeepID(ocr2keepers.LogTrigger, "1")},
				{WorkID: "2", UpkeepID: core2.GenUpkeepID(ocr2keepers.LogTrigger, "2")},
				{WorkID: "4", UpkeepID: core2.GenUpkeepID(ocr2keepers.LogTrigger, "4")},
			},
			[]string{"1", "2", "4"},
		},
	}
...
func TestLogRecoverer_GetProposalData(t *testing.T) {
	for _, tc := range []struct {
		...
		stateReader core2.UpkeepStateReader
		wantBytes   []byte
		expectErr   bool
		wantErr     error
	}{
		...
		},
		{
			...
			proposal: ocr2keepers.CoordinatedBlockProposal{
				UpkeepID: core2.GenUpkeepID(ocr2keepers.LogTrigger, "123"),
			},
			skipFilter: true,
			expectErr:  true,
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			if !tc.skipFilter {
				filterStore.AddActiveUpkeeps(upkeepFilter{
					...
					upkeepID: core2.GenUpkeepID(ocr2keepers.LogTrigger, "123").BigInt(),
				})
			}
