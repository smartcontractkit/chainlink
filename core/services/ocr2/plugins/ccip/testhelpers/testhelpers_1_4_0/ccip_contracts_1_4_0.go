...
import (
	...
	lock_release_token_pool_1_0_0 "github.com/smartcontractkit/chainlink-contracts/sdks/evm/go-bindings/ccip/generated/v1_0_0/lock_release_token_pool"
	...
	"github.com/smartcontractkit/chainlink-contracts/sdks/evm/go-bindings/ccip/generated/v1_2_0/evm_2_evm_offramp"
	"github.com/smartcontractkit/chainlink-contracts/sdks/evm/go-bindings/ccip/generated/v1_2_0/evm_2_evm_onramp"
...
func SetupCCIPContracts(t *testing.T, sourceChainID, sourceChainSelector, destChainID, destChainSelector uint64) CCIPContracts {
	...
	require.NoError(t, err)
	sourceChain.Commit()
	sourcePool, err := lock_release_token_pool_1_4_0.NewLockReleaseTokenPool(sourcePoolAddress, sourceChain.Client())
	require.NoError(t, err)
	...
	require.NoError(t, err)
	destChain.Commit()
	destPool, err := lock_release_token_pool_1_4_0.NewLockReleaseTokenPool(destPoolAddress, destChain.Client())
	require.NoError(t, err)
	destChain.Commit()
