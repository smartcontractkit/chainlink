...
func (_m *PriceService) UpdateDynamicConfig(ctx context.Context, gasPriceEstimator prices.GasPriceEstimatorCommit, destPriceRegistryReader types.PriceRegistryReader) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, prices.GasPriceEstimatorCommit, types.PriceRegistryReader) error); ok {
...
func (_c *PriceService_UpdateDynamicConfig_Call) Run(run func(ctx context.Context, gasPriceEstimator prices.GasPriceEstimatorCommit, destPriceRegistryReader types.PriceRegistryReader)) *PriceService_UpdateDynamicConfig_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(prices.GasPriceEstimatorCommit), args[2].(types.PriceRegistryReader))
	})
	return _c
}
...
func (_c *PriceService_UpdateDynamicConfig_Call) RunAndReturn(run func(context.Context, prices.GasPriceEstimatorCommit, types.PriceRegistryReader) error) *PriceService_UpdateDynamicConfig_Call {
	_c.Call.Return(run)
	return _c
}
