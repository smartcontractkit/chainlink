...
func (_m *MockOffRampReader) GetTokenPoolsRateLimits(ctx context.Context, poolAddresses []common.Address) ([]TokenBucketRateLimit, error) {
	ret := _m.Called(ctx, poolAddresses)

	var r0 []TokenBucketRateLimit
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []common.Address) ([]TokenBucketRateLimit, error)); ok {
		return rf(ctx, poolAddresses)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []common.Address) []TokenBucketRateLimit); ok {
		r0 = rf(ctx, poolAddresses)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]TokenBucketRateLimit)
		}
	}
