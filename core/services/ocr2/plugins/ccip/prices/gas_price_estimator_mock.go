...
type mockConstructorTestingTNewMockGasPriceEstimator interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockGasPriceEstimator(t mockConstructorTestingTNewMockGasPriceEstimator) *MockGasPriceEstimator {
