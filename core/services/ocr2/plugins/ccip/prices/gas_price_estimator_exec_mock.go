...
type mockConstructorTestingTNewMockGasPriceEstimatorExec interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockGasPriceEstimatorExec(t mockConstructorTestingTNewMockGasPriceEstimatorExec) *MockGasPriceEstimatorExec {
