...
import (
	...
	chaintypes "github.com/smartcontractkit/chainlink-common/pkg/chains/types"
...
func (d *Delegate) ServicesForSpec(ctx context.Context, spec job.Job) ([]job.ServiceCtx, error) {
	...
	ocrEvmKeyBundles, err := d.ks.OCR2().GetAllOfType(chaintypes.EVM)
	if err != nil {
		return nil, err
	}
	...
	if len(ocrEvmKeyBundles) == 0 {
		ocrEvmKeyBundle, err = d.ks.OCR2().Create(ctx, chaintypes.EVM)
		if err != nil {
