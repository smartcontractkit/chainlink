...
func (o *orm) withDataSource(ds sqlutil.DataSource) *orm {
	return &orm{
		...
		lggr:        o.lggr,
		keyStore:    o.keyStore,
		pipelineORM: o.pipelineORM.WithDataSource(ds),
		bridgeORM:   o.bridgeORM.WithDataSource(ds),
	}
}
	...
	err := o.transact(ctx, false, func(tx *orm) error {
		...
		case OffchainReporting:
			...
			if jb.OCROracleSpec.TransmitterAddress != nil {
				_, err := o.keyStore.Eth().Get(ctx, jb.OCROracleSpec.TransmitterAddress.Hex())
				if err != nil {
		...
		case OffchainReporting2:
			...
			sendingKeysDefined, err := areSendingKeysDefined(ctx, jb, o.keyStore)
			if err != nil {
				return err
			}
			...
			if !sendingKeysDefined {
				if err = ValidateKeyStoreMatch(ctx, jb.OCR2OracleSpec, o.keyStore, jb.OCR2OracleSpec.TransmitterID.String); err != nil {
			...
			specID, err := o.insertOCR2OracleSpec(ctx, jb.OCR2OracleSpec)
			if err != nil {
		...
		case Keeper:
			...
			specID, err := o.insertKeeperSpec(ctx, jb.KeeperSpec)
			if err != nil {
				return fmt.Errorf("failed to create KeeperSpec for jobSpec: %w", err)
			}
			jb.KeeperSpecID = &specID
		case Cron:
			specID, err := o.insertCronSpec(ctx, jb.CronSpec)
			if err != nil {
		...
		case VRF:
			...
			specID, err := o.insertVRFSpec(ctx, jb.VRFSpec)
		...
		case Webhook:
			...
			VALUES (:external_initiator_id, :webhook_spec_id, :spec);`
				query, args, err := tx.ds.BindNamed(sql, jb.WebhookSpec.ExternalInitiatorWebhookSpecs)
				if err != nil {
					return errors.Wrap(err, "failed to bindquery for ExternalInitiatorWebhookSpecs")
				}
				if _, err = tx.ds.ExecContext(ctx, query, args...); err != nil {
		...
		case BlockhashStore:
			...
			specID, err := o.insertBlockhashStoreSpec(ctx, jb.BlockhashStoreSpec)
			if err != nil {
		...
		case BlockHeaderFeeder:
			...
			specID, err := o.insertBlockHeaderFeederSpec(ctx, jb.BlockHeaderFeederSpec)
			if err != nil {
		...
		case LegacyGasStationServer:
			...
			specID, err := o.insertLegacyGasStationServerSpec(ctx, jb.LegacyGasStationServerSpec)
			if err != nil {
...
func (o *orm) insertDirectRequestSpec(ctx context.Context, spec *DirectRequestSpec) (specID int32, err error) {
	stmt, err := o.ds.PrepareNamedContext(ctx, `INSERT INTO direct_request_specs (contract_address, min_incoming_confirmations, requesters, min_contract_payment, evm_chain_id, created_at, updated_at)
			VALUES (:contract_address, :min_incoming_confirmations, :requesters, :min_contract_payment, :evm_chain_id, now(), now())
			RETURNING id;`)
	if err != nil {
		return -1, fmt.Errorf("error preparing named statement: %w", err)
	}
	defer stmt.Close()
	err = stmt.QueryRowxContext(ctx, spec).Scan(&specID)
	return
}

func (o *orm) insertFluxMonitorSpec(ctx context.Context, spec *FluxMonitorSpec) (specID int32, err error) {
	stmt, err := o.ds.PrepareNamedContext(ctx, `INSERT INTO flux_monitor_specs (contract_address, threshold, absolute_threshold, poll_timer_period, poll_timer_disabled, idle_timer_period, idle_timer_disabled,
...
func (o *orm) insertOCROracleSpec(ctx context.Context, spec *OCROracleSpec) (specID int32, err error) {
	stmt, err := o.ds.PrepareNamedContext(ctx, `INSERT INTO ocr_oracle_specs (contract_address, p2pv2_bootstrappers, is_bootstrap_peer, encrypted_ocr_key_bundle_id, transmitter_address,
...
func (o *orm) insertOCR2OracleSpec(ctx context.Context, spec *OCR2OracleSpec) (specID int32, err error) {
	stmt, err := o.ds.PrepareNamedContext(ctx, `INSERT INTO ocr2_oracle_specs (contract_id, feed_id, relay, relay_config, plugin_type, plugin_config, p2pv2_bootstrappers, ocr_key_bundle_id, transmitter_id,
...
func (o *orm) insertKeeperSpec(ctx context.Context, spec *KeeperSpec) (specID int32, err error) {
	stmt, err := o.ds.PrepareNamedContext(ctx, `INSERT INTO keeper_specs (contract_address, from_address, evm_chain_id, created_at, updated_at)
...
func (o *orm) insertCronSpec(ctx context.Context, spec *CronSpec) (specID int32, err error) {
	stmt, err := o.ds.PrepareNamedContext(ctx, `INSERT INTO cron_specs (cron_schedule, created_at, updated_at)
...
func (o *orm) insertVRFSpec(ctx context.Context, spec *VRFSpec) (specID int32, err error) {
	stmt, err := o.ds.PrepareNamedContext(ctx, `INSERT INTO vrf_specs (
...
func (o *orm) insertBlockHeaderFeederSpec(ctx context.Context, spec *BlockHeaderFeederSpec) (specID int32, err error) {
	...
	defer stmt.Close()
	err = stmt.QueryRowxContext(ctx, toBlockHeaderFeederSpecRow(spec)).Scan(&specID)
	return
}

func (o *orm) insertLegacyGasStationServerSpec(ctx context.Context, spec *LegacyGasStationServerSpec) (specID int32, err error) {
	stmt, err := o.ds.PrepareNamedContext(ctx, `INSERT INTO legacy_gas_station_server_specs (forwarder_address, evm_chain_id, ccip_chain_selector, from_addresses, created_at, updated_at)
	...
	defer stmt.Close()
	err = stmt.QueryRowxContext(ctx, toLegacyGasStationServerSpecRow(spec)).Scan(&specID)
	return
}

func (o *orm) insertLegacyGasStationSidecarSpec(ctx context.Context, spec *LegacyGasStationSidecarSpec) (specID int32, err error) {
	stmt, err := o.ds.PrepareNamedContext(ctx, `INSERT INTO legacy_gas_station_sidecar_specs (forwarder_address, off_ramp_address, lookback_blocks, poll_period, run_timeout, evm_chain_id, ccip_chain_selector, created_at, updated_at)
...
func (o *orm) insertBootstrapSpec(ctx context.Context, spec *BootstrapSpec) (specID int32, err error) {
	stmt, err := o.ds.PrepareNamedContext(ctx, `INSERT INTO bootstrap_specs (contract_id, feed_id, relay, relay_config, monitoring_endpoint,
...
func (o *orm) insertGatewaySpec(ctx context.Context, spec *GatewaySpec) (specID int32, err error) {
	stmt, err := o.ds.PrepareNamedContext(ctx, `INSERT INTO gateway_specs (gateway_config, created_at, updated_at)
...
func (o *orm) InsertJob(ctx context.Context, job *Job) error {
	...
	query, args, err := o.ds.BindNamed(query, job)
	if err != nil {
		return fmt.Errorf("error binding arg: %w", err)
	}
	return o.ds.GetContext(ctx, job, query, args...)
}
...
func (o *orm) FindJobs(ctx context.Context, offset, limit int) (jobs []Job, count int, err error) {
	// TODO this tx breaks test scripts - why
	err = o.transact(ctx, false, func(tx *orm) error {
...
func (o *orm) findJob(ctx context.Context, jb *Job, col string, arg interface{}) error {
	err := o.transact(ctx, false, func(tx *orm) error {
		...
		return o.loadJobSpecErrors(ctx, jb)
	})
	if err != nil {
...
func (o *orm) FindJobIDsWithBridge(ctx context.Context, name string) (jids []int32, err error) {
	err = o.transact(ctx, false, func(tx *orm) error {
		...
		var rows *sqlx.Rows
		rows, err = tx.ds.QueryxContext(ctx, query, name)
		if err != nil {
			return err
		}
		defer rows.Close()
...
func (o *orm) FindTaskResultByRunIDAndTaskName(ctx context.Context, runID int64, taskName string) (result []byte, err error) {
	err = o.transact(ctx, false, func(tx *orm) error {
		...
		if errB := tx.ds.SelectContext(ctx, &taskRuns, stmt, runID); errB != nil {
			return errB
		}
		if len(taskRuns) == 0 {
...
func (o *orm) CountPipelineRunsByJobID(ctx context.Context, jobID int32) (count int32, err error) {
	err = o.transact(ctx, false, func(tx *orm) error {
		...
		if err = tx.ds.GetContext(ctx, &count, stmt, jobID); err != nil {
...
func (o *orm) PipelineRuns(ctx context.Context, jobID *int32, offset, size int) (runs []pipeline.Run, count int, err error) {
	...
	err = o.transact(ctx, false, func(tx *orm) error {
		...
		var ids []int64
		ids, err = o.loadPipelineRunIDs(ctx, jobID, offset, size)
		runs, err = o.loadPipelineRunsByID(ctx, ids)
...
func (o *orm) loadAllJobTypes(ctx context.Context, job *Job) error {
	return multierr.Combine(
		o.loadJobType(ctx, job, "PipelineSpec", "pipeline_specs", &job.PipelineSpecID),
