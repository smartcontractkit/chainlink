...
func (o *orm) InsertJob(job *Job, qopts ...pg.QOpt) error {
	...
	return q.GetNamed(`INSERT INTO jobs (pipeline_spec_id, name, schema_version, type, max_task_duration, ocr_oracle_spec_id, ocr2_oracle_spec_id, direct_request_spec_id, flux_monitor_spec_id,
