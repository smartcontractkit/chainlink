...
// CheckForDeletedJobs provides a mock function with given fields: ctx, currentJobIDs
func (_m *ORM) CheckForDeletedJobs(ctx context.Context, currentJobIDs []int32) ([]int32, error) {
	ret := _m.Called(ctx, currentJobIDs)

	var r0 []int32
	if rf, ok := ret.Get(0).(func(context.Context, []int32) []int32); ok {
		r0 = rf(ctx, currentJobIDs)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]int32)
		}
