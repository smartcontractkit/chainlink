...
// NewSpawner creates a new instance of Spawner. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewSpawner(t testing.TB) *Spawner {
	mock := &Spawner{}
	mock.Mock.Test(t)
