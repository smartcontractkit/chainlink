...
func (_m *Spawner) ActiveJobs() map[int32]Job {
	ret := _m.Called()
	...
	var r0 map[int32]Job
	if rf, ok := ret.Get(0).(func() map[int32]Job); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(map[int32]Job)
		}
	}
...
func (_c *Spawner_ActiveJobs_Call) Return(_a0 map[int32]Job) *Spawner_ActiveJobs_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Spawner_ActiveJobs_Call) RunAndReturn(run func() map[int32]Job) *Spawner_ActiveJobs_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Spawner) CreateJob(ctx context.Context, ds sqlutil.DataSource, jb *Job) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, sqlutil.DataSource, *Job) error); ok {
		r0 = rf(ctx, ds, jb)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *Spawner_CreateJob_Call) Run(run func(ctx context.Context, ds sqlutil.DataSource, jb *Job)) *Spawner_CreateJob_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(sqlutil.DataSource), args[2].(*Job))
	})
	return _c
}
...
func (_c *Spawner_CreateJob_Call) RunAndReturn(run func(context.Context, sqlutil.DataSource, *Job) error) *Spawner_CreateJob_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Spawner) StartService(ctx context.Context, spec Job) error {
...
func (_c *Spawner_StartService_Call) Run(run func(ctx context.Context, spec Job)) *Spawner_StartService_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Spawner_StartService_Call) RunAndReturn(run func(context.Context, Job) error) *Spawner_StartService_Call {
	_c.Call.Return(run)
	return _c
}
