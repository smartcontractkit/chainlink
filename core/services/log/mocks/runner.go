...
// PipelineRunner is an autogenerated mock type for the Runner type
type PipelineRunner struct {
	mock.Mock
}

// AwaitRun provides a mock function with given fields: ctx, runID
func (_m *PipelineRunner) AwaitRun(ctx context.Context, runID int64) error {
...
func (_m *PipelineRunner) Close() error {
	ret := _m.Called()
...
func (_m *PipelineRunner) CreateRun(ctx context.Context, jobID int32, meta map[string]interface{}) (int64, error) {
...
func (_m *PipelineRunner) ExecuteRun(ctx context.Context, run pipeline.Run, l logger.Logger) (pipeline.TaskRunResults, error) {
...
func (_m *PipelineRunner) ResultsForRun(ctx context.Context, runID int64) ([]pipeline.Result, error) {
	ret := _m.Called(ctx, runID)
...
func (_m *PipelineRunner) Start() error {
	ret := _m.Called()
