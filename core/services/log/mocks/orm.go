...
func (_m *ORM) MarkBroadcastConsumed(e postgres.Queryer, blockHash common.Hash, blockNumber uint64, logIndex uint, jobID log.JobIdSelect) error {
	ret := _m.Called(e, blockHash, blockNumber, logIndex, jobID)

	var r0 error
	if rf, ok := ret.Get(0).(func(postgres.Queryer, common.Hash, uint64, uint, log.JobIdSelect) error); ok {
...
func (_m *ORM) WasBroadcastConsumed(q postgres.Queryer, blockHash common.Hash, logIndex uint, jobID log.JobIdSelect) (bool, error) {
	ret := _m.Called(q, blockHash, logIndex, jobID)

	var r0 bool
	if rf, ok := ret.Get(0).(func(postgres.Queryer, common.Hash, uint, log.JobIdSelect) bool); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(postgres.Queryer, common.Hash, uint, log.JobIdSelect) error); ok {
