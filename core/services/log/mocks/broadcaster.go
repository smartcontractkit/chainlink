...
func (_m *Broadcaster) MarkConsumed(e postgres.Queryer, lb log.Broadcast) error {
	ret := _m.Called(e, lb)

	var r0 error
	if rf, ok := ret.Get(0).(func(postgres.Queryer, log.Broadcast) error); ok {
		r0 = rf(e, lb)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *Broadcaster) WasAlreadyConsumed(q postgres.Queryer, lb log.Broadcast) (bool, error) {
	ret := _m.Called(q, lb)

	var r0 bool
	if rf, ok := ret.Get(0).(func(postgres.Queryer, log.Broadcast) bool); ok {
		r0 = rf(q, lb)
	} else {
		r0 = ret.Get(0).(bool)
	}
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(postgres.Queryer, log.Broadcast) error); ok {
		r1 = rf(q, lb)
	} else {
		r1 = ret.Error(1)
	}
