...
// MarkConsumed provides a mock function with given fields: tx, lb
func (_m *Broadcaster) MarkConsumed(tx *gorm.DB, lb log.Broadcast) error {
	ret := _m.Called(tx, lb)
...
// WasAlreadyConsumed provides a mock function with given fields: tx, lb
func (_m *Broadcaster) WasAlreadyConsumed(tx *gorm.DB, lb log.Broadcast) (bool, error) {
	ret := _m.Called(tx, lb)
