...
// NewEventBroadcaster creates a new instance of EventBroadcaster. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewEventBroadcaster(t testing.TB) *EventBroadcaster {
