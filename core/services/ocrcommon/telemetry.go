...
type EnhancedTelemetryMercuryData struct {
	TaskRunResults pipeline.TaskRunResults
	Observation    relaymercuryv0.Observation
...
// sends the telemetry
func (e *EnhancedTelemetryService[T]) collectMercuryEnhancedTelemetry(obs relaymercuryv0.Observation, trrs pipeline.TaskRunResults, repts ocrtypes.ReportTimestamp) {
	if e.monitoringEndpoint == nil {
		return
	}
...
func (e *EnhancedTelemetryService[T]) getFinalValues(obs relaymercuryv0.Observation) (int64, int64, int64, int64, []byte, uint64) {
