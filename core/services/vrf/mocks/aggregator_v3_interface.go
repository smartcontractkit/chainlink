...
// AggregatorV3Interface is an autogenerated mock type for the IAggregatorV3Interface type
...
type NewAggregatorV3InterfaceT interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewAggregatorV3Interface(t NewAggregatorV3InterfaceT) *AggregatorV3Interface {
