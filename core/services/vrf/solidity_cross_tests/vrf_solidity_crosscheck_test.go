...
func TestUnit_VRF_CompareProjectiveECAddToVerifier(t *testing.T) {
	t.Parallel()
...
func TestUnit_VRF_CompareBigModExpToVerifier(t *testing.T) {
	t.Parallel()
...
func TestUnit_VRF_CompareSquareRoot(t *testing.T) {
	t.Parallel()
...
func TestUnit_VRF_CompareYSquared(t *testing.T) {
	t.Parallel()
...
func TestUnit_VRF_CompareFieldHash(t *testing.T) {
	t.Parallel()
...
func TestUnit_VRF_CompareHashToCurve(t *testing.T) {
	t.Parallel()
...
func TestUnit_VRF_CheckSolidityPointAddition(t *testing.T) {
	t.Parallel()
...
func TestUnit_VRF_CheckSolidityECMulVerify(t *testing.T) {
	t.Parallel()
...
func TestUnit_VRF_CheckSolidityVerifyLinearCombinationWithGenerator(t *testing.T) {
	t.Parallel()
...
func TestUnit_VRF_CheckSolidityLinearComination(t *testing.T) {
	t.Parallel()
...
func TestUnit_VRF_CompareSolidityScalarFromCurvePoints(t *testing.T) {
	t.Parallel()
...
func TestUnit_VRF_MarshalProof(t *testing.T) {
	t.Parallel()
