...
type ORM interface {
	...
	CreateSpec(ctx context.Context, pipeline Pipeline, maxTaskTimeout types.Interval) (int32, error)
...
func (o *orm) CreateSpec(ctx context.Context, pipeline Pipeline, maxTaskDuration types.Interval) (id int32, err error) {
