...
import (
	...
	common "github.com/smartcontractkit/chainlink-common/pkg/pipeline"
)

type Spec = common.Spec

// RunStatus represents the status of a run
type RunStatus = common.RunStatus
...
func (r *Run) Status() RunStatus {
	if r.HasFatalErrors() {
		return common.RunStatusErrored
	} else if r.FinishedAt.Valid {
		return common.RunStatusCompleted
	}

	return common.RunStatusRunning
}
