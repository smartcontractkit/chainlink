...
type Run struct {
	...
	Meta           json_serializable.JSONSerializable `json:"meta"`
	...
	Inputs      json_serializable.JSONSerializable `json:"inputs"`
	// Its expected that Output.Val is of type []interface{}.
	// DB example: [1234, {"a": 10}, null]
	Outputs          json_serializable.JSONSerializable `json:"outputs"`
...
type TaskRun struct {
	...
	Output        json_serializable.JSONSerializable `json:"output"`
	Error         null.String                        `json:"error"`
	CreatedAt     time.Time                          `json:"createdAt"`
	FinishedAt    null.Time                          `json:"finishedAt"`
