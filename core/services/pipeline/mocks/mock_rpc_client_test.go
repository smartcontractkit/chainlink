...
func (_m *Runner) ExecuteAndInsertFinishedRun(ctx context.Context, spec Spec, vars Vars, l logger.Logger, saveSuccessfulTaskRuns bool) (int64, TaskRunResults, error) {
	...
	var r0 int64
	var r1 TaskRunResults
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, Spec, Vars, logger.Logger, bool) (int64, TaskRunResults, error)); ok {
		return rf(ctx, spec, vars, l, saveSuccessfulTaskRuns)
	}
	if rf, ok := ret.Get(0).(func(context.Context, Spec, Vars, logger.Logger, bool) int64); ok {
		r0 = rf(ctx, spec, vars, l, saveSuccessfulTaskRuns)
	} else {
		r0 = ret.Get(0).(int64)
	}

	if rf, ok := ret.Get(1).(func(context.Context, Spec, Vars, logger.Logger, bool) TaskRunResults); ok {
		r1 = rf(ctx, spec, vars, l, saveSuccessfulTaskRuns)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(TaskRunResults)
		}
	}

	if rf, ok := ret.Get(2).(func(context.Context, Spec, Vars, logger.Logger, bool) error); ok {
...
func (_c *Runner_ExecuteAndInsertFinishedRun_Call) Run(run func(ctx context.Context, spec Spec, vars Vars, l logger.Logger, saveSuccessfulTaskRuns bool)) *Runner_ExecuteAndInsertFinishedRun_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(Spec), args[2].(Vars), args[3].(logger.Logger), args[4].(bool))
	})
	return _c
}

func (_c *Runner_ExecuteAndInsertFinishedRun_Call) Return(runID int64, results TaskRunResults, err error) *Runner_ExecuteAndInsertFinishedRun_Call {
	_c.Call.Return(runID, results, err)
	return _c
}

func (_c *Runner_ExecuteAndInsertFinishedRun_Call) RunAndReturn(run func(context.Context, Spec, Vars, logger.Logger, bool) (int64, TaskRunResults, error)) *Runner_ExecuteAndInsertFinishedRun_Call {
	_c.Call.Return(run)
	return _c
}

// ExecuteRun provides a mock function with given fields: ctx, spec, vars, l
func (_m *Runner) ExecuteRun(ctx context.Context, spec Spec, vars Vars, l logger.Logger) (*Run, TaskRunResults, error) {
	...
	var r1 TaskRunResults
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, Spec, Vars, logger.Logger) (*Run, TaskRunResults, error)); ok {
		return rf(ctx, spec, vars, l)
	}
	if rf, ok := ret.Get(0).(func(context.Context, Spec, Vars, logger.Logger) *Run); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, Spec, Vars, logger.Logger) TaskRunResults); ok {
	...
	if rf, ok := ret.Get(2).(func(context.Context, Spec, Vars, logger.Logger) error); ok {
...
func (_c *Runner_ExecuteRun_Call) Run(run func(ctx context.Context, spec Spec, vars Vars, l logger.Logger)) *Runner_ExecuteRun_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(Spec), args[2].(Vars), args[3].(logger.Logger))
	})
	return _c
}

func (_c *Runner_ExecuteRun_Call) Return(run *Run, trrs TaskRunResults, err error) *Runner_ExecuteRun_Call {
	_c.Call.Return(run, trrs, err)
	return _c
}

func (_c *Runner_ExecuteRun_Call) RunAndReturn(run func(context.Context, Spec, Vars, logger.Logger) (*Run, TaskRunResults, error)) *Runner_ExecuteRun_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Runner) InitializePipeline(spec Spec) (*Pipeline, error) {
	ret := _m.Called(spec)
	...
	var r0 *Pipeline
	var r1 error
	if rf, ok := ret.Get(0).(func(Spec) (*Pipeline, error)); ok {
		return rf(spec)
	}
	if rf, ok := ret.Get(0).(func(Spec) *Pipeline); ok {
		r0 = rf(spec)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(Spec) error); ok {
		r1 = rf(spec)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *Runner_InitializePipeline_Call) Run(run func(spec Spec)) *Runner_InitializePipeline_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(Spec))
	})
	return _c
...
func (_c *Runner_InitializePipeline_Call) Return(_a0 *Pipeline, _a1 error) *Runner_InitializePipeline_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Runner_InitializePipeline_Call) RunAndReturn(run func(Spec) (*Pipeline, error)) *Runner_InitializePipeline_Call {
	_c.Call.Return(run)
	return _c
}

// InsertFinishedRun provides a mock function with given fields: ctx, ds, run, saveSuccessfulTaskRuns
func (_m *Runner) InsertFinishedRun(ctx context.Context, ds sqlutil.DataSource, run *Run, saveSuccessfulTaskRuns bool) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, sqlutil.DataSource, *Run, bool) error); ok {
...
func (_c *Runner_InsertFinishedRun_Call) Run(run func(ctx context.Context, ds sqlutil.DataSource, run *Run, saveSuccessfulTaskRuns bool)) *Runner_InsertFinishedRun_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(sqlutil.DataSource), args[2].(*Run), args[3].(bool))
	})
	return _c
}
...
func (_c *Runner_InsertFinishedRun_Call) RunAndReturn(run func(context.Context, sqlutil.DataSource, *Run, bool) error) *Runner_InsertFinishedRun_Call {
	_c.Call.Return(run)
	return _c
}

// InsertFinishedRuns provides a mock function with given fields: ctx, ds, runs, saveSuccessfulTaskRuns
func (_m *Runner) InsertFinishedRuns(ctx context.Context, ds sqlutil.DataSource, runs []*Run, saveSuccessfulTaskRuns bool) error {
...
func (_c *Runner_InsertFinishedRuns_Call) Run(run func(ctx context.Context, ds sqlutil.DataSource, runs []*Run, saveSuccessfulTaskRuns bool)) *Runner_InsertFinishedRuns_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(sqlutil.DataSource), args[2].([]*Run), args[3].(bool))
	})
	return _c
...
func (_c *Runner_InsertFinishedRuns_Call) RunAndReturn(run func(context.Context, sqlutil.DataSource, []*Run, bool) error) *Runner_InsertFinishedRuns_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Runner) OnRunFinished(_a0 func(*Run)) {
	_m.Called(_a0)
}
...
func (_c *Runner_OnRunFinished_Call) Run(run func(_a0 func(*Run))) *Runner_OnRunFinished_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(func(*Run)))
	})
	return _c
...
func (_c *Runner_OnRunFinished_Call) RunAndReturn(run func(func(*Run))) *Runner_OnRunFinished_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Runner) Run(ctx context.Context, run *Run, l logger.Logger, saveSuccessfulTaskRuns bool, fn func(sqlutil.DataSource) error) (bool, error) {
	...
	var r0 bool
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *Run, logger.Logger, bool, func(sqlutil.DataSource) error) (bool, error)); ok {
		return rf(ctx, run, l, saveSuccessfulTaskRuns, fn)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *Run, logger.Logger, bool, func(sqlutil.DataSource) error) bool); ok {
		r0 = rf(ctx, run, l, saveSuccessfulTaskRuns, fn)
	} else {
		r0 = ret.Get(0).(bool)
	}

	if rf, ok := ret.Get(1).(func(context.Context, *Run, logger.Logger, bool, func(sqlutil.DataSource) error) error); ok {
...
func (_c *Runner_Run_Call) Run(run func(ctx context.Context, run *Run, l logger.Logger, saveSuccessfulTaskRuns bool, fn func(sqlutil.DataSource) error)) *Runner_Run_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*Run), args[2].(logger.Logger), args[3].(bool), args[4].(func(sqlutil.DataSource) error))
	})
	return _c
}
...
func (_c *Runner_Run_Call) RunAndReturn(run func(context.Context, *Run, logger.Logger, bool, func(sqlutil.DataSource) error) (bool, error)) *Runner_Run_Call {
	_c.Call.Return(run)
	return _c
}
