...
func (_m *ORM) CreateSpec(ctx context.Context, _a1 pipeline.Pipeline, maxTaskTimeout types.Interval) (int32, error) {
	...
	var r0 int32
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, pipeline.Pipeline, types.Interval) (int32, error)); ok {
		return rf(ctx, _a1, maxTaskTimeout)
	}
	if rf, ok := ret.Get(0).(func(context.Context, pipeline.Pipeline, types.Interval) int32); ok {
		r0 = rf(ctx, _a1, maxTaskTimeout)
	} else {
		r0 = ret.Get(0).(int32)
	}

	if rf, ok := ret.Get(1).(func(context.Context, pipeline.Pipeline, types.Interval) error); ok {
...
func (_c *ORM_CreateSpec_Call) Run(run func(ctx context.Context, _a1 pipeline.Pipeline, maxTaskTimeout types.Interval)) *ORM_CreateSpec_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(pipeline.Pipeline), args[2].(types.Interval))
	})
	return _c
}
...
func (_c *ORM_CreateSpec_Call) RunAndReturn(run func(context.Context, pipeline.Pipeline, types.Interval) (int32, error)) *ORM_CreateSpec_Call {
	_c.Call.Return(run)
	return _c
}
