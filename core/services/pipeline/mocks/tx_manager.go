...
func (_m *TxManager) CreateEthTransaction(db postgres.Queryer, fromAddress common.Address, toAddress common.Address, payload []byte, gasLimit uint64, meta interface{}, strategy bulletprooftxmanager.TxStrategy) (bulletprooftxmanager.EthTx, error) {
	ret := _m.Called(db, fromAddress, toAddress, payload, gasLimit, meta, strategy)

	var r0 bulletprooftxmanager.EthTx
	if rf, ok := ret.Get(0).(func(postgres.Queryer, common.Address, common.Address, []byte, uint64, interface{}, bulletprooftxmanager.TxStrategy) bulletprooftxmanager.EthTx); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(postgres.Queryer, common.Address, common.Address, []byte, uint64, interface{}, bulletprooftxmanager.TxStrategy) error); ok {
