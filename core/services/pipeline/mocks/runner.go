...
// Runner_Name_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'String'
...
func (_e *Runner_Expecter) Name() *Runner_Name_Call {
	return &Runner_Name_Call{Call: _e.mock.On("String")}
}
