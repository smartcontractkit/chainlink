...
// InsertFinishedRun provides a mock function with given fields: ctx, tx, run, trrs, saveSuccessfulTaskRuns
func (_m *Runner) InsertFinishedRun(ctx context.Context, tx postgres.Queryer, run pipeline.Run, trrs pipeline.TaskRunResults, saveSuccessfulTaskRuns bool) (int64, error) {
	ret := _m.Called(ctx, tx, run, trrs, saveSuccessfulTaskRuns)

	var r0 int64
	if rf, ok := ret.Get(0).(func(context.Context, postgres.Queryer, pipeline.Run, pipeline.TaskRunResults, bool) int64); ok {
		r0 = rf(ctx, tx, run, trrs, saveSuccessfulTaskRuns)
	} else {
		r0 = ret.Get(0).(int64)
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, postgres.Queryer, pipeline.Run, pipeline.TaskRunResults, bool) error); ok {
		r1 = rf(ctx, tx, run, trrs, saveSuccessfulTaskRuns)
	} else {
		r1 = ret.Error(1)
	}
...
// TestInsertFinishedRun provides a mock function with given fields: ctx, tx, jobID, jobName, jobType, specID
func (_m *Runner) TestInsertFinishedRun(ctx context.Context, tx postgres.Queryer, jobID int32, jobName string, jobType string, specID int32) (int64, error) {
	ret := _m.Called(ctx, tx, jobID, jobName, jobType, specID)

	var r0 int64
	if rf, ok := ret.Get(0).(func(context.Context, postgres.Queryer, int32, string, string, int32) int64); ok {
		r0 = rf(ctx, tx, jobID, jobName, jobType, specID)
	} else {
		r0 = ret.Get(0).(int64)
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, postgres.Queryer, int32, string, string, int32) error); ok {
		r1 = rf(ctx, tx, jobID, jobName, jobType, specID)
	} else {
		r1 = ret.Error(1)
	}
