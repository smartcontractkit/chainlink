...
func (_m *Runner) InsertFinishedRun(ctx context.Context, tx sqlx.ExtContext, run pipeline.Run, trrs pipeline.TaskRunResults, saveSuccessfulTaskRuns bool) (int64, error) {
	ret := _m.Called(ctx, tx, run, trrs, saveSuccessfulTaskRuns)

	var r0 int64
	if rf, ok := ret.Get(0).(func(context.Context, sqlx.ExtContext, pipeline.Run, pipeline.TaskRunResults, bool) int64); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, sqlx.ExtContext, pipeline.Run, pipeline.TaskRunResults, bool) error); ok {
...
func (_m *Runner) TestInsertFinishedRun(ctx context.Context, tx sqlx.ExtContext, jobID int32, jobName string, jobType string, specID int32) (int64, error) {
	ret := _m.Called(ctx, tx, jobID, jobName, jobType, specID)

	var r0 int64
	if rf, ok := ret.Get(0).(func(context.Context, sqlx.ExtContext, int32, string, string, int32) int64); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, sqlx.ExtContext, int32, string, string, int32) error); ok {
