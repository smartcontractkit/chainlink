...
func TestUnit_ModeTask(t *testing.T) {
	t.Parallel()
	...
	tests := []struct {
		...
		},
		{
			...
			"2",
			[]any{mustDecimal(t, "2")}, 2, nil,
		},
		{
			"exactly threshold of errors",
			[]pipeline.Result{{Error: errors.New("")}, {Error: errors.New("")}, {Value: []any{1, 2, 3}}, {Value: []any{1, 2, 3}}},
			"2",
			[]any{[]any{1, 2, 3}}, 2, nil,
		},
		{
