...
func TestWinsorizedMeanTask(t *testing.T) {
	t.Parallel()
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			task := pipeline.WinsorizedMeanTask{
...
func TestWinsorizedMeanTaskBoundedOutput(t *testing.T) {
	t.Parallel()
...
func TestWinsorizedMeanTaskGate(t *testing.T) {
	t.Parallel()
...
func TestWinsorizedMeanTaskReference(t *testing.T) {
	t.Parallel()
...
func TestWinsorizedMeanTaskPrecision(t *testing.T) {
	t.Parallel()
...
func TestWinsorizedMeanTaskInputErrors(t *testing.T) {
	t.Parallel()
