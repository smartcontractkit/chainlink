...
func TestHTTP_WithRestrictedIP(t *testing.T) {
	cfg := orm.NewConfig()
...
// func makeHTTPGetAdapter(t *testing.T, server *httptest.Server) *pipeline.HTTPGet {
// 	return &pipeline.HTTPGet{
