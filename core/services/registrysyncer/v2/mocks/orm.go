...
func (_m *ORM) AddLocalRegistry(ctx context.Context, localRegistry v2.LocalRegistry) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, v2.LocalRegistry) error); ok {
...
func (_c *ORM_AddLocalRegistry_Call) Run(run func(ctx context.Context, localRegistry v2.LocalRegistry)) *ORM_AddLocalRegistry_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(v2.LocalRegistry))
	})
	return _c
}
...
func (_c *ORM_AddLocalRegistry_Call) RunAndReturn(run func(context.Context, v2.LocalRegistry) error) *ORM_AddLocalRegistry_Call {
	_c.Call.Return(run)
	return _c
}

// LatestLocalRegistry provides a mock function with given fields: ctx
func (_m *ORM) LatestLocalRegistry(ctx context.Context) (*v2.LocalRegistry, error) {
	ret := _m.Called(ctx)
	...
	var r0 *v2.LocalRegistry
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) (*v2.LocalRegistry, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(context.Context) *v2.LocalRegistry); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*v2.LocalRegistry)
		}
	}
...
func (_c *ORM_LatestLocalRegistry_Call) Return(_a0 *v2.LocalRegistry, _a1 error) *ORM_LatestLocalRegistry_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *ORM_LatestLocalRegistry_Call) RunAndReturn(run func(context.Context) (*v2.LocalRegistry, error)) *ORM_LatestLocalRegistry_Call {
	_c.Call.Return(run)
	return _c
}
