...
// SaveLatestRoundRequested provides a mock function with given fields: rr
func (_m *OCRContractTrackerDB) SaveLatestRoundRequested(rr offchainaggregator.OffchainAggregatorRoundRequested) error {
	ret := _m.Called(rr)
