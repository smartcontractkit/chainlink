...
`
	...
	assert.Equal(t, "0x6135616331346538373632393437323662316631316165303533666338323965", s.ExternalIDToHexTopic().String())
	assert.Equal(t, "0xa5ac14e876294726b1f11ae053fc829e00000000000000000000000000000000", s.ExternalIDToPaddedBytesTopic().String())
