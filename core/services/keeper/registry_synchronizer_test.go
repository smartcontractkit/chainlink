...
func setupRegistrySync(t *testing.T) (
	...
	*logmocks.Broadcaster,
	...
	cc := evmtest.NewChainCollection(t, evmtest.TestChainOpts{DB: store.DB, Client: ethClient, LogBroadcaster: lbMock, GeneralConfig: cfg})
	jpv2 := cltest.NewJobPipelineV2(t, cfg, cc, store.DB, nil)
