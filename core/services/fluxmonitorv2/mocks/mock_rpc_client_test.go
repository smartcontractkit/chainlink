...
func (_m *ORM) FindOrCreateFluxMonitorRoundStats(ctx context.Context, aggregator common.Address, roundID uint32, newRoundLogs uint) (FluxMonitorRoundStatsV2, error) {
	...
	var r0 FluxMonitorRoundStatsV2
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, common.Address, uint32, uint) (FluxMonitorRoundStatsV2, error)); ok {
		return rf(ctx, aggregator, roundID, newRoundLogs)
	}
	if rf, ok := ret.Get(0).(func(context.Context, common.Address, uint32, uint) FluxMonitorRoundStatsV2); ok {
		r0 = rf(ctx, aggregator, roundID, newRoundLogs)
	} else {
		r0 = ret.Get(0).(FluxMonitorRoundStatsV2)
	}
...
func (_c *ORM_FindOrCreateFluxMonitorRoundStats_Call) Return(_a0 FluxMonitorRoundStatsV2, _a1 error) *ORM_FindOrCreateFluxMonitorRoundStats_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *ORM_FindOrCreateFluxMonitorRoundStats_Call) RunAndReturn(run func(context.Context, common.Address, uint32, uint) (FluxMonitorRoundStatsV2, error)) *ORM_FindOrCreateFluxMonitorRoundStats_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *ORM) WithDataSource(_a0 sqlutil.DataSource) ORM {
	ret := _m.Called(_a0)
	...
	var r0 ORM
	if rf, ok := ret.Get(0).(func(sqlutil.DataSource) ORM); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(ORM)
...
func (_c *ORM_WithDataSource_Call) Return(_a0 ORM) *ORM_WithDataSource_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *ORM_WithDataSource_Call) RunAndReturn(run func(sqlutil.DataSource) ORM) *ORM_WithDataSource_Call {
	_c.Call.Return(run)
	return _c
}
