...
func (_m *ORM) UpdateFluxMonitorRoundStats(aggregator common.Address, roundID uint32, runID int64, newRoundLogsAddition uint, qopts ...postgres.QOpt) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(common.Address, uint32, int64, uint, ...postgres.QOpt) error); ok {
