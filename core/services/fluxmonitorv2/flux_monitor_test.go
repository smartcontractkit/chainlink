...
func TestIntegration_Shared_FluxMonitor_PollIfEligible(t *testing.T) {
	t.Parallel()
	testCases := []struct {
		name              string
		eligible          bool
...
func TestIntegration_Shared_FluxMonitor_PollIfEligible_Creates_JobErr(t *testing.T) {
	t.Parallel()
	db, nodeAddr := setupStoreWithKey(t)
	oracles := []common.Address{nodeAddr, testutils.NewAddress()}
...
func TestIntegration_Shared_PollingDeviationChecker_BuffersLogs(t *testing.T) {
	t.Parallel()
	db, nodeAddr := setupStoreWithKey(t)
	oracles := []common.Address{nodeAddr, testutils.NewAddress()}
...
func TestIntegration_Shared_FluxMonitor_TriggerIdleTimeThreshold(t *testing.T) {
	t.Parallel()
	g := gomega.NewWithT(t)
...
func TestIntegration_Shared_FluxMonitor_HibernationTickerFiresMultipleTimes(t *testing.T) {
	t.Parallel()
...
func TestIntegration_Shared_FluxMonitor_HibernationIsEnteredAndRetryTickerStopped(t *testing.T) {
...
func TestIntegration_Shared_FluxMonitor_IdleTimerResetsOnNewRound(t *testing.T) {
...
func TestIntegration_Shared_FluxMonitor_RoundTimeoutCausesPoll_timesOutAtZero(t *testing.T) {
	t.Parallel()
...
func TestIntegration_Shared_FluxMonitor_UsesPreviousRoundStateOnStartup_RoundTimeout(t *testing.T) {
...
func TestIntegration_Shared_FluxMonitor_UsesPreviousRoundStateOnStartup_IdleTimer(t *testing.T) {
	t.Parallel()
	g := gomega.NewWithT(t)
...
func TestIntegration_Shared_FluxMonitor_RoundTimeoutCausesPoll_timesOutNotZero(t *testing.T) {
	t.Parallel()
...
func TestIntegration_Shared_FluxMonitor_ConsumeLogBroadcast(t *testing.T) {
	t.Parallel()
...
func TestIntegration_Shared_FluxMonitor_ConsumeLogBroadcast_Error(t *testing.T) {
	t.Parallel()
...
func TestIntegration_Shared_FluxMonitor_DoesNotDoubleSubmit(t *testing.T) {
	t.Parallel()
...
func TestIntegration_Shared_FluxMonitor_DrumbeatTicker(t *testing.T) {
	t.Parallel()
