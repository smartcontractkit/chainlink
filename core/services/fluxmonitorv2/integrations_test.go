...
func TestIntegration_Shared_FluxMonitor_Deviation(t *testing.T) {
...
func TestIntegration_Shared_FluxMonitor_NewRound(t *testing.T) {
...
func TestIntegration_Shared_FluxMonitor_HibernationMode(t *testing.T) {
	g := gomega.NewWithT(t)
	fa := setupFluxAggregatorUniverse(t)
...
func TestIntegration_Shared_FluxMonitor_InvalidSubmission(t *testing.T) {
...
func TestIntegration_Shared_FluxMonitorAntiSpamLogic(t *testing.T) {
