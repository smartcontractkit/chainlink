...
import (
	...
	ocr2pluskey "github.com/smartcontractkit/chainlink/v2/core/services/keystore/keys/ocr2pluskey"
)
...
func (_m *OCR2) Add(key ocr2pluskey.KeyBundle) error {
	ret := _m.Called(key)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(ocr2pluskey.KeyBundle) error); ok {
		r0 = rf(key)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *OCR2) Create(_a0 chaintype.ChainType) (ocr2pluskey.KeyBundle, error) {
	ret := _m.Called(_a0)
	...
	var r0 ocr2pluskey.KeyBundle
	var r1 error
	if rf, ok := ret.Get(0).(func(chaintype.ChainType) (ocr2pluskey.KeyBundle, error)); ok {
		return rf(_a0)
	}
	if rf, ok := ret.Get(0).(func(chaintype.ChainType) ocr2pluskey.KeyBundle); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(ocr2pluskey.KeyBundle)
		}
	}
...
func (_m *OCR2) Get(id string) (ocr2pluskey.KeyBundle, error) {
	ret := _m.Called(id)
	...
	var r0 ocr2pluskey.KeyBundle
	var r1 error
	if rf, ok := ret.Get(0).(func(string) (ocr2pluskey.KeyBundle, error)); ok {
		return rf(id)
	}
	if rf, ok := ret.Get(0).(func(string) ocr2pluskey.KeyBundle); ok {
		r0 = rf(id)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(ocr2pluskey.KeyBundle)
...
func (_m *OCR2) GetAll() ([]ocr2pluskey.KeyBundle, error) {
	ret := _m.Called()
	...
	if rf, ok := ret.Get(0).(func() []ocr2pluskey.KeyBundle); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]ocr2pluskey.KeyBundle)
...
func (_m *OCR2) GetAllOfType(_a0 chaintype.ChainType) ([]ocr2pluskey.KeyBundle, error) {
	ret := _m.Called(_a0)
...
func (_m *OCR2) Import(keyJSON []byte, password string) (ocr2pluskey.KeyBundle, error) {
	...
	var r0 ocr2pluskey.KeyBundle
	var r1 error
	if rf, ok := ret.Get(0).(func([]byte, string) (ocr2pluskey.KeyBundle, error)); ok {
		return rf(keyJSON, password)
	}
	if rf, ok := ret.Get(0).(func([]byte, string) ocr2pluskey.KeyBundle); ok {
