...
// NewSolana creates a new instance of Solana. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewSolana(t testing.TB) *Solana {
	mock := &Solana{}
	mock.Mock.Test(t)
