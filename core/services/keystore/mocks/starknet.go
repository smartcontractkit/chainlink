...
// NewStarknet creates a new instance of Starknet. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewStarknet(t testing.TB) *Starknet {
	mock := &Starknet{}
	mock.Mock.Test(t)
