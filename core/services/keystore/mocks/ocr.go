...
// NewOCR creates a new instance of OCR. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewOCR(t testing.TB) *OCR {
	mock := &OCR{}
	mock.Mock.Test(t)
