...
func TestUnit_OCR_OffchainPublicKey_MarshalJSON(t *testing.T) {
	t.Parallel()
...
func TestUnit_OCR_OffchainPublicKey_UnmarshalJSON_Happy(t *testing.T) {
	t.Parallel()
...
func TestUnit_OCR_OffchainPublicKey_UnmarshalJSON_Error(t *testing.T) {
	t.Parallel()
