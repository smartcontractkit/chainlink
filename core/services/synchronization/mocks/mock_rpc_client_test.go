...
func (_m *TelemetryService) Send(ctx context.Context, telemetry []byte, contractID string, telemType TelemetryType) {
...
func (_c *TelemetryService_Send_Call) Run(run func(ctx context.Context, telemetry []byte, contractID string, telemType TelemetryType)) *TelemetryService_Send_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].([]byte), args[2].(string), args[3].(TelemetryType))
	})
	return _c
}
...
func (_c *TelemetryService_Send_Call) RunAndReturn(run func(context.Context, []byte, string, TelemetryType)) *TelemetryService_Send_Call {
	_c.Call.Return(run)
	return _c
}
