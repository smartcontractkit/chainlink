...
const (
	...
	MarketStatus_CLOSED MarketStatus = 0
	MarketStatus_OPEN   MarketStatus = 1
	// OCR guarantees that the market status value is valid if present, however for telemetry purposes
	// it may be unset if there is an error. Instead of using the zero value which can be confused
	// with CLOSED, let's use -1 as a sentinel value which will never be used by OCR.
	MarketStatus_UNKNOWN MarketStatus = -1
)
...
var file_core_services_synchronization_telem_telem_enhanced_ea_mercury_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x74, 0x53, 0x79, 0x6d, 0x62, 0x6f, 0x6c, 0x2a, 0x3a, 0x0a, 0x0c, 0x4d, 0x61, 0x72,
	0x6b, 0x65, 0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x0a, 0x0a, 0x06, 0x43, 0x4c, 0x4f,
	0x53, 0x45, 0x44, 0x10, 0x00, 0x12, 0x08, 0x0a, 0x04, 0x4f, 0x50, 0x45, 0x4e, 0x10, 0x01, 0x12,
	0x14, 0x0a, 0x07, 0x55, 0x4e, 0x4b, 0x4e, 0x4f, 0x57, 0x4e, 0x10, 0xff, 0xff, 0xff, 0xff, 0xff,
	0xff, 0xff, 0xff, 0xff, 0x01, 0x42, 0x4e, 0x5a, 0x4c, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
