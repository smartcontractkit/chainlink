...
func (_m *Storage) Constraints() Constraints {
	ret := _m.Called()
...
func (_c *Storage_Constraints_Call) Return(_a0 Constraints) *Storage_Constraints_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Storage_Constraints_Call) RunAndReturn(run func() Constraints) *Storage_Constraints_Call {
	_c.Call.Return(run)
	return _c
}

// Get provides a mock function with given fields: ctx, key
func (_m *Storage) Get(ctx context.Context, key *Key) (*Record, *Metadata, error) {
	...
	var r1 *Metadata
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, *Key) (*Record, *Metadata, error)); ok {
		return rf(ctx, key)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *Key) *Record); ok {
		r0 = rf(ctx, key)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*Record)
	...
	if rf, ok := ret.Get(1).(func(context.Context, *Key) *Metadata); ok {
		r1 = rf(ctx, key)
	} else {
		if ret.Get(1) != nil {
	...
	if rf, ok := ret.Get(2).(func(context.Context, *Key) error); ok {
		r2 = rf(ctx, key)
	} else {
		r2 = ret.Error(2)
	}
...
func (_c *Storage_Get_Call) Run(run func(ctx context.Context, key *Key)) *Storage_Get_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Storage_Get_Call) Return(_a0 *Record, _a1 *Metadata, _a2 error) *Storage_Get_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *Storage_Get_Call) RunAndReturn(run func(context.Context, *Key) (*Record, *Metadata, error)) *Storage_Get_Call {
	_c.Call.Return(run)
	return _c
}

// List provides a mock function with given fields: ctx, address
func (_m *Storage) List(ctx context.Context, address common.Address) ([]*SnapshotRow, error) {
	...
	var r0 []*SnapshotRow
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, common.Address) ([]*SnapshotRow, error)); ok {
		return rf(ctx, address)
	}
	if rf, ok := ret.Get(0).(func(context.Context, common.Address) []*SnapshotRow); ok {
		r0 = rf(ctx, address)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*SnapshotRow)
		}
	}
...
func (_c *Storage_List_Call) Return(_a0 []*SnapshotRow, _a1 error) *Storage_List_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Storage_List_Call) RunAndReturn(run func(context.Context, common.Address) ([]*SnapshotRow, error)) *Storage_List_Call {
	_c.Call.Return(run)
	return _c
}

// Put provides a mock function with given fields: ctx, key, record, signature
func (_m *Storage) Put(ctx context.Context, key *Key, record *Record, signature []byte) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *Key, *Record, []byte) error); ok {
...
func (_c *Storage_Put_Call) Run(run func(ctx context.Context, key *Key, record *Record, signature []byte)) *Storage_Put_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*Key), args[2].(*Record), args[3].([]byte))
	})
	return _c
}
...
func (_c *Storage_Put_Call) RunAndReturn(run func(context.Context, *Key, *Record, []byte) error) *Storage_Put_Call {
	_c.Call.Return(run)
	return _c
}
