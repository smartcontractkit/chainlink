...
var file_telem_streams_proto_rawDesc = []byte{
...
var (
	...
	file_telem_streams_proto_rawDescData = file_telem_streams_proto_rawDesc
)

func file_telem_streams_proto_rawDescGZIP() []byte {
	file_telem_streams_proto_rawDescOnce.Do(func() {
		file_telem_streams_proto_rawDescData = protoimpl.X.CompressGZIP(file_telem_streams_proto_rawDescData)
	})
...
func file_telem_streams_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_telem_streams_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*LLOBridgeTelemetry); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_telem_streams_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*LLOObservationTelemetry); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_telem_streams_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_telem_streams_proto_rawDesc = nil
