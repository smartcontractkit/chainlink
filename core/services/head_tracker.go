...
func NewHeadTracker(l *logger.Logger, store *strpkg.Store, headTrackerAddressChannel chan common.Address, callbacks []strpkg.HeadTrackable, sleepers ...utils.Sleeper) *HeadTracker {
