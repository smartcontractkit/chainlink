...
func (_m *Handler) HandleUserMessage(ctx context.Context, msg *api.Message, callbackCh chan<- UserCallbackPayload) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *api.Message, chan<- UserCallbackPayload) error); ok {
...
func (_c *Handler_HandleUserMessage_Call) Run(run func(ctx context.Context, msg *api.Message, callbackCh chan<- UserCallbackPayload)) *Handler_HandleUserMessage_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*api.Message), args[2].(chan<- UserCallbackPayload))
	})
	return _c
}
...
func (_c *Handler_HandleUserMessage_Call) RunAndReturn(run func(context.Context, *api.Message, chan<- UserCallbackPayload) error) *Handler_HandleUserMessage_Call {
	_c.Call.Return(run)
	return _c
}
