...
func (_m *DON) SendToNode(ctx context.Context, nodeAddress string, req *jsonrpc2.Request[jsontext.Value]) error {
...
func (_c *DON_SendToNode_Call) Run(run func(ctx context.Context, nodeAddress string, req *jsonrpc2.Request[jsontext.Value])) *DON_SendToNode_Call {
...
func (_c *DON_SendToNode_Call) RunAndReturn(run func(context.Context, string, *jsonrpc2.Request[jsontext.Value]) error) *DON_SendToNode_Call {
	_c.Call.Return(run)
	return _c
}
