...
func TestIntegration_Shared_ORM_GetAllowedSenders(t *testing.T) {
	t.Parallel()
...
func TestIntegration_Shared_ORM_CreateAllowedSenders(t *testing.T) {
	t.Parallel()
...
func TestIntegration_Shared_ORM_DeleteAllowedSenders(t *testing.T) {
	t.Parallel()
...
func TestIntegration_Shared_ORM_PurgeAllowedSenders(t *testing.T) {
	t.Parallel()
...
func TestIntegration_Shared_NewORM(t *testing.T) {
