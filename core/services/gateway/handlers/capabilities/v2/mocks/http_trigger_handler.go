...
func (_m *HTTPTriggerHandler) HandleNodeTriggerResponse(ctx context.Context, resp *jsonrpc2.Response[jsontext.Value], nodeAddr string) error {
...
func (_c *HTTPTriggerHandler_HandleNodeTriggerResponse_Call) Run(run func(ctx context.Context, resp *jsonrpc2.Response[jsontext.Value], nodeAddr string)) *HTTPTriggerHandler_HandleNodeTriggerResponse_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *HTTPTriggerHandler_HandleNodeTriggerResponse_Call) RunAndReturn(run func(context.Context, *jsonrpc2.Response[jsontext.Value], string) error) *HTTPTriggerHandler_HandleNodeTriggerResponse_Call {
	_c.Call.Return(run)
	return _c
}

// HandleUserTriggerRequest provides a mock function with given fields: ctx, req, callback, requestStartTime
func (_m *HTTPTriggerHandler) HandleUserTriggerRequest(ctx context.Context, req *jsonrpc2.Request[jsontext.Value], callback handlers.Callback, requestStartTime time.Time) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *jsonrpc2.Request[jsontext.Value], handlers.Callback, time.Time) error); ok {
...
func (_c *HTTPTriggerHandler_HandleUserTriggerRequest_Call) Run(run func(ctx context.Context, req *jsonrpc2.Request[jsontext.Value], callback handlers.Callback, requestStartTime time.Time)) *HTTPTriggerHandler_HandleUserTriggerRequest_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*jsonrpc2.Request[jsontext.Value]), args[2].(handlers.Callback), args[3].(time.Time))
	})
	return _c
}
...
func (_c *HTTPTriggerHandler_HandleUserTriggerRequest_Call) RunAndReturn(run func(context.Context, *jsonrpc2.Request[jsontext.Value], handlers.Callback, time.Time) error) *HTTPTriggerHandler_HandleUserTriggerRequest_Call {
	_c.Call.Return(run)
	return _c
}
