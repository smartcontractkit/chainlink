...
type mockConstructorTestingTNewConnectionInitiator interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewConnectionInitiator(t mockConstructorTestingTNewConnectionInitiator) *ConnectionInitiator {
