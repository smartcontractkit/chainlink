...
type ConnectorConfig = Config //nolint:revive // backward compatibility alias

// Deprecated: Use GatewayConfig instead.
type ConnectorGatewayConfig = GatewayConfig //nolint:revive // backward compatibility alias
