...
func (_m *GatewayConnector) ChallengeResponse(challenge []byte) ([]byte, error) {
...
type mockConstructorTestingTNewGatewayConnector interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewGatewayConnector(t mockConstructorTestingTNewGatewayConnector) *GatewayConnector {
