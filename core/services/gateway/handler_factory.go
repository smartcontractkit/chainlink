...
func NewHandlerFactory(legacyChains legacyevm.LegacyChainContainer, ds sqlutil.DataSource, httpClient network.HTTPClient, capabilitiesRegistry core.CapabilitiesRegistry, allowlistedRequestsSyncer workflowsyncerv2.AllowlistedRequestsSyncer, lggr logger.Logger, lf limits.Factory) HandlerFactory {
...
func (hf *handlerFactory) NewHandler(
	...
	case VaultHandlerType:
		requestAuthorizer := vaultcap.NewRequestAuthorizer(hf.lggr, hf.allowlistedRequestsSyncer)
