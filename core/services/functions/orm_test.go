...
func TestIntegration_Shared_ORM_CreateRequestsAndFindByID(t *testing.T) {
	t.Parallel()
	ctx := testutils.Context(t)
...
func TestIntegration_Shared_ORM_SetResult(t *testing.T) {
	t.Parallel()
	ctx := testutils.Context(t)
...
func TestIntegration_Shared_ORM_SetError(t *testing.T) {
	t.Parallel()
	ctx := testutils.Context(t)
...
func TestIntegration_Shared_ORM_SetError_Internal(t *testing.T) {
	t.Parallel()
	ctx := testutils.Context(t)
...
func TestIntegration_Shared_ORM_SetFinalized(t *testing.T) {
	t.Parallel()
	ctx := testutils.Context(t)
...
func TestIntegration_Shared_ORM_SetConfirmed(t *testing.T) {
	t.Parallel()
	ctx := testutils.Context(t)
...
func TestIntegration_Shared_ORM_StateTransitions(t *testing.T) {
	t.Parallel()
	ctx := testutils.Context(t)
...
func TestIntegration_Shared_ORM_FindOldestEntriesByState(t *testing.T) {
	t.Parallel()
...
func TestIntegration_Shared_ORM_TimeoutExpiredResults(t *testing.T) {
	t.Parallel()
	ctx := testutils.Context(t)
...
func TestIntegration_Shared_ORM_PruneOldestRequests(t *testing.T) {
	t.Parallel()
	ctx := testutils.Context(t)
...
func TestIntegration_Shared_ORM_PruneOldestRequests_Large(t *testing.T) {
	t.Parallel()
	ctx := testutils.Context(t)
