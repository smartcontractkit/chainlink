...
// CreateEthTransaction provides a mock function with given fields: tx, fromAddress, toAddress, payload, gasLimit, meta, strategy
func (_m *TxManager) CreateEthTransaction(tx postgres.Queryer, fromAddress common.Address, toAddress common.Address, payload []byte, gasLimit uint64, meta interface{}, strategy bulletprooftxmanager.TxStrategy) (bulletprooftxmanager.EthTx, error) {
	ret := _m.Called(tx, fromAddress, toAddress, payload, gasLimit, meta, strategy)
	...
	if rf, ok := ret.Get(0).(func(postgres.Queryer, common.Address, common.Address, []byte, uint64, interface{}, bulletprooftxmanager.TxStrategy) bulletprooftxmanager.EthTx); ok {
		r0 = rf(tx, fromAddress, toAddress, payload, gasLimit, meta, strategy)
	} else {
	...
	if rf, ok := ret.Get(1).(func(postgres.Queryer, common.Address, common.Address, []byte, uint64, interface{}, bulletprooftxmanager.TxStrategy) error); ok {
		r1 = rf(tx, fromAddress, toAddress, payload, gasLimit, meta, strategy)
	} else {
		r1 = ret.Error(1)
	}
