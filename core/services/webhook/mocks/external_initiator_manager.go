...
// NewExternalInitiatorManager creates a new instance of ExternalInitiatorManager. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewExternalInitiatorManager(t testing.TB) *ExternalInitiatorManager {
