...
// DeleteJobV2 provides a mock function with given fields: jobID
func (_m *ExternalInitiatorManager) DeleteJobV2(jobID models.JobID) error {
	ret := _m.Called(jobID)
...
// NotifyV2 provides a mock function with given fields: jobUUID, initrName, initrSpec
func (_m *ExternalInitiatorManager) NotifyV2(jobUUID models.JobID, initrName string, initrSpec *models.JSON) error {
	ret := _m.Called(jobUUID, initrName, initrSpec)

	var r0 error
	if rf, ok := ret.Get(0).(func(models.JobID, string, *models.JSON) error); ok {
		r0 = rf(jobUUID, initrName, initrSpec)
	} else {
		r0 = ret.Error(0)
	}
