...
type (
	...
	JobRunner interface {
		RunJob(ctx context.Context, jobUUID uuid.UUID, requestBody string, meta json_serializable.JSONSerializable) (int64, error)
	}
)
...
func (r *webhookJobRunner) RunJob(ctx context.Context, jobUUID uuid.UUID, requestBody string, meta json_serializable.JSONSerializable) (int64, error) {
