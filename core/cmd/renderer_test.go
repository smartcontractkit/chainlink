...
func TestIntegration_Shared_RendererJSON_RenderVRFKeys(t *testing.T) {
	t.Parallel()
...
func TestIntegration_Shared_RendererTable_RenderConfigurationV2(t *testing.T) {
	t.Parallel()
...
func TestIntegration_Shared_RendererTable_RenderExternalInitiatorAuthentication(t *testing.T) {
	t.Parallel()
...
func TestIntegration_Shared_RendererTable_RenderUnknown(t *testing.T) {
	t.Parallel()
