...
func TestShell_IndexEVMNodes(t *testing.T) {
	...
	assert.Equal(t, cltest.FormatWithPrefixedChainID(*node1.Name, chainID.String()), n1.ID)
	...
	assert.Equal(t, cltest.FormatWithPrefixedChainID(*node2.Name, chainID.String()), n2.ID)
