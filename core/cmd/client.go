...
type AppFactory interface {
	NewApplication(orm.Depot, ...func(services.Application)) services.Application
}
...
func (n ChainlinkAppFactory) NewApplication(config orm.Depot, onConnectCallbacks ...func(services.Application)) services.Application {
...
// and builder.
func NewSessionCookieAuthenticator(config orm.Depot, store CookieStore) CookieAuthenticator {
