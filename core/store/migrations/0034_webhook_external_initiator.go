...
const up34 = `
    ...
    ALTER TABLE webhook_specs ADD CONSTRAINT external_initiator_null_or_not_null CHECK (
...
const down34 = `
    ...
    ALTER TABLE webhook_specs DROP CONSTRAINT external_initiator_null_or_not_null;
`
