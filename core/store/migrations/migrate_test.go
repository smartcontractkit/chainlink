...
func TestMigrate_Initial(t *testing.T) {
	_, orm, cleanup := heavyweight.BootstrapThrowawayORM(t, "migrations", false)
	defer cleanup()
...
func TestMigrate_BridgeFK(t *testing.T) {
	_, orm, cleanup := heavyweight.BootstrapThrowawayORM(t, "migrations_bridgefk", false)
	defer cleanup()
...
func TestMigrate_ChangeJobsToNumeric(t *testing.T) {
	_, orm, cleanup := heavyweight.BootstrapThrowawayORM(t, "migrations_change_jobs_to_numeric", false)
	defer cleanup()
...
func TestMigrate_PipelineTaskRunDotID(t *testing.T) {
	_, orm, cleanup := heavyweight.BootstrapThrowawayORM(t, "migrations_task_run_dot_id", false)
	defer cleanup()
...
func TestMigrate_RemoveResultTask(t *testing.T) {
	_, orm, cleanup := heavyweight.BootstrapThrowawayORM(t, "migrations_result_task", false)
	defer cleanup()
...
func TestMigrate_LogConfigTables(t *testing.T) {
	_, orm, cleanup := heavyweight.BootstrapThrowawayORM(t, "migrations_create_log_config_tables", false)
	defer cleanup()
...
func TestMigrate_CreateCronTables(t *testing.T) {
	_, orm, cleanup := heavyweight.BootstrapThrowawayORM(t, "migrations_create_cron_tables", false)
	defer cleanup()
...
func TestMigrate_CreateWebhookTables(t *testing.T) {
	_, orm, cleanup := heavyweight.BootstrapThrowawayORM(t, "migrations_create_webhook_tables", false)
	defer cleanup()
