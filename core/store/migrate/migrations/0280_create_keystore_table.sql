-- +goose Up
-- This is a very basic storage table for the keystore https://github.com/smartcontractkit/chainlink-common/tree/main/keystore entries.
-- Support for versioning (and other automatic handling) can be conveniently done using triggers on the database level.
-- Please do not implement such logic on the go library level.
