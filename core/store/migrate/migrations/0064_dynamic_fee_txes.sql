...
ALTER TABLE eth_tx_attempts DROP COLUMN tx_type, DROP COLUMN gas_tip_cap, DROP COLUMN gas_fee_cap, ALTER COLUMN gas_price SET NOT NULL, DROP CONSTRAINT chk_chain_specific_gas_limit_not_zero;
