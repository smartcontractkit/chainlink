...
-- INSERT INTO keeper_registries (job_id, keeper_index, contract_address, from_address, check_gas, block_count_per_turn, num_keepers) VALUES(1, 1, decode('0000000000000000000000000000000000000000', 'hex'), decode('0000000000000000000000000000000000000000', 'hex'), 1, 1, 1);
-- INSERT INTO upkeep_registrations (registry_id, execute_gas, check_data, upkeep_id, positioning_constant) VALUES(1, 1, decode('01', 'hex'), 1, 1);

-- DROP INDEX idx_upkeep_registrations_unique_upkeep_ids_per_keeper;
