...
func init() {
	...
	arbitrum := ChainSpecificDefaultSet{
		...
		EthGasBumpThreshold:              0,
		EthGasBumpWei:                    *big.NewInt(5000000000),
		EthGasPriceDefault:               *big.NewInt(1000000000000),
		EthMaxGasPriceWei:                *big.NewInt(1000000000000),
		EthFinalityDepth:                 1,
		EthHeadTrackerHistoryDepth:       10,
		EthBalanceMonitorBlockDelay:      0,
	...
	ChainSpecificDefaults[421611] = arbitrum // Rinkeby testnet 1
