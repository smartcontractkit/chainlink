...
// func TestInitiatorParams_FeedURLs(t *testing.T) {
// 	tests := []struct {
// 		name        string
// 		in          models.JSON
// 		expectation []*url.URL
// 	}{
// 		// TODO add bridge before test
// 		{
// 			"single",
// 			cltest.JSONFromString(t, `["https://lambda.staging.devnet.tools/bnc/call"]`),
// 			// []string{"https://lambda.staging.devnet.tools/bnc/call"},
// 			[]*url.URL{cltest.MustParseURL("https://lambda.staging.devnet.tools/bnc/call")},
// 			// `["https://lambda.staging.devnet.tools/bnc/call"]`,
// 		},
// 		{
// 			"double",
// 			cltest.JSONFromString(t, `["https://lambda.staging.devnet.tools/bnc/call", "https://lambda.staging.devnet.tools/cc/call"]`),
// 			[]*url.URL{cltest.MustParseURL("https://lambda.staging.devnet.tools/bnc/call"), cltest.MustParseURL("https://lambda.staging.devnet.tools/cc/call")},
...
// 				Feeds: test.in,
// 			}
// 			val, err := initiatorParams.FeedURLs(nil) // TODO update to use ORM
// 			require.NoError(t, err)
