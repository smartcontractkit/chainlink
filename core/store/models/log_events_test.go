	...
	tests := []struct {
	...
	}{
		{
			...
			wantData: cltest.JSONFromString(t, `{
				...
				"transactionHash": "0xe05b171038320aca6634ce50de669bd0baa337130269c3ce3594ce4d45fc342a"
			}`),
		},
		{
			...
			wantData: cltest.JSONFromString(t, `{
				...
				"transactionHash": "0x04250548cd0b5d03b3bf1331aa83f32b35879440db31a6008d151260a5f3cc76"
			}`),
		},
		{
