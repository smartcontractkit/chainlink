...
func logErrF(str string, args ...interface{}) {
}
func TestRetryableZeroMaxRetries(t *testing.T) {
	...
	err := utils.Retryable(ctx, logErrF, 100, 0, fn)
...
func TestRetryableSuccessOnFirstAttempt(t *testing.T) {
	...
	err := utils.Retryable(ctx, logErrF, 100, 3, fn)
...
func TestRetryableSuccessAfterRetries(t *testing.T) {
	...
	err := utils.Retryable(ctx, logErrF, 100, 5, fn)
...
func TestRetryableErrorOnFirstTryNoRetries(t *testing.T) {
	...
	err := utils.Retryable(ctx, logErrF, 100, 1, fn)
...
func TestRetryableErrorAfterMultipleRetries(t *testing.T) {
	...
	maxRetries := 3
	err := utils.Retryable(ctx, logErrF, 100, maxRetries, fn)
