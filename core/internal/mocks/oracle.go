...
func (_m *Oracle) SubscribeToLogs(listener eth.LogListener) (bool, eth.UnsubscribeFunc) {
...
func (_m *Oracle) UnpackLog(out interface{}, event string, log types.Log) error {
