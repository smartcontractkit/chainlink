...
func (_m *DeviationCheckerFactory) New(_a0 models.Initiator, _a1 fluxmonitor.RunManager, _a2 *orm.ORM) (fluxmonitor.DeviationChecker, error) {
	ret := _m.Called(_a0, _a1, _a2)

	var r0 fluxmonitor.DeviationChecker
	if rf, ok := ret.Get(0).(func(models.Initiator, fluxmonitor.RunManager, *orm.ORM) fluxmonitor.DeviationChecker); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(models.Initiator, fluxmonitor.RunManager, *orm.ORM) error); ok {
		r1 = rf(_a0, _a1, _a2)
	} else {
		r1 = ret.Error(1)
	}
