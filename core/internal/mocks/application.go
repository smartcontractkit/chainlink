...
func (_m *Application) TxmStorageService() txmgrtypes.TxStore[common.Address, *big.Int, common.Hash, common.Hash, txmgrtypes.NewTx[common.Address, common.Hash], *types.Receipt, txmgr.EthTx[common.Address, common.Hash], txmgr.EvmTxAttempt, types.Nonce] {
	ret := _m.Called()

	var r0 txmgrtypes.TxStore[common.Address, *big.Int, common.Hash, common.Hash, txmgrtypes.NewTx[common.Address, common.Hash], *types.Receipt, txmgr.EthTx[common.Address, common.Hash], txmgr.EvmTxAttempt, types.Nonce]
	if rf, ok := ret.Get(0).(func() txmgrtypes.TxStore[common.Address, *big.Int, common.Hash, common.Hash, txmgrtypes.NewTx[common.Address, common.Hash], *types.Receipt, txmgr.EthTx[common.Address, common.Hash], txmgr.EvmTxAttempt, types.Nonce]); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(txmgrtypes.TxStore[common.Address, *big.Int, common.Hash, common.Hash, txmgrtypes.NewTx[common.Address, common.Hash], *types.Receipt, txmgr.EthTx[common.Address, common.Hash], txmgr.EvmTxAttempt, types.Nonce])
		}
	}
