...
func (_m *Application) TxmStorageService() txmgrtypes.TxStore[types.Address, *big.Int, types.TxHash, types.BlockHash, txmgr.NewTx[types.Address], *types.Receipt, txmgr.EthTx[types.Address, types.TxHash], txmgr.EthTxAttempt[types.Address, types.TxHash], types.Nonce] {
	ret := _m.Called()

	var r0 txmgrtypes.TxStore[types.Address, *big.Int, types.TxHash, types.BlockHash, txmgr.NewTx[types.Address], *types.Receipt, txmgr.EthTx[types.Address, types.TxHash], txmgr.EthTxAttempt[types.Address, types.TxHash], types.Nonce]
	if rf, ok := ret.Get(0).(func() txmgrtypes.TxStore[types.Address, *big.Int, types.TxHash, types.BlockHash, txmgr.NewTx[types.Address], *types.Receipt, txmgr.EthTx[types.Address, types.TxHash], txmgr.EthTxAttempt[types.Address, types.TxHash], types.Nonce]); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(txmgrtypes.TxStore[types.Address, *big.Int, types.TxHash, types.BlockHash, txmgr.NewTx[types.Address], *types.Receipt, txmgr.EthTx[types.Address, types.TxHash], txmgr.EthTxAttempt[types.Address, types.TxHash], types.Nonce])
		}
	}
