...
func (_m *Application) TxmStorageService() txmgrtypes.TxStorageService[*types.Address, big.Int, *types.TxHash, *types.BlockHash, txmgr.NewTx[*types.Address], *types.Receipt, txmgr.EthTx[*types.Address, *types.TxHash], txmgr.EthTxAttempt[*types.Address, *types.TxHash], int64, int64] {
	ret := _m.Called()

	var r0 txmgrtypes.TxStorageService[*types.Address, big.Int, *types.TxHash, *types.BlockHash, txmgr.NewTx[*types.Address], *types.Receipt, txmgr.EthTx[*types.Address, *types.TxHash], txmgr.EthTxAttempt[*types.Address, *types.TxHash], int64, int64]
	if rf, ok := ret.Get(0).(func() txmgrtypes.TxStorageService[*types.Address, big.Int, *types.TxHash, *types.BlockHash, txmgr.NewTx[*types.Address], *types.Receipt, txmgr.EthTx[*types.Address, *types.TxHash], txmgr.EthTxAttempt[*types.Address, *types.TxHash], int64, int64]); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(txmgrtypes.TxStorageService[*types.Address, big.Int, *types.TxHash, *types.BlockHash, txmgr.NewTx[*types.Address], *types.Receipt, txmgr.EthTx[*types.Address, *types.TxHash], txmgr.EthTxAttempt[*types.Address, *types.TxHash], int64, int64])
		}
	}
