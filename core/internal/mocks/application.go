...
func (_m *Application) GetRelayers() *chainlink.Relayers {
	ret := _m.Called()

	var r0 *chainlink.Relayers
	if rf, ok := ret.Get(0).(func() *chainlink.Relayers); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*chainlink.Relayers)
		}
	}
