...
func (_m *EthClient) GetBlockByNumber(hex string) (eth.BlockHeader, error) {
	ret := _m.Called(hex)
...
func (_m *EthClient) GetTxReceipt(hash common.Hash) (*eth.TxReceipt, error) {
	ret := _m.Called(hash)
...
func (_m *EthClient) SubscribeToNewHeads(channel chan<- eth.BlockHeader) (eth.EthSubscription, error) {
