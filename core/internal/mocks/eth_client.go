...
import assets "chainlink/core/store/assets"
import big "math/big"
...
func (_m *EthClient) GetBlockByNumber(hex string) (models.BlockHeader, error) {
	ret := _m.Called(hex)
...
func (_m *EthClient) GetChainID() (*big.Int, error) {
	ret := _m.Called()
...
func (_m *EthClient) GetERC20Balance(address common.Address, contractAddress common.Address) (*big.Int, error) {
...
func (_m *EthClient) GetEthBalance(address common.Address) (*assets.Eth, error) {
...
func (_m *EthClient) GetLogs(q ethereum.FilterQuery) ([]models.Log, error) {
	ret := _m.Called(q)
...
func (_m *EthClient) GetNonce(address common.Address) (uint64, error) {
	ret := _m.Called(address)
...
func (_m *EthClient) GetTxReceipt(hash common.Hash) (*models.TxReceipt, error) {
	ret := _m.Called(hash)
...
func (_m *EthClient) SendRawTx(hex string) (common.Hash, error) {
	ret := _m.Called(hex)
...
func (_m *EthClient) SubscribeToLogs(channel chan<- models.Log, q ethereum.FilterQuery) (models.EthSubscription, error) {
...
func (_m *EthClient) SubscribeToNewHeads(channel chan<- models.BlockHeader) (models.EthSubscription, error) {
