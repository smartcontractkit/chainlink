...
func (_m *EthClient) GetLogs(q ethereum.FilterQuery) ([]eth.Log, error) {
	ret := _m.Called(q)
...
func (_m *EthClient) SubscribeToLogs(channel chan<- eth.Log, q ethereum.FilterQuery) (eth.EthSubscription, error) {
...
func (_m *EthClient) SubscribeToNewHeads(channel chan<- models.BlockHeader) (eth.EthSubscription, error) {
