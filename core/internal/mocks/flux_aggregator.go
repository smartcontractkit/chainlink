...
func (_m *FluxAggregator) LatestRoundData() (contracts.FluxAggregatorRoundData, error) {
	ret := _m.Called()

	var r0 contracts.FluxAggregatorRoundData
	if rf, ok := ret.Get(0).(func() contracts.FluxAggregatorRoundData); ok {
		r0 = rf()
	} else {
...
func (_m *FluxAggregator) SubscribeToLogs(listener log.LogListener) (bool, contracts.UnsubscribeFunc) {
	ret := _m.Called(listener)

	var r0 bool
	if rf, ok := ret.Get(0).(func(log.LogListener) bool); ok {
		r0 = rf(listener)
	} else {
		r0 = ret.Get(0).(bool)
	}
	...
	if rf, ok := ret.Get(1).(func(log.LogListener) contracts.UnsubscribeFunc); ok {
		r1 = rf(listener)
	} else {
		if ret.Get(1) != nil {
