...
`, ocrContractAddress, blockNum)
			...
			for i := 0; i < 4; i++ {
				...
				if test.chainReaderAndCodec {
					chainReaderSpec = `[relayConfig.chainReader]
[relayConfig.chainReader.chainContractReaders]
...
[[relayConfig.chainReader.chainContractReaders.median.chainReaderDefinitions.LatestTransmissionDetails.outputModifications]]
[relayConfig.chainReader.chainContractReaders.median.chainReaderDefinitions.LatestTransmissionDetails.outputModifications.Fields]
LatestAnswer_ = 'LatestAnswer'
LatestTimestamp_ = 'LatestTimestamp'

[relayConfig.codec]
[relayConfig.codec.chainCodecConfigs]
[relayConfig.codec.chainCodecConfigs.MedianReport]
