...
func NewOracle(address common.Address, backend bind.ContractBackend) (*Oracle, error) {
	...
	return &Oracle{address: address, OracleCaller: OracleCaller{contract: contract}, OracleTransactor: OracleTransactor{contract: contract}, OracleFilterer: OracleFilterer{contract: contract}}, nil
}
...
func (_Oracle *Oracle) UnpackLog(out interface{}, event string, log types.Log) error {
	return _Oracle.OracleFilterer.contract.UnpackLog(out, event, log)
}

func (_Oracle *Oracle) ParseLog(log types.Log) (interface{}, error) {
