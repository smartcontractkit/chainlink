...
//go:generate go run ./generation/generate/wrap.go ../../../contracts/solc/v0.7/UpkeepCounterPerformOnlyOdd.abi ../../../contracts/solc/v0.7/UpkeepCounterPerformOnlyOdd.bin UpkeepCounterPerformOnlyOdd upkeep_counter_perform_only_odd
