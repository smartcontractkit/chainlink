...
// AssertLogMessage fails the test if emitted logs don't contain the given message
func AssertLogMessage(t *testing.T, observedLogs *observer.ObservedLogs, msg string) {
