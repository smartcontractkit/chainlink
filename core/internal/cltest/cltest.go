...
func NewEthMocksWithStartupAssertions(t testing.TB) (*mocks.Client, *mocks.Subscription, func()) {
	...
	c.On("PendingNonceAt", mock.Anything, mock.Anything).Maybe().Return(uint64(0), nil).Maybe()
...
func MockSubscribeToLogsCh(ethClient *mocks.Client, sub *mocks.Subscription) chan chan<- models.Log {
