...
func (_m *BasicAdminUsersORM) CreateUser(ctx context.Context, user *User) error {
...
func (_c *BasicAdminUsersORM_CreateUser_Call) Run(run func(ctx context.Context, user *User)) *BasicAdminUsersORM_CreateUser_Call {
...
func (_c *BasicAdminUsersORM_CreateUser_Call) RunAndReturn(run func(context.Context, *User) error) *BasicAdminUsersORM_CreateUser_Call {
	_c.Call.Return(run)
	return _c
}

// FindUser provides a mock function with given fields: ctx, email
func (_m *BasicAdminUsersORM) FindUser(ctx context.Context, email string) (User, error) {
...
func (_c *BasicAdminUsersORM_FindUser_Call) Return(_a0 User, _a1 error) *BasicAdminUsersORM_FindUser_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *BasicAdminUsersORM_FindUser_Call) RunAndReturn(run func(context.Context, string) (User, error)) *BasicAdminUsersORM_FindUser_Call {
	_c.Call.Return(run)
	return _c
}

// ListUsers provides a mock function with given fields: ctx
func (_m *BasicAdminUsersORM) ListUsers(ctx context.Context) ([]User, error) {
	ret := _m.Called(ctx)
...
func (_c *BasicAdminUsersORM_ListUsers_Call) Return(_a0 []User, _a1 error) *BasicAdminUsersORM_ListUsers_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *BasicAdminUsersORM_ListUsers_Call) RunAndReturn(run func(context.Context) ([]User, error)) *BasicAdminUsersORM_ListUsers_Call {
	_c.Call.Return(run)
	return _c
}
