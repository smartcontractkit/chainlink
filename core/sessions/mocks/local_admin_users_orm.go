...
type mockConstructorTestingTNewLocalAdminUsersORM interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewLocalAdminUsersORM(t mockConstructorTestingTNewLocalAdminUsersORM) *LocalAdminUsersORM {
