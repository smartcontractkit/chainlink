...
type mockConstructorTestingTNewAuthenticationProvider interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewAuthenticationProvider(t mockConstructorTestingTNewAuthenticationProvider) *AuthenticationProvider {
