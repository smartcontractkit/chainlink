...
func TestIntegration_Shared_BuildInfoController_Show_APICredentials(t *testing.T) {
	t.Parallel()
...
func TestIntegration_Shared_BuildInfoController_Show_NoCredentials(t *testing.T) {
	t.Parallel()
