...
func TestIntegration_Shared_SolanaKeysController_Index_HappyPath(t *testing.T) {
	t.Parallel()
...
func TestIntegration_Shared_SolanaKeysController_Create_HappyPath(t *testing.T) {
	t.Parallel()
...
func TestIntegration_Shared_SolanaKeysController_Delete_NonExistentSolanaKeyID(t *testing.T) {
	t.Parallel()
...
func TestIntegration_Shared_SolanaKeysController_Delete_HappyPath(t *testing.T) {
	t.Parallel()
