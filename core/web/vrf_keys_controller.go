...
func (vrfkc *VRFKeysController) Create(c *gin.Context) {
	...
	vrfkc.App.GetAuditLogger().Audit(c.Request.Context(), audit.VRFKeyCreated, map[string]interface{}{
...
func (vrfkc *VRFKeysController) Delete(c *gin.Context) {
	...
	vrfkc.App.GetAuditLogger().Audit(c.Request.Context(), audit.VRFKeyDeleted, map[string]interface{}{"id": keyID})
...
func (vrfkc *VRFKeysController) Import(c *gin.Context) {
	...
	vrfkc.App.GetAuditLogger().Audit(c.Request.Context(), audit.VRFKeyImported, map[string]interface{}{
		"vrfID":        key.ID(),
...
func (vrfkc *VRFKeysController) Export(c *gin.Context) {
	...
	vrfkc.App.GetAuditLogger().Audit(c.Request.Context(), audit.VRFKeyExported, map[string]interface{}{"keyID": keyID})
