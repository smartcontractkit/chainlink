...
func TestPipelineRunsController_CreateWithBody_HappyPath(t *testing.T) {
	...
	_, bridge := cltest.MustCreateBridge(t, app.GetDS(), cltest.BridgeOpts{URL: mockServer.URL})
...
func TestPipelineRunsController_CreateNoBody_HappyPath(t *testing.T) {
	...
	_, submitBridge := cltest.MustCreateBridge(t, app.GetDS(), cltest.BridgeOpts{URL: mockServer.URL})
