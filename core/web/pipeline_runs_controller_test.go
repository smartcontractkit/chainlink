...
func TestIntegration_Shared_PipelineRunsController_CreateWithBody_HappyPath(t *testing.T) {
	t.Parallel()
...
func TestIntegration_Shared_PipelineRunsController_CreateNoBody_HappyPath(t *testing.T) {
	t.Parallel()
...
func TestIntegration_Shared_PipelineRunsController_Index_GlobalHappyPath(t *testing.T) {
...
func TestIntegration_Shared_PipelineRunsController_Index_HappyPath(t *testing.T) {
	client, jobID, runIDs := setupPipelineRunsControllerTests(t)
...
func TestIntegration_Shared_PipelineRunsController_Index_Pagination(t *testing.T) {
	client, jobID, runIDs := setupPipelineRunsControllerTests(t)
...
func TestIntegration_Shared_PipelineRunsController_Show_HappyPath(t *testing.T) {
	client, jobID, runIDs := setupPipelineRunsControllerTests(t)
...
func TestIntegration_Shared_PipelineRunsController_ShowRun_InvalidID(t *testing.T) {
	t.Parallel()
