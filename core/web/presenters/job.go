...
type OffChainReportingSpec struct {
	...
	ObservationTimeout                     commontypes.Interval  `json:"observationTimeout"`
	BlockchainTimeout                      commontypes.Interval  `json:"blockchainTimeout"`
	ContractConfigTrackerSubscribeInterval commontypes.Interval  `json:"contractConfigTrackerSubscribeInterval"`
	ContractConfigTrackerPollInterval      commontypes.Interval  `json:"contractConfigTrackerPollInterval"`
	ContractConfigConfirmations            uint16                `json:"contractConfigConfirmations"`
	CreatedAt                              time.Time             `json:"createdAt"`
	UpdatedAt                              time.Time             `json:"updatedAt"`
	EVMChainID                             *big.Big              `json:"evmChainID"`
	DatabaseTimeout                        *commontypes.Interval `json:"databaseTimeout"`
	ObservationGracePeriod                 *commontypes.Interval `json:"observationGracePeriod"`
	ContractTransmitterTransmitTimeout     *commontypes.Interval `json:"contractTransmitterTransmitTimeout"`
...
type JobResource struct {
	...
	MaxTaskDuration          commontypes.Interval      `json:"maxTaskDuration"`
