...
func TestIntegration_Shared_HealthController_Readyz(t *testing.T) {
	var tt = []struct {
		name   string
		ready  bool
		status int
...
func TestIntegration_Shared_HealthController_Health_status(t *testing.T) {
	var tt = []struct {
		name   string
		ready  bool
		status int
...
func TestIntegration_Shared_HealthController_Health_body(t *testing.T) {
