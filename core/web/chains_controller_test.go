...
func TestIntegration_Shared_EVMChainsController_Show(t *testing.T) {
	t.Parallel()
...
func TestIntegration_Shared_EVMChainsController_Index(t *testing.T) {
...
func TestIntegration_Shared_SolanaChainsController_Show(t *testing.T) {
	t.Parallel()
...
func TestIntegration_Shared_SolanaChainsController_Index(t *testing.T) {
	t.Parallel()
