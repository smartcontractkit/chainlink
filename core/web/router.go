...
// for TLS redirection
func secureOptions(config orm.Configger) secure.Options {
...
// for this node
func secureMiddleware(config orm.Configger) gin.HandlerFunc {
...
func uiCorsHandler(config orm.Configger) gin.HandlerFunc {
	c := cors.Config{
