...
// for TLS redirection
func secureOptions(config config.RuntimeConfig) secure.Options {
...
// for this node
func secureMiddleware(config orm.RuntimeConfig) gin.HandlerFunc {
...
func uiCorsHandler(config orm.RuntimeConfig) gin.HandlerFunc {
	c := cors.Config{
