...
func TestIntegration_Shared_PipelineJobSpecErrorsController_Delete_2(t *testing.T) {
...
func TestIntegration_Shared_PipelineJobSpecErrorsController_Delete_NotFound(t *testing.T) {
