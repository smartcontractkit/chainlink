		...
		unauthorizedTestCase(GQLTestCase{query: query}, "config"),
		{
			...
			before: func(f *gqlTestFramework) {
				...
				cfg := configtest.NewTestGeneralConfigWithOverrides(t, configtest.GeneralConfigOverrides{
					...
					GlobalEvmGasLimitOCRJobType:          null.IntFrom(1),
					GlobalEvmGasLimitDRJobType:           null.IntFrom(1),
					GlobalEvmGasLimitVRFJobType:          null.IntFrom(1),
					GlobalEvmGasLimitFMJobType:           null.IntFrom(1),
					GlobalEvmGasLimitKeeperJobType:       null.IntFrom(1),
