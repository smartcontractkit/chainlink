		...
		unauthorizedTestCase(GQLTestCase{query: query}, "config"),
		{
			...
			before: func(f *gqlTestFramework) {
				...
				cfg := configtest.NewTestGeneralConfigWithOverrides(t, configtest.GeneralConfigOverrides{
					...
					GlobalOCRJobGasLimit:                 null.IntFrom(1),
					GlobalDRJobGasLimit:                  null.IntFrom(1),
					GlobalVRFJobGasLimit:                 null.IntFrom(1),
					GlobalFMJobGasLimit:                  null.IntFrom(1),
					GlobalKeeperJobGasLimit:              null.IntFrom(1),
