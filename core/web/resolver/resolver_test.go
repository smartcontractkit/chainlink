...
func setupFramework(t *testing.T) *gqlTestFramework {
	...
	m := &mocks{
		...
		txmStorageService: txmgrtypesMocks.NewTxStorageService[*evmtypes.Address, big.Int, *evmtypes.TxHash, *evmtypes.BlockHash, txmgr.NewTx[*evmtypes.Address], *evmtypes.Receipt, txmgr.EthTx[*evmtypes.Address, *evmtypes.TxHash], txmgr.EthTxAttempt[*evmtypes.Address, *evmtypes.TxHash], int64, int64](t),
		auditLogger:       &audit.AuditLoggerService{},
	}
