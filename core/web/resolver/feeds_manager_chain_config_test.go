...
func TestUnit_CreateFeedsManagerChainConfig(t *testing.T) {
	var (
		mgrID          = int64(100)
		cfgID          = int64(1)
		chainID        = "42"
...
func TestUnit_DeleteFeedsManagerChainConfig(t *testing.T) {
	var (
		cfgID = int64(1)
...
func TestUnit_UpdateFeedsManagerChainConfig(t *testing.T) {
	var (
		cfgID             = int64(1)
		peerID            = null.StringFrom("p2p_12D3KooWMoejJznyDuEk5aX6GvbjaG12UzeornPCBNzMRqdwrFJw")
		keyBundleID       = null.StringFrom("6fdb8235e16e099de91df7ef8a8088e9deea0ed6ae106b133e5d985a8a9e1562")
