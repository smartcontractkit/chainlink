...
func TestIntegration_Shared_PingController_Show_APICredentials(t *testing.T) {
	t.Parallel()
...
func TestIntegration_Shared_PingController_Show_ExternalInitiatorCredentials(t *testing.T) {
	t.Parallel()
...
func TestIntegration_Shared_PingController_Show_NoCredentials(t *testing.T) {
	t.Parallel()
