...
//go:generate go run ./generation/generate/wrap.go ../../contracts/solc/v0.8.6/functions/1_0_0/Functions.abi ../../contracts/solc/v0.8.6/functions/1_0_0/Functions.bin Functions functions
//go:generate go run ./generation/generate/wrap.go ../../contracts/solc/v0.8.6/functions/1_0_0/FunctionsClient.abi ../../contracts/solc/v0.8.6/functions/1_0_0/FunctionsClient.bin FunctionsClient functions_client
