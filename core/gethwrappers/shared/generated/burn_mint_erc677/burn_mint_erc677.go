...
func DeployBurnMintERC677(auth *bind.TransactOpts, backend bind.ContractBackend, name string, symbol string, decimals uint8, maxSupply *big.Int) (common.Address, *types.Transaction, *BurnMintERC677, error) {
	...
	address, tx, contract, err := bind.DeployContract(auth, *parsed, common.FromHex(BurnMintERC677Bin), backend, name, symbol, decimals, maxSupply)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
