...
//go:generate go run ../generation/generate/wrap.go ../../../contracts/solc/v0.8.24/ConfirmedOwnerWithProposal/ConfirmedOwnerWithProposal.abi ../../../contracts/solc/v0.8.24/ConfirmedOwnerWithProposal/ConfirmedOwnerWithProposal.bin ConfirmedOwnerWithProposal confirmed_owner_with_proposal
