...
func (_IAutomationRegistryMaster *IAutomationRegistryMasterCaller) GetBillingToken(opts *bind.CallOpts, token common.Address) (AutomationRegistryBase23BillingConfig, error) {
	var out []interface{}
	err := _IAutomationRegistryMaster.contract.Call(opts, &out, "getBillingToken", token)
...
func (_IAutomationRegistryMaster *IAutomationRegistryMasterSession) GetBillingToken(token common.Address) (AutomationRegistryBase23BillingConfig, error) {
	return _IAutomationRegistryMaster.Contract.GetBillingToken(&_IAutomationRegistryMaster.CallOpts, token)
}

func (_IAutomationRegistryMaster *IAutomationRegistryMasterCallerSession) GetBillingToken(token common.Address) (AutomationRegistryBase23BillingConfig, error) {
	return _IAutomationRegistryMaster.Contract.GetBillingToken(&_IAutomationRegistryMaster.CallOpts, token)
}

func (_IAutomationRegistryMaster *IAutomationRegistryMasterCaller) GetBillingTokens(opts *bind.CallOpts) ([]common.Address, error) {
	var out []interface{}
	err := _IAutomationRegistryMaster.contract.Call(opts, &out, "getBillingTokens")
...
func (_IAutomationRegistryMaster *IAutomationRegistryMasterSession) GetBillingTokens() ([]common.Address, error) {
	return _IAutomationRegistryMaster.Contract.GetBillingTokens(&_IAutomationRegistryMaster.CallOpts)
}

func (_IAutomationRegistryMaster *IAutomationRegistryMasterCallerSession) GetBillingTokens() ([]common.Address, error) {
	return _IAutomationRegistryMaster.Contract.GetBillingTokens(&_IAutomationRegistryMaster.CallOpts)
}
...
func (_IAutomationRegistryMaster *IAutomationRegistryMasterTransactor) SetBillingConfig(opts *bind.TransactOpts, token common.Address, config AutomationRegistryBase23BillingConfig) (*types.Transaction, error) {
	return _IAutomationRegistryMaster.contract.Transact(opts, "setBillingConfig", token, config)
}

func (_IAutomationRegistryMaster *IAutomationRegistryMasterSession) SetBillingConfig(token common.Address, config AutomationRegistryBase23BillingConfig) (*types.Transaction, error) {
	return _IAutomationRegistryMaster.Contract.SetBillingConfig(&_IAutomationRegistryMaster.TransactOpts, token, config)
}

func (_IAutomationRegistryMaster *IAutomationRegistryMasterTransactorSession) SetBillingConfig(token common.Address, config AutomationRegistryBase23BillingConfig) (*types.Transaction, error) {
	return _IAutomationRegistryMaster.Contract.SetBillingConfig(&_IAutomationRegistryMaster.TransactOpts, token, config)
}
...
type IAutomationRegistryMasterBillingConfigSetIterator struct {
	Event *IAutomationRegistryMasterBillingConfigSet
...
func (it *IAutomationRegistryMasterBillingConfigSetIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(IAutomationRegistryMasterBillingConfigSet)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
func (it *IAutomationRegistryMasterBillingConfigSetIterator) Error() error {
	return it.fail
}

func (it *IAutomationRegistryMasterBillingConfigSetIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

type IAutomationRegistryMasterBillingConfigSet struct {
	Token  common.Address
	Config AutomationRegistryBase23BillingConfig
	Raw    types.Log
}

func (_IAutomationRegistryMaster *IAutomationRegistryMasterFilterer) FilterBillingConfigSet(opts *bind.FilterOpts, token []common.Address) (*IAutomationRegistryMasterBillingConfigSetIterator, error) {
	...
	logs, sub, err := _IAutomationRegistryMaster.contract.FilterLogs(opts, "BillingConfigSet", tokenRule)
	if err != nil {
		return nil, err
	}
	return &IAutomationRegistryMasterBillingConfigSetIterator{contract: _IAutomationRegistryMaster.contract, event: "BillingConfigSet", logs: logs, sub: sub}, nil
}

func (_IAutomationRegistryMaster *IAutomationRegistryMasterFilterer) WatchBillingConfigSet(opts *bind.WatchOpts, sink chan<- *IAutomationRegistryMasterBillingConfigSet, token []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _IAutomationRegistryMaster.contract.WatchLogs(opts, "BillingConfigSet", tokenRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(IAutomationRegistryMasterBillingConfigSet)
				if err := _IAutomationRegistryMaster.contract.UnpackLog(event, "BillingConfigSet", log); err != nil {
					return err
				}
				event.Raw = log
...
func (_IAutomationRegistryMaster *IAutomationRegistryMasterFilterer) ParseBillingConfigSet(log types.Log) (*IAutomationRegistryMasterBillingConfigSet, error) {
	event := new(IAutomationRegistryMasterBillingConfigSet)
	if err := _IAutomationRegistryMaster.contract.UnpackLog(event, "BillingConfigSet", log); err != nil {
		return nil, err
	}
...
func (_IAutomationRegistryMaster *IAutomationRegistryMaster) ParseLog(log types.Log) (generated.AbigenLog, error) {
	...
	case _IAutomationRegistryMaster.abi.Events["BillingConfigSet"].ID:
		return _IAutomationRegistryMaster.ParseBillingConfigSet(log)
...
func (IAutomationRegistryMasterBillingConfigSet) Topic() common.Hash {
...
type IAutomationRegistryMasterInterface interface {
	...
	FilterBillingConfigSet(opts *bind.FilterOpts, token []common.Address) (*IAutomationRegistryMasterBillingConfigSetIterator, error)

	WatchBillingConfigSet(opts *bind.WatchOpts, sink chan<- *IAutomationRegistryMasterBillingConfigSet, token []common.Address) (event.Subscription, error)

	ParseBillingConfigSet(log types.Log) (*IAutomationRegistryMasterBillingConfigSet, error)
