...
type OnchainConfigV21Legacy struct {
...
func (_IAutomationV21PlusCommon *IAutomationV21PlusCommonCaller) GetState(opts *bind.CallOpts) (GetState,
	...
	outstruct.State = *abi.ConvertType(out[0], new(StateV21Legacy)).(*StateV21Legacy)
	outstruct.Config = *abi.ConvertType(out[1], new(OnchainConfigV21Legacy)).(*OnchainConfigV21Legacy)
...
func (_IAutomationV21PlusCommon *IAutomationV21PlusCommonCaller) GetUpkeep(opts *bind.CallOpts, id *big.Int) (UpkeepInfo, error) {
	var out []interface{}
...
func (_IAutomationV21PlusCommon *IAutomationV21PlusCommonSession) GetUpkeep(id *big.Int) (UpkeepInfo, error) {
	return _IAutomationV21PlusCommon.Contract.GetUpkeep(&_IAutomationV21PlusCommon.CallOpts, id)
}

func (_IAutomationV21PlusCommon *IAutomationV21PlusCommonCallerSession) GetUpkeep(id *big.Int) (UpkeepInfo, error) {
	return _IAutomationV21PlusCommon.Contract.GetUpkeep(&_IAutomationV21PlusCommon.CallOpts, id)
}
...
func (_IAutomationV21PlusCommon *IAutomationV21PlusCommonTransactor) RegisterUpkeep(opts *bind.TransactOpts, target common.Address, gasLimit uint32, admin common.Address, triggerType uint8, checkData []byte, triggerConfig []byte, offchainConfig []byte) (*types.Transaction, error) {
	return _IAutomationV21PlusCommon.contract.Transact(opts, "registerUpkeep", target, gasLimit, admin, triggerType, checkData, triggerConfig, offchainConfig)
}

func (_IAutomationV21PlusCommon *IAutomationV21PlusCommonSession) RegisterUpkeep(target common.Address, gasLimit uint32, admin common.Address, triggerType uint8, checkData []byte, triggerConfig []byte, offchainConfig []byte) (*types.Transaction, error) {
	return _IAutomationV21PlusCommon.Contract.RegisterUpkeep(&_IAutomationV21PlusCommon.TransactOpts, target, gasLimit, admin, triggerType, checkData, triggerConfig, offchainConfig)
}

func (_IAutomationV21PlusCommon *IAutomationV21PlusCommonTransactorSession) RegisterUpkeep(target common.Address, gasLimit uint32, admin common.Address, triggerType uint8, checkData []byte, triggerConfig []byte, offchainConfig []byte) (*types.Transaction, error) {
	return _IAutomationV21PlusCommon.Contract.RegisterUpkeep(&_IAutomationV21PlusCommon.TransactOpts, target, gasLimit, admin, triggerType, checkData, triggerConfig, offchainConfig)
}
...
type IAutomationV21PlusCommonOwnerFundsWithdrawnIterator struct {
	Event *IAutomationV21PlusCommonOwnerFundsWithdrawn
...
func (it *IAutomationV21PlusCommonOwnerFundsWithdrawnIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(IAutomationV21PlusCommonOwnerFundsWithdrawn)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
func (it *IAutomationV21PlusCommonOwnerFundsWithdrawnIterator) Error() error {
	return it.fail
}

func (it *IAutomationV21PlusCommonOwnerFundsWithdrawnIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

type IAutomationV21PlusCommonOwnerFundsWithdrawn struct {
	Amount *big.Int
	Raw    types.Log
}

func (_IAutomationV21PlusCommon *IAutomationV21PlusCommonFilterer) FilterOwnerFundsWithdrawn(opts *bind.FilterOpts) (*IAutomationV21PlusCommonOwnerFundsWithdrawnIterator, error) {

	logs, sub, err := _IAutomationV21PlusCommon.contract.FilterLogs(opts, "OwnerFundsWithdrawn")
	if err != nil {
		return nil, err
	}
	return &IAutomationV21PlusCommonOwnerFundsWithdrawnIterator{contract: _IAutomationV21PlusCommon.contract, event: "OwnerFundsWithdrawn", logs: logs, sub: sub}, nil
}

func (_IAutomationV21PlusCommon *IAutomationV21PlusCommonFilterer) WatchOwnerFundsWithdrawn(opts *bind.WatchOpts, sink chan<- *IAutomationV21PlusCommonOwnerFundsWithdrawn) (event.Subscription, error) {

	logs, sub, err := _IAutomationV21PlusCommon.contract.WatchLogs(opts, "OwnerFundsWithdrawn")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(IAutomationV21PlusCommonOwnerFundsWithdrawn)
				if err := _IAutomationV21PlusCommon.contract.UnpackLog(event, "OwnerFundsWithdrawn", log); err != nil {
					return err
				}
				event.Raw = log
...
func (_IAutomationV21PlusCommon *IAutomationV21PlusCommonFilterer) ParseOwnerFundsWithdrawn(log types.Log) (*IAutomationV21PlusCommonOwnerFundsWithdrawn, error) {
	event := new(IAutomationV21PlusCommonOwnerFundsWithdrawn)
	if err := _IAutomationV21PlusCommon.contract.UnpackLog(event, "OwnerFundsWithdrawn", log); err != nil {
		return nil, err
	}
...
type GetState struct {
	State        StateV21Legacy
	Config       OnchainConfigV21Legacy
	Signers      []common.Address
	Transmitters []common.Address
	F            uint8
}
...
func (_IAutomationV21PlusCommon *IAutomationV21PlusCommon) ParseLog(log types.Log) (generated.AbigenLog, error) {
	...
	case _IAutomationV21PlusCommon.abi.Events["OwnerFundsWithdrawn"].ID:
		return _IAutomationV21PlusCommon.ParseOwnerFundsWithdrawn(log)
...
func (IAutomationV21PlusCommonOwnerFundsWithdrawn) Topic() common.Hash {
...
type IAutomationV21PlusCommonInterface interface {
	...
	FilterOwnerFundsWithdrawn(opts *bind.FilterOpts) (*IAutomationV21PlusCommonOwnerFundsWithdrawnIterator, error)

	WatchOwnerFundsWithdrawn(opts *bind.WatchOpts, sink chan<- *IAutomationV21PlusCommonOwnerFundsWithdrawn) (event.Subscription, error)

	ParseOwnerFundsWithdrawn(log types.Log) (*IAutomationV21PlusCommonOwnerFundsWithdrawn, error)
