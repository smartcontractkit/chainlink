...
type IAutomationV21PlusCommonState struct {
	Nonce                   uint32
...
func (_IAutomationV21PlusCommon *IAutomationV21PlusCommonCaller) GetState(opts *bind.CallOpts) (GetState,
	...
	outstruct.State = *abi.ConvertType(out[0], new(IAutomationV21PlusCommonState)).(*IAutomationV21PlusCommonState)
...
type GetState struct {
	State        IAutomationV21PlusCommonState
