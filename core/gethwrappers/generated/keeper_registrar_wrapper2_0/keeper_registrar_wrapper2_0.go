...
func DeployKeeperRegistrar20(auth *bind.TransactOpts, backend bind.ContractBackend, LINKAddress common.Address, autoApproveConfigType uint8, autoApproveMaxAllowed uint16, keeperRegistry common.Address, minLINKJuels *big.Int) (common.Address, *types.Transaction, *KeeperRegistrar20, error) {
	...
	return address, tx, &KeeperRegistrar20{address: address, abi: *parsed, KeeperRegistrar20Caller: KeeperRegistrar20Caller{contract: contract}, KeeperRegistrar20Transactor: KeeperRegistrar20Transactor{contract: contract}, KeeperRegistrar20Filterer: KeeperRegistrar20Filterer{contract: contract}}, nil
}

type KeeperRegistrar20 struct {
	address common.Address
	abi     abi.ABI
	KeeperRegistrar20Caller
	KeeperRegistrar20Transactor
	KeeperRegistrar20Filterer
}
...
func NewKeeperRegistrar20(address common.Address, backend bind.ContractBackend) (*KeeperRegistrar20, error) {
	abi, err := abi.JSON(strings.NewReader(KeeperRegistrar20ABI))
	if err != nil {
		return nil, err
	}
	...
	return &KeeperRegistrar20{address: address, abi: abi, KeeperRegistrar20Caller: KeeperRegistrar20Caller{contract: contract}, KeeperRegistrar20Transactor: KeeperRegistrar20Transactor{contract: contract}, KeeperRegistrar20Filterer: KeeperRegistrar20Filterer{contract: contract}}, nil
}
...
func (_KeeperRegistrar20 *KeeperRegistrar20Caller) GetRegistrationConfig(opts *bind.CallOpts) (GetRegistrationConfig,
...
func (_KeeperRegistrar20 *KeeperRegistrar20Session) GetRegistrationConfig() (GetRegistrationConfig,

	error) {
	return _KeeperRegistrar20.Contract.GetRegistrationConfig(&_KeeperRegistrar20.CallOpts)
}

func (_KeeperRegistrar20 *KeeperRegistrar20CallerSession) GetRegistrationConfig() (GetRegistrationConfig,
...
type KeeperRegistrar20AutoApproveAllowedSenderSetIterator struct {
	Event *KeeperRegistrar20AutoApproveAllowedSenderSet
...
type KeeperRegistrar20ConfigChangedIterator struct {
	Event *KeeperRegistrar20ConfigChanged
...
type KeeperRegistrar20OwnershipTransferRequestedIterator struct {
	Event *KeeperRegistrar20OwnershipTransferRequested
...
type KeeperRegistrar20OwnershipTransferredIterator struct {
	Event *KeeperRegistrar20OwnershipTransferred
...
type KeeperRegistrar20RegistrationApprovedIterator struct {
	Event *KeeperRegistrar20RegistrationApproved
...
type KeeperRegistrar20RegistrationRejectedIterator struct {
	Event *KeeperRegistrar20RegistrationRejected
...
type KeeperRegistrar20RegistrationRequestedIterator struct {
	Event *KeeperRegistrar20RegistrationRequested
...
func (_KeeperRegistrar20 *KeeperRegistrar20) ParseLog(log types.Log) (generated.AbigenLog, error) {
	switch log.Topics[0] {
	case _KeeperRegistrar20.abi.Events["AutoApproveAllowedSenderSet"].ID:
		return _KeeperRegistrar20.ParseAutoApproveAllowedSenderSet(log)
	case _KeeperRegistrar20.abi.Events["ConfigChanged"].ID:
		return _KeeperRegistrar20.ParseConfigChanged(log)
	case _KeeperRegistrar20.abi.Events["OwnershipTransferRequested"].ID:
		return _KeeperRegistrar20.ParseOwnershipTransferRequested(log)
	case _KeeperRegistrar20.abi.Events["OwnershipTransferred"].ID:
		return _KeeperRegistrar20.ParseOwnershipTransferred(log)
	case _KeeperRegistrar20.abi.Events["RegistrationApproved"].ID:
		return _KeeperRegistrar20.ParseRegistrationApproved(log)
	case _KeeperRegistrar20.abi.Events["RegistrationRejected"].ID:
		return _KeeperRegistrar20.ParseRegistrationRejected(log)
	case _KeeperRegistrar20.abi.Events["RegistrationRequested"].ID:
		return _KeeperRegistrar20.ParseRegistrationRequested(log)
...
func (KeeperRegistrar20AutoApproveAllowedSenderSet) Topic() common.Hash {
	return common.HexToHash("0x20c6237dac83526a849285a9f79d08a483291bdd3a056a0ef9ae94ecee1ad356")
}

func (KeeperRegistrar20ConfigChanged) Topic() common.Hash {
	return common.HexToHash("0x6293a703ec7145dfa23c5cde2e627d6a02e153fc2e9c03b14d1e22cbb4a7e9cd")
}

func (KeeperRegistrar20OwnershipTransferRequested) Topic() common.Hash {
	return common.HexToHash("0xed8889f560326eb138920d842192f0eb3dd22b4f139c87a2c57538e05bae1278")
}

func (KeeperRegistrar20OwnershipTransferred) Topic() common.Hash {
	return common.HexToHash("0x8be0079c531659141344cd1fd0a4f28419497f9722a3daafe3b4186f6b6457e0")
}

func (KeeperRegistrar20RegistrationApproved) Topic() common.Hash {
	return common.HexToHash("0xb9a292fb7e3edd920cd2d2829a3615a640c43fd7de0a0820aa0668feb4c37d4b")
}

func (KeeperRegistrar20RegistrationRejected) Topic() common.Hash {
	return common.HexToHash("0x3663fb28ebc87645eb972c9dad8521bf665c623f287e79f1c56f1eb374b82a22")
}

func (KeeperRegistrar20RegistrationRequested) Topic() common.Hash {
	return common.HexToHash("0x9b8456f925542af2c5fb15ff4be32cc8f209dda96c544766e301367df40f4998")
}

func (_KeeperRegistrar20 *KeeperRegistrar20) Address() common.Address {
	return _KeeperRegistrar20.address
}

type KeeperRegistrar20Interface interface {
	...
	FilterAutoApproveAllowedSenderSet(opts *bind.FilterOpts, senderAddress []common.Address) (*KeeperRegistrar20AutoApproveAllowedSenderSetIterator, error)

	WatchAutoApproveAllowedSenderSet(opts *bind.WatchOpts, sink chan<- *KeeperRegistrar20AutoApproveAllowedSenderSet, senderAddress []common.Address) (event.Subscription, error)

	ParseAutoApproveAllowedSenderSet(log types.Log) (*KeeperRegistrar20AutoApproveAllowedSenderSet, error)

	FilterConfigChanged(opts *bind.FilterOpts) (*KeeperRegistrar20ConfigChangedIterator, error)

	WatchConfigChanged(opts *bind.WatchOpts, sink chan<- *KeeperRegistrar20ConfigChanged) (event.Subscription, error)

	ParseConfigChanged(log types.Log) (*KeeperRegistrar20ConfigChanged, error)

	FilterOwnershipTransferRequested(opts *bind.FilterOpts, from []common.Address, to []common.Address) (*KeeperRegistrar20OwnershipTransferRequestedIterator, error)

	WatchOwnershipTransferRequested(opts *bind.WatchOpts, sink chan<- *KeeperRegistrar20OwnershipTransferRequested, from []common.Address, to []common.Address) (event.Subscription, error)

	ParseOwnershipTransferRequested(log types.Log) (*KeeperRegistrar20OwnershipTransferRequested, error)

	FilterOwnershipTransferred(opts *bind.FilterOpts, from []common.Address, to []common.Address) (*KeeperRegistrar20OwnershipTransferredIterator, error)

	WatchOwnershipTransferred(opts *bind.WatchOpts, sink chan<- *KeeperRegistrar20OwnershipTransferred, from []common.Address, to []common.Address) (event.Subscription, error)

	ParseOwnershipTransferred(log types.Log) (*KeeperRegistrar20OwnershipTransferred, error)

	FilterRegistrationApproved(opts *bind.FilterOpts, hash [][32]byte, upkeepId []*big.Int) (*KeeperRegistrar20RegistrationApprovedIterator, error)

	WatchRegistrationApproved(opts *bind.WatchOpts, sink chan<- *KeeperRegistrar20RegistrationApproved, hash [][32]byte, upkeepId []*big.Int) (event.Subscription, error)

	ParseRegistrationApproved(log types.Log) (*KeeperRegistrar20RegistrationApproved, error)

	FilterRegistrationRejected(opts *bind.FilterOpts, hash [][32]byte) (*KeeperRegistrar20RegistrationRejectedIterator, error)

	WatchRegistrationRejected(opts *bind.WatchOpts, sink chan<- *KeeperRegistrar20RegistrationRejected, hash [][32]byte) (event.Subscription, error)

	ParseRegistrationRejected(log types.Log) (*KeeperRegistrar20RegistrationRejected, error)

	FilterRegistrationRequested(opts *bind.FilterOpts, hash [][32]byte, upkeepContract []common.Address) (*KeeperRegistrar20RegistrationRequestedIterator, error)

	WatchRegistrationRequested(opts *bind.WatchOpts, sink chan<- *KeeperRegistrar20RegistrationRequested, hash [][32]byte, upkeepContract []common.Address) (event.Subscription, error)

	ParseRegistrationRequested(log types.Log) (*KeeperRegistrar20RegistrationRequested, error)
