...
func bindFunctionsClient(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(FunctionsClientABI))
	if err != nil {
		return nil, err
	}
...
func (_FunctionsClient *FunctionsClientCaller) EstimateCost(opts *bind.CallOpts, req FunctionsRequest, subscriptionId uint64, gasLimit uint32, gasPrice *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _FunctionsClient.contract.Call(opts, &out, "estimateCost", req, subscriptionId, gasLimit, gasPrice)
...
func (_FunctionsClient *FunctionsClientSession) EstimateCost(req FunctionsRequest, subscriptionId uint64, gasLimit uint32, gasPrice *big.Int) (*big.Int, error) {
	return _FunctionsClient.Contract.EstimateCost(&_FunctionsClient.CallOpts, req, subscriptionId, gasLimit, gasPrice)
}

func (_FunctionsClient *FunctionsClientCallerSession) EstimateCost(req FunctionsRequest, subscriptionId uint64, gasLimit uint32, gasPrice *big.Int) (*big.Int, error) {
	return _FunctionsClient.Contract.EstimateCost(&_FunctionsClient.CallOpts, req, subscriptionId, gasLimit, gasPrice)
}

func (_FunctionsClient *FunctionsClientCaller) GetDONPublicKey(opts *bind.CallOpts) ([]byte, error) {
	var out []interface{}
	err := _FunctionsClient.contract.Call(opts, &out, "getDONPublicKey")
...
func (_FunctionsClient *FunctionsClientSession) GetDONPublicKey() ([]byte, error) {
	return _FunctionsClient.Contract.GetDONPublicKey(&_FunctionsClient.CallOpts)
}

func (_FunctionsClient *FunctionsClientCallerSession) GetDONPublicKey() ([]byte, error) {
	return _FunctionsClient.Contract.GetDONPublicKey(&_FunctionsClient.CallOpts)
}

func (_FunctionsClient *FunctionsClientTransactor) HandleDONFulfillment(opts *bind.TransactOpts, requestId [32]byte, response []byte, err []byte) (*types.Transaction, error) {
	return _FunctionsClient.contract.Transact(opts, "handleDONFulfillment", requestId, response, err)
}

func (_FunctionsClient *FunctionsClientSession) HandleDONFulfillment(requestId [32]byte, response []byte, err []byte) (*types.Transaction, error) {
	return _FunctionsClient.Contract.HandleDONFulfillment(&_FunctionsClient.TransactOpts, requestId, response, err)
}

func (_FunctionsClient *FunctionsClientTransactorSession) HandleDONFulfillment(requestId [32]byte, response []byte, err []byte) (*types.Transaction, error) {
	return _FunctionsClient.Contract.HandleDONFulfillment(&_FunctionsClient.TransactOpts, requestId, response, err)
}
