...
func DeployKeeperRegistryLogic13(auth *bind.TransactOpts, backend bind.ContractBackend, paymentModel uint8, registryGasOverhead *big.Int, link common.Address, linkEthFeed common.Address, fastGasFeed common.Address) (common.Address, *types.Transaction, *KeeperRegistryLogic13, error) {
	...
	return address, tx, &KeeperRegistryLogic13{address: address, abi: *parsed, KeeperRegistryLogic13Caller: KeeperRegistryLogic13Caller{contract: contract}, KeeperRegistryLogic13Transactor: KeeperRegistryLogic13Transactor{contract: contract}, KeeperRegistryLogic13Filterer: KeeperRegistryLogic13Filterer{contract: contract}}, nil
}

type KeeperRegistryLogic13 struct {
	address common.Address
	abi     abi.ABI
	KeeperRegistryLogic13Caller
	KeeperRegistryLogic13Transactor
	KeeperRegistryLogic13Filterer
}
...
type KeeperRegistryLogic13Session struct {
	Contract     *KeeperRegistryLogic13
	CallOpts     bind.CallOpts
	TransactOpts bind.TransactOpts
}

type KeeperRegistryLogic13CallerSession struct {
	Contract *KeeperRegistryLogic13Caller
	CallOpts bind.CallOpts
}

type KeeperRegistryLogic13TransactorSession struct {
	Contract     *KeeperRegistryLogic13Transactor
	TransactOpts bind.TransactOpts
}
...
func NewKeeperRegistryLogic13(address common.Address, backend bind.ContractBackend) (*KeeperRegistryLogic13, error) {
	abi, err := abi.JSON(strings.NewReader(KeeperRegistryLogic13ABI))
	if err != nil {
		return nil, err
	}
	...
	return &KeeperRegistryLogic13{address: address, abi: abi, KeeperRegistryLogic13Caller: KeeperRegistryLogic13Caller{contract: contract}, KeeperRegistryLogic13Transactor: KeeperRegistryLogic13Transactor{contract: contract}, KeeperRegistryLogic13Filterer: KeeperRegistryLogic13Filterer{contract: contract}}, nil
}
...
type KeeperRegistryLogic13ConfigSetIterator struct {
	Event *KeeperRegistryLogic13ConfigSet
...
type KeeperRegistryLogic13FundsAddedIterator struct {
	Event *KeeperRegistryLogic13FundsAdded
...
type KeeperRegistryLogic13FundsWithdrawnIterator struct {
	Event *KeeperRegistryLogic13FundsWithdrawn
...
type KeeperRegistryLogic13KeepersUpdatedIterator struct {
	Event *KeeperRegistryLogic13KeepersUpdated
...
type KeeperRegistryLogic13OwnerFundsWithdrawnIterator struct {
	Event *KeeperRegistryLogic13OwnerFundsWithdrawn
...
type KeeperRegistryLogic13OwnershipTransferRequestedIterator struct {
	Event *KeeperRegistryLogic13OwnershipTransferRequested
...
type KeeperRegistryLogic13OwnershipTransferredIterator struct {
	Event *KeeperRegistryLogic13OwnershipTransferred
...
type KeeperRegistryLogic13PausedIterator struct {
	Event *KeeperRegistryLogic13Paused
...
type KeeperRegistryLogic13PayeeshipTransferRequestedIterator struct {
	Event *KeeperRegistryLogic13PayeeshipTransferRequested
...
type KeeperRegistryLogic13PayeeshipTransferredIterator struct {
	Event *KeeperRegistryLogic13PayeeshipTransferred
...
type KeeperRegistryLogic13PaymentWithdrawnIterator struct {
	Event *KeeperRegistryLogic13PaymentWithdrawn
...
type KeeperRegistryLogic13UnpausedIterator struct {
	Event *KeeperRegistryLogic13Unpaused
...
type KeeperRegistryLogic13UpkeepAdminTransferRequestedIterator struct {
	Event *KeeperRegistryLogic13UpkeepAdminTransferRequested
...
type KeeperRegistryLogic13UpkeepAdminTransferredIterator struct {
	Event *KeeperRegistryLogic13UpkeepAdminTransferred
...
type KeeperRegistryLogic13UpkeepCanceledIterator struct {
	Event *KeeperRegistryLogic13UpkeepCanceled
...
type KeeperRegistryLogic13UpkeepCheckDataUpdatedIterator struct {
	Event *KeeperRegistryLogic13UpkeepCheckDataUpdated
...
type KeeperRegistryLogic13UpkeepGasLimitSetIterator struct {
	Event *KeeperRegistryLogic13UpkeepGasLimitSet
...
type KeeperRegistryLogic13UpkeepMigratedIterator struct {
	Event *KeeperRegistryLogic13UpkeepMigrated
...
type KeeperRegistryLogic13UpkeepPausedIterator struct {
	Event *KeeperRegistryLogic13UpkeepPaused
...
type KeeperRegistryLogic13UpkeepPerformedIterator struct {
	Event *KeeperRegistryLogic13UpkeepPerformed
...
type KeeperRegistryLogic13UpkeepReceivedIterator struct {
	Event *KeeperRegistryLogic13UpkeepReceived
...
type KeeperRegistryLogic13UpkeepRegisteredIterator struct {
	Event *KeeperRegistryLogic13UpkeepRegistered
...
type KeeperRegistryLogic13UpkeepUnpausedIterator struct {
	Event *KeeperRegistryLogic13UpkeepUnpaused
...
func (_KeeperRegistryLogic13 *KeeperRegistryLogic13) ParseLog(log types.Log) (generated.AbigenLog, error) {
	switch log.Topics[0] {
	case _KeeperRegistryLogic13.abi.Events["ConfigSet"].ID:
		return _KeeperRegistryLogic13.ParseConfigSet(log)
	case _KeeperRegistryLogic13.abi.Events["FundsAdded"].ID:
		return _KeeperRegistryLogic13.ParseFundsAdded(log)
	case _KeeperRegistryLogic13.abi.Events["FundsWithdrawn"].ID:
		return _KeeperRegistryLogic13.ParseFundsWithdrawn(log)
	case _KeeperRegistryLogic13.abi.Events["KeepersUpdated"].ID:
		return _KeeperRegistryLogic13.ParseKeepersUpdated(log)
	case _KeeperRegistryLogic13.abi.Events["OwnerFundsWithdrawn"].ID:
		return _KeeperRegistryLogic13.ParseOwnerFundsWithdrawn(log)
	case _KeeperRegistryLogic13.abi.Events["OwnershipTransferRequested"].ID:
		return _KeeperRegistryLogic13.ParseOwnershipTransferRequested(log)
	case _KeeperRegistryLogic13.abi.Events["OwnershipTransferred"].ID:
		return _KeeperRegistryLogic13.ParseOwnershipTransferred(log)
	case _KeeperRegistryLogic13.abi.Events["Paused"].ID:
		return _KeeperRegistryLogic13.ParsePaused(log)
	case _KeeperRegistryLogic13.abi.Events["PayeeshipTransferRequested"].ID:
		return _KeeperRegistryLogic13.ParsePayeeshipTransferRequested(log)
	case _KeeperRegistryLogic13.abi.Events["PayeeshipTransferred"].ID:
		return _KeeperRegistryLogic13.ParsePayeeshipTransferred(log)
	case _KeeperRegistryLogic13.abi.Events["PaymentWithdrawn"].ID:
		return _KeeperRegistryLogic13.ParsePaymentWithdrawn(log)
	case _KeeperRegistryLogic13.abi.Events["Unpaused"].ID:
		return _KeeperRegistryLogic13.ParseUnpaused(log)
	case _KeeperRegistryLogic13.abi.Events["UpkeepAdminTransferRequested"].ID:
		return _KeeperRegistryLogic13.ParseUpkeepAdminTransferRequested(log)
	case _KeeperRegistryLogic13.abi.Events["UpkeepAdminTransferred"].ID:
		return _KeeperRegistryLogic13.ParseUpkeepAdminTransferred(log)
	case _KeeperRegistryLogic13.abi.Events["UpkeepCanceled"].ID:
		return _KeeperRegistryLogic13.ParseUpkeepCanceled(log)
	case _KeeperRegistryLogic13.abi.Events["UpkeepCheckDataUpdated"].ID:
		return _KeeperRegistryLogic13.ParseUpkeepCheckDataUpdated(log)
	case _KeeperRegistryLogic13.abi.Events["UpkeepGasLimitSet"].ID:
		return _KeeperRegistryLogic13.ParseUpkeepGasLimitSet(log)
	case _KeeperRegistryLogic13.abi.Events["UpkeepMigrated"].ID:
		return _KeeperRegistryLogic13.ParseUpkeepMigrated(log)
	case _KeeperRegistryLogic13.abi.Events["UpkeepPaused"].ID:
		return _KeeperRegistryLogic13.ParseUpkeepPaused(log)
	case _KeeperRegistryLogic13.abi.Events["UpkeepPerformed"].ID:
		return _KeeperRegistryLogic13.ParseUpkeepPerformed(log)
	case _KeeperRegistryLogic13.abi.Events["UpkeepReceived"].ID:
		return _KeeperRegistryLogic13.ParseUpkeepReceived(log)
	case _KeeperRegistryLogic13.abi.Events["UpkeepRegistered"].ID:
		return _KeeperRegistryLogic13.ParseUpkeepRegistered(log)
	case _KeeperRegistryLogic13.abi.Events["UpkeepUnpaused"].ID:
		return _KeeperRegistryLogic13.ParseUpkeepUnpaused(log)
...
func (KeeperRegistryLogic13ConfigSet) Topic() common.Hash {
	return common.HexToHash("0xfe125a41957477226ba20f85ef30a4024ea3bb8d066521ddc16df3f2944de325")
}

func (KeeperRegistryLogic13FundsAdded) Topic() common.Hash {
	return common.HexToHash("0xafd24114486da8ebfc32f3626dada8863652e187461aa74d4bfa734891506203")
}

func (KeeperRegistryLogic13FundsWithdrawn) Topic() common.Hash {
	return common.HexToHash("0xf3b5906e5672f3e524854103bcafbbdba80dbdfeca2c35e116127b1060a68318")
}

func (KeeperRegistryLogic13KeepersUpdated) Topic() common.Hash {
	return common.HexToHash("0x056264c94f28bb06c99d13f0446eb96c67c215d8d707bce2655a98ddf1c0b71f")
}

func (KeeperRegistryLogic13OwnerFundsWithdrawn) Topic() common.Hash {
	return common.HexToHash("0x1d07d0b0be43d3e5fee41a80b579af370affee03fa595bf56d5d4c19328162f1")
}

func (KeeperRegistryLogic13OwnershipTransferRequested) Topic() common.Hash {
	return common.HexToHash("0xed8889f560326eb138920d842192f0eb3dd22b4f139c87a2c57538e05bae1278")
}

func (KeeperRegistryLogic13OwnershipTransferred) Topic() common.Hash {
	return common.HexToHash("0x8be0079c531659141344cd1fd0a4f28419497f9722a3daafe3b4186f6b6457e0")
}

func (KeeperRegistryLogic13Paused) Topic() common.Hash {
	return common.HexToHash("0x62e78cea01bee320cd4e420270b5ea74000d11b0c9f74754ebdbfc544b05a258")
}

func (KeeperRegistryLogic13PayeeshipTransferRequested) Topic() common.Hash {
	return common.HexToHash("0x84f7c7c80bb8ed2279b4aab5f61cd05e6374073d38f46d7f32de8c30e9e38367")
}

func (KeeperRegistryLogic13PayeeshipTransferred) Topic() common.Hash {
	return common.HexToHash("0x78af32efdcad432315431e9b03d27e6cd98fb79c405fdc5af7c1714d9c0f75b3")
}

func (KeeperRegistryLogic13PaymentWithdrawn) Topic() common.Hash {
	return common.HexToHash("0x9819093176a1851202c7bcfa46845809b4e47c261866550e94ed3775d2f40698")
}

func (KeeperRegistryLogic13Unpaused) Topic() common.Hash {
	return common.HexToHash("0x5db9ee0a495bf2e6ff9c91a7834c1ba4fdd244a5e8aa4e537bd38aeae4b073aa")
}

func (KeeperRegistryLogic13UpkeepAdminTransferRequested) Topic() common.Hash {
	return common.HexToHash("0xb1cbb2c4b8480034c27e06da5f096b8233a8fd4497028593a41ff6df79726b35")
}

func (KeeperRegistryLogic13UpkeepAdminTransferred) Topic() common.Hash {
	return common.HexToHash("0x5cff4db96bef051785e999f44bfcd21c18823e034fb92dd376e3db4ce0feeb2c")
}

func (KeeperRegistryLogic13UpkeepCanceled) Topic() common.Hash {
	return common.HexToHash("0x91cb3bb75cfbd718bbfccc56b7f53d92d7048ef4ca39a3b7b7c6d4af1f791181")
}

func (KeeperRegistryLogic13UpkeepCheckDataUpdated) Topic() common.Hash {
	return common.HexToHash("0x7b778136e5211932b51a145badd01959415e79e051a933604b3d323f862dcabf")
}

func (KeeperRegistryLogic13UpkeepGasLimitSet) Topic() common.Hash {
	return common.HexToHash("0xc24c07e655ce79fba8a589778987d3c015bc6af1632bb20cf9182e02a65d972c")
}

func (KeeperRegistryLogic13UpkeepMigrated) Topic() common.Hash {
	return common.HexToHash("0xb38647142fbb1ea4c000fc4569b37a4e9a9f6313317b84ee3e5326c1a6cd06ff")
}

func (KeeperRegistryLogic13UpkeepPaused) Topic() common.Hash {
	return common.HexToHash("0x8ab10247ce168c27748e656ecf852b951fcaac790c18106b19aa0ae57a8b741f")
}

func (KeeperRegistryLogic13UpkeepPerformed) Topic() common.Hash {
	return common.HexToHash("0xcaacad83e47cc45c280d487ec84184eee2fa3b54ebaa393bda7549f13da228f6")
}

func (KeeperRegistryLogic13UpkeepReceived) Topic() common.Hash {
	return common.HexToHash("0x74931a144e43a50694897f241d973aecb5024c0e910f9bb80a163ea3c1cf5a71")
}

func (KeeperRegistryLogic13UpkeepRegistered) Topic() common.Hash {
	return common.HexToHash("0xbae366358c023f887e791d7a62f2e4316f1026bd77f6fb49501a917b3bc5d012")
}

func (KeeperRegistryLogic13UpkeepUnpaused) Topic() common.Hash {
	return common.HexToHash("0x7bada562044eb163f6b4003c4553e4e62825344c0418eea087bed5ee05a47456")
}

func (_KeeperRegistryLogic13 *KeeperRegistryLogic13) Address() common.Address {
	return _KeeperRegistryLogic13.address
}

type KeeperRegistryLogic13Interface interface {
	...
	FilterConfigSet(opts *bind.FilterOpts) (*KeeperRegistryLogic13ConfigSetIterator, error)

	WatchConfigSet(opts *bind.WatchOpts, sink chan<- *KeeperRegistryLogic13ConfigSet) (event.Subscription, error)

	ParseConfigSet(log types.Log) (*KeeperRegistryLogic13ConfigSet, error)

	FilterFundsAdded(opts *bind.FilterOpts, id []*big.Int, from []common.Address) (*KeeperRegistryLogic13FundsAddedIterator, error)

	WatchFundsAdded(opts *bind.WatchOpts, sink chan<- *KeeperRegistryLogic13FundsAdded, id []*big.Int, from []common.Address) (event.Subscription, error)

	ParseFundsAdded(log types.Log) (*KeeperRegistryLogic13FundsAdded, error)

	FilterFundsWithdrawn(opts *bind.FilterOpts, id []*big.Int) (*KeeperRegistryLogic13FundsWithdrawnIterator, error)

	WatchFundsWithdrawn(opts *bind.WatchOpts, sink chan<- *KeeperRegistryLogic13FundsWithdrawn, id []*big.Int) (event.Subscription, error)

	ParseFundsWithdrawn(log types.Log) (*KeeperRegistryLogic13FundsWithdrawn, error)

	FilterKeepersUpdated(opts *bind.FilterOpts) (*KeeperRegistryLogic13KeepersUpdatedIterator, error)

	WatchKeepersUpdated(opts *bind.WatchOpts, sink chan<- *KeeperRegistryLogic13KeepersUpdated) (event.Subscription, error)

	ParseKeepersUpdated(log types.Log) (*KeeperRegistryLogic13KeepersUpdated, error)

	FilterOwnerFundsWithdrawn(opts *bind.FilterOpts) (*KeeperRegistryLogic13OwnerFundsWithdrawnIterator, error)

	WatchOwnerFundsWithdrawn(opts *bind.WatchOpts, sink chan<- *KeeperRegistryLogic13OwnerFundsWithdrawn) (event.Subscription, error)

	ParseOwnerFundsWithdrawn(log types.Log) (*KeeperRegistryLogic13OwnerFundsWithdrawn, error)

	FilterOwnershipTransferRequested(opts *bind.FilterOpts, from []common.Address, to []common.Address) (*KeeperRegistryLogic13OwnershipTransferRequestedIterator, error)

	WatchOwnershipTransferRequested(opts *bind.WatchOpts, sink chan<- *KeeperRegistryLogic13OwnershipTransferRequested, from []common.Address, to []common.Address) (event.Subscription, error)

	ParseOwnershipTransferRequested(log types.Log) (*KeeperRegistryLogic13OwnershipTransferRequested, error)

	FilterOwnershipTransferred(opts *bind.FilterOpts, from []common.Address, to []common.Address) (*KeeperRegistryLogic13OwnershipTransferredIterator, error)

	WatchOwnershipTransferred(opts *bind.WatchOpts, sink chan<- *KeeperRegistryLogic13OwnershipTransferred, from []common.Address, to []common.Address) (event.Subscription, error)

	ParseOwnershipTransferred(log types.Log) (*KeeperRegistryLogic13OwnershipTransferred, error)

	FilterPaused(opts *bind.FilterOpts) (*KeeperRegistryLogic13PausedIterator, error)

	WatchPaused(opts *bind.WatchOpts, sink chan<- *KeeperRegistryLogic13Paused) (event.Subscription, error)

	ParsePaused(log types.Log) (*KeeperRegistryLogic13Paused, error)

	FilterPayeeshipTransferRequested(opts *bind.FilterOpts, keeper []common.Address, from []common.Address, to []common.Address) (*KeeperRegistryLogic13PayeeshipTransferRequestedIterator, error)

	WatchPayeeshipTransferRequested(opts *bind.WatchOpts, sink chan<- *KeeperRegistryLogic13PayeeshipTransferRequested, keeper []common.Address, from []common.Address, to []common.Address) (event.Subscription, error)

	ParsePayeeshipTransferRequested(log types.Log) (*KeeperRegistryLogic13PayeeshipTransferRequested, error)

	FilterPayeeshipTransferred(opts *bind.FilterOpts, keeper []common.Address, from []common.Address, to []common.Address) (*KeeperRegistryLogic13PayeeshipTransferredIterator, error)

	WatchPayeeshipTransferred(opts *bind.WatchOpts, sink chan<- *KeeperRegistryLogic13PayeeshipTransferred, keeper []common.Address, from []common.Address, to []common.Address) (event.Subscription, error)

	ParsePayeeshipTransferred(log types.Log) (*KeeperRegistryLogic13PayeeshipTransferred, error)

	FilterPaymentWithdrawn(opts *bind.FilterOpts, keeper []common.Address, amount []*big.Int, to []common.Address) (*KeeperRegistryLogic13PaymentWithdrawnIterator, error)

	WatchPaymentWithdrawn(opts *bind.WatchOpts, sink chan<- *KeeperRegistryLogic13PaymentWithdrawn, keeper []common.Address, amount []*big.Int, to []common.Address) (event.Subscription, error)

	ParsePaymentWithdrawn(log types.Log) (*KeeperRegistryLogic13PaymentWithdrawn, error)

	FilterUnpaused(opts *bind.FilterOpts) (*KeeperRegistryLogic13UnpausedIterator, error)

	WatchUnpaused(opts *bind.WatchOpts, sink chan<- *KeeperRegistryLogic13Unpaused) (event.Subscription, error)

	ParseUnpaused(log types.Log) (*KeeperRegistryLogic13Unpaused, error)

	FilterUpkeepAdminTransferRequested(opts *bind.FilterOpts, id []*big.Int, from []common.Address, to []common.Address) (*KeeperRegistryLogic13UpkeepAdminTransferRequestedIterator, error)

	WatchUpkeepAdminTransferRequested(opts *bind.WatchOpts, sink chan<- *KeeperRegistryLogic13UpkeepAdminTransferRequested, id []*big.Int, from []common.Address, to []common.Address) (event.Subscription, error)

	ParseUpkeepAdminTransferRequested(log types.Log) (*KeeperRegistryLogic13UpkeepAdminTransferRequested, error)

	FilterUpkeepAdminTransferred(opts *bind.FilterOpts, id []*big.Int, from []common.Address, to []common.Address) (*KeeperRegistryLogic13UpkeepAdminTransferredIterator, error)

	WatchUpkeepAdminTransferred(opts *bind.WatchOpts, sink chan<- *KeeperRegistryLogic13UpkeepAdminTransferred, id []*big.Int, from []common.Address, to []common.Address) (event.Subscription, error)

	ParseUpkeepAdminTransferred(log types.Log) (*KeeperRegistryLogic13UpkeepAdminTransferred, error)

	FilterUpkeepCanceled(opts *bind.FilterOpts, id []*big.Int, atBlockHeight []uint64) (*KeeperRegistryLogic13UpkeepCanceledIterator, error)

	WatchUpkeepCanceled(opts *bind.WatchOpts, sink chan<- *KeeperRegistryLogic13UpkeepCanceled, id []*big.Int, atBlockHeight []uint64) (event.Subscription, error)

	ParseUpkeepCanceled(log types.Log) (*KeeperRegistryLogic13UpkeepCanceled, error)

	FilterUpkeepCheckDataUpdated(opts *bind.FilterOpts, id []*big.Int) (*KeeperRegistryLogic13UpkeepCheckDataUpdatedIterator, error)

	WatchUpkeepCheckDataUpdated(opts *bind.WatchOpts, sink chan<- *KeeperRegistryLogic13UpkeepCheckDataUpdated, id []*big.Int) (event.Subscription, error)

	ParseUpkeepCheckDataUpdated(log types.Log) (*KeeperRegistryLogic13UpkeepCheckDataUpdated, error)

	FilterUpkeepGasLimitSet(opts *bind.FilterOpts, id []*big.Int) (*KeeperRegistryLogic13UpkeepGasLimitSetIterator, error)

	WatchUpkeepGasLimitSet(opts *bind.WatchOpts, sink chan<- *KeeperRegistryLogic13UpkeepGasLimitSet, id []*big.Int) (event.Subscription, error)

	ParseUpkeepGasLimitSet(log types.Log) (*KeeperRegistryLogic13UpkeepGasLimitSet, error)

	FilterUpkeepMigrated(opts *bind.FilterOpts, id []*big.Int) (*KeeperRegistryLogic13UpkeepMigratedIterator, error)

	WatchUpkeepMigrated(opts *bind.WatchOpts, sink chan<- *KeeperRegistryLogic13UpkeepMigrated, id []*big.Int) (event.Subscription, error)

	ParseUpkeepMigrated(log types.Log) (*KeeperRegistryLogic13UpkeepMigrated, error)

	FilterUpkeepPaused(opts *bind.FilterOpts, id []*big.Int) (*KeeperRegistryLogic13UpkeepPausedIterator, error)

	WatchUpkeepPaused(opts *bind.WatchOpts, sink chan<- *KeeperRegistryLogic13UpkeepPaused, id []*big.Int) (event.Subscription, error)

	ParseUpkeepPaused(log types.Log) (*KeeperRegistryLogic13UpkeepPaused, error)

	FilterUpkeepPerformed(opts *bind.FilterOpts, id []*big.Int, success []bool, from []common.Address) (*KeeperRegistryLogic13UpkeepPerformedIterator, error)

	WatchUpkeepPerformed(opts *bind.WatchOpts, sink chan<- *KeeperRegistryLogic13UpkeepPerformed, id []*big.Int, success []bool, from []common.Address) (event.Subscription, error)

	ParseUpkeepPerformed(log types.Log) (*KeeperRegistryLogic13UpkeepPerformed, error)

	FilterUpkeepReceived(opts *bind.FilterOpts, id []*big.Int) (*KeeperRegistryLogic13UpkeepReceivedIterator, error)

	WatchUpkeepReceived(opts *bind.WatchOpts, sink chan<- *KeeperRegistryLogic13UpkeepReceived, id []*big.Int) (event.Subscription, error)

	ParseUpkeepReceived(log types.Log) (*KeeperRegistryLogic13UpkeepReceived, error)

	FilterUpkeepRegistered(opts *bind.FilterOpts, id []*big.Int) (*KeeperRegistryLogic13UpkeepRegisteredIterator, error)

	WatchUpkeepRegistered(opts *bind.WatchOpts, sink chan<- *KeeperRegistryLogic13UpkeepRegistered, id []*big.Int) (event.Subscription, error)

	ParseUpkeepRegistered(log types.Log) (*KeeperRegistryLogic13UpkeepRegistered, error)

	FilterUpkeepUnpaused(opts *bind.FilterOpts, id []*big.Int) (*KeeperRegistryLogic13UpkeepUnpausedIterator, error)

	WatchUpkeepUnpaused(opts *bind.WatchOpts, sink chan<- *KeeperRegistryLogic13UpkeepUnpaused, id []*big.Int) (event.Subscription, error)

	ParseUpkeepUnpaused(log types.Log) (*KeeperRegistryLogic13UpkeepUnpaused, error)
