...
func DeployKeeperRegistry12(auth *bind.TransactOpts, backend bind.ContractBackend, link common.Address, linkEthFeed common.Address, fastGasFeed common.Address, config Config) (common.Address, *types.Transaction, *KeeperRegistry12, error) {
	...
	return address, tx, &KeeperRegistry12{address: address, abi: *parsed, KeeperRegistry12Caller: KeeperRegistry12Caller{contract: contract}, KeeperRegistry12Transactor: KeeperRegistry12Transactor{contract: contract}, KeeperRegistry12Filterer: KeeperRegistry12Filterer{contract: contract}}, nil
}

type KeeperRegistry12 struct {
	address common.Address
	abi     abi.ABI
	KeeperRegistry12Caller
	KeeperRegistry12Transactor
	KeeperRegistry12Filterer
}
...
func NewKeeperRegistry12(address common.Address, backend bind.ContractBackend) (*KeeperRegistry12, error) {
	abi, err := abi.JSON(strings.NewReader(KeeperRegistry12ABI))
	if err != nil {
		return nil, err
	}
	...
	return &KeeperRegistry12{address: address, abi: abi, KeeperRegistry12Caller: KeeperRegistry12Caller{contract: contract}, KeeperRegistry12Transactor: KeeperRegistry12Transactor{contract: contract}, KeeperRegistry12Filterer: KeeperRegistry12Filterer{contract: contract}}, nil
}
...
func (_KeeperRegistry12 *KeeperRegistry12Caller) GetKeeperInfo(opts *bind.CallOpts, query common.Address) (GetKeeperInfo,
...
func (_KeeperRegistry12 *KeeperRegistry12Session) GetKeeperInfo(query common.Address) (GetKeeperInfo,

	error) {
	return _KeeperRegistry12.Contract.GetKeeperInfo(&_KeeperRegistry12.CallOpts, query)
}

func (_KeeperRegistry12 *KeeperRegistry12CallerSession) GetKeeperInfo(query common.Address) (GetKeeperInfo,
...
func (_KeeperRegistry12 *KeeperRegistry12Caller) GetState(opts *bind.CallOpts) (GetState,
...
func (_KeeperRegistry12 *KeeperRegistry12Session) GetState() (GetState,

	error) {
	return _KeeperRegistry12.Contract.GetState(&_KeeperRegistry12.CallOpts)
}

func (_KeeperRegistry12 *KeeperRegistry12CallerSession) GetState() (GetState,

	error) {
	return _KeeperRegistry12.Contract.GetState(&_KeeperRegistry12.CallOpts)
}

func (_KeeperRegistry12 *KeeperRegistry12Caller) GetUpkeep(opts *bind.CallOpts, id *big.Int) (GetUpkeep,
...
func (_KeeperRegistry12 *KeeperRegistry12Session) GetUpkeep(id *big.Int) (GetUpkeep,

	error) {
	return _KeeperRegistry12.Contract.GetUpkeep(&_KeeperRegistry12.CallOpts, id)
}

func (_KeeperRegistry12 *KeeperRegistry12CallerSession) GetUpkeep(id *big.Int) (GetUpkeep,
...
type KeeperRegistry12ConfigSetIterator struct {
	Event *KeeperRegistry12ConfigSet
...
type KeeperRegistry12FundsAddedIterator struct {
	Event *KeeperRegistry12FundsAdded
...
type KeeperRegistry12FundsWithdrawnIterator struct {
	Event *KeeperRegistry12FundsWithdrawn
...
type KeeperRegistry12KeepersUpdatedIterator struct {
	Event *KeeperRegistry12KeepersUpdated
...
type KeeperRegistry12OwnerFundsWithdrawnIterator struct {
	Event *KeeperRegistry12OwnerFundsWithdrawn
...
type KeeperRegistry12OwnershipTransferRequestedIterator struct {
	Event *KeeperRegistry12OwnershipTransferRequested
...
type KeeperRegistry12OwnershipTransferredIterator struct {
	Event *KeeperRegistry12OwnershipTransferred
...
type KeeperRegistry12PayeeshipTransferRequestedIterator struct {
	Event *KeeperRegistry12PayeeshipTransferRequested
...
type KeeperRegistry12PayeeshipTransferredIterator struct {
	Event *KeeperRegistry12PayeeshipTransferred
...
type KeeperRegistry12PaymentWithdrawnIterator struct {
	Event *KeeperRegistry12PaymentWithdrawn
...
type KeeperRegistry12UnpausedIterator struct {
	Event *KeeperRegistry12Unpaused
...
type KeeperRegistry12UpkeepCanceledIterator struct {
	Event *KeeperRegistry12UpkeepCanceled
...
type KeeperRegistry12UpkeepGasLimitSetIterator struct {
	Event *KeeperRegistry12UpkeepGasLimitSet
...
type KeeperRegistry12UpkeepMigratedIterator struct {
	Event *KeeperRegistry12UpkeepMigrated
...
type KeeperRegistry12UpkeepPerformedIterator struct {
	Event *KeeperRegistry12UpkeepPerformed
...
type KeeperRegistry12UpkeepReceivedIterator struct {
	Event *KeeperRegistry12UpkeepReceived
...
type KeeperRegistry12UpkeepRegisteredIterator struct {
	Event *KeeperRegistry12UpkeepRegistered
...
func (_KeeperRegistry12 *KeeperRegistry12) ParseLog(log types.Log) (generated.AbigenLog, error) {
	switch log.Topics[0] {
	case _KeeperRegistry12.abi.Events["ConfigSet"].ID:
		return _KeeperRegistry12.ParseConfigSet(log)
	case _KeeperRegistry12.abi.Events["FundsAdded"].ID:
		return _KeeperRegistry12.ParseFundsAdded(log)
	case _KeeperRegistry12.abi.Events["FundsWithdrawn"].ID:
		return _KeeperRegistry12.ParseFundsWithdrawn(log)
	case _KeeperRegistry12.abi.Events["KeepersUpdated"].ID:
		return _KeeperRegistry12.ParseKeepersUpdated(log)
	case _KeeperRegistry12.abi.Events["OwnerFundsWithdrawn"].ID:
		return _KeeperRegistry12.ParseOwnerFundsWithdrawn(log)
	case _KeeperRegistry12.abi.Events["OwnershipTransferRequested"].ID:
		return _KeeperRegistry12.ParseOwnershipTransferRequested(log)
	case _KeeperRegistry12.abi.Events["OwnershipTransferred"].ID:
		return _KeeperRegistry12.ParseOwnershipTransferred(log)
	case _KeeperRegistry12.abi.Events["Paused"].ID:
		return _KeeperRegistry12.ParsePaused(log)
	case _KeeperRegistry12.abi.Events["PayeeshipTransferRequested"].ID:
		return _KeeperRegistry12.ParsePayeeshipTransferRequested(log)
	case _KeeperRegistry12.abi.Events["PayeeshipTransferred"].ID:
		return _KeeperRegistry12.ParsePayeeshipTransferred(log)
	case _KeeperRegistry12.abi.Events["PaymentWithdrawn"].ID:
		return _KeeperRegistry12.ParsePaymentWithdrawn(log)
	case _KeeperRegistry12.abi.Events["Unpaused"].ID:
		return _KeeperRegistry12.ParseUnpaused(log)
	case _KeeperRegistry12.abi.Events["UpkeepCanceled"].ID:
		return _KeeperRegistry12.ParseUpkeepCanceled(log)
	case _KeeperRegistry12.abi.Events["UpkeepGasLimitSet"].ID:
		return _KeeperRegistry12.ParseUpkeepGasLimitSet(log)
	case _KeeperRegistry12.abi.Events["UpkeepMigrated"].ID:
		return _KeeperRegistry12.ParseUpkeepMigrated(log)
	case _KeeperRegistry12.abi.Events["UpkeepPerformed"].ID:
		return _KeeperRegistry12.ParseUpkeepPerformed(log)
	case _KeeperRegistry12.abi.Events["UpkeepReceived"].ID:
		return _KeeperRegistry12.ParseUpkeepReceived(log)
	case _KeeperRegistry12.abi.Events["UpkeepRegistered"].ID:
		return _KeeperRegistry12.ParseUpkeepRegistered(log)
...
func (KeeperRegistry12ConfigSet) Topic() common.Hash {
	return common.HexToHash("0xfe125a41957477226ba20f85ef30a4024ea3bb8d066521ddc16df3f2944de325")
}

func (KeeperRegistry12FundsAdded) Topic() common.Hash {
	return common.HexToHash("0xafd24114486da8ebfc32f3626dada8863652e187461aa74d4bfa734891506203")
}

func (KeeperRegistry12FundsWithdrawn) Topic() common.Hash {
	return common.HexToHash("0xf3b5906e5672f3e524854103bcafbbdba80dbdfeca2c35e116127b1060a68318")
}

func (KeeperRegistry12KeepersUpdated) Topic() common.Hash {
	return common.HexToHash("0x056264c94f28bb06c99d13f0446eb96c67c215d8d707bce2655a98ddf1c0b71f")
}

func (KeeperRegistry12OwnerFundsWithdrawn) Topic() common.Hash {
	return common.HexToHash("0x1d07d0b0be43d3e5fee41a80b579af370affee03fa595bf56d5d4c19328162f1")
}

func (KeeperRegistry12OwnershipTransferRequested) Topic() common.Hash {
	return common.HexToHash("0xed8889f560326eb138920d842192f0eb3dd22b4f139c87a2c57538e05bae1278")
}

func (KeeperRegistry12OwnershipTransferred) Topic() common.Hash {
	return common.HexToHash("0x8be0079c531659141344cd1fd0a4f28419497f9722a3daafe3b4186f6b6457e0")
}

func (KeeperRegistry12Paused) Topic() common.Hash {
	return common.HexToHash("0x62e78cea01bee320cd4e420270b5ea74000d11b0c9f74754ebdbfc544b05a258")
}

func (KeeperRegistry12PayeeshipTransferRequested) Topic() common.Hash {
	return common.HexToHash("0x84f7c7c80bb8ed2279b4aab5f61cd05e6374073d38f46d7f32de8c30e9e38367")
}

func (KeeperRegistry12PayeeshipTransferred) Topic() common.Hash {
	return common.HexToHash("0x78af32efdcad432315431e9b03d27e6cd98fb79c405fdc5af7c1714d9c0f75b3")
}

func (KeeperRegistry12PaymentWithdrawn) Topic() common.Hash {
	return common.HexToHash("0x9819093176a1851202c7bcfa46845809b4e47c261866550e94ed3775d2f40698")
}

func (KeeperRegistry12Unpaused) Topic() common.Hash {
	return common.HexToHash("0x5db9ee0a495bf2e6ff9c91a7834c1ba4fdd244a5e8aa4e537bd38aeae4b073aa")
}

func (KeeperRegistry12UpkeepCanceled) Topic() common.Hash {
	return common.HexToHash("0x91cb3bb75cfbd718bbfccc56b7f53d92d7048ef4ca39a3b7b7c6d4af1f791181")
}

func (KeeperRegistry12UpkeepGasLimitSet) Topic() common.Hash {
	return common.HexToHash("0xc24c07e655ce79fba8a589778987d3c015bc6af1632bb20cf9182e02a65d972c")
}

func (KeeperRegistry12UpkeepMigrated) Topic() common.Hash {
	return common.HexToHash("0xb38647142fbb1ea4c000fc4569b37a4e9a9f6313317b84ee3e5326c1a6cd06ff")
}

func (KeeperRegistry12UpkeepPerformed) Topic() common.Hash {
	return common.HexToHash("0xcaacad83e47cc45c280d487ec84184eee2fa3b54ebaa393bda7549f13da228f6")
}

func (KeeperRegistry12UpkeepReceived) Topic() common.Hash {
	return common.HexToHash("0x74931a144e43a50694897f241d973aecb5024c0e910f9bb80a163ea3c1cf5a71")
}

func (KeeperRegistry12UpkeepRegistered) Topic() common.Hash {
	return common.HexToHash("0xbae366358c023f887e791d7a62f2e4316f1026bd77f6fb49501a917b3bc5d012")
}

func (_KeeperRegistry12 *KeeperRegistry12) Address() common.Address {
	return _KeeperRegistry12.address
}

type KeeperRegistry12Interface interface {
	...
	FilterConfigSet(opts *bind.FilterOpts) (*KeeperRegistry12ConfigSetIterator, error)

	WatchConfigSet(opts *bind.WatchOpts, sink chan<- *KeeperRegistry12ConfigSet) (event.Subscription, error)

	ParseConfigSet(log types.Log) (*KeeperRegistry12ConfigSet, error)

	FilterFundsAdded(opts *bind.FilterOpts, id []*big.Int, from []common.Address) (*KeeperRegistry12FundsAddedIterator, error)

	WatchFundsAdded(opts *bind.WatchOpts, sink chan<- *KeeperRegistry12FundsAdded, id []*big.Int, from []common.Address) (event.Subscription, error)

	ParseFundsAdded(log types.Log) (*KeeperRegistry12FundsAdded, error)

	FilterFundsWithdrawn(opts *bind.FilterOpts, id []*big.Int) (*KeeperRegistry12FundsWithdrawnIterator, error)

	WatchFundsWithdrawn(opts *bind.WatchOpts, sink chan<- *KeeperRegistry12FundsWithdrawn, id []*big.Int) (event.Subscription, error)

	ParseFundsWithdrawn(log types.Log) (*KeeperRegistry12FundsWithdrawn, error)

	FilterKeepersUpdated(opts *bind.FilterOpts) (*KeeperRegistry12KeepersUpdatedIterator, error)

	WatchKeepersUpdated(opts *bind.WatchOpts, sink chan<- *KeeperRegistry12KeepersUpdated) (event.Subscription, error)

	ParseKeepersUpdated(log types.Log) (*KeeperRegistry12KeepersUpdated, error)

	FilterOwnerFundsWithdrawn(opts *bind.FilterOpts) (*KeeperRegistry12OwnerFundsWithdrawnIterator, error)

	WatchOwnerFundsWithdrawn(opts *bind.WatchOpts, sink chan<- *KeeperRegistry12OwnerFundsWithdrawn) (event.Subscription, error)

	ParseOwnerFundsWithdrawn(log types.Log) (*KeeperRegistry12OwnerFundsWithdrawn, error)

	FilterOwnershipTransferRequested(opts *bind.FilterOpts, from []common.Address, to []common.Address) (*KeeperRegistry12OwnershipTransferRequestedIterator, error)

	WatchOwnershipTransferRequested(opts *bind.WatchOpts, sink chan<- *KeeperRegistry12OwnershipTransferRequested, from []common.Address, to []common.Address) (event.Subscription, error)

	ParseOwnershipTransferRequested(log types.Log) (*KeeperRegistry12OwnershipTransferRequested, error)

	FilterOwnershipTransferred(opts *bind.FilterOpts, from []common.Address, to []common.Address) (*KeeperRegistry12OwnershipTransferredIterator, error)

	WatchOwnershipTransferred(opts *bind.WatchOpts, sink chan<- *KeeperRegistry12OwnershipTransferred, from []common.Address, to []common.Address) (event.Subscription, error)

	ParseOwnershipTransferred(log types.Log) (*KeeperRegistry12OwnershipTransferred, error)

	FilterPaused(opts *bind.FilterOpts) (*KeeperRegistry12PausedIterator, error)

	WatchPaused(opts *bind.WatchOpts, sink chan<- *KeeperRegistry12Paused) (event.Subscription, error)

	ParsePaused(log types.Log) (*KeeperRegistry12Paused, error)

	FilterPayeeshipTransferRequested(opts *bind.FilterOpts, keeper []common.Address, from []common.Address, to []common.Address) (*KeeperRegistry12PayeeshipTransferRequestedIterator, error)

	WatchPayeeshipTransferRequested(opts *bind.WatchOpts, sink chan<- *KeeperRegistry12PayeeshipTransferRequested, keeper []common.Address, from []common.Address, to []common.Address) (event.Subscription, error)

	ParsePayeeshipTransferRequested(log types.Log) (*KeeperRegistry12PayeeshipTransferRequested, error)

	FilterPayeeshipTransferred(opts *bind.FilterOpts, keeper []common.Address, from []common.Address, to []common.Address) (*KeeperRegistry12PayeeshipTransferredIterator, error)

	WatchPayeeshipTransferred(opts *bind.WatchOpts, sink chan<- *KeeperRegistry12PayeeshipTransferred, keeper []common.Address, from []common.Address, to []common.Address) (event.Subscription, error)

	ParsePayeeshipTransferred(log types.Log) (*KeeperRegistry12PayeeshipTransferred, error)

	FilterPaymentWithdrawn(opts *bind.FilterOpts, keeper []common.Address, amount []*big.Int, to []common.Address) (*KeeperRegistry12PaymentWithdrawnIterator, error)

	WatchPaymentWithdrawn(opts *bind.WatchOpts, sink chan<- *KeeperRegistry12PaymentWithdrawn, keeper []common.Address, amount []*big.Int, to []common.Address) (event.Subscription, error)

	ParsePaymentWithdrawn(log types.Log) (*KeeperRegistry12PaymentWithdrawn, error)

	FilterUnpaused(opts *bind.FilterOpts) (*KeeperRegistry12UnpausedIterator, error)

	WatchUnpaused(opts *bind.WatchOpts, sink chan<- *KeeperRegistry12Unpaused) (event.Subscription, error)

	ParseUnpaused(log types.Log) (*KeeperRegistry12Unpaused, error)

	FilterUpkeepCanceled(opts *bind.FilterOpts, id []*big.Int, atBlockHeight []uint64) (*KeeperRegistry12UpkeepCanceledIterator, error)

	WatchUpkeepCanceled(opts *bind.WatchOpts, sink chan<- *KeeperRegistry12UpkeepCanceled, id []*big.Int, atBlockHeight []uint64) (event.Subscription, error)

	ParseUpkeepCanceled(log types.Log) (*KeeperRegistry12UpkeepCanceled, error)

	FilterUpkeepGasLimitSet(opts *bind.FilterOpts, id []*big.Int) (*KeeperRegistry12UpkeepGasLimitSetIterator, error)

	WatchUpkeepGasLimitSet(opts *bind.WatchOpts, sink chan<- *KeeperRegistry12UpkeepGasLimitSet, id []*big.Int) (event.Subscription, error)

	ParseUpkeepGasLimitSet(log types.Log) (*KeeperRegistry12UpkeepGasLimitSet, error)

	FilterUpkeepMigrated(opts *bind.FilterOpts, id []*big.Int) (*KeeperRegistry12UpkeepMigratedIterator, error)

	WatchUpkeepMigrated(opts *bind.WatchOpts, sink chan<- *KeeperRegistry12UpkeepMigrated, id []*big.Int) (event.Subscription, error)

	ParseUpkeepMigrated(log types.Log) (*KeeperRegistry12UpkeepMigrated, error)

	FilterUpkeepPerformed(opts *bind.FilterOpts, id []*big.Int, success []bool, from []common.Address) (*KeeperRegistry12UpkeepPerformedIterator, error)

	WatchUpkeepPerformed(opts *bind.WatchOpts, sink chan<- *KeeperRegistry12UpkeepPerformed, id []*big.Int, success []bool, from []common.Address) (event.Subscription, error)

	ParseUpkeepPerformed(log types.Log) (*KeeperRegistry12UpkeepPerformed, error)

	FilterUpkeepReceived(opts *bind.FilterOpts, id []*big.Int) (*KeeperRegistry12UpkeepReceivedIterator, error)

	WatchUpkeepReceived(opts *bind.WatchOpts, sink chan<- *KeeperRegistry12UpkeepReceived, id []*big.Int) (event.Subscription, error)

	ParseUpkeepReceived(log types.Log) (*KeeperRegistry12UpkeepReceived, error)

	FilterUpkeepRegistered(opts *bind.FilterOpts, id []*big.Int) (*KeeperRegistry12UpkeepRegisteredIterator, error)

	WatchUpkeepRegistered(opts *bind.WatchOpts, sink chan<- *KeeperRegistry12UpkeepRegistered, id []*big.Int) (event.Subscription, error)

	ParseUpkeepRegistered(log types.Log) (*KeeperRegistry12UpkeepRegistered, error)
