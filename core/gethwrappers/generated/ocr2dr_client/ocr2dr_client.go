...
func (_OCR2DRClient *OCR2DRClientCaller) EstimateCost(opts *bind.CallOpts, req OCR2DRRequest, subscriptionId uint64, gasLimit uint32) (*big.Int, error) {
	var out []interface{}
	err := _OCR2DRClient.contract.Call(opts, &out, "estimateCost", req, subscriptionId, gasLimit)
...
func (_OCR2DRClient *OCR2DRClientSession) EstimateCost(req OCR2DRRequest, subscriptionId uint64, gasLimit uint32) (*big.Int, error) {
	return _OCR2DRClient.Contract.EstimateCost(&_OCR2DRClient.CallOpts, req, subscriptionId, gasLimit)
}

func (_OCR2DRClient *OCR2DRClientCallerSession) EstimateCost(req OCR2DRRequest, subscriptionId uint64, gasLimit uint32) (*big.Int, error) {
	return _OCR2DRClient.Contract.EstimateCost(&_OCR2DRClient.CallOpts, req, subscriptionId, gasLimit)
}
