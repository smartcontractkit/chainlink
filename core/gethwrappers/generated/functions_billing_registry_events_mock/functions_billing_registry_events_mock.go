...
type FunctionsBillingRegistryEventsMockFunctionsBillingRegistryCommitment struct {
...
func (_FunctionsBillingRegistryEventsMock *FunctionsBillingRegistryEventsMockTransactor) EmitBillingStart(opts *bind.TransactOpts, requestId [32]byte, commitment FunctionsBillingRegistryEventsMockFunctionsBillingRegistryCommitment) (*types.Transaction, error) {
	return _FunctionsBillingRegistryEventsMock.contract.Transact(opts, "emitBillingStart", requestId, commitment)
}

func (_FunctionsBillingRegistryEventsMock *FunctionsBillingRegistryEventsMockSession) EmitBillingStart(requestId [32]byte, commitment FunctionsBillingRegistryEventsMockFunctionsBillingRegistryCommitment) (*types.Transaction, error) {
...
func (_FunctionsBillingRegistryEventsMock *FunctionsBillingRegistryEventsMockTransactorSession) EmitBillingStart(requestId [32]byte, commitment FunctionsBillingRegistryEventsMockFunctionsBillingRegistryCommitment) (*types.Transaction, error) {
	return _FunctionsBillingRegistryEventsMock.Contract.EmitBillingStart(&_FunctionsBillingRegistryEventsMock.TransactOpts, requestId, commitment)
}
...
type FunctionsBillingRegistryEventsMockBillingStart struct {
	RequestId  [32]byte
	Commitment FunctionsBillingRegistryEventsMockFunctionsBillingRegistryCommitment
	Raw        types.Log
}
...
type FunctionsBillingRegistryEventsMockInterface interface {
	...
	EmitBillingStart(opts *bind.TransactOpts, requestId [32]byte, commitment FunctionsBillingRegistryEventsMockFunctionsBillingRegistryCommitment) (*types.Transaction, error)
