...
func (_IKeeperRegistryMaster *IKeeperRegistryMasterCaller) GetUpkeepAdministrativeConfig(opts *bind.CallOpts, upkeepId *big.Int) ([]byte, error) {
	var out []interface{}
	err := _IKeeperRegistryMaster.contract.Call(opts, &out, "getUpkeepAdministrativeConfig", upkeepId)
...
func (_IKeeperRegistryMaster *IKeeperRegistryMasterSession) GetUpkeepAdministrativeConfig(upkeepId *big.Int) ([]byte, error) {
	return _IKeeperRegistryMaster.Contract.GetUpkeepAdministrativeConfig(&_IKeeperRegistryMaster.CallOpts, upkeepId)
}

func (_IKeeperRegistryMaster *IKeeperRegistryMasterCallerSession) GetUpkeepAdministrativeConfig(upkeepId *big.Int) ([]byte, error) {
	return _IKeeperRegistryMaster.Contract.GetUpkeepAdministrativeConfig(&_IKeeperRegistryMaster.CallOpts, upkeepId)
}
...
func (_IKeeperRegistryMaster *IKeeperRegistryMasterTransactor) SetUpkeepAdministrativeConfig(opts *bind.TransactOpts, upkeepId *big.Int, newAdministrativeConfig []byte) (*types.Transaction, error) {
	return _IKeeperRegistryMaster.contract.Transact(opts, "setUpkeepAdministrativeConfig", upkeepId, newAdministrativeConfig)
}

func (_IKeeperRegistryMaster *IKeeperRegistryMasterSession) SetUpkeepAdministrativeConfig(upkeepId *big.Int, newAdministrativeConfig []byte) (*types.Transaction, error) {
	return _IKeeperRegistryMaster.Contract.SetUpkeepAdministrativeConfig(&_IKeeperRegistryMaster.TransactOpts, upkeepId, newAdministrativeConfig)
}

func (_IKeeperRegistryMaster *IKeeperRegistryMasterTransactorSession) SetUpkeepAdministrativeConfig(upkeepId *big.Int, newAdministrativeConfig []byte) (*types.Transaction, error) {
	return _IKeeperRegistryMaster.Contract.SetUpkeepAdministrativeConfig(&_IKeeperRegistryMaster.TransactOpts, upkeepId, newAdministrativeConfig)
}
...
type IKeeperRegistryMasterUpkeepAdministrativeConfigSetIterator struct {
	Event *IKeeperRegistryMasterUpkeepAdministrativeConfigSet
...
func (it *IKeeperRegistryMasterUpkeepAdministrativeConfigSetIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(IKeeperRegistryMasterUpkeepAdministrativeConfigSet)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
func (it *IKeeperRegistryMasterUpkeepAdministrativeConfigSetIterator) Error() error {
	return it.fail
}

func (it *IKeeperRegistryMasterUpkeepAdministrativeConfigSetIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

type IKeeperRegistryMasterUpkeepAdministrativeConfigSet struct {
	Id                   *big.Int
	AdministrativeConfig []byte
	Raw                  types.Log
}

func (_IKeeperRegistryMaster *IKeeperRegistryMasterFilterer) FilterUpkeepAdministrativeConfigSet(opts *bind.FilterOpts, id []*big.Int) (*IKeeperRegistryMasterUpkeepAdministrativeConfigSetIterator, error) {
	...
	logs, sub, err := _IKeeperRegistryMaster.contract.FilterLogs(opts, "UpkeepAdministrativeConfigSet", idRule)
	if err != nil {
		return nil, err
	}
	return &IKeeperRegistryMasterUpkeepAdministrativeConfigSetIterator{contract: _IKeeperRegistryMaster.contract, event: "UpkeepAdministrativeConfigSet", logs: logs, sub: sub}, nil
}

func (_IKeeperRegistryMaster *IKeeperRegistryMasterFilterer) WatchUpkeepAdministrativeConfigSet(opts *bind.WatchOpts, sink chan<- *IKeeperRegistryMasterUpkeepAdministrativeConfigSet, id []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _IKeeperRegistryMaster.contract.WatchLogs(opts, "UpkeepAdministrativeConfigSet", idRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(IKeeperRegistryMasterUpkeepAdministrativeConfigSet)
				if err := _IKeeperRegistryMaster.contract.UnpackLog(event, "UpkeepAdministrativeConfigSet", log); err != nil {
					return err
				}
				event.Raw = log
...
func (_IKeeperRegistryMaster *IKeeperRegistryMasterFilterer) ParseUpkeepAdministrativeConfigSet(log types.Log) (*IKeeperRegistryMasterUpkeepAdministrativeConfigSet, error) {
	event := new(IKeeperRegistryMasterUpkeepAdministrativeConfigSet)
	if err := _IKeeperRegistryMaster.contract.UnpackLog(event, "UpkeepAdministrativeConfigSet", log); err != nil {
		return nil, err
	}
...
func (_IKeeperRegistryMaster *IKeeperRegistryMaster) ParseLog(log types.Log) (generated.AbigenLog, error) {
	...
	case _IKeeperRegistryMaster.abi.Events["UpkeepAdministrativeConfigSet"].ID:
		return _IKeeperRegistryMaster.ParseUpkeepAdministrativeConfigSet(log)
...
func (IKeeperRegistryMasterUpkeepAdministrativeConfigSet) Topic() common.Hash {
...
type IKeeperRegistryMasterInterface interface {
	...
	FilterUpkeepAdministrativeConfigSet(opts *bind.FilterOpts, id []*big.Int) (*IKeeperRegistryMasterUpkeepAdministrativeConfigSetIterator, error)

	WatchUpkeepAdministrativeConfigSet(opts *bind.WatchOpts, sink chan<- *IKeeperRegistryMasterUpkeepAdministrativeConfigSet, id []*big.Int) (event.Subscription, error)

	ParseUpkeepAdministrativeConfigSet(log types.Log) (*IKeeperRegistryMasterUpkeepAdministrativeConfigSet, error)
