...
func (_IKeeperRegistryMaster *IKeeperRegistryMasterTransactor) RegisterUpkeep(opts *bind.TransactOpts, target common.Address, gasLimit uint32, admin common.Address, checkData []byte, offchainConfig []byte) (*types.Transaction, error) {
	return _IKeeperRegistryMaster.contract.Transact(opts, "registerUpkeep", target, gasLimit, admin, checkData, offchainConfig)
}

func (_IKeeperRegistryMaster *IKeeperRegistryMasterSession) RegisterUpkeep(target common.Address, gasLimit uint32, admin common.Address, checkData []byte, offchainConfig []byte) (*types.Transaction, error) {
	return _IKeeperRegistryMaster.Contract.RegisterUpkeep(&_IKeeperRegistryMaster.TransactOpts, target, gasLimit, admin, checkData, offchainConfig)
}

func (_IKeeperRegistryMaster *IKeeperRegistryMasterTransactorSession) RegisterUpkeep(target common.Address, gasLimit uint32, admin common.Address, checkData []byte, offchainConfig []byte) (*types.Transaction, error) {
	return _IKeeperRegistryMaster.Contract.RegisterUpkeep(&_IKeeperRegistryMaster.TransactOpts, target, gasLimit, admin, checkData, offchainConfig)
}
...
func (_IKeeperRegistryMaster *IKeeperRegistryMasterTransactor) ValidateTrigger(opts *bind.TransactOpts, triggerType uint8, offchainConfig []byte) (*types.Transaction, error) {
	return _IKeeperRegistryMaster.contract.Transact(opts, "validateTrigger", triggerType, offchainConfig)
}

func (_IKeeperRegistryMaster *IKeeperRegistryMasterSession) ValidateTrigger(triggerType uint8, offchainConfig []byte) (*types.Transaction, error) {
	return _IKeeperRegistryMaster.Contract.ValidateTrigger(&_IKeeperRegistryMaster.TransactOpts, triggerType, offchainConfig)
}

func (_IKeeperRegistryMaster *IKeeperRegistryMasterTransactorSession) ValidateTrigger(triggerType uint8, offchainConfig []byte) (*types.Transaction, error) {
	return _IKeeperRegistryMaster.Contract.ValidateTrigger(&_IKeeperRegistryMaster.TransactOpts, triggerType, offchainConfig)
}
...
type IKeeperRegistryMasterInterface interface {
	...
	ValidateTrigger(opts *bind.TransactOpts, triggerType uint8, offchainConfig []byte) (*types.Transaction, error)
