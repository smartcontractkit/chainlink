...
type KeeperRegistryBase21TriggerData struct {
	TxHash    [32]byte
	LogIndex  uint32
	BlockNum  uint32
	BlockHash [32]byte
...
type IKeeperRegistryMasterCancelledUpkeepReport struct {
	Id      *big.Int
	Trigger KeeperRegistryBase21TriggerData
	Raw     types.Log
}
...
func (IKeeperRegistryMasterCancelledUpkeepReport) Topic() common.Hash {
	return common.HexToHash("0x21be0907d76610cf0b5833992804aaa6a9f379a345571d6f84af5ba217a4b7bc")
}
...
func (IKeeperRegistryMasterInsufficientFundsUpkeepReport) Topic() common.Hash {
	return common.HexToHash("0xeca412aef6bdf165fdf90c01546b136066ce5ecd615d289d429fee612b6469d3")
}
...
func (IKeeperRegistryMasterReorgedUpkeepReport) Topic() common.Hash {
	return common.HexToHash("0xc07dd01b164b85178d2bc44f223b01eaac824997a5fe84055f551c6644c3b29a")
}

func (IKeeperRegistryMasterStaleUpkeepReport) Topic() common.Hash {
	return common.HexToHash("0x812360806ec61fbdcfbc49c4c2f2c7c44141fc5be609be8b173a36f41163886a")
}
...
func (IKeeperRegistryMasterUpkeepPerformed) Topic() common.Hash {
	return common.HexToHash("0xc7f9dbe1100cb3b2516d0610d2b17eb1ccbdfdca31a658ef4d0d7d517d1339db")
}
