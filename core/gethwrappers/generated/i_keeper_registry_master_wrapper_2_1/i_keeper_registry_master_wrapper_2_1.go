...
func (_IKeeperRegistryMaster *IKeeperRegistryMasterCaller) GetCheckGasOverhead(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _IKeeperRegistryMaster.contract.Call(opts, &out, "getCheckGasOverhead")
...
func (_IKeeperRegistryMaster *IKeeperRegistryMasterSession) GetCheckGasOverhead() (*big.Int, error) {
	return _IKeeperRegistryMaster.Contract.GetCheckGasOverhead(&_IKeeperRegistryMaster.CallOpts)
}

func (_IKeeperRegistryMaster *IKeeperRegistryMasterCallerSession) GetCheckGasOverhead() (*big.Int, error) {
	return _IKeeperRegistryMaster.Contract.GetCheckGasOverhead(&_IKeeperRegistryMaster.CallOpts)
}
...
func (_IKeeperRegistryMaster *IKeeperRegistryMasterCaller) GetTransmitGasOverhead(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _IKeeperRegistryMaster.contract.Call(opts, &out, "getTransmitGasOverhead")
...
func (_IKeeperRegistryMaster *IKeeperRegistryMasterSession) GetTransmitGasOverhead() (*big.Int, error) {
	return _IKeeperRegistryMaster.Contract.GetTransmitGasOverhead(&_IKeeperRegistryMaster.CallOpts)
}

func (_IKeeperRegistryMaster *IKeeperRegistryMasterCallerSession) GetTransmitGasOverhead() (*big.Int, error) {
	return _IKeeperRegistryMaster.Contract.GetTransmitGasOverhead(&_IKeeperRegistryMaster.CallOpts)
}
...
func (_IKeeperRegistryMaster *IKeeperRegistryMasterTransactor) CheckUpkeep(opts *bind.TransactOpts, id *big.Int, triggerData []byte) (*types.Transaction, error) {
	return _IKeeperRegistryMaster.contract.Transact(opts, "checkUpkeep", id, triggerData)
}

func (_IKeeperRegistryMaster *IKeeperRegistryMasterSession) CheckUpkeep(id *big.Int, triggerData []byte) (*types.Transaction, error) {
	return _IKeeperRegistryMaster.Contract.CheckUpkeep(&_IKeeperRegistryMaster.TransactOpts, id, triggerData)
}

func (_IKeeperRegistryMaster *IKeeperRegistryMasterTransactorSession) CheckUpkeep(id *big.Int, triggerData []byte) (*types.Transaction, error) {
	return _IKeeperRegistryMaster.Contract.CheckUpkeep(&_IKeeperRegistryMaster.TransactOpts, id, triggerData)
}
...
func (_IKeeperRegistryMaster *IKeeperRegistryMasterTransactor) SetConfig(opts *bind.TransactOpts, signers []common.Address, transmitters []common.Address, f uint8, onchainConfig KeeperRegistryBase21OnchainConfig, offchainConfigVersion uint64, offchainConfig []byte) (*types.Transaction, error) {
...
func (_IKeeperRegistryMaster *IKeeperRegistryMasterSession) SetConfig(signers []common.Address, transmitters []common.Address, f uint8, onchainConfig KeeperRegistryBase21OnchainConfig, offchainConfigVersion uint64, offchainConfig []byte) (*types.Transaction, error) {
...
func (_IKeeperRegistryMaster *IKeeperRegistryMasterTransactorSession) SetConfig(signers []common.Address, transmitters []common.Address, f uint8, onchainConfig KeeperRegistryBase21OnchainConfig, offchainConfigVersion uint64, offchainConfig []byte) (*types.Transaction, error) {
	return _IKeeperRegistryMaster.Contract.SetConfig(&_IKeeperRegistryMaster.TransactOpts, signers, transmitters, f, onchainConfig, offchainConfigVersion, offchainConfig)
}

func (_IKeeperRegistryMaster *IKeeperRegistryMasterTransactor) SetConfig0(opts *bind.TransactOpts, signers []common.Address, transmitters []common.Address, f uint8, onchainConfigBytes []byte, offchainConfigVersion uint64, offchainConfig []byte) (*types.Transaction, error) {
	return _IKeeperRegistryMaster.contract.Transact(opts, "setConfig0", signers, transmitters, f, onchainConfigBytes, offchainConfigVersion, offchainConfig)
}

func (_IKeeperRegistryMaster *IKeeperRegistryMasterSession) SetConfig0(signers []common.Address, transmitters []common.Address, f uint8, onchainConfigBytes []byte, offchainConfigVersion uint64, offchainConfig []byte) (*types.Transaction, error) {
	return _IKeeperRegistryMaster.Contract.SetConfig0(&_IKeeperRegistryMaster.TransactOpts, signers, transmitters, f, onchainConfigBytes, offchainConfigVersion, offchainConfig)
}

func (_IKeeperRegistryMaster *IKeeperRegistryMasterTransactorSession) SetConfig0(signers []common.Address, transmitters []common.Address, f uint8, onchainConfigBytes []byte, offchainConfigVersion uint64, offchainConfig []byte) (*types.Transaction, error) {
	return _IKeeperRegistryMaster.Contract.SetConfig0(&_IKeeperRegistryMaster.TransactOpts, signers, transmitters, f, onchainConfigBytes, offchainConfigVersion, offchainConfig)
}
