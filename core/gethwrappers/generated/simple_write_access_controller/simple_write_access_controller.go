...
package simple_write_access_controller
...
var SimpleWriteAccessControllerMetaData = &bind.MetaData{
	...
	Bin: "",
}
...
func NewSimpleWriteAccessController(address common.Address, backend bind.ContractBackend) (*SimpleWriteAccessController, error) {
	abi, err := abi.JSON(strings.NewReader(SimpleWriteAccessControllerABI))
	if err != nil {
		return nil, err
	}
	...
	return &SimpleWriteAccessController{address: address, abi: abi, SimpleWriteAccessControllerCaller: SimpleWriteAccessControllerCaller{contract: contract}, SimpleWriteAccessControllerTransactor: SimpleWriteAccessControllerTransactor{contract: contract}, SimpleWriteAccessControllerFilterer: SimpleWriteAccessControllerFilterer{contract: contract}}, nil
}
...
func (_SimpleWriteAccessController *SimpleWriteAccessController) ParseLog(log types.Log) (generated.AbigenLog, error) {
	switch log.Topics[0] {
	case _SimpleWriteAccessController.abi.Events["AddedAccess"].ID:
		return _SimpleWriteAccessController.ParseAddedAccess(log)
	case _SimpleWriteAccessController.abi.Events["CheckAccessDisabled"].ID:
		return _SimpleWriteAccessController.ParseCheckAccessDisabled(log)
	case _SimpleWriteAccessController.abi.Events["CheckAccessEnabled"].ID:
		return _SimpleWriteAccessController.ParseCheckAccessEnabled(log)
	case _SimpleWriteAccessController.abi.Events["OwnershipTransferRequested"].ID:
		return _SimpleWriteAccessController.ParseOwnershipTransferRequested(log)
	case _SimpleWriteAccessController.abi.Events["OwnershipTransferred"].ID:
		return _SimpleWriteAccessController.ParseOwnershipTransferred(log)
	case _SimpleWriteAccessController.abi.Events["RemovedAccess"].ID:
		return _SimpleWriteAccessController.ParseRemovedAccess(log)
...
func (SimpleWriteAccessControllerAddedAccess) Topic() common.Hash {
	return common.HexToHash("0x87286ad1f399c8e82bf0c4ef4fcdc570ea2e1e92176e5c848b6413545b885db4")
}

func (SimpleWriteAccessControllerCheckAccessDisabled) Topic() common.Hash {
	return common.HexToHash("0x3be8a977a014527b50ae38adda80b56911c267328965c98ddc385d248f539638")
}

func (SimpleWriteAccessControllerCheckAccessEnabled) Topic() common.Hash {
	return common.HexToHash("0xaebf329500988c6488a0074e5a0a9ff304561fc5c6fc877aeb1d59c8282c3480")
}

func (SimpleWriteAccessControllerOwnershipTransferRequested) Topic() common.Hash {
	return common.HexToHash("0xed8889f560326eb138920d842192f0eb3dd22b4f139c87a2c57538e05bae1278")
}

func (SimpleWriteAccessControllerOwnershipTransferred) Topic() common.Hash {
	return common.HexToHash("0x8be0079c531659141344cd1fd0a4f28419497f9722a3daafe3b4186f6b6457e0")
}

func (SimpleWriteAccessControllerRemovedAccess) Topic() common.Hash {
	return common.HexToHash("0x3d68a6fce901d20453d1a7aa06bf3950302a735948037deb182a8db66df2a0d1")
}

func (_SimpleWriteAccessController *SimpleWriteAccessController) Address() common.Address {
	return _SimpleWriteAccessController.address
}

type SimpleWriteAccessControllerInterface interface {
	...
	FilterAddedAccess(opts *bind.FilterOpts) (*SimpleWriteAccessControllerAddedAccessIterator, error)

	WatchAddedAccess(opts *bind.WatchOpts, sink chan<- *SimpleWriteAccessControllerAddedAccess) (event.Subscription, error)

	ParseAddedAccess(log types.Log) (*SimpleWriteAccessControllerAddedAccess, error)

	FilterCheckAccessDisabled(opts *bind.FilterOpts) (*SimpleWriteAccessControllerCheckAccessDisabledIterator, error)

	WatchCheckAccessDisabled(opts *bind.WatchOpts, sink chan<- *SimpleWriteAccessControllerCheckAccessDisabled) (event.Subscription, error)

	ParseCheckAccessDisabled(log types.Log) (*SimpleWriteAccessControllerCheckAccessDisabled, error)

	FilterCheckAccessEnabled(opts *bind.FilterOpts) (*SimpleWriteAccessControllerCheckAccessEnabledIterator, error)

	WatchCheckAccessEnabled(opts *bind.WatchOpts, sink chan<- *SimpleWriteAccessControllerCheckAccessEnabled) (event.Subscription, error)

	ParseCheckAccessEnabled(log types.Log) (*SimpleWriteAccessControllerCheckAccessEnabled, error)

	FilterOwnershipTransferRequested(opts *bind.FilterOpts, from []common.Address, to []common.Address) (*SimpleWriteAccessControllerOwnershipTransferRequestedIterator, error)

	WatchOwnershipTransferRequested(opts *bind.WatchOpts, sink chan<- *SimpleWriteAccessControllerOwnershipTransferRequested, from []common.Address, to []common.Address) (event.Subscription, error)

	ParseOwnershipTransferRequested(log types.Log) (*SimpleWriteAccessControllerOwnershipTransferRequested, error)

	FilterOwnershipTransferred(opts *bind.FilterOpts, from []common.Address, to []common.Address) (*SimpleWriteAccessControllerOwnershipTransferredIterator, error)

	WatchOwnershipTransferred(opts *bind.WatchOpts, sink chan<- *SimpleWriteAccessControllerOwnershipTransferred, from []common.Address, to []common.Address) (event.Subscription, error)

	ParseOwnershipTransferred(log types.Log) (*SimpleWriteAccessControllerOwnershipTransferred, error)

	FilterRemovedAccess(opts *bind.FilterOpts) (*SimpleWriteAccessControllerRemovedAccessIterator, error)

	WatchRemovedAccess(opts *bind.WatchOpts, sink chan<- *SimpleWriteAccessControllerRemovedAccess) (event.Subscription, error)

	ParseRemovedAccess(log types.Log) (*SimpleWriteAccessControllerRemovedAccess, error)
