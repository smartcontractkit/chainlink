...
func DeployKeeperRegistry20(auth *bind.TransactOpts, backend bind.ContractBackend, keeperRegistryLogic common.Address) (common.Address, *types.Transaction, *KeeperRegistry20, error) {
	...
	return address, tx, &KeeperRegistry20{address: address, abi: *parsed, KeeperRegistry20Caller: KeeperRegistry20Caller{contract: contract}, KeeperRegistry20Transactor: KeeperRegistry20Transactor{contract: contract}, KeeperRegistry20Filterer: KeeperRegistry20Filterer{contract: contract}}, nil
}

type KeeperRegistry20 struct {
	address common.Address
	abi     abi.ABI
	KeeperRegistry20Caller
	KeeperRegistry20Transactor
	KeeperRegistry20Filterer
}
...
func NewKeeperRegistry20(address common.Address, backend bind.ContractBackend) (*KeeperRegistry20, error) {
	abi, err := abi.JSON(strings.NewReader(KeeperRegistry20ABI))
	if err != nil {
		return nil, err
	}
	...
	return &KeeperRegistry20{address: address, abi: abi, KeeperRegistry20Caller: KeeperRegistry20Caller{contract: contract}, KeeperRegistry20Transactor: KeeperRegistry20Transactor{contract: contract}, KeeperRegistry20Filterer: KeeperRegistry20Filterer{contract: contract}}, nil
}
...
func (_KeeperRegistry20 *KeeperRegistry20Caller) GetMode(opts *bind.CallOpts) (uint8, error) {
	var out []interface{}
	err := _KeeperRegistry20.contract.Call(opts, &out, "getMode")
...
func (_KeeperRegistry20 *KeeperRegistry20Session) GetMode() (uint8, error) {
	return _KeeperRegistry20.Contract.GetMode(&_KeeperRegistry20.CallOpts)
}

func (_KeeperRegistry20 *KeeperRegistry20CallerSession) GetMode() (uint8, error) {
	return _KeeperRegistry20.Contract.GetMode(&_KeeperRegistry20.CallOpts)
}
...
func (_KeeperRegistry20 *KeeperRegistry20Caller) GetSignerInfo(opts *bind.CallOpts, query common.Address) (GetSignerInfo,
...
func (_KeeperRegistry20 *KeeperRegistry20Session) GetSignerInfo(query common.Address) (GetSignerInfo,

	error) {
	return _KeeperRegistry20.Contract.GetSignerInfo(&_KeeperRegistry20.CallOpts, query)
}

func (_KeeperRegistry20 *KeeperRegistry20CallerSession) GetSignerInfo(query common.Address) (GetSignerInfo,

	error) {
	return _KeeperRegistry20.Contract.GetSignerInfo(&_KeeperRegistry20.CallOpts, query)
}

func (_KeeperRegistry20 *KeeperRegistry20Caller) GetState(opts *bind.CallOpts) (GetState,
...
func (_KeeperRegistry20 *KeeperRegistry20Session) GetState() (GetState,

	error) {
	return _KeeperRegistry20.Contract.GetState(&_KeeperRegistry20.CallOpts)
}

func (_KeeperRegistry20 *KeeperRegistry20CallerSession) GetState() (GetState,

	error) {
	return _KeeperRegistry20.Contract.GetState(&_KeeperRegistry20.CallOpts)
}

func (_KeeperRegistry20 *KeeperRegistry20Caller) GetTransmitterInfo(opts *bind.CallOpts, query common.Address) (GetTransmitterInfo,
...
func (_KeeperRegistry20 *KeeperRegistry20Session) GetTransmitterInfo(query common.Address) (GetTransmitterInfo,

	error) {
	return _KeeperRegistry20.Contract.GetTransmitterInfo(&_KeeperRegistry20.CallOpts, query)
}

func (_KeeperRegistry20 *KeeperRegistry20CallerSession) GetTransmitterInfo(query common.Address) (GetTransmitterInfo,
...
func (_KeeperRegistry20 *KeeperRegistry20Caller) LatestConfigDetails(opts *bind.CallOpts) (LatestConfigDetails,
...
func (_KeeperRegistry20 *KeeperRegistry20Session) LatestConfigDetails() (LatestConfigDetails,

	error) {
	return _KeeperRegistry20.Contract.LatestConfigDetails(&_KeeperRegistry20.CallOpts)
}

func (_KeeperRegistry20 *KeeperRegistry20CallerSession) LatestConfigDetails() (LatestConfigDetails,

	error) {
	return _KeeperRegistry20.Contract.LatestConfigDetails(&_KeeperRegistry20.CallOpts)
}

func (_KeeperRegistry20 *KeeperRegistry20Caller) LatestConfigDigestAndEpoch(opts *bind.CallOpts) (LatestConfigDigestAndEpoch,
...
func (_KeeperRegistry20 *KeeperRegistry20Session) LatestConfigDigestAndEpoch() (LatestConfigDigestAndEpoch,

	error) {
	return _KeeperRegistry20.Contract.LatestConfigDigestAndEpoch(&_KeeperRegistry20.CallOpts)
}

func (_KeeperRegistry20 *KeeperRegistry20CallerSession) LatestConfigDigestAndEpoch() (LatestConfigDigestAndEpoch,
...
func (_KeeperRegistry20 *KeeperRegistry20Caller) UpkeepVersion(opts *bind.CallOpts) (uint8, error) {
	var out []interface{}
	err := _KeeperRegistry20.contract.Call(opts, &out, "upkeepVersion")
...
func (_KeeperRegistry20 *KeeperRegistry20Session) UpkeepVersion() (uint8, error) {
	return _KeeperRegistry20.Contract.UpkeepVersion(&_KeeperRegistry20.CallOpts)
}

func (_KeeperRegistry20 *KeeperRegistry20CallerSession) UpkeepVersion() (uint8, error) {
	return _KeeperRegistry20.Contract.UpkeepVersion(&_KeeperRegistry20.CallOpts)
}
...
func (_KeeperRegistry20 *KeeperRegistry20Transactor) Receive(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _KeeperRegistry20.contract.RawTransact(opts, nil)
}
...
type KeeperRegistry20CancelledUpkeepReportIterator struct {
	Event *KeeperRegistry20CancelledUpkeepReport
...
type KeeperRegistry20ConfigSetIterator struct {
	Event *KeeperRegistry20ConfigSet
...
type KeeperRegistry20FundsAddedIterator struct {
	Event *KeeperRegistry20FundsAdded
...
type KeeperRegistry20FundsWithdrawnIterator struct {
	Event *KeeperRegistry20FundsWithdrawn
...
type KeeperRegistry20InsufficientFundsUpkeepReportIterator struct {
	Event *KeeperRegistry20InsufficientFundsUpkeepReport
...
type KeeperRegistry20OwnerFundsWithdrawnIterator struct {
	Event *KeeperRegistry20OwnerFundsWithdrawn
...
type KeeperRegistry20OwnershipTransferRequestedIterator struct {
	Event *KeeperRegistry20OwnershipTransferRequested
...
type KeeperRegistry20OwnershipTransferredIterator struct {
	Event *KeeperRegistry20OwnershipTransferred
...
type KeeperRegistry20PayeesUpdatedIterator struct {
	Event *KeeperRegistry20PayeesUpdated
...
type KeeperRegistry20PayeeshipTransferRequestedIterator struct {
	Event *KeeperRegistry20PayeeshipTransferRequested
...
type KeeperRegistry20PayeeshipTransferredIterator struct {
	Event *KeeperRegistry20PayeeshipTransferred
...
type KeeperRegistry20PaymentWithdrawnIterator struct {
	Event *KeeperRegistry20PaymentWithdrawn
...
type KeeperRegistry20ReorgedUpkeepReportIterator struct {
	Event *KeeperRegistry20ReorgedUpkeepReport
...
type KeeperRegistry20StaleUpkeepReportIterator struct {
	Event *KeeperRegistry20StaleUpkeepReport
...
type KeeperRegistry20TransmittedIterator struct {
	Event *KeeperRegistry20Transmitted
...
type KeeperRegistry20UnpausedIterator struct {
	Event *KeeperRegistry20Unpaused
...
type KeeperRegistry20UpkeepAdminTransferRequestedIterator struct {
	Event *KeeperRegistry20UpkeepAdminTransferRequested
...
type KeeperRegistry20UpkeepAdminTransferredIterator struct {
	Event *KeeperRegistry20UpkeepAdminTransferred
...
type KeeperRegistry20UpkeepCanceledIterator struct {
	Event *KeeperRegistry20UpkeepCanceled
...
type KeeperRegistry20UpkeepCheckDataUpdatedIterator struct {
	Event *KeeperRegistry20UpkeepCheckDataUpdated
...
type KeeperRegistry20UpkeepGasLimitSetIterator struct {
	Event *KeeperRegistry20UpkeepGasLimitSet
...
type KeeperRegistry20UpkeepMigratedIterator struct {
	Event *KeeperRegistry20UpkeepMigrated
...
type KeeperRegistry20UpkeepOffchainConfigSetIterator struct {
	Event *KeeperRegistry20UpkeepOffchainConfigSet
...
type KeeperRegistry20UpkeepPausedIterator struct {
	Event *KeeperRegistry20UpkeepPaused
...
type KeeperRegistry20UpkeepPerformedIterator struct {
	Event *KeeperRegistry20UpkeepPerformed
...
type KeeperRegistry20UpkeepReceivedIterator struct {
	Event *KeeperRegistry20UpkeepReceived
...
type KeeperRegistry20UpkeepRegisteredIterator struct {
	Event *KeeperRegistry20UpkeepRegistered
...
type KeeperRegistry20UpkeepUnpausedIterator struct {
	Event *KeeperRegistry20UpkeepUnpaused
...
func (_KeeperRegistry20 *KeeperRegistry20) ParseLog(log types.Log) (generated.AbigenLog, error) {
	switch log.Topics[0] {
	case _KeeperRegistry20.abi.Events["CancelledUpkeepReport"].ID:
		return _KeeperRegistry20.ParseCancelledUpkeepReport(log)
	case _KeeperRegistry20.abi.Events["ConfigSet"].ID:
		return _KeeperRegistry20.ParseConfigSet(log)
	case _KeeperRegistry20.abi.Events["FundsAdded"].ID:
		return _KeeperRegistry20.ParseFundsAdded(log)
	case _KeeperRegistry20.abi.Events["FundsWithdrawn"].ID:
		return _KeeperRegistry20.ParseFundsWithdrawn(log)
	case _KeeperRegistry20.abi.Events["InsufficientFundsUpkeepReport"].ID:
		return _KeeperRegistry20.ParseInsufficientFundsUpkeepReport(log)
	case _KeeperRegistry20.abi.Events["OwnerFundsWithdrawn"].ID:
		return _KeeperRegistry20.ParseOwnerFundsWithdrawn(log)
	case _KeeperRegistry20.abi.Events["OwnershipTransferRequested"].ID:
		return _KeeperRegistry20.ParseOwnershipTransferRequested(log)
	case _KeeperRegistry20.abi.Events["OwnershipTransferred"].ID:
		return _KeeperRegistry20.ParseOwnershipTransferred(log)
	case _KeeperRegistry20.abi.Events["Paused"].ID:
		return _KeeperRegistry20.ParsePaused(log)
	case _KeeperRegistry20.abi.Events["PayeesUpdated"].ID:
		return _KeeperRegistry20.ParsePayeesUpdated(log)
	case _KeeperRegistry20.abi.Events["PayeeshipTransferRequested"].ID:
		return _KeeperRegistry20.ParsePayeeshipTransferRequested(log)
	case _KeeperRegistry20.abi.Events["PayeeshipTransferred"].ID:
		return _KeeperRegistry20.ParsePayeeshipTransferred(log)
	case _KeeperRegistry20.abi.Events["PaymentWithdrawn"].ID:
		return _KeeperRegistry20.ParsePaymentWithdrawn(log)
	case _KeeperRegistry20.abi.Events["ReorgedUpkeepReport"].ID:
		return _KeeperRegistry20.ParseReorgedUpkeepReport(log)
	case _KeeperRegistry20.abi.Events["StaleUpkeepReport"].ID:
		return _KeeperRegistry20.ParseStaleUpkeepReport(log)
	case _KeeperRegistry20.abi.Events["Transmitted"].ID:
		return _KeeperRegistry20.ParseTransmitted(log)
	case _KeeperRegistry20.abi.Events["Unpaused"].ID:
		return _KeeperRegistry20.ParseUnpaused(log)
	case _KeeperRegistry20.abi.Events["UpkeepAdminTransferRequested"].ID:
		return _KeeperRegistry20.ParseUpkeepAdminTransferRequested(log)
	case _KeeperRegistry20.abi.Events["UpkeepAdminTransferred"].ID:
		return _KeeperRegistry20.ParseUpkeepAdminTransferred(log)
	case _KeeperRegistry20.abi.Events["UpkeepCanceled"].ID:
		return _KeeperRegistry20.ParseUpkeepCanceled(log)
	case _KeeperRegistry20.abi.Events["UpkeepCheckDataUpdated"].ID:
		return _KeeperRegistry20.ParseUpkeepCheckDataUpdated(log)
	case _KeeperRegistry20.abi.Events["UpkeepGasLimitSet"].ID:
		return _KeeperRegistry20.ParseUpkeepGasLimitSet(log)
	case _KeeperRegistry20.abi.Events["UpkeepMigrated"].ID:
		return _KeeperRegistry20.ParseUpkeepMigrated(log)
	case _KeeperRegistry20.abi.Events["UpkeepOffchainConfigSet"].ID:
		return _KeeperRegistry20.ParseUpkeepOffchainConfigSet(log)
	case _KeeperRegistry20.abi.Events["UpkeepPaused"].ID:
		return _KeeperRegistry20.ParseUpkeepPaused(log)
	case _KeeperRegistry20.abi.Events["UpkeepPerformed"].ID:
		return _KeeperRegistry20.ParseUpkeepPerformed(log)
	case _KeeperRegistry20.abi.Events["UpkeepReceived"].ID:
		return _KeeperRegistry20.ParseUpkeepReceived(log)
	case _KeeperRegistry20.abi.Events["UpkeepRegistered"].ID:
		return _KeeperRegistry20.ParseUpkeepRegistered(log)
	case _KeeperRegistry20.abi.Events["UpkeepUnpaused"].ID:
		return _KeeperRegistry20.ParseUpkeepUnpaused(log)
...
func (KeeperRegistry20CancelledUpkeepReport) Topic() common.Hash {
	return common.HexToHash("0xd84831b6a3a7fbd333f42fe7f9104a139da6cca4cc1507aef4ddad79b31d017f")
}

func (KeeperRegistry20ConfigSet) Topic() common.Hash {
	return common.HexToHash("0x1591690b8638f5fb2dbec82ac741805ac5da8b45dc5263f4875b0496fdce4e05")
}

func (KeeperRegistry20FundsAdded) Topic() common.Hash {
	return common.HexToHash("0xafd24114486da8ebfc32f3626dada8863652e187461aa74d4bfa734891506203")
}

func (KeeperRegistry20FundsWithdrawn) Topic() common.Hash {
	return common.HexToHash("0xf3b5906e5672f3e524854103bcafbbdba80dbdfeca2c35e116127b1060a68318")
}

func (KeeperRegistry20InsufficientFundsUpkeepReport) Topic() common.Hash {
	return common.HexToHash("0x7895fdfe292beab0842d5beccd078e85296b9e17a30eaee4c261a2696b84eb96")
}

func (KeeperRegistry20OwnerFundsWithdrawn) Topic() common.Hash {
	return common.HexToHash("0x1d07d0b0be43d3e5fee41a80b579af370affee03fa595bf56d5d4c19328162f1")
}

func (KeeperRegistry20OwnershipTransferRequested) Topic() common.Hash {
	return common.HexToHash("0xed8889f560326eb138920d842192f0eb3dd22b4f139c87a2c57538e05bae1278")
}

func (KeeperRegistry20OwnershipTransferred) Topic() common.Hash {
	return common.HexToHash("0x8be0079c531659141344cd1fd0a4f28419497f9722a3daafe3b4186f6b6457e0")
}

func (KeeperRegistry20Paused) Topic() common.Hash {
	return common.HexToHash("0x62e78cea01bee320cd4e420270b5ea74000d11b0c9f74754ebdbfc544b05a258")
}

func (KeeperRegistry20PayeesUpdated) Topic() common.Hash {
	return common.HexToHash("0xa46de38886467c59be07a0675f14781206a5477d871628af46c2443822fcb725")
}

func (KeeperRegistry20PayeeshipTransferRequested) Topic() common.Hash {
	return common.HexToHash("0x84f7c7c80bb8ed2279b4aab5f61cd05e6374073d38f46d7f32de8c30e9e38367")
}

func (KeeperRegistry20PayeeshipTransferred) Topic() common.Hash {
	return common.HexToHash("0x78af32efdcad432315431e9b03d27e6cd98fb79c405fdc5af7c1714d9c0f75b3")
}

func (KeeperRegistry20PaymentWithdrawn) Topic() common.Hash {
	return common.HexToHash("0x9819093176a1851202c7bcfa46845809b4e47c261866550e94ed3775d2f40698")
}

func (KeeperRegistry20ReorgedUpkeepReport) Topic() common.Hash {
	return common.HexToHash("0x561ff77e59394941a01a456497a9418dea82e2a39abb3ecebfb1cef7e0bfdc13")
}

func (KeeperRegistry20StaleUpkeepReport) Topic() common.Hash {
	return common.HexToHash("0x5aa44821f7938098502bff537fbbdc9aaaa2fa655c10740646fce27e54987a89")
}

func (KeeperRegistry20Transmitted) Topic() common.Hash {
	return common.HexToHash("0xb04e63db38c49950639fa09d29872f21f5d49d614f3a969d8adf3d4b52e41a62")
}

func (KeeperRegistry20Unpaused) Topic() common.Hash {
	return common.HexToHash("0x5db9ee0a495bf2e6ff9c91a7834c1ba4fdd244a5e8aa4e537bd38aeae4b073aa")
}

func (KeeperRegistry20UpkeepAdminTransferRequested) Topic() common.Hash {
	return common.HexToHash("0xb1cbb2c4b8480034c27e06da5f096b8233a8fd4497028593a41ff6df79726b35")
}

func (KeeperRegistry20UpkeepAdminTransferred) Topic() common.Hash {
	return common.HexToHash("0x5cff4db96bef051785e999f44bfcd21c18823e034fb92dd376e3db4ce0feeb2c")
}

func (KeeperRegistry20UpkeepCanceled) Topic() common.Hash {
	return common.HexToHash("0x91cb3bb75cfbd718bbfccc56b7f53d92d7048ef4ca39a3b7b7c6d4af1f791181")
}

func (KeeperRegistry20UpkeepCheckDataUpdated) Topic() common.Hash {
	return common.HexToHash("0x7b778136e5211932b51a145badd01959415e79e051a933604b3d323f862dcabf")
}

func (KeeperRegistry20UpkeepGasLimitSet) Topic() common.Hash {
	return common.HexToHash("0xc24c07e655ce79fba8a589778987d3c015bc6af1632bb20cf9182e02a65d972c")
}

func (KeeperRegistry20UpkeepMigrated) Topic() common.Hash {
	return common.HexToHash("0xb38647142fbb1ea4c000fc4569b37a4e9a9f6313317b84ee3e5326c1a6cd06ff")
}

func (KeeperRegistry20UpkeepOffchainConfigSet) Topic() common.Hash {
	return common.HexToHash("0x3e8740446213c8a77d40e08f79136ce3f347d13ed270a6ebdf57159e0faf4850")
}

func (KeeperRegistry20UpkeepPaused) Topic() common.Hash {
	return common.HexToHash("0x8ab10247ce168c27748e656ecf852b951fcaac790c18106b19aa0ae57a8b741f")
}

func (KeeperRegistry20UpkeepPerformed) Topic() common.Hash {
	return common.HexToHash("0x29233ba1d7b302b8fe230ad0b81423aba5371b2a6f6b821228212385ee6a4420")
}

func (KeeperRegistry20UpkeepReceived) Topic() common.Hash {
	return common.HexToHash("0x74931a144e43a50694897f241d973aecb5024c0e910f9bb80a163ea3c1cf5a71")
}

func (KeeperRegistry20UpkeepRegistered) Topic() common.Hash {
	return common.HexToHash("0xbae366358c023f887e791d7a62f2e4316f1026bd77f6fb49501a917b3bc5d012")
}

func (KeeperRegistry20UpkeepUnpaused) Topic() common.Hash {
	return common.HexToHash("0x7bada562044eb163f6b4003c4553e4e62825344c0418eea087bed5ee05a47456")
}

func (_KeeperRegistry20 *KeeperRegistry20) Address() common.Address {
	return _KeeperRegistry20.address
}

type KeeperRegistry20Interface interface {
	...
	FilterCancelledUpkeepReport(opts *bind.FilterOpts, id []*big.Int) (*KeeperRegistry20CancelledUpkeepReportIterator, error)

	WatchCancelledUpkeepReport(opts *bind.WatchOpts, sink chan<- *KeeperRegistry20CancelledUpkeepReport, id []*big.Int) (event.Subscription, error)

	ParseCancelledUpkeepReport(log types.Log) (*KeeperRegistry20CancelledUpkeepReport, error)

	FilterConfigSet(opts *bind.FilterOpts) (*KeeperRegistry20ConfigSetIterator, error)

	WatchConfigSet(opts *bind.WatchOpts, sink chan<- *KeeperRegistry20ConfigSet) (event.Subscription, error)

	ParseConfigSet(log types.Log) (*KeeperRegistry20ConfigSet, error)

	FilterFundsAdded(opts *bind.FilterOpts, id []*big.Int, from []common.Address) (*KeeperRegistry20FundsAddedIterator, error)

	WatchFundsAdded(opts *bind.WatchOpts, sink chan<- *KeeperRegistry20FundsAdded, id []*big.Int, from []common.Address) (event.Subscription, error)

	ParseFundsAdded(log types.Log) (*KeeperRegistry20FundsAdded, error)

	FilterFundsWithdrawn(opts *bind.FilterOpts, id []*big.Int) (*KeeperRegistry20FundsWithdrawnIterator, error)

	WatchFundsWithdrawn(opts *bind.WatchOpts, sink chan<- *KeeperRegistry20FundsWithdrawn, id []*big.Int) (event.Subscription, error)

	ParseFundsWithdrawn(log types.Log) (*KeeperRegistry20FundsWithdrawn, error)

	FilterInsufficientFundsUpkeepReport(opts *bind.FilterOpts, id []*big.Int) (*KeeperRegistry20InsufficientFundsUpkeepReportIterator, error)

	WatchInsufficientFundsUpkeepReport(opts *bind.WatchOpts, sink chan<- *KeeperRegistry20InsufficientFundsUpkeepReport, id []*big.Int) (event.Subscription, error)

	ParseInsufficientFundsUpkeepReport(log types.Log) (*KeeperRegistry20InsufficientFundsUpkeepReport, error)

	FilterOwnerFundsWithdrawn(opts *bind.FilterOpts) (*KeeperRegistry20OwnerFundsWithdrawnIterator, error)

	WatchOwnerFundsWithdrawn(opts *bind.WatchOpts, sink chan<- *KeeperRegistry20OwnerFundsWithdrawn) (event.Subscription, error)

	ParseOwnerFundsWithdrawn(log types.Log) (*KeeperRegistry20OwnerFundsWithdrawn, error)

	FilterOwnershipTransferRequested(opts *bind.FilterOpts, from []common.Address, to []common.Address) (*KeeperRegistry20OwnershipTransferRequestedIterator, error)

	WatchOwnershipTransferRequested(opts *bind.WatchOpts, sink chan<- *KeeperRegistry20OwnershipTransferRequested, from []common.Address, to []common.Address) (event.Subscription, error)

	ParseOwnershipTransferRequested(log types.Log) (*KeeperRegistry20OwnershipTransferRequested, error)

	FilterOwnershipTransferred(opts *bind.FilterOpts, from []common.Address, to []common.Address) (*KeeperRegistry20OwnershipTransferredIterator, error)

	WatchOwnershipTransferred(opts *bind.WatchOpts, sink chan<- *KeeperRegistry20OwnershipTransferred, from []common.Address, to []common.Address) (event.Subscription, error)

	ParseOwnershipTransferred(log types.Log) (*KeeperRegistry20OwnershipTransferred, error)

	FilterPaused(opts *bind.FilterOpts) (*KeeperRegistry20PausedIterator, error)

	WatchPaused(opts *bind.WatchOpts, sink chan<- *KeeperRegistry20Paused) (event.Subscription, error)

	ParsePaused(log types.Log) (*KeeperRegistry20Paused, error)

	FilterPayeesUpdated(opts *bind.FilterOpts) (*KeeperRegistry20PayeesUpdatedIterator, error)

	WatchPayeesUpdated(opts *bind.WatchOpts, sink chan<- *KeeperRegistry20PayeesUpdated) (event.Subscription, error)

	ParsePayeesUpdated(log types.Log) (*KeeperRegistry20PayeesUpdated, error)

	FilterPayeeshipTransferRequested(opts *bind.FilterOpts, transmitter []common.Address, from []common.Address, to []common.Address) (*KeeperRegistry20PayeeshipTransferRequestedIterator, error)

	WatchPayeeshipTransferRequested(opts *bind.WatchOpts, sink chan<- *KeeperRegistry20PayeeshipTransferRequested, transmitter []common.Address, from []common.Address, to []common.Address) (event.Subscription, error)

	ParsePayeeshipTransferRequested(log types.Log) (*KeeperRegistry20PayeeshipTransferRequested, error)

	FilterPayeeshipTransferred(opts *bind.FilterOpts, transmitter []common.Address, from []common.Address, to []common.Address) (*KeeperRegistry20PayeeshipTransferredIterator, error)

	WatchPayeeshipTransferred(opts *bind.WatchOpts, sink chan<- *KeeperRegistry20PayeeshipTransferred, transmitter []common.Address, from []common.Address, to []common.Address) (event.Subscription, error)

	ParsePayeeshipTransferred(log types.Log) (*KeeperRegistry20PayeeshipTransferred, error)

	FilterPaymentWithdrawn(opts *bind.FilterOpts, transmitter []common.Address, amount []*big.Int, to []common.Address) (*KeeperRegistry20PaymentWithdrawnIterator, error)

	WatchPaymentWithdrawn(opts *bind.WatchOpts, sink chan<- *KeeperRegistry20PaymentWithdrawn, transmitter []common.Address, amount []*big.Int, to []common.Address) (event.Subscription, error)

	ParsePaymentWithdrawn(log types.Log) (*KeeperRegistry20PaymentWithdrawn, error)

	FilterReorgedUpkeepReport(opts *bind.FilterOpts, id []*big.Int) (*KeeperRegistry20ReorgedUpkeepReportIterator, error)

	WatchReorgedUpkeepReport(opts *bind.WatchOpts, sink chan<- *KeeperRegistry20ReorgedUpkeepReport, id []*big.Int) (event.Subscription, error)

	ParseReorgedUpkeepReport(log types.Log) (*KeeperRegistry20ReorgedUpkeepReport, error)

	FilterStaleUpkeepReport(opts *bind.FilterOpts, id []*big.Int) (*KeeperRegistry20StaleUpkeepReportIterator, error)

	WatchStaleUpkeepReport(opts *bind.WatchOpts, sink chan<- *KeeperRegistry20StaleUpkeepReport, id []*big.Int) (event.Subscription, error)

	ParseStaleUpkeepReport(log types.Log) (*KeeperRegistry20StaleUpkeepReport, error)

	FilterTransmitted(opts *bind.FilterOpts) (*KeeperRegistry20TransmittedIterator, error)

	WatchTransmitted(opts *bind.WatchOpts, sink chan<- *KeeperRegistry20Transmitted) (event.Subscription, error)

	ParseTransmitted(log types.Log) (*KeeperRegistry20Transmitted, error)

	FilterUnpaused(opts *bind.FilterOpts) (*KeeperRegistry20UnpausedIterator, error)

	WatchUnpaused(opts *bind.WatchOpts, sink chan<- *KeeperRegistry20Unpaused) (event.Subscription, error)

	ParseUnpaused(log types.Log) (*KeeperRegistry20Unpaused, error)

	FilterUpkeepAdminTransferRequested(opts *bind.FilterOpts, id []*big.Int, from []common.Address, to []common.Address) (*KeeperRegistry20UpkeepAdminTransferRequestedIterator, error)

	WatchUpkeepAdminTransferRequested(opts *bind.WatchOpts, sink chan<- *KeeperRegistry20UpkeepAdminTransferRequested, id []*big.Int, from []common.Address, to []common.Address) (event.Subscription, error)

	ParseUpkeepAdminTransferRequested(log types.Log) (*KeeperRegistry20UpkeepAdminTransferRequested, error)

	FilterUpkeepAdminTransferred(opts *bind.FilterOpts, id []*big.Int, from []common.Address, to []common.Address) (*KeeperRegistry20UpkeepAdminTransferredIterator, error)

	WatchUpkeepAdminTransferred(opts *bind.WatchOpts, sink chan<- *KeeperRegistry20UpkeepAdminTransferred, id []*big.Int, from []common.Address, to []common.Address) (event.Subscription, error)

	ParseUpkeepAdminTransferred(log types.Log) (*KeeperRegistry20UpkeepAdminTransferred, error)

	FilterUpkeepCanceled(opts *bind.FilterOpts, id []*big.Int, atBlockHeight []uint64) (*KeeperRegistry20UpkeepCanceledIterator, error)

	WatchUpkeepCanceled(opts *bind.WatchOpts, sink chan<- *KeeperRegistry20UpkeepCanceled, id []*big.Int, atBlockHeight []uint64) (event.Subscription, error)

	ParseUpkeepCanceled(log types.Log) (*KeeperRegistry20UpkeepCanceled, error)

	FilterUpkeepCheckDataUpdated(opts *bind.FilterOpts, id []*big.Int) (*KeeperRegistry20UpkeepCheckDataUpdatedIterator, error)

	WatchUpkeepCheckDataUpdated(opts *bind.WatchOpts, sink chan<- *KeeperRegistry20UpkeepCheckDataUpdated, id []*big.Int) (event.Subscription, error)

	ParseUpkeepCheckDataUpdated(log types.Log) (*KeeperRegistry20UpkeepCheckDataUpdated, error)

	FilterUpkeepGasLimitSet(opts *bind.FilterOpts, id []*big.Int) (*KeeperRegistry20UpkeepGasLimitSetIterator, error)

	WatchUpkeepGasLimitSet(opts *bind.WatchOpts, sink chan<- *KeeperRegistry20UpkeepGasLimitSet, id []*big.Int) (event.Subscription, error)

	ParseUpkeepGasLimitSet(log types.Log) (*KeeperRegistry20UpkeepGasLimitSet, error)

	FilterUpkeepMigrated(opts *bind.FilterOpts, id []*big.Int) (*KeeperRegistry20UpkeepMigratedIterator, error)

	WatchUpkeepMigrated(opts *bind.WatchOpts, sink chan<- *KeeperRegistry20UpkeepMigrated, id []*big.Int) (event.Subscription, error)

	ParseUpkeepMigrated(log types.Log) (*KeeperRegistry20UpkeepMigrated, error)

	FilterUpkeepOffchainConfigSet(opts *bind.FilterOpts, id []*big.Int) (*KeeperRegistry20UpkeepOffchainConfigSetIterator, error)

	WatchUpkeepOffchainConfigSet(opts *bind.WatchOpts, sink chan<- *KeeperRegistry20UpkeepOffchainConfigSet, id []*big.Int) (event.Subscription, error)

	ParseUpkeepOffchainConfigSet(log types.Log) (*KeeperRegistry20UpkeepOffchainConfigSet, error)

	FilterUpkeepPaused(opts *bind.FilterOpts, id []*big.Int) (*KeeperRegistry20UpkeepPausedIterator, error)

	WatchUpkeepPaused(opts *bind.WatchOpts, sink chan<- *KeeperRegistry20UpkeepPaused, id []*big.Int) (event.Subscription, error)

	ParseUpkeepPaused(log types.Log) (*KeeperRegistry20UpkeepPaused, error)

	FilterUpkeepPerformed(opts *bind.FilterOpts, id []*big.Int, success []bool) (*KeeperRegistry20UpkeepPerformedIterator, error)

	WatchUpkeepPerformed(opts *bind.WatchOpts, sink chan<- *KeeperRegistry20UpkeepPerformed, id []*big.Int, success []bool) (event.Subscription, error)

	ParseUpkeepPerformed(log types.Log) (*KeeperRegistry20UpkeepPerformed, error)

	FilterUpkeepReceived(opts *bind.FilterOpts, id []*big.Int) (*KeeperRegistry20UpkeepReceivedIterator, error)

	WatchUpkeepReceived(opts *bind.WatchOpts, sink chan<- *KeeperRegistry20UpkeepReceived, id []*big.Int) (event.Subscription, error)

	ParseUpkeepReceived(log types.Log) (*KeeperRegistry20UpkeepReceived, error)

	FilterUpkeepRegistered(opts *bind.FilterOpts, id []*big.Int) (*KeeperRegistry20UpkeepRegisteredIterator, error)

	WatchUpkeepRegistered(opts *bind.WatchOpts, sink chan<- *KeeperRegistry20UpkeepRegistered, id []*big.Int) (event.Subscription, error)

	ParseUpkeepRegistered(log types.Log) (*KeeperRegistry20UpkeepRegistered, error)

	FilterUpkeepUnpaused(opts *bind.FilterOpts, id []*big.Int) (*KeeperRegistry20UpkeepUnpausedIterator, error)

	WatchUpkeepUnpaused(opts *bind.WatchOpts, sink chan<- *KeeperRegistry20UpkeepUnpaused, id []*big.Int) (event.Subscription, error)

	ParseUpkeepUnpaused(log types.Log) (*KeeperRegistry20UpkeepUnpaused, error)
