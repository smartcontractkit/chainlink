...
func (_IAutomationRegistryMaster *IAutomationRegistryMasterCaller) GetAllowedReadOnlyAddresses(opts *bind.CallOpts) ([]common.Address, error) {
	var out []interface{}
	err := _IAutomationRegistryMaster.contract.Call(opts, &out, "getAllowedReadOnlyAddresses")
...
func (_IAutomationRegistryMaster *IAutomationRegistryMasterSession) GetAllowedReadOnlyAddresses() ([]common.Address, error) {
	return _IAutomationRegistryMaster.Contract.GetAllowedReadOnlyAddresses(&_IAutomationRegistryMaster.CallOpts)
}

func (_IAutomationRegistryMaster *IAutomationRegistryMasterCallerSession) GetAllowedReadOnlyAddresses() ([]common.Address, error) {
	return _IAutomationRegistryMaster.Contract.GetAllowedReadOnlyAddresses(&_IAutomationRegistryMaster.CallOpts)
}
...
func (_IAutomationRegistryMaster *IAutomationRegistryMasterTransactor) SetAllowedReadOnlyAddresses(opts *bind.TransactOpts, addresses []common.Address) (*types.Transaction, error) {
	return _IAutomationRegistryMaster.contract.Transact(opts, "setAllowedReadOnlyAddresses", addresses)
}

func (_IAutomationRegistryMaster *IAutomationRegistryMasterSession) SetAllowedReadOnlyAddresses(addresses []common.Address) (*types.Transaction, error) {
	return _IAutomationRegistryMaster.Contract.SetAllowedReadOnlyAddresses(&_IAutomationRegistryMaster.TransactOpts, addresses)
}

func (_IAutomationRegistryMaster *IAutomationRegistryMasterTransactorSession) SetAllowedReadOnlyAddresses(addresses []common.Address) (*types.Transaction, error) {
	return _IAutomationRegistryMaster.Contract.SetAllowedReadOnlyAddresses(&_IAutomationRegistryMaster.TransactOpts, addresses)
}
...
type IAutomationRegistryMasterAllowedReadOnlyAddressesUpdatedIterator struct {
	Event *IAutomationRegistryMasterAllowedReadOnlyAddressesUpdated
...
func (it *IAutomationRegistryMasterAllowedReadOnlyAddressesUpdatedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(IAutomationRegistryMasterAllowedReadOnlyAddressesUpdated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
func (it *IAutomationRegistryMasterAllowedReadOnlyAddressesUpdatedIterator) Error() error {
	return it.fail
}

func (it *IAutomationRegistryMasterAllowedReadOnlyAddressesUpdatedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

type IAutomationRegistryMasterAllowedReadOnlyAddressesUpdated struct {
	Addresses []common.Address
	Raw       types.Log
}

func (_IAutomationRegistryMaster *IAutomationRegistryMasterFilterer) FilterAllowedReadOnlyAddressesUpdated(opts *bind.FilterOpts) (*IAutomationRegistryMasterAllowedReadOnlyAddressesUpdatedIterator, error) {

	logs, sub, err := _IAutomationRegistryMaster.contract.FilterLogs(opts, "AllowedReadOnlyAddressesUpdated")
	if err != nil {
		return nil, err
	}
	return &IAutomationRegistryMasterAllowedReadOnlyAddressesUpdatedIterator{contract: _IAutomationRegistryMaster.contract, event: "AllowedReadOnlyAddressesUpdated", logs: logs, sub: sub}, nil
}

func (_IAutomationRegistryMaster *IAutomationRegistryMasterFilterer) WatchAllowedReadOnlyAddressesUpdated(opts *bind.WatchOpts, sink chan<- *IAutomationRegistryMasterAllowedReadOnlyAddressesUpdated) (event.Subscription, error) {

	logs, sub, err := _IAutomationRegistryMaster.contract.WatchLogs(opts, "AllowedReadOnlyAddressesUpdated")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(IAutomationRegistryMasterAllowedReadOnlyAddressesUpdated)
				if err := _IAutomationRegistryMaster.contract.UnpackLog(event, "AllowedReadOnlyAddressesUpdated", log); err != nil {
					return err
				}
				event.Raw = log
...
func (_IAutomationRegistryMaster *IAutomationRegistryMasterFilterer) ParseAllowedReadOnlyAddressesUpdated(log types.Log) (*IAutomationRegistryMasterAllowedReadOnlyAddressesUpdated, error) {
	event := new(IAutomationRegistryMasterAllowedReadOnlyAddressesUpdated)
	if err := _IAutomationRegistryMaster.contract.UnpackLog(event, "AllowedReadOnlyAddressesUpdated", log); err != nil {
		return nil, err
	}
...
func (_IAutomationRegistryMaster *IAutomationRegistryMaster) ParseLog(log types.Log) (generated.AbigenLog, error) {
	...
	case _IAutomationRegistryMaster.abi.Events["AllowedReadOnlyAddressesUpdated"].ID:
		return _IAutomationRegistryMaster.ParseAllowedReadOnlyAddressesUpdated(log)
...
func (IAutomationRegistryMasterAllowedReadOnlyAddressesUpdated) Topic() common.Hash {
...
type IAutomationRegistryMasterInterface interface {
	...
	GetAllowedReadOnlyAddresses(opts *bind.CallOpts) ([]common.Address, error)
	...
	SetAllowedReadOnlyAddresses(opts *bind.TransactOpts, addresses []common.Address) (*types.Transaction, error)
	...
	FilterAllowedReadOnlyAddressesUpdated(opts *bind.FilterOpts) (*IAutomationRegistryMasterAllowedReadOnlyAddressesUpdatedIterator, error)

	WatchAllowedReadOnlyAddressesUpdated(opts *bind.WatchOpts, sink chan<- *IAutomationRegistryMasterAllowedReadOnlyAddressesUpdated) (event.Subscription, error)

	ParseAllowedReadOnlyAddressesUpdated(log types.Log) (*IAutomationRegistryMasterAllowedReadOnlyAddressesUpdated, error)
