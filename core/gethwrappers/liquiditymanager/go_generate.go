...
//go:generate go run ../generation/generate/wrap.go ../../../contracts/solc/v0.8.19/LiquidityManager/LiquidityManager.abi ../../../contracts/solc/v0.8.19/LiquidityManager/LiquidityManager.bin LiquidityManager liquiditymanager
...
//go:generate go run ../generation/generate/wrap.go ../../../contracts/solc/v0.8.19/ReportEncoder/ReportEncoder.abi ../../../contracts/solc/v0.8.19/ReportEncoder/ReportEncoder.bin ReportEncoder report_encoder
