...
//go:generate go run ../generation/generate/wrap.go ../../../contracts/solc/v0.8.19/FeeManagerNoNative/FeeManagerNoNative.abi ../../../contracts/solc/v0.8.19/FeeManagerNoNative/FeeManagerNoNative.bin FeeManagerNoNative fee_manager_no_native
