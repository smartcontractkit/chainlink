...
//go:generate go run ../generation/generate/wrap.go ../../../contracts/solc/v0.8.16/FeeManager/FeeManager.abi ../../../contracts/solc/v0.8.16/FeeManager/FeeManager.bin FeeManager fee_managerlConfigStore.bin ChannelConfigStore channel_config_store
//go:generate go run ../generation/generate/wrap.go ../../../contracts/solc/v0.8.16/ChannelConfigStore/ChannelConfigStore.abi ../../../contracts/solc/v0.8.16/ChannelConfigStore/Channe
