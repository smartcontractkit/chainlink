...
func (_VerifierProxy *VerifierProxyTransactor) Verify(opts *bind.TransactOpts, payload []byte, feePayload []byte) (*types.Transaction, error) {
	return _VerifierProxy.contract.Transact(opts, "verify", payload, feePayload)
}

func (_VerifierProxy *VerifierProxySession) Verify(payload []byte, feePayload []byte) (*types.Transaction, error) {
	return _VerifierProxy.Contract.Verify(&_VerifierProxy.TransactOpts, payload, feePayload)
}

func (_VerifierProxy *VerifierProxyTransactorSession) Verify(payload []byte, feePayload []byte) (*types.Transaction, error) {
	return _VerifierProxy.Contract.Verify(&_VerifierProxy.TransactOpts, payload, feePayload)
}

func (_VerifierProxy *VerifierProxyTransactor) VerifyBulk(opts *bind.TransactOpts, payloads [][]byte, feePayload []byte) (*types.Transaction, error) {
	return _VerifierProxy.contract.Transact(opts, "verifyBulk", payloads, feePayload)
}

func (_VerifierProxy *VerifierProxySession) VerifyBulk(payloads [][]byte, feePayload []byte) (*types.Transaction, error) {
	return _VerifierProxy.Contract.VerifyBulk(&_VerifierProxy.TransactOpts, payloads, feePayload)
}

func (_VerifierProxy *VerifierProxyTransactorSession) VerifyBulk(payloads [][]byte, feePayload []byte) (*types.Transaction, error) {
	return _VerifierProxy.Contract.VerifyBulk(&_VerifierProxy.TransactOpts, payloads, feePayload)
}
...
type VerifierProxyInterface interface {
	...
	Verify(opts *bind.TransactOpts, payload []byte, feePayload []byte) (*types.Transaction, error)

	VerifyBulk(opts *bind.TransactOpts, payloads [][]byte, feePayload []byte) (*types.Transaction, error)
