...
func (_FeeManager *FeeManagerCaller) NativeSurcharge(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _FeeManager.contract.Call(opts, &out, "nativeSurcharge")
...
func (_FeeManager *FeeManagerSession) NativeSurcharge() (*big.Int, error) {
	return _FeeManager.Contract.NativeSurcharge(&_FeeManager.CallOpts)
}

func (_FeeManager *FeeManagerCallerSession) NativeSurcharge() (*big.Int, error) {
	return _FeeManager.Contract.NativeSurcharge(&_FeeManager.CallOpts)
}
...
func (_FeeManager *FeeManagerCaller) SubscriberDiscounts(opts *bind.CallOpts, arg0 common.Address, arg1 [32]byte, arg2 common.Address) (*big.Int, error) {
	var out []interface{}
	err := _FeeManager.contract.Call(opts, &out, "subscriberDiscounts", arg0, arg1, arg2)
...
func (_FeeManager *FeeManagerSession) SubscriberDiscounts(arg0 common.Address, arg1 [32]byte, arg2 common.Address) (*big.Int, error) {
	return _FeeManager.Contract.SubscriberDiscounts(&_FeeManager.CallOpts, arg0, arg1, arg2)
}

func (_FeeManager *FeeManagerCallerSession) SubscriberDiscounts(arg0 common.Address, arg1 [32]byte, arg2 common.Address) (*big.Int, error) {
	return _FeeManager.Contract.SubscriberDiscounts(&_FeeManager.CallOpts, arg0, arg1, arg2)
}
...
type FeeManagerNativeSurchargeSetIterator struct {
	Event *FeeManagerNativeSurchargeSet
...
func (it *FeeManagerNativeSurchargeSetIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(FeeManagerNativeSurchargeSet)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
func (it *FeeManagerNativeSurchargeSetIterator) Error() error {
	return it.fail
}

func (it *FeeManagerNativeSurchargeSetIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

type FeeManagerNativeSurchargeSet struct {
	NewSurcharge *big.Int
	Raw          types.Log
}

func (_FeeManager *FeeManagerFilterer) FilterNativeSurchargeSet(opts *bind.FilterOpts) (*FeeManagerNativeSurchargeSetIterator, error) {

	logs, sub, err := _FeeManager.contract.FilterLogs(opts, "NativeSurchargeSet")
	if err != nil {
		return nil, err
	}
	return &FeeManagerNativeSurchargeSetIterator{contract: _FeeManager.contract, event: "NativeSurchargeSet", logs: logs, sub: sub}, nil
}

func (_FeeManager *FeeManagerFilterer) WatchNativeSurchargeSet(opts *bind.WatchOpts, sink chan<- *FeeManagerNativeSurchargeSet) (event.Subscription, error) {

	logs, sub, err := _FeeManager.contract.WatchLogs(opts, "NativeSurchargeSet")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(FeeManagerNativeSurchargeSet)
				if err := _FeeManager.contract.UnpackLog(event, "NativeSurchargeSet", log); err != nil {
					return err
				}
				event.Raw = log
...
func (_FeeManager *FeeManagerFilterer) ParseNativeSurchargeSet(log types.Log) (*FeeManagerNativeSurchargeSet, error) {
	event := new(FeeManagerNativeSurchargeSet)
	if err := _FeeManager.contract.UnpackLog(event, "NativeSurchargeSet", log); err != nil {
		return nil, err
	}
...
func (_FeeManager *FeeManager) ParseLog(log types.Log) (generated.AbigenLog, error) {
	...
	case _FeeManager.abi.Events["NativeSurchargeSet"].ID:
		return _FeeManager.ParseNativeSurchargeSet(log)
...
func (FeeManagerNativeSurchargeSet) Topic() common.Hash {
...
type FeeManagerInterface interface {
	...
	FilterNativeSurchargeSet(opts *bind.FilterOpts) (*FeeManagerNativeSurchargeSetIterator, error)

	WatchNativeSurchargeSet(opts *bind.WatchOpts, sink chan<- *FeeManagerNativeSurchargeSet) (event.Subscription, error)

	ParseNativeSurchargeSet(log types.Log) (*FeeManagerNativeSurchargeSet, error)
