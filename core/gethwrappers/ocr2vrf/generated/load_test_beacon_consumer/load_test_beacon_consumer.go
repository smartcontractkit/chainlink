...
func (_LoadTestBeaconVRFConsumer *LoadTestBeaconVRFConsumerTransactor) GetFulfillmentDurationByRequestID(opts *bind.TransactOpts, reqID *big.Int) (*types.Transaction, error) {
	return _LoadTestBeaconVRFConsumer.contract.Transact(opts, "getFulfillmentDurationByRequestID", reqID)
}

func (_LoadTestBeaconVRFConsumer *LoadTestBeaconVRFConsumerSession) GetFulfillmentDurationByRequestID(reqID *big.Int) (*types.Transaction, error) {
	return _LoadTestBeaconVRFConsumer.Contract.GetFulfillmentDurationByRequestID(&_LoadTestBeaconVRFConsumer.TransactOpts, reqID)
}

func (_LoadTestBeaconVRFConsumer *LoadTestBeaconVRFConsumerTransactorSession) GetFulfillmentDurationByRequestID(reqID *big.Int) (*types.Transaction, error) {
	return _LoadTestBeaconVRFConsumer.Contract.GetFulfillmentDurationByRequestID(&_LoadTestBeaconVRFConsumer.TransactOpts, reqID)
}
...
type LoadTestBeaconVRFConsumerInterface interface {
	...
	GetFulfillmentDurationByRequestID(opts *bind.TransactOpts, reqID *big.Int) (*types.Transaction, error)
