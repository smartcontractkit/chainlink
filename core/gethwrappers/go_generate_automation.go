...
//go:generate go run ./generation/generate_automation/wrap.go UpkeepTranscoder upkeep_transcoder
//go:generate go run ./generation/generate_automation/wrap.go VerifiableLoadUpkeep verifiable_load_upkeep_wrapper
//go:generate go run ./generation/generate_automation/wrap.go VerifiableLoadStreamsLookupUpkeep verifiable_load_streams_lookup_upkeep_wrapper
//go:generate go run ./generation/generate_automation/wrap.go StreamsLookupUpkeep streams_lookup_upkeep_wrapper
//go:generate go run ./generation/generate_automation/wrap.go StreamsLookupCompatibleInterface streams_lookup_compatible_interface
//go:generate go run ./generation/generate_automation/wrap.go AutomationConsumerBenchmark automation_consumer_benchmark
...
//go:generate go run ./generation/generate_automation/wrap.go IKeeperRegistryMaster i_keeper_registry_master_wrapper_2_1
...
//go:generate go run ./generation/generate_automation/wrap.go IAutomationRegistryMaster i_automation_registry_master_wrapper_2_2
//go:generate go run ./generation/generate_automation/wrap.go AutomationCompatibleUtils automation_compatible_utils
...
//go:generate go run ./generation/generate_automation/wrap.go IAutomationRegistryMaster2_3 i_automation_registry_master_wrapper_2_3
//go:generate go run ./generation/generate_automation/wrap.go ArbitrumModule arbitrum_module
//go:generate go run ./generation/generate_automation/wrap.go ChainModuleBase chain_module_base
//go:generate go run ./generation/generate_automation/wrap.go ScrollModule scroll_module
//go:generate go run ./generation/generate_automation/wrap.go IChainModule i_chain_module
//go:generate go run ./generation/generate_automation/wrap.go IAutomationV21PlusCommon i_automation_v21_plus_common
//go:generate go run ./generation/generate_automation/wrap.go MockETHUSDAggregator mock_ethusd_aggregator_wrapper

//go:generate go run ./generation/generate_automation/wrap.go ILogAutomation i_log_automation
//go:generate go run ./generation/generate_automation/wrap.go AutomationForwarderLogic automation_forwarder_logic
//go:generate go run ./generation/generate_automation/wrap.go LogUpkeepCounter log_upkeep_counter_wrapper
//go:generate go run ./generation/generate_automation/wrap.go SimpleLogUpkeepCounter simple_log_upkeep_counter_wrapper
//go:generate go run ./generation/generate_automation/wrap.go LogTriggeredStreamsLookup log_triggered_streams_lookup_wrapper
//go:generate go run ./generation/generate_automation/wrap.go DummyProtocol dummy_protocol_wrapper

//go:generate go run ./generation/generate_automation/wrap.go KeeperConsumerPerformance keeper_consumer_performance_wrapper
//go:generate go run ./generation/generate_automation/wrap.go PerformDataChecker perform_data_checker_wrapper
//go:generate go run ./generation/generate_automation/wrap.go UpkeepCounter upkeep_counter_wrapper
//go:generate go run ./generation/generate_automation/wrap.go  UpkeepPerformCounterRestrictive upkeep_perform_counter_restrictive_wrapper
