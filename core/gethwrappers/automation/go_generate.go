...
//go:generate go run ../generation/generate/wrap.go ../../../contracts/solc/v0.8.16/StreamsLookupUpkeep.abi ../../../contracts/solc/v0.8.16/StreamsLookupUpkeep.bin StreamsLookupUpkeep streams_lookup_upkeep
