...
//go:generate go run ./generation/generate/wrap.go ../../contracts/solc/v0.8.6/EthBalanceMonitor.abi ../../contracts/solc/v0.8.6/EthBalanceMonitor.bin EthBalanceMonitor eth_balance_monitor
