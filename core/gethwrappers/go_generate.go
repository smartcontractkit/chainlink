...
//go:generate go run ./generation/generate/wrap.go ../../contracts/solc/v0.8.6/MigratableVRFConsumerV2.abi ../../contracts/solc/v0.8.6/MigratableVRFConsumerV2.bin MigratableVRFConsumerV2 vrf_migratable_consumer_v2
...
//go:generate go run ./generation/generate/wrap.go ../../contracts/solc/v0.8.6/VRFMaliciousConsumerV2.abi ../../contracts/solc/v0.8.6/VRFMaliciousConsumerV2Plus.bin VRFMaliciousConsumerV2Plus vrf_malicious_consumer_v2_plus
...
//go:generate go run ./generation/generate/wrap.go ../../contracts/solc/v0.8.6/VRFConsumerV2UpgradeableExample.abi ../../contracts/solc/v0.8.6/VRFConsumerV2PlusUpgradeableExample.bin VRFConsumerV2PlusUpgradeableExample vrf_consumer_v2_plus_upgradeable_example
