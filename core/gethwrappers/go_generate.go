...
//go:generate go run ./generation/generate_events_mock/create_events_mock_contract.go ../../contracts/solc/v0.8.6/VRFCoordinatorV2.abi ../../contracts/src/v0.8/mocks/VRFCoordinatorV2EventsMock.sol VRFCoordinatorV2EventsMock
...
//go:generate go run ./generation/generate/wrap.go ../../contracts/solc/v0.8.6/VRFCoordinatorV2EventsMock.abi ../../contracts/solc/v0.8.6/VRFCoordinatorV2EventsMock.bin VRFCoordinatorV2EventsMock vrf_coordinator_v2_events_mock
