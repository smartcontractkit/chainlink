...
//go:generate go run ./generation/generate/wrap.go ../../contracts/solc/v0.8.6/LogTriggeredFeedLookup.abi ../../contracts/solc/v0.8.6/LogTriggeredFeedLookup.bin LogTriggeredFeedLookup log_triggered_feed_lookup_wrapper
