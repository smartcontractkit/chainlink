...
//go:generate go run ./generation/generate/wrap.go ../../contracts/solc/v0.8.6/LotteryConsumer.abi ../../contracts/solc/v0.8.6/LotteryConsumer.bin LotteryConsumer lottery_consumer
