...
//go:generate go run ./generation/generate/wrap.go ../../contracts/solc/v0.8.6/OCR2Aggregator.abi ../../contracts/solc/v0.8.6/OCR2Aggregator.bin OCR2Aggregator ocr2_aggregator
//go:generate go run ./generation/generate/wrap.go ../../contracts/solc/v0.8.6/OCR2Aggregator.abi ../../contracts/solc/v0.8.6/OCR2Aggregator.bin OCR2Aggregator ocr2_aggregator
//go:generate go run ./generation/generate/wrap.go ../../contracts/solc/v0.8.6/AccessController.abi ../../contracts/solc/v0.8.6/AccessController.bin AccessController access_controller
