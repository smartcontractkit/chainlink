...
func (_m *MockLogger) Helper(skip int) logger.Logger {
	ret := _m.Called(skip)
...
func (_c *MockLogger_Helper_Call) Return(_a0 logger.Logger) *MockLogger_Helper_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockLogger_Helper_Call) RunAndReturn(run func(int) logger.Logger) *MockLogger_Helper_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockLogger) With(args ...interface{}) logger.Logger {
	var _ca []interface{}
	_ca = append(_ca, args...)
	ret := _m.Called(_ca...)
...
func (_c *MockLogger_With_Call) RunAndReturn(run func(...interface{}) logger.Logger) *MockLogger_With_Call {
	_c.Call.Return(run)
	return _c
}
