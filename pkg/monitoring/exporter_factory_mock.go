...
type mockConstructorTestingTNewExporterFactoryMock interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewExporterFactoryMock(t mockConstructorTestingTNewExporterFactoryMock) *ExporterFactoryMock {
