...
var file_relayer_proto_rawDesc = []byte{
	...
	0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x42, 0x36, 0x5a,
	0x34, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x73, 0x6d, 0x61, 0x72,
	...
	0x2f, 0x6c, 0x6f, 0x6f, 0x70, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_relayer_proto_depIdxs = []int32{
	...
	8,  // 43: loop.Relayer.NewConfigProvider:output_type -> loop.NewConfigProviderReply
	10, // 44: loop.Relayer.NewMedianProvider:output_type -> loop.NewMedianProviderReply
	12, // 45: loop.Relayer.NewMercuryProvider:output_type -> loop.NewMercuryProviderReply
	14, // 46: loop.Relayer.ChainStatus:output_type -> loop.ChainStatusReply
	16, // 47: loop.Relayer.ChainStatuses:output_type -> loop.ChainStatusesReply
	19, // 48: loop.Relayer.NodeStatuses:output_type -> loop.NodeStatusesReply
	48, // 49: loop.Relayer.SendTx:output_type -> google.protobuf.Empty
	23, // 50: loop.DataSource.Observe:output_type -> loop.ObserveReply
	26, // 51: loop.OffchainConfigDigester.ConfigDigest:output_type -> loop.ConfigDigestReply
	28, // 52: loop.OffchainConfigDigester.ConfigDigestPrefix:output_type -> loop.ConfigDigestPrefixReply
	30, // 53: loop.ContractConfigTracker.LatestConfigDetails:output_type -> loop.LatestConfigDetailsReply
	32, // 54: loop.ContractConfigTracker.LatestConfig:output_type -> loop.LatestConfigReply
	34, // 55: loop.ContractConfigTracker.LatestBlockHeight:output_type -> loop.LatestBlockHeightReply
	39, // 56: loop.ContractTransmitter.Transmit:output_type -> loop.TransmitReply
	41, // 57: loop.ContractTransmitter.LatestConfigDigestAndEpoch:output_type -> loop.LatestConfigDigestAndEpochReply
	43, // 58: loop.ContractTransmitter.FromAccount:output_type -> loop.FromAccountReply
	44, // 59: loop.Service.Name:output_type -> loop.NameReply
	48, // 60: loop.Service.Close:output_type -> google.protobuf.Empty
	48, // 61: loop.Service.Ready:output_type -> google.protobuf.Empty
	45, // 62: loop.Service.HealthReport:output_type -> loop.HealthReportReply
