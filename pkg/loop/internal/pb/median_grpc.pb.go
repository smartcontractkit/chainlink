...
type ErrorLogClient interface {
	SaveError(ctx context.Context, in *SaveErrorRequest, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *errorLogClient) SaveError(ctx context.Context, in *SaveErrorRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type ErrorLogServer interface {
	SaveError(context.Context, *SaveErrorRequest) (*empty.Empty, error)
...
func (UnimplementedErrorLogServer) SaveError(context.Context, *SaveErrorRequest) (*empty.Empty, error) {
