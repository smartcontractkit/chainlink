...
module.exports.models = {
  ...
  attributes: {
    createdAt: { type: 'string', defaultsTo: new Date().toISOString() },
    updatedAt: { type: 'string', defaultsTo: new Date().toISOString() },
  ...
  dataEncryptionKeys: {
    default: 'AsG01MrCGyWAxnVXRuvJQHE3UOBUkODkJMJxc5OTOUk='
  },
