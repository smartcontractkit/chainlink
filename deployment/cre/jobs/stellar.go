...
// verifyStellarJobSpecInputs validates the inputs for a Stellar standard-capability worker job.
func verifyStellarJobSpecInputs(inputs job_types.JobSpecInput) error {
