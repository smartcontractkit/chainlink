...
import (
	...
	cldf_ocr "github.com/smartcontractkit/chainlink-deployments-framework/offchain/ocr"
...
func GenerateDKGConfig(cfg OracleConfig, nca []NodeKeys, secrets cldf_ocr.OCRSecrets, dkgCfg dkgocrtypes.ReportingPluginConfig) (OCR2OracleConfig, error) {
...
type ConfigureDKGRequest struct {
	...
	DryRun                bool
	OcrSecrets            cldf_ocr.OCRSecrets
