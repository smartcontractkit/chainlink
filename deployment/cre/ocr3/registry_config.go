...
// offchain config, etc.) from oracle config parameters and DON node information
// fetched from the Job Distributor.
...
// Bytes fields are base64-encoded per the protojson convention.
