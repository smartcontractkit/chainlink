...
func AddLanes(t *testing.T, e cldf.Environment, state changeset.CCIPOnChainState, pairs []testhelpers.SourceDestPair) cldf.Environment {
...
func LaneConfigsForChains(t *testing.T, env cldf.Environment, state changeset.CCIPOnChainState, pairs []testhelpers.SourceDestPair) (
