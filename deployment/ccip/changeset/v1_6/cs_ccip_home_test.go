...
func TestCalculateConfigDigest(t *testing.T) {
	// generated using solidity on the value below
	expectedConfiDigest := "000ae91955deabc570f3cbc1f55c913cda458e1c465f3b466ef0f2d8ce68d885"
	donID := uint32(1)
	pluginType := internal.Commit
	staticConfig := []byte{}
	version := uint32(1)
	chainID := int64(1)
	contractAddress := "0xeAd886DbDc35d832E3De66AB4807a5Ea1ce3f4d3"
