...
func validateExecOffchainConfig(e cldf.Environment, c *pluginconfig.ExecuteOffchainConfig, selector uint64, state changeset.CCIPOnChainState) error {
...
func (c CCIPOCRParams) Validate(e cldf.Environment, selector uint64, feedChainSel uint64, state changeset.CCIPOnChainState) error {
...
func (p SetCandidatePluginInfo) Validate(e cldf.Environment, state changeset.CCIPOnChainState, homeChain uint64, feedChain uint64) error {
...
func (s SetCandidateConfigBase) Validate(e cldf.Environment, state changeset.CCIPOnChainState) error {
...
func (a AddDonAndSetCandidateChangesetConfig) Validate(e cldf.Environment, state changeset.CCIPOnChainState) error {
...
func (s SetCandidateChangesetConfig) Validate(e cldf.Environment, state changeset.CCIPOnChainState) (map[uint64]uint32, error) {
...
func (r RevokeCandidateChangesetConfig) Validate(e cldf.Environment, state changeset.CCIPOnChainState) (donID uint32, err error) {
...
func deployDonIDClaimerContract(e cldf.Environment, ab cldf.AddressBook, state changeset.CCIPOnChainState, chain cldf.Chain) error {
