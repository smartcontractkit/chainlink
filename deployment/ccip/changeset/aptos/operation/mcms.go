...
func deployMCMS(b operations.Bundle, deps deps.AptosDeps, _ operations.EmptyInput) (aptos.AccountAddress, error) {
...
func configureMCMS(b operations.Bundle, deps deps.AptosDeps, in ConfigureMCMSInput) (any, error) {
...
func transferOwnershipToSelf(b operations.Bundle, deps deps.AptosDeps, mcmsAddress aptos.AccountAddress) (any, error) {
...
func acceptOwnership(b operations.Bundle, deps deps.AptosDeps, mcmsAddress aptos.AccountAddress) (mcmstypes.Transaction, error) {
	contractMCMS := mcmsbind.Bind(mcmsAddress, deps.AptosChain.Client)
...
func setMinDelay(b operations.Bundle, deps deps.AptosDeps, in TimelockMinDelayInput) (mcmstypes.Transaction, error) {
...
func cleanupStagingArea(b operations.Bundle, deps deps.AptosDeps, mcmsAddress aptos.AccountAddress) (mcmstypes.BatchOperation, error) {
