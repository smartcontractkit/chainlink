...
func deployToken(b operations.Bundle, deps deps.AptosDeps, in DeployTokenInput) (DeployTokenOutput, error) {
...
func deployTokenMCMSRegistrar(b operations.Bundle, deps deps.AptosDeps, in DeployTokenRegistrarInput) ([]types.Operation, error) {
	mcmsContract := mcmsbind.Bind(in.MCMSAddress, deps.AptosChain.Client)
...
func initializeToken(b operations.Bundle, deps deps.AptosDeps, in InitializeTokenInput) (types.Transaction, error) {
...
func mintTokens(b operations.Bundle, deps deps.AptosDeps, in MintTokensInput) (types.Transaction, error) {
	boundManagedToken := managed_token.Bind(in.TokenCodeObjectAddress, deps.AptosChain.Client)
...
func applyAllowedMinters(b operations.Bundle, deps deps.AptosDeps, in ApplyAllowedMintersInput) (types.Transaction, error) {
...
func applyAllowedBurners(b operations.Bundle, deps deps.AptosDeps, in ApplyAllowedBurnersInput) (types.Transaction, error) {
	tokenContract := managed_token.Bind(in.TokenCodeObjectAddress, deps.AptosChain.Client)
...
func deployTokenFaucet(b operations.Bundle, deps deps.AptosDeps, in DeployTokenFaucetInput) ([]types.Operation, error) {
...
func grantRole(b operations.Bundle, deps deps.AptosDeps, in GrantRoleInput) (types.Transaction, error) {
...
func transferTokenOwnership(b operations.Bundle, deps deps.AptosDeps, in TransferTokenOwnershipInput) (types.Transaction, error) {
	var (
...
func acceptTokenOwnership(b operations.Bundle, deps deps.AptosDeps, in AcceptTokenOwnershipInput) (types.Transaction, error) {
	var (
		moduleInfo bind.ModuleInformation
		function   string
		args       [][]byte
...
func executeTokenOwnershipTransfer(b operations.Bundle, deps deps.AptosDeps, in ExecuteTokenOwnershipTransferInput) (types.Transaction, error) {
	var (
		moduleInfo bind.ModuleInformation
		function   string
		args       [][]byte
...
func transferAdmin(b operations.Bundle, deps deps.AptosDeps, in TransferTokenAdminInput) (types.Transaction, error) {
	tokenContract := regulated_token.Bind(in.TokenCodeObjectAddress, deps.AptosChain.Client)
...
func acceptTokenAdmin(b operations.Bundle, deps deps.AptosDeps, in AcceptTokenAdminInput) (types.Transaction, error) {
	tokenContract := regulated_token.Bind(in.TokenCodeObjectAddress, deps.AptosChain.Client)
