...
func deployAptosTokenSequence(b operations.Bundle, deps deps.AptosDeps, in DeployTokenSeqInput) (DeployTokenSeqOutput, error) {
...
func deployAptosTokenFaucetSequence(b operations.Bundle, deps deps.AptosDeps, in DeployTokenFaucetSeqInput) ([]mcmstypes.BatchOperation, error) {
	var mcmsOperations []mcmstypes.BatchOperation
...
func transferTokenOwnershipsSequence(b operations.Bundle, deps deps.AptosDeps, in TransferTokenOwnershipsSeqInput) (mcmstypes.BatchOperation, error) {
	var txs []mcmstypes.Transaction
...
func acceptTokenOwnershipsSequence(b operations.Bundle, deps deps.AptosDeps, in AcceptTokenOwnershipsSeqInput) (mcmstypes.BatchOperation, error) {
	var txs []mcmstypes.Transaction
...
func executeTokenOwnershipTransfersSequence(b operations.Bundle, deps deps.AptosDeps, in ExecuteTokenOwnershipTransfersSeqInput) (mcmstypes.BatchOperation, error) {
	var txs []mcmstypes.Transaction
...
func transferTokenAdminsSequence(b operations.Bundle, deps deps.AptosDeps, in TransferTokenAdminsSeqInput) (mcmstypes.BatchOperation, error) {
	var txs []mcmstypes.Transaction
...
func acceptTokenAdminsSequence(b operations.Bundle, deps deps.AptosDeps, in AcceptTokenAdminsSeqInput) (mcmstypes.BatchOperation, error) {
	var txs []mcmstypes.Transaction
