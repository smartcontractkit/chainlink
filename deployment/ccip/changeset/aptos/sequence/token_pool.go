...
func deployAptosTokenPoolSequence(b operations.Bundle, deps deps.AptosDeps, in DeployTokenPoolSeqInput) (DeployTokenPoolSeqOutput, error) {
...
func connectTokenPoolSequence(b operations.Bundle, deps deps.AptosDeps, in ConnectTokenPoolSeqInput) (mcmstypes.BatchOperation, error) {
	var txs []mcmstypes.Transaction
...
func transferTokenPoolOwnershipSequence(b operations.Bundle, deps deps.AptosDeps, in TransferTokenPoolOwnershipsSeqInput) (mcmstypes.BatchOperation, error) {
	var txs []mcmstypes.Transaction
...
func acceptTokenPoolOwnershipsSequence(b operations.Bundle, deps deps.AptosDeps, in AcceptTokenPoolOwnershipsSeqInput) (mcmstypes.BatchOperation, error) {
	var txs []mcmstypes.Transaction
...
func executeTokenPoolOwnershipTransfersSequence(b operations.Bundle, deps deps.AptosDeps, in ExecuteTokenPoolOwnershipTransfersSeqInput) (mcmstypes.BatchOperation, error) {
	var txs []mcmstypes.Transaction
