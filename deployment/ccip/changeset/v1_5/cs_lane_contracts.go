...
func (c *DeployLanesConfig) Validate(e cldf.Environment, state changeset.CCIPOnChainState) error {
...
func (c *DeployLaneConfig) Validate(e cldf.Environment, state changeset.CCIPOnChainState) error {
...
func deployLane(e cldf.Environment, state changeset.CCIPOnChainState, ab cldf.AddressBook, cfg DeployLaneConfig) error {
...
func arePrerequisitesMet(chainState changeset.CCIPChainState, chain cldf.Chain) error {
