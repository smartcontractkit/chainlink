...
func setFeedAdminLogic(env cldf.Environment, c types.SetFeedAdminTronConfig) (cldf.ChangesetOutput, error) {
	...
	txInfo, err := chain.TriggerContractAndConfirm(context.Background(), c.CacheAddress, "setFeedAdmin(address,bool)", []interface{}{"address", c.AdminAddress, "bool", c.IsAdmin})
	if err != nil {
