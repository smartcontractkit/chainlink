...
// Use local ccip-base repository for development
replace github.com/smartcontractkit/ccip-base/chains/solana/go_bindings => ../../ccip-base/chains/solana/go_bindings
