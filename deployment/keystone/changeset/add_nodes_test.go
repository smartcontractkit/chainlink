			...
			for _, tc := range cases {
				...
				t.Run(tc.name, func(t *testing.T) {
					...
					if !useMCMS {
						...
						require.NotNil(t, r.MCMSTimelockProposals) //nolint:staticcheck //SA1019 ignoring deprecated field for compatibility; we don't have tools to generate the new field
						require.Len(t, r.MCMSTimelockProposals, 1) //nolint:staticcheck //SA1019 ignoring deprecated field for compatibility; we don't have tools to generate the new field
