...
type TxManager[CHAIN_ID types.ID, HEAD types.Head[BLOCK_HASH], ADDR types.Hashable, TX_HASH types.Hashable, BLOCK_HASH types.Hashable, SEQ types.Sequence, FEE feetypes.Fee, ERROR error] struct {
	mock.Mock
}

// Close provides a mock function with given fields:
func (_m *TxManager[CHAIN_ID, HEAD, ADDR, TX_HASH, BLOCK_HASH, SEQ, FEE, ERROR]) Close() error {
	ret := _m.Called()
...
func (_m *TxManager[CHAIN_ID, HEAD, ADDR, TX_HASH, BLOCK_HASH, SEQ, FEE, ERROR]) CountTransactionsByState(ctx context.Context, state txmgrtypes.TxState) (uint32, error) {
...
func (_m *TxManager[CHAIN_ID, HEAD, ADDR, TX_HASH, BLOCK_HASH, SEQ, FEE, ERROR]) CreateTransaction(ctx context.Context, txRequest txmgrtypes.TxRequest[ADDR, TX_HASH]) (txmgrtypes.Tx[CHAIN_ID, ADDR, TX_HASH, BLOCK_HASH, SEQ, FEE], error) {
...
func (_m *TxManager[CHAIN_ID, HEAD, ADDR, TX_HASH, BLOCK_HASH, SEQ, FEE, ERROR]) FindEarliestUnconfirmedBroadcastTime(ctx context.Context) (null.Time, error) {
	ret := _m.Called(ctx)
...
func (_m *TxManager[CHAIN_ID, HEAD, ADDR, TX_HASH, BLOCK_HASH, SEQ, FEE, ERROR]) FindEarliestUnconfirmedTxAttemptBlock(ctx context.Context) (null.Int, error) {
	ret := _m.Called(ctx)
...
func (_m *TxManager[CHAIN_ID, HEAD, ADDR, TX_HASH, BLOCK_HASH, SEQ, FEE, ERROR]) FindTxesByMetaFieldAndStates(ctx context.Context, metaField string, metaValue string, states []txmgrtypes.TxState, chainID *big.Int) ([]*txmgrtypes.Tx[CHAIN_ID, ADDR, TX_HASH, BLOCK_HASH, SEQ, FEE], error) {
...
func (_m *TxManager[CHAIN_ID, HEAD, ADDR, TX_HASH, BLOCK_HASH, SEQ, FEE, ERROR]) FindTxesWithAttemptsAndReceiptsByIdsAndState(ctx context.Context, ids []int64, states []txmgrtypes.TxState, chainID *big.Int) ([]*txmgrtypes.Tx[CHAIN_ID, ADDR, TX_HASH, BLOCK_HASH, SEQ, FEE], error) {
...
func (_m *TxManager[CHAIN_ID, HEAD, ADDR, TX_HASH, BLOCK_HASH, SEQ, FEE, ERROR]) FindTxesWithMetaFieldByReceiptBlockNum(ctx context.Context, metaField string, blockNum int64, chainID *big.Int) ([]*txmgrtypes.Tx[CHAIN_ID, ADDR, TX_HASH, BLOCK_HASH, SEQ, FEE], error) {
...
func (_m *TxManager[CHAIN_ID, HEAD, ADDR, TX_HASH, BLOCK_HASH, SEQ, FEE, ERROR]) FindTxesWithMetaFieldByStates(ctx context.Context, metaField string, states []txmgrtypes.TxState, chainID *big.Int) ([]*txmgrtypes.Tx[CHAIN_ID, ADDR, TX_HASH, BLOCK_HASH, SEQ, FEE], error) {
...
func (_m *TxManager[CHAIN_ID, HEAD, ADDR, TX_HASH, BLOCK_HASH, SEQ, FEE, ERROR]) GetForwarderForEOA(ctx context.Context, eoa ADDR) (ADDR, error) {
...
func (_m *TxManager[CHAIN_ID, HEAD, ADDR, TX_HASH, BLOCK_HASH, SEQ, FEE, ERROR]) HealthReport() map[string]error {
	ret := _m.Called()
...
func (_m *TxManager[CHAIN_ID, HEAD, ADDR, TX_HASH, BLOCK_HASH, SEQ, FEE, ERROR]) Name() string {
	ret := _m.Called()
...
func (_m *TxManager[CHAIN_ID, HEAD, ADDR, TX_HASH, BLOCK_HASH, SEQ, FEE, ERROR]) OnNewLongestChain(ctx context.Context, head HEAD) {
	_m.Called(ctx, head)
}

// Ready provides a mock function with given fields:
func (_m *TxManager[CHAIN_ID, HEAD, ADDR, TX_HASH, BLOCK_HASH, SEQ, FEE, ERROR]) Ready() error {
	ret := _m.Called()
...
func (_m *TxManager[CHAIN_ID, HEAD, ADDR, TX_HASH, BLOCK_HASH, SEQ, FEE, ERROR]) RegisterResumeCallback(fn txmgr.ResumeCallback) {
	_m.Called(fn)
}

// Reset provides a mock function with given fields: addr, abandon
func (_m *TxManager[CHAIN_ID, HEAD, ADDR, TX_HASH, BLOCK_HASH, SEQ, FEE, ERROR]) Reset(addr ADDR, abandon bool) error {
...
func (_m *TxManager[CHAIN_ID, HEAD, ADDR, TX_HASH, BLOCK_HASH, SEQ, FEE, ERROR]) SendNativeToken(ctx context.Context, chainID CHAIN_ID, from ADDR, to ADDR, value big.Int, gasLimit uint64) (txmgrtypes.Tx[CHAIN_ID, ADDR, TX_HASH, BLOCK_HASH, SEQ, FEE], error) {
...
func (_m *TxManager[CHAIN_ID, HEAD, ADDR, TX_HASH, BLOCK_HASH, SEQ, FEE, ERROR]) Start(_a0 context.Context) error {
	ret := _m.Called(_a0)
...
func (_m *TxManager[CHAIN_ID, HEAD, ADDR, TX_HASH, BLOCK_HASH, SEQ, FEE, ERROR]) Trigger(addr ADDR) {
	_m.Called(addr)
}

// TxStatusByIdempotencyKey provides a mock function with given fields: ctx, idempotency
func (_m *TxManager[CHAIN_ID, HEAD, ADDR, TX_HASH, BLOCK_HASH, SEQ, FEE, ERROR]) TxStatusByIdempotencyKey(ctx context.Context, idempotency string) (txmgrtypes.TxState, ERROR, error) {
	ret := _m.Called(ctx, idempotency)

	if len(ret) == 0 {
		panic("no return value specified for TxStatusByIdempotencyKey")
	}

	var r0 txmgrtypes.TxState
	var r1 ERROR
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (txmgrtypes.TxState, ERROR, error)); ok {
		return rf(ctx, idempotency)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) txmgrtypes.TxState); ok {
		r0 = rf(ctx, idempotency)
	} else {
		r0 = ret.Get(0).(txmgrtypes.TxState)
	}

	if rf, ok := ret.Get(1).(func(context.Context, string) ERROR); ok {
		r1 = rf(ctx, idempotency)
	} else {
		r1 = ret.Get(1).(ERROR)
	}

	if rf, ok := ret.Get(2).(func(context.Context, string) error); ok {
		r2 = rf(ctx, idempotency)
	} else {
		r2 = ret.Error(2)
	}
...
func NewTxManager[CHAIN_ID types.ID, HEAD types.Head[BLOCK_HASH], ADDR types.Hashable, TX_HASH types.Hashable, BLOCK_HASH types.Hashable, SEQ types.Sequence, FEE feetypes.Fee, ERROR error](t interface {
	mock.TestingT
	Cleanup(func())
}) *TxManager[CHAIN_ID, HEAD, ADDR, TX_HASH, BLOCK_HASH, SEQ, FEE, ERROR] {
	mock := &TxManager[CHAIN_ID, HEAD, ADDR, TX_HASH, BLOCK_HASH, SEQ, FEE, ERROR]{}
	mock.Mock.Test(t)
