...
type TransactionStore[
	...
	GetNonFatalTransactions(ctx context.Context) (txs []*Tx[CHAIN_ID, ADDR, TX_HASH, BLOCK_HASH, SEQ, FEE], err error)
	GetFatalTransactions(ctx context.Context) (txs []*Tx[CHAIN_ID, ADDR, TX_HASH, BLOCK_HASH, SEQ, FEE], err error)
	...
	UpdateTxAbandoned(ctx context.Context, etx *Tx[CHAIN_ID, ADDR, TX_HASH, BLOCK_HASH, SEQ, FEE]) error
	...
	IsTxFinalized(ctx context.Context, blockHeight int64, txID int64) (finalized bool, err error)
}
