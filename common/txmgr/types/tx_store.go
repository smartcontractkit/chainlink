...
type TxStore[
	...
	// Find confirmed txes before the LatestFinalizedBlockNum param that require callback but have not yet been signaled
	FindTxesPendingCallback(ctx context.Context, latestFinalizedBlockNum int64, chainID CHAIN_ID) (receiptsPlus []ReceiptPlus[R], err error)
...
type TransactionStore[
	...
	UpdateTxesFinalized(ctx context.Context, etxs []int64, chainId CHAIN_ID) error
