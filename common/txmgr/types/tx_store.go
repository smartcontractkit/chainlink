...
type TransactionStore[
	...
	// Search for Tx using the requestID and chainID
	FindTxWithRequestID(requestID string, chainID CHAIN_ID) (tx *Tx[CHAIN_ID, ADDR, TX_HASH, BLOCK_HASH, SEQ, FEE], err error)
