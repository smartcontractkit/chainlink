...
func (_m *ChainReceipt[THASH, BHASH]) GetBlockHash() BHASH {
	ret := _m.Called()
	...
	var r0 BHASH
	if rf, ok := ret.Get(0).(func() BHASH); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(BHASH)
...
func (_c *ChainReceipt_GetBlockHash_Call[THASH, BHASH]) Return(_a0 BHASH) *ChainReceipt_GetBlockHash_Call[THASH, BHASH] {
	_c.Call.Return(_a0)
	return _c
}

func (_c *ChainReceipt_GetBlockHash_Call[THASH, BHASH]) RunAndReturn(run func() BHASH) *ChainReceipt_GetBlockHash_Call[THASH, BHASH] {
	_c.Call.Return(run)
	return _c
}
...
func (_m *ChainReceipt[THASH, BHASH]) GetTxHash() THASH {
	ret := _m.Called()
	...
	var r0 THASH
	if rf, ok := ret.Get(0).(func() THASH); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(THASH)
...
func (_c *ChainReceipt_GetTxHash_Call[THASH, BHASH]) Return(_a0 THASH) *ChainReceipt_GetTxHash_Call[THASH, BHASH] {
	_c.Call.Return(_a0)
	return _c
}

func (_c *ChainReceipt_GetTxHash_Call[THASH, BHASH]) RunAndReturn(run func() THASH) *ChainReceipt_GetTxHash_Call[THASH, BHASH] {
	_c.Call.Return(run)
	return _c
}
