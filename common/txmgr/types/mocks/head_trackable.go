...
type HeadTrackable[H types.Head[HASH], HASH types.Hashable] struct {
	mock.Mock
}

// OnNewLongestChain provides a mock function with given fields: ctx, head
func (_m *HeadTrackable[H, HASH]) OnNewLongestChain(ctx context.Context, head H) {
	_m.Called(ctx, head)
}
...
func NewHeadTrackable[H types.Head[HASH], HASH types.Hashable](t mockConstructorTestingTNewHeadTrackable) *HeadTrackable[H, HASH] {
	mock := &HeadTrackable[H, HASH]{}
	mock.Mock.Test(t)
