...
type ForwarderManager[ADDR chains.Hashable] struct {
	mock.Mock
}

type ForwarderManager_Expecter[ADDR chains.Hashable] struct {
	mock *mock.Mock
}
...
type ForwarderManager_Close_Call[ADDR chains.Hashable] struct {
	*mock.Call
}
...
type ForwarderManager_ConvertPayload_Call[ADDR chains.Hashable] struct {
	*mock.Call
}
...
type ForwarderManager_ForwarderFor_Call[ADDR chains.Hashable] struct {
	*mock.Call
}
...
type ForwarderManager_ForwarderForOCR2Feeds_Call[ADDR chains.Hashable] struct {
	*mock.Call
}
...
type ForwarderManager_HealthReport_Call[ADDR chains.Hashable] struct {
	*mock.Call
}
...
type ForwarderManager_Name_Call[ADDR chains.Hashable] struct {
	*mock.Call
}
...
type ForwarderManager_Ready_Call[ADDR chains.Hashable] struct {
	*mock.Call
}
...
type ForwarderManager_Start_Call[ADDR chains.Hashable] struct {
	*mock.Call
}
...
func NewForwarderManager[ADDR chains.Hashable](t interface {
	mock.TestingT
	Cleanup(func())
