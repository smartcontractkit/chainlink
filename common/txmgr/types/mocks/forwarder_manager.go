...
type ForwarderManager[ADDR types.Hashable[ADDR]] struct {
	mock.Mock
}
...
func NewForwarderManager[ADDR types.Hashable[ADDR]](t mockConstructorTestingTNewForwarderManager) *ForwarderManager[ADDR] {
