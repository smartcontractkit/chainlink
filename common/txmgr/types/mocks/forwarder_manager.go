...
// ForwarderForOCR2 provides a mock function with given fields: eoa, ocr2Aggregator
func (_m *ForwarderManager[ADDR]) ForwarderForOCR2(eoa ADDR, ocr2Aggregator ADDR) (ADDR, error) {
	ret := _m.Called(eoa, ocr2Aggregator)

	if len(ret) == 0 {
		panic("no return value specified for ForwarderForOCR2")
	}
