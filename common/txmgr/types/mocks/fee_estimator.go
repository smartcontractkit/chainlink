...
type FeeEstimator[H types.Head, F types.Fee, MAXPRICE interface{}, TX_HASH commontypes.Hashable[TX_HASH]] struct {
	mock.Mock
}
...
func NewFeeEstimator[H types.Head, F types.Fee, MAXPRICE interface{}, TX_HASH commontypes.Hashable[TX_HASH]](t mockConstructorTestingTNewFeeEstimator) *FeeEstimator[H, F, MAXPRICE, TX_HASH] {
