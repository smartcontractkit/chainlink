...
type FeeEstimator[H types.Head, F interface{}, MAXPRICE interface{}, TX_HASH commontypes.Hashable] struct {
	mock.Mock
}
...
func NewFeeEstimator[H types.Head, F interface{}, MAXPRICE interface{}, TX_HASH commontypes.Hashable](t mockConstructorTestingTNewFeeEstimator) *FeeEstimator[H, F, MAXPRICE, TX_HASH] {
