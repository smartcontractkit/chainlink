...
type FeeEstimator[HEAD interface{}, FEE interface{}, MAXPRICE interface{}, HASH interface{}] struct {
	mock.Mock
}
...
func (_m *FeeEstimator[HEAD, FEE, MAXPRICE, HASH]) Close() error {
	ret := _m.Called()
...
func (_m *FeeEstimator[HEAD, FEE, MAXPRICE, HASH]) OnNewLongestChain(ctx context.Context, head types.HeadView[HEAD]) {
	_m.Called(ctx, head)
}

// Start provides a mock function with given fields: _a0
func (_m *FeeEstimator[HEAD, FEE, MAXPRICE, HASH]) Start(_a0 context.Context) error {
	ret := _m.Called(_a0)
...
func NewFeeEstimator[HEAD interface{}, FEE interface{}, MAXPRICE interface{}, HASH interface{}](t mockConstructorTestingTNewFeeEstimator) *FeeEstimator[HEAD, FEE, MAXPRICE, HASH] {
	mock := &FeeEstimator[HEAD, FEE, MAXPRICE, HASH]{}
	mock.Mock.Test(t)
