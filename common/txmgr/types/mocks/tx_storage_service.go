...
// TxStorageService is an autogenerated mock type for the TxStorageService type
type TxStorageService[ADDR interface{}, CHAINID interface{}, TX_HASH types.Hashable[TX_HASH], BLOCK_HASH types.Hashable[BLOCK_HASH], NEWTX interface{}, R interface{}, TX interface{}, TXATTEMPT interface{}, TXID interface{}, TXMETA interface{}] struct {
	mock.Mock
}

// CheckEthTxQueueCapacity provides a mock function with given fields: fromAddress, maxQueuedTransactions, chainID, qopts
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) CheckEthTxQueueCapacity(fromAddress ADDR, maxQueuedTransactions uint64, chainID CHAINID, qopts ...pg.QOpt) error {
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) Close() {
	_m.Called()
}

// CountUnconfirmedTransactions provides a mock function with given fields: fromAddress, chainID, qopts
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) CountUnconfirmedTransactions(fromAddress ADDR, chainID CHAINID, qopts ...pg.QOpt) (uint32, error) {
	_va := make([]interface{}, len(qopts))
	for _i := range qopts {
		_va[_i] = qopts[_i]
	}
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) CountUnstartedTransactions(fromAddress ADDR, chainID CHAINID, qopts ...pg.QOpt) (uint32, error) {
	_va := make([]interface{}, len(qopts))
	for _i := range qopts {
		_va[_i] = qopts[_i]
	}
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) CreateEthTransaction(newTx NEWTX, chainID CHAINID, qopts ...pg.QOpt) (txmgrtypes.Transaction, error) {
	_va := make([]interface{}, len(qopts))
	for _i := range qopts {
		_va[_i] = qopts[_i]
	}
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) DeleteInProgressAttempt(ctx context.Context, attempt TXATTEMPT) error {
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) EthTransactions(offset int, limit int) ([]TX, int, error) {
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) EthTransactionsWithAttempts(offset int, limit int) ([]TX, int, error) {
	ret := _m.Called(offset, limit)
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) EthTxAttempts(offset int, limit int) ([]TXATTEMPT, int, error) {
	ret := _m.Called(offset, limit)
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) FindEthReceiptsPendingConfirmation(ctx context.Context, blockNum int64, chainID CHAINID) ([]txmgrtypes.ReceiptPlus[R], error) {
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) FindEthTxAttempt(hash TX_HASH) (*TXATTEMPT, error) {
	ret := _m.Called(hash)
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) FindEthTxAttemptConfirmedByEthTxIDs(ids []TXID) ([]TXATTEMPT, error) {
	ret := _m.Called(ids)
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) FindEthTxAttemptsByEthTxIDs(ids []TXID) ([]TXATTEMPT, error) {
	ret := _m.Called(ids)
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) FindEthTxAttemptsRequiringReceiptFetch(chainID CHAINID) ([]TXATTEMPT, error) {
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) FindEthTxAttemptsRequiringResend(olderThan time.Time, maxInFlightTransactions uint32, chainID CHAINID, address ADDR) ([]TXATTEMPT, error) {
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) FindEthTxByHash(hash TX_HASH) (*TX, error) {
	ret := _m.Called(hash)
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) FindEthTxWithAttempts(etxID TXID) (TX, error) {
	ret := _m.Called(etxID)
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) FindEthTxWithNonce(fromAddress ADDR, nonce TXMETA) (*TX, error) {
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) FindEthTxsRequiringGasBump(ctx context.Context, address ADDR, blockNum int64, gasBumpThreshold int64, depth int64, chainID CHAINID) ([]*TX, error) {
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) FindEthTxsRequiringResubmissionDueToInsufficientEth(address ADDR, chainID CHAINID, qopts ...pg.QOpt) ([]*TX, error) {
	_va := make([]interface{}, len(qopts))
	for _i := range qopts {
		_va[_i] = qopts[_i]
	}
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) FindEtxAttemptsConfirmedMissingReceipt(chainID CHAINID) ([]TXATTEMPT, error) {
	ret := _m.Called(chainID)
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) FindNextUnstartedTransactionFromAddress(etx *TX, fromAddress ADDR, chainID CHAINID, qopts ...pg.QOpt) error {
	_va := make([]interface{}, len(qopts))
	for _i := range qopts {
		_va[_i] = qopts[_i]
	}
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) FindTransactionsConfirmedInBlockRange(highBlockNumber int64, lowBlockNumber int64, chainID CHAINID) ([]*TX, error) {
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) GetEthTxInProgress(fromAddress ADDR, qopts ...pg.QOpt) (*TX, error) {
	_va := make([]interface{}, len(qopts))
	for _i := range qopts {
		_va[_i] = qopts[_i]
	}
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) GetInProgressEthTxAttempts(ctx context.Context, address ADDR, chainID CHAINID) ([]TXATTEMPT, error) {
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) HasInProgressTransaction(account ADDR, chainID CHAINID, qopts ...pg.QOpt) (bool, error) {
	_va := make([]interface{}, len(qopts))
	for _i := range qopts {
		_va[_i] = qopts[_i]
	}
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) InsertEthReceipt(receipt *txmgrtypes.Receipt[R, TX_HASH, BLOCK_HASH]) error {
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) InsertEthTx(etx *TX) error {
	ret := _m.Called(etx)
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) InsertEthTxAttempt(attempt *TXATTEMPT) error {
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) LoadEthTxAttempts(etx *TX, qopts ...pg.QOpt) error {
	_va := make([]interface{}, len(qopts))
	for _i := range qopts {
		_va[_i] = qopts[_i]
	}
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) LoadEthTxesAttempts(etxs []*TX, qopts ...pg.QOpt) error {
	_va := make([]interface{}, len(qopts))
	for _i := range qopts {
		_va[_i] = qopts[_i]
	}
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) MarkAllConfirmedMissingReceipt(chainID CHAINID) error {
	ret := _m.Called(chainID)
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) MarkOldTxesMissingReceiptAsErrored(blockNum int64, finalityDepth uint32, chainID CHAINID, qopts ...pg.QOpt) error {
	_va := make([]interface{}, len(qopts))
	for _i := range qopts {
		_va[_i] = qopts[_i]
	}
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) PreloadEthTxes(attempts []TXATTEMPT) error {
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) PruneUnstartedTxQueue(queueSize uint32, subject uuid.UUID, qopts ...pg.QOpt) (int64, error) {
	_va := make([]interface{}, len(qopts))
	for _i := range qopts {
		_va[_i] = qopts[_i]
	}
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) SaveConfirmedMissingReceiptAttempt(ctx context.Context, timeout time.Duration, attempt *TXATTEMPT, broadcastAt time.Time) error {
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) SaveFetchedReceipts(receipts []R, chainID CHAINID) error {
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) SaveInProgressAttempt(attempt *TXATTEMPT) error {
	ret := _m.Called(attempt)
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) SaveInsufficientEthAttempt(timeout time.Duration, attempt *TXATTEMPT, broadcastAt time.Time) error {
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) SaveReplacementInProgressAttempt(oldAttempt TXATTEMPT, replacementAttempt *TXATTEMPT, qopts ...pg.QOpt) error {
	_va := make([]interface{}, len(qopts))
	for _i := range qopts {
		_va[_i] = qopts[_i]
	}
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) SaveSentAttempt(timeout time.Duration, attempt *TXATTEMPT, broadcastAt time.Time) error {
	ret := _m.Called(timeout, attempt, broadcastAt)
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) SetBroadcastBeforeBlockNum(blockNum int64, chainID CHAINID) error {
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) UpdateBroadcastAts(now time.Time, etxIDs []TXID) error {
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) UpdateEthKeyNextNonce(newNextNonce TXMETA, currentNextNonce TXMETA, address ADDR, chainID CHAINID, qopts ...pg.QOpt) error {
	_va := make([]interface{}, len(qopts))
	for _i := range qopts {
		_va[_i] = qopts[_i]
	}
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) UpdateEthTxAttemptInProgressToBroadcast(etx *TX, attempt TXATTEMPT, NewAttemptState txmgrtypes.TxAttemptState, incrNextNonceCallback func(pg.Queryer) error, qopts ...pg.QOpt) error {
	_va := make([]interface{}, len(qopts))
	for _i := range qopts {
		_va[_i] = qopts[_i]
	}
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) UpdateEthTxFatalError(etx *TX, qopts ...pg.QOpt) error {
	_va := make([]interface{}, len(qopts))
	for _i := range qopts {
		_va[_i] = qopts[_i]
	}
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) UpdateEthTxForRebroadcast(etx TX, etxAttempt TXATTEMPT) error {
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) UpdateEthTxUnstartedToInProgress(etx *TX, attempt *TXATTEMPT, qopts ...pg.QOpt) error {
	_va := make([]interface{}, len(qopts))
	for _i := range qopts {
		_va[_i] = qopts[_i]
	}
...
func (_m *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]) UpdateEthTxsUnconfirmed(ids []int64) error {
	ret := _m.Called(ids)
...
type mockConstructorTestingTNewTxStorageService interface {
	mock.TestingT
	Cleanup(func())
}

// NewTxStorageService creates a new instance of TxStorageService. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewTxStorageService[ADDR interface{}, CHAINID interface{}, TX_HASH types.Hashable[TX_HASH], BLOCK_HASH types.Hashable[BLOCK_HASH], NEWTX interface{}, R interface{}, TX interface{}, TXATTEMPT interface{}, TXID interface{}, TXMETA interface{}](t mockConstructorTestingTNewTxStorageService) *TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA] {
	mock := &TxStorageService[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA]{}
	mock.Mock.Test(t)
