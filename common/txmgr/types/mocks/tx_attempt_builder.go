...
type TxAttemptBuilder[HEAD types.Head, FEE types.Fee, ADDR commontypes.Hashable[ADDR], TX_HASH commontypes.Hashable[TX_HASH], TX interface{}, TXATTEMPT interface{}] struct {
	mock.Mock
}

// Close provides a mock function with given fields:
func (_m *TxAttemptBuilder[HEAD, FEE, ADDR, TX_HASH, TX, TXATTEMPT]) Close() error {
	ret := _m.Called()
...
func (_m *TxAttemptBuilder[HEAD, FEE, ADDR, TX_HASH, TX, TXATTEMPT]) HealthReport() map[string]error {
	ret := _m.Called()
...
func (_m *TxAttemptBuilder[HEAD, FEE, ADDR, TX_HASH, TX, TXATTEMPT]) Name() string {
	ret := _m.Called()
...
func (_m *TxAttemptBuilder[HEAD, FEE, ADDR, TX_HASH, TX, TXATTEMPT]) NewBumpTxAttempt(ctx context.Context, tx TX, previousAttempt TXATTEMPT, priorAttempts []types.PriorAttempt[FEE, TX_HASH], lggr logger.Logger) (TXATTEMPT, FEE, uint32, bool, error) {
...
func (_m *TxAttemptBuilder[HEAD, FEE, ADDR, TX_HASH, TX, TXATTEMPT]) NewCustomTxAttempt(tx TX, fee FEE, gasLimit uint32, txType int, lggr logger.Logger) (TXATTEMPT, bool, error) {
...
func (_m *TxAttemptBuilder[HEAD, FEE, ADDR, TX_HASH, TX, TXATTEMPT]) NewEmptyTxAttempt(nonce uint64, feeLimit uint32, fee FEE, fromAddress ADDR) (TXATTEMPT, error) {
...
func (_m *TxAttemptBuilder[HEAD, FEE, ADDR, TX_HASH, TX, TXATTEMPT]) NewTxAttempt(ctx context.Context, tx TX, lggr logger.Logger, opts ...types.Opt) (TXATTEMPT, FEE, uint32, bool, error) {
...
func (_m *TxAttemptBuilder[HEAD, FEE, ADDR, TX_HASH, TX, TXATTEMPT]) NewTxAttemptWithType(ctx context.Context, tx TX, lggr logger.Logger, txType int, opts ...types.Opt) (TXATTEMPT, FEE, uint32, bool, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *TxAttemptBuilder[HEAD, FEE, ADDR, TX_HASH, TX, TXATTEMPT]) OnNewLongestChain(ctx context.Context, head HEAD) {
	_m.Called(ctx, head)
}

// Ready provides a mock function with given fields:
func (_m *TxAttemptBuilder[HEAD, FEE, ADDR, TX_HASH, TX, TXATTEMPT]) Ready() error {
	ret := _m.Called()
...
func (_m *TxAttemptBuilder[HEAD, FEE, ADDR, TX_HASH, TX, TXATTEMPT]) Start(_a0 context.Context) error {
	ret := _m.Called(_a0)
...
func NewTxAttemptBuilder[HEAD types.Head, FEE types.Fee, ADDR commontypes.Hashable[ADDR], TX_HASH commontypes.Hashable[TX_HASH], TX interface{}, TXATTEMPT interface{}](t mockConstructorTestingTNewTxAttemptBuilder) *TxAttemptBuilder[HEAD, FEE, ADDR, TX_HASH, TX, TXATTEMPT] {
	mock := &TxAttemptBuilder[HEAD, FEE, ADDR, TX_HASH, TX, TXATTEMPT]{}
	mock.Mock.Test(t)
