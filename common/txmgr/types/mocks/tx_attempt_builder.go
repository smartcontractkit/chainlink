...
type TxAttemptBuilder[HEAD types.Head[TX_HASH], FEE txmgrtypes.Fee, ADDR types.Hashable, TX_HASH types.Hashable, TX interface{}, TXATTEMPT interface{}, SEQ txmgrtypes.Sequence] struct {
	mock.Mock
}
...
func (_m *TxAttemptBuilder[HEAD, FEE, ADDR, TX_HASH, TX, TXATTEMPT, SEQ]) NewBumpTxAttempt(ctx context.Context, tx TX, previousAttempt TXATTEMPT, priorAttempts []txmgrtypes.PriorAttempt[FEE, TX_HASH], lggr logger.Logger) (TXATTEMPT, FEE, uint32, bool, error) {
	...
	var r3 bool
	var r4 error
	if rf, ok := ret.Get(0).(func(context.Context, TX, TXATTEMPT, []txmgrtypes.PriorAttempt[FEE, TX_HASH], logger.Logger) (TXATTEMPT, FEE, uint32, bool, error)); ok {
		return rf(ctx, tx, previousAttempt, priorAttempts, lggr)
	}
	if rf, ok := ret.Get(0).(func(context.Context, TX, TXATTEMPT, []txmgrtypes.PriorAttempt[FEE, TX_HASH], logger.Logger) TXATTEMPT); ok {
		r0 = rf(ctx, tx, previousAttempt, priorAttempts, lggr)
	} else {
		r0 = ret.Get(0).(TXATTEMPT)
	}

	if rf, ok := ret.Get(1).(func(context.Context, TX, TXATTEMPT, []txmgrtypes.PriorAttempt[FEE, TX_HASH], logger.Logger) FEE); ok {
		r1 = rf(ctx, tx, previousAttempt, priorAttempts, lggr)
	} else {
		r1 = ret.Get(1).(FEE)
	}

	if rf, ok := ret.Get(2).(func(context.Context, TX, TXATTEMPT, []txmgrtypes.PriorAttempt[FEE, TX_HASH], logger.Logger) uint32); ok {
		r2 = rf(ctx, tx, previousAttempt, priorAttempts, lggr)
	} else {
		r2 = ret.Get(2).(uint32)
	}

	if rf, ok := ret.Get(3).(func(context.Context, TX, TXATTEMPT, []txmgrtypes.PriorAttempt[FEE, TX_HASH], logger.Logger) bool); ok {
		r3 = rf(ctx, tx, previousAttempt, priorAttempts, lggr)
	} else {
		r3 = ret.Get(3).(bool)
	}

	if rf, ok := ret.Get(4).(func(context.Context, TX, TXATTEMPT, []txmgrtypes.PriorAttempt[FEE, TX_HASH], logger.Logger) error); ok {
...
func (_m *TxAttemptBuilder[HEAD, FEE, ADDR, TX_HASH, TX, TXATTEMPT, SEQ]) NewTxAttempt(ctx context.Context, tx TX, lggr logger.Logger, opts ...txmgrtypes.Opt) (TXATTEMPT, FEE, uint32, bool, error) {
	...
	var r3 bool
	var r4 error
	if rf, ok := ret.Get(0).(func(context.Context, TX, logger.Logger, ...txmgrtypes.Opt) (TXATTEMPT, FEE, uint32, bool, error)); ok {
		return rf(ctx, tx, lggr, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, TX, logger.Logger, ...txmgrtypes.Opt) TXATTEMPT); ok {
		r0 = rf(ctx, tx, lggr, opts...)
	} else {
		r0 = ret.Get(0).(TXATTEMPT)
	}

	if rf, ok := ret.Get(1).(func(context.Context, TX, logger.Logger, ...txmgrtypes.Opt) FEE); ok {
		r1 = rf(ctx, tx, lggr, opts...)
	} else {
		r1 = ret.Get(1).(FEE)
	}

	if rf, ok := ret.Get(2).(func(context.Context, TX, logger.Logger, ...txmgrtypes.Opt) uint32); ok {
		r2 = rf(ctx, tx, lggr, opts...)
	} else {
		r2 = ret.Get(2).(uint32)
	}

	if rf, ok := ret.Get(3).(func(context.Context, TX, logger.Logger, ...txmgrtypes.Opt) bool); ok {
		r3 = rf(ctx, tx, lggr, opts...)
	} else {
		r3 = ret.Get(3).(bool)
	}

	if rf, ok := ret.Get(4).(func(context.Context, TX, logger.Logger, ...txmgrtypes.Opt) error); ok {
...
func (_m *TxAttemptBuilder[HEAD, FEE, ADDR, TX_HASH, TX, TXATTEMPT, SEQ]) NewTxAttemptWithType(ctx context.Context, tx TX, lggr logger.Logger, txType int, opts ...txmgrtypes.Opt) (TXATTEMPT, FEE, uint32, bool, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r3 bool
	var r4 error
	if rf, ok := ret.Get(0).(func(context.Context, TX, logger.Logger, int, ...txmgrtypes.Opt) (TXATTEMPT, FEE, uint32, bool, error)); ok {
		return rf(ctx, tx, lggr, txType, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, TX, logger.Logger, int, ...txmgrtypes.Opt) TXATTEMPT); ok {
		r0 = rf(ctx, tx, lggr, txType, opts...)
	} else {
		r0 = ret.Get(0).(TXATTEMPT)
	}

	if rf, ok := ret.Get(1).(func(context.Context, TX, logger.Logger, int, ...txmgrtypes.Opt) FEE); ok {
		r1 = rf(ctx, tx, lggr, txType, opts...)
	} else {
		r1 = ret.Get(1).(FEE)
	}

	if rf, ok := ret.Get(2).(func(context.Context, TX, logger.Logger, int, ...txmgrtypes.Opt) uint32); ok {
		r2 = rf(ctx, tx, lggr, txType, opts...)
	} else {
		r2 = ret.Get(2).(uint32)
	}

	if rf, ok := ret.Get(3).(func(context.Context, TX, logger.Logger, int, ...txmgrtypes.Opt) bool); ok {
		r3 = rf(ctx, tx, lggr, txType, opts...)
	} else {
		r3 = ret.Get(3).(bool)
	}

	if rf, ok := ret.Get(4).(func(context.Context, TX, logger.Logger, int, ...txmgrtypes.Opt) error); ok {
...
func NewTxAttemptBuilder[HEAD types.Head[TX_HASH], FEE txmgrtypes.Fee, ADDR types.Hashable, TX_HASH types.Hashable, TX interface{}, TXATTEMPT interface{}, SEQ txmgrtypes.Sequence](t mockConstructorTestingTNewTxAttemptBuilder) *TxAttemptBuilder[HEAD, FEE, ADDR, TX_HASH, TX, TXATTEMPT, SEQ] {
