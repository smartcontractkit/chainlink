...
type TxAttemptBuilder[HEAD types.Head, FEE types.Fee, ADDR commontypes.Hashable, TX_HASH commontypes.Hashable, TX interface{}, TXATTEMPT interface{}] struct {
	mock.Mock
}
...
func NewTxAttemptBuilder[HEAD types.Head, FEE types.Fee, ADDR commontypes.Hashable, TX_HASH commontypes.Hashable, TX interface{}, TXATTEMPT interface{}](t mockConstructorTestingTNewTxAttemptBuilder) *TxAttemptBuilder[HEAD, FEE, ADDR, TX_HASH, TX, TXATTEMPT] {
