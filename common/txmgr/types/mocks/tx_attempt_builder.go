...
type TxAttemptBuilder[HEAD types.Head, FEE types.Fee, ADDR commontypes.Hashable[ADDR], TX_HASH commontypes.Hashable[TX_HASH], TX interface{}, TXATTEMPT interface{}, SEQ types.Sequence] struct {
	mock.Mock
}
...
func NewTxAttemptBuilder[HEAD types.Head, FEE types.Fee, ADDR commontypes.Hashable[ADDR], TX_HASH commontypes.Hashable[TX_HASH], TX interface{}, TXATTEMPT interface{}, SEQ types.Sequence](t mockConstructorTestingTNewTxAttemptBuilder) *TxAttemptBuilder[HEAD, FEE, ADDR, TX_HASH, TX, TXATTEMPT, SEQ] {
