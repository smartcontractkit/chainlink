...
type TxAttemptBuilder[HEAD types.Head, FEE types.Fee, ADDR interface{}, TXHASH interface{}, GASUNIT interface{}, TX interface{}, TXATTEMPT interface{}] struct {
	mock.Mock
}

// Close provides a mock function with given fields:
func (_m *TxAttemptBuilder[HEAD, FEE, ADDR, TXHASH, GASUNIT, TX, TXATTEMPT]) Close() error {
	ret := _m.Called()
...
func (_m *TxAttemptBuilder[HEAD, FEE, ADDR, TXHASH, GASUNIT, TX, TXATTEMPT]) FeeEstimator() types.FeeEstimator[HEAD, FEE, GASUNIT, TXHASH] {
	ret := _m.Called()

	var r0 types.FeeEstimator[HEAD, FEE, GASUNIT, TXHASH]
	if rf, ok := ret.Get(0).(func() types.FeeEstimator[HEAD, FEE, GASUNIT, TXHASH]); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(types.FeeEstimator[HEAD, FEE, GASUNIT, TXHASH])
		}
	}
...
func (_m *TxAttemptBuilder[HEAD, FEE, ADDR, TXHASH, GASUNIT, TX, TXATTEMPT]) HealthReport() map[string]error {
	ret := _m.Called()
...
func (_m *TxAttemptBuilder[HEAD, FEE, ADDR, TXHASH, GASUNIT, TX, TXATTEMPT]) Name() string {
	ret := _m.Called()
...
func (_m *TxAttemptBuilder[HEAD, FEE, ADDR, TXHASH, GASUNIT, TX, TXATTEMPT]) NewBumpTxAttempt(ctx context.Context, tx TX, previousAttempt TXATTEMPT, priorAttempts []types.PriorAttempt[FEE, TXHASH], lggr logger.Logger) (TXATTEMPT, FEE, uint32, bool, error) {
...
func (_m *TxAttemptBuilder[HEAD, FEE, ADDR, TXHASH, GASUNIT, TX, TXATTEMPT]) NewCustomTxAttempt(tx TX, fee FEE, gasLimit uint32, txType int, lggr logger.Logger) (TXATTEMPT, bool, error) {
...
func (_m *TxAttemptBuilder[HEAD, FEE, ADDR, TXHASH, GASUNIT, TX, TXATTEMPT]) NewEmptyTxAttempt(nonce uint64, feeLimit uint32, fee FEE, fromAddress ADDR) (TXATTEMPT, error) {
...
func (_m *TxAttemptBuilder[HEAD, FEE, ADDR, TXHASH, GASUNIT, TX, TXATTEMPT]) NewTxAttempt(ctx context.Context, tx TX, lggr logger.Logger, opts ...types.Opt) (TXATTEMPT, FEE, uint32, bool, error) {
...
func (_m *TxAttemptBuilder[HEAD, FEE, ADDR, TXHASH, GASUNIT, TX, TXATTEMPT]) NewTxAttemptWithType(ctx context.Context, tx TX, lggr logger.Logger, txType int, opts ...types.Opt) (TXATTEMPT, FEE, uint32, bool, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *TxAttemptBuilder[HEAD, FEE, ADDR, TXHASH, GASUNIT, TX, TXATTEMPT]) OnNewLongestChain(ctx context.Context, head HEAD) {
	_m.Called(ctx, head)
}

// Ready provides a mock function with given fields:
func (_m *TxAttemptBuilder[HEAD, FEE, ADDR, TXHASH, GASUNIT, TX, TXATTEMPT]) Ready() error {
	ret := _m.Called()
...
func (_m *TxAttemptBuilder[HEAD, FEE, ADDR, TXHASH, GASUNIT, TX, TXATTEMPT]) Start(_a0 context.Context) error {
	ret := _m.Called(_a0)
...
func NewTxAttemptBuilder[HEAD types.Head, FEE types.Fee, ADDR interface{}, TXHASH interface{}, GASUNIT interface{}, TX interface{}, TXATTEMPT interface{}](t mockConstructorTestingTNewTxAttemptBuilder) *TxAttemptBuilder[HEAD, FEE, ADDR, TXHASH, GASUNIT, TX, TXATTEMPT] {
	mock := &TxAttemptBuilder[HEAD, FEE, ADDR, TXHASH, GASUNIT, TX, TXATTEMPT]{}
	mock.Mock.Test(t)
