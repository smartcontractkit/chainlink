...
type TxStore[ADDR types.Hashable[ADDR], CHAIN_ID chains.ID, TX_HASH types.Hashable[TX_HASH], BLOCK_HASH types.Hashable[BLOCK_HASH], NEWTX interface{}, R interface{}, TX interface{}, TXATTEMPT interface{}, SEQ txmgrtypes.SEQUENCE] struct {
	mock.Mock
}
...
func (_m *TxStore[ADDR, CHAIN_ID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, SEQ]) PreloadEthTxes(attempts []TXATTEMPT) error {
...
func NewTxStore[ADDR types.Hashable[ADDR], CHAIN_ID chains.ID, TX_HASH types.Hashable[TX_HASH], BLOCK_HASH types.Hashable[BLOCK_HASH], NEWTX interface{}, R interface{}, TX interface{}, TXATTEMPT interface{}, SEQ txmgrtypes.SEQUENCE](t mockConstructorTestingTNewTxStore) *TxStore[ADDR, CHAIN_ID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, SEQ] {
