...
type TxStore[ADDR types.Hashable[ADDR], CHAIN_ID txmgrtypes.ID, TX_HASH types.Hashable[TX_HASH], BLOCK_HASH types.Hashable[BLOCK_HASH], NEWTX interface{}, R interface{}, TX interface{}, TXATTEMPT interface{}, SEQ txmgrtypes.Sequence] struct {
	mock.Mock
}
...
func NewTxStore[ADDR types.Hashable[ADDR], CHAIN_ID txmgrtypes.ID, TX_HASH types.Hashable[TX_HASH], BLOCK_HASH types.Hashable[BLOCK_HASH], NEWTX interface{}, R interface{}, TX interface{}, TXATTEMPT interface{}, SEQ txmgrtypes.Sequence](t mockConstructorTestingTNewTxStore) *TxStore[ADDR, CHAIN_ID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, SEQ] {
