...
type TxStore[ADDR interface{}, CHAINID interface{}, TX_HASH types.Hashable, BLOCK_HASH types.Hashable, NEWTX interface{}, R interface{}, TX interface{}, TXATTEMPT interface{}, TXID interface{}, TXMETA interface{}] struct {
	mock.Mock
}
...
func NewTxStore[ADDR interface{}, CHAINID interface{}, TX_HASH types.Hashable, BLOCK_HASH types.Hashable, NEWTX interface{}, R interface{}, TX interface{}, TXATTEMPT interface{}, TXID interface{}, TXMETA interface{}](t mockConstructorTestingTNewTxStore) *TxStore[ADDR, CHAINID, TX_HASH, BLOCK_HASH, NEWTX, R, TX, TXATTEMPT, TXID, TXMETA] {
