...
type KeyStore[ADDR types.Hashable[ADDR], CHAIN_ID txmgrtypes.ID, SEQ txmgrtypes.Sequence] struct {
	mock.Mock
}
...
func NewKeyStore[ADDR types.Hashable[ADDR], CHAIN_ID txmgrtypes.ID, SEQ txmgrtypes.Sequence](t mockConstructorTestingTNewKeyStore) *KeyStore[ADDR, CHAIN_ID, SEQ] {
