...
type KeyStore[ADDR types.Hashable, CHAIN_ID types.ID, SEQ txmgrtypes.Sequence] struct {
	mock.Mock
}
...
func NewKeyStore[ADDR types.Hashable, CHAIN_ID types.ID, SEQ txmgrtypes.Sequence](t mockConstructorTestingTNewKeyStore) *KeyStore[ADDR, CHAIN_ID, SEQ] {
