...
type KeyStore[ADDR types.Hashable, ID interface{}, S interface{}] struct {
	mock.Mock
}
...
func NewKeyStore[ADDR types.Hashable, ID interface{}, S interface{}](t mockConstructorTestingTNewKeyStore) *KeyStore[ADDR, ID, S] {
