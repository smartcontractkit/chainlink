...
type KeyStore[ADDR types.Hashable, CHAIN_ID types.ID, SEQ types.Sequence[SEQ]] struct {
	mock.Mock
}
...
func NewKeyStore[ADDR types.Hashable, CHAIN_ID types.ID, SEQ types.Sequence[SEQ]](t mockConstructorTestingTNewKeyStore) *KeyStore[ADDR, CHAIN_ID, SEQ] {
