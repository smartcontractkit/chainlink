...
type PriorAttempt[F interface{}, TX_HASH types.Hashable] struct {
	mock.Mock
}
...
func NewPriorAttempt[F interface{}, TX_HASH types.Hashable](t mockConstructorTestingTNewPriorAttempt) *PriorAttempt[F, TX_HASH] {
