...
type PriorAttempt[F types.Fee, TX_HASH commontypes.Hashable[TX_HASH]] struct {
	mock.Mock
}
...
func NewPriorAttempt[F types.Fee, TX_HASH commontypes.Hashable[TX_HASH]](t mockConstructorTestingTNewPriorAttempt) *PriorAttempt[F, TX_HASH] {
