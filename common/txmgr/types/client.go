...
type Client[CHAINID ID, SEQ Sequence, ADDR types.Hashable[ADDR], BLOCK any, TX any, HASH types.Hashable[HASH], TXRECEIPT any, EVENT any, EVENTOPS any] interface {
...
type Accounts[ADDR types.Hashable[ADDR], SEQ Sequence] interface {
...
type Transactions[TX any, HASH types.Hashable[HASH], TXRECEIPT any] interface {
...
type Blocks[BLOCK any, HASH types.Hashable[HASH]] interface {
