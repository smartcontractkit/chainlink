...
// TODO: check that txns are deep copied when returned from the in-memory store
...
// TODO: make sure all address states are locked when updating the in-memory store
