...
const (
	...
	// ChainXDai has been renamed to ChainGnosis
...
func (c ChainType) IsValid() bool {
	switch c {
	case "", ChainArbitrum, ChainMetis, ChainOptimismBedrock, ChainXDai, ChainGnosis, ChainCelo, ChainKroma, ChainWeMix, ChainZkSync, ChainScroll:
		return true
	}
	return false
}
