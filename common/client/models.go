...
const (
	Successful              ClientErrorType = iota
	...
	Unknown                                 // Tx failed with an error response that is not recognized by the txm.
	Unsupported                             // Attempt failed with an error response that is not supported by the TXM for the given chain.
