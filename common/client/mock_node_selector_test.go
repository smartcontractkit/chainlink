...
type mockNodeSelector[CHAIN_ID types.ID, HEAD Head, RPC RPCClient[CHAIN_ID, HEAD]] struct {
	mock.Mock
}
...
func newMockNodeSelector[CHAIN_ID types.ID, HEAD Head, RPC RPCClient[CHAIN_ID, HEAD]](t interface {
	mock.TestingT
	Cleanup(func())
