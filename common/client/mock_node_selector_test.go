...
type mockConstructorTestingTnewMockNodeSelector interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockNodeSelector[CHAIN_ID types.ID, HEAD Head, RPC NodeClient[CHAIN_ID, HEAD]](t mockConstructorTestingTnewMockNodeSelector) *mockNodeSelector[CHAIN_ID, HEAD, RPC] {
