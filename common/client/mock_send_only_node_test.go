...
type mockConstructorTestingTnewMockSendOnlyNode interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockSendOnlyNode[CHAIN_ID types.ID, RPC sendOnlyClient[CHAIN_ID]](t mockConstructorTestingTnewMockSendOnlyNode) *mockSendOnlyNode[CHAIN_ID, RPC] {
