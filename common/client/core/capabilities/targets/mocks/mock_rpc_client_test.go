...
func (_m *ChainWriter) GetFeeComponents(ctx context.Context) (*ChainFeeComponents, error) {
	ret := _m.Called(ctx)
	...
	var r0 *ChainFeeComponents
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) (*ChainFeeComponents, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(context.Context) *ChainFeeComponents); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*ChainFeeComponents)
		}
	}
...
func (_c *ChainWriter_GetFeeComponents_Call) Return(_a0 *ChainFeeComponents, _a1 error) *ChainWriter_GetFeeComponents_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *ChainWriter_GetFeeComponents_Call) RunAndReturn(run func(context.Context) (*ChainFeeComponents, error)) *ChainWriter_GetFeeComponents_Call {
	_c.Call.Return(run)
	return _c
}

// GetTransactionStatus provides a mock function with given fields: ctx, transactionID
func (_m *ChainWriter) GetTransactionStatus(ctx context.Context, transactionID string) (TransactionStatus, error) {
	...
	var r0 TransactionStatus
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (TransactionStatus, error)); ok {
		return rf(ctx, transactionID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) TransactionStatus); ok {
		r0 = rf(ctx, transactionID)
	} else {
		r0 = ret.Get(0).(TransactionStatus)
	}
...
func (_c *ChainWriter_GetTransactionStatus_Call) Return(_a0 TransactionStatus, _a1 error) *ChainWriter_GetTransactionStatus_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *ChainWriter_GetTransactionStatus_Call) RunAndReturn(run func(context.Context, string) (TransactionStatus, error)) *ChainWriter_GetTransactionStatus_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *ChainWriter) SubmitTransaction(ctx context.Context, contractName string, method string, args interface{}, transactionID string, toAddress string, meta *TxMeta, value *big.Int) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, interface{}, string, string, *TxMeta, *big.Int) error); ok {
...
func (_c *ChainWriter_SubmitTransaction_Call) Run(run func(ctx context.Context, contractName string, method string, args interface{}, transactionID string, toAddress string, meta *TxMeta, value *big.Int)) *ChainWriter_SubmitTransaction_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(string), args[3].(interface{}), args[4].(string), args[5].(string), args[6].(*TxMeta), args[7].(*big.Int))
	})
	return _c
}
...
func (_c *ChainWriter_SubmitTransaction_Call) RunAndReturn(run func(context.Context, string, string, interface{}, string, string, *TxMeta, *big.Int) error) *ChainWriter_SubmitTransaction_Call {
	_c.Call.Return(run)
	return _c
}
