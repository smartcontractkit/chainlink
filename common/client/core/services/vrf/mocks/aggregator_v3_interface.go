...
func (_m *AggregatorV3InterfaceInterface) GetRoundData(opts *bind.CallOpts, _roundId *big.Int) (GetRoundData, error) {
...
func (_c *AggregatorV3InterfaceInterface_GetRoundData_Call) Return(_a0 GetRoundData, _a1 error) *AggregatorV3InterfaceInterface_GetRoundData_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *AggregatorV3InterfaceInterface_GetRoundData_Call) RunAndReturn(run func(*bind.CallOpts, *big.Int) (GetRoundData, error)) *AggregatorV3InterfaceInterface_GetRoundData_Call {
	_c.Call.Return(run)
	return _c
}

// LatestRoundData provides a mock function with given fields: opts
func (_m *AggregatorV3InterfaceInterface) LatestRoundData(opts *bind.CallOpts) (LatestRoundData, error) {
	ret := _m.Called(opts)
...
func (_c *AggregatorV3InterfaceInterface_LatestRoundData_Call) Return(_a0 LatestRoundData, _a1 error) *AggregatorV3InterfaceInterface_LatestRoundData_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *AggregatorV3InterfaceInterface_LatestRoundData_Call) RunAndReturn(run func(*bind.CallOpts) (LatestRoundData, error)) *AggregatorV3InterfaceInterface_LatestRoundData_Call {
	_c.Call.Return(run)
	return _c
}
