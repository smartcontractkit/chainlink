...
// HeadTracker_Name_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'String'
...
func (_e *HeadTracker_Expecter[H, BLOCK_HASH]) Name() *HeadTracker_Name_Call[H, BLOCK_HASH] {
	return &HeadTracker_Name_Call[H, BLOCK_HASH]{Call: _e.mock.On("String")}
}
