...
type HeadTrackable[H chains.Head[BLOCK_HASH], BLOCK_HASH chains.Hashable] struct {
	mock.Mock
}

type HeadTrackable_Expecter[H chains.Head[BLOCK_HASH], BLOCK_HASH chains.Hashable] struct {
	mock *mock.Mock
}
...
type HeadTrackable_OnNewLongestChain_Call[H chains.Head[BLOCK_HASH], BLOCK_HASH chains.Hashable] struct {
	*mock.Call
}
...
func NewHeadTrackable[H chains.Head[BLOCK_HASH], BLOCK_HASH chains.Hashable](t interface {
	mock.TestingT
	Cleanup(func())
