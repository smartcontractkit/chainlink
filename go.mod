...
require (
	...
	github.com/smartcontractkit/chainlink-cosmos v0.4.1-0.20230907173149-609fec64bbc2
	github.com/smartcontractkit/chainlink-relay v0.1.7-0.20230905185157-da01915913a4
