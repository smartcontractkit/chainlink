...
require (
	...
	github.com/smartcontractkit/chainlink-solana v1.0.3-0.20231218224757-7bdd753a504a
	github.com/smartcontractkit/chainlink-starknet/relayer v0.0.1-beta-test.0.20231218164059-e21436ef6202
