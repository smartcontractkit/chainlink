...
require (
	...
	github.com/cosmos/cosmos-sdk v0.45.13-rc.0
	...
	github.com/libp2p/go-libp2p-peerstore v0.2.10
	...
	github.com/smartcontractkit/chainlink-starknet/relayer v0.0.0-20230519085039-6a0588d1d2e4
