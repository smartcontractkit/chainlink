...
require (
	...
	github.com/smartcontractkit/chain-selectors v1.0.48-0.20250410113230-7b2cb012b943
	...
	github.com/smartcontractkit/chainlink-tron/relayer v0.0.0-20250411083531-d0eb296a49de
