...
require (
	...
	github.com/smartcontractkit/chainlink-ccip/chains/evm v0.0.0-20250826185453-79d696f12cb7
	...
	github.com/smartcontractkit/chainlink-solana v1.1.2-0.20250826175651-d0ef48f94bbf
