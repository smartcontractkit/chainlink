...
require (
	...
	github.com/smartcontractkit/chainlink/v2/tools/test v0.0.0-00010101000000-000000000000 // indirect
...
tool github.com/smartcontractkit/chainlink/v2/tools/test
