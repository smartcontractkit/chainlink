...
require (
	...
	github.com/smartcontractkit/chainlink-cosmos v0.4.1-0.20230824145305-c6541b2b0070 // TODO: update when https://github.com/smartcontractkit/chainlink-cosmos/pull/356 is merged
