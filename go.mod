...
require (
	...
	github.com/smartcontractkit/chainlink-solana v1.0.3-0.20230317181219-4334c233b581
	github.com/smartcontractkit/chainlink-starknet/relayer v0.0.0-20230317132141-3038a5ec45a1
