...
require (
	...
	github.com/smartcontractkit/chainlink-cosmos v0.4.1-0.20230822122237-1ff10c288bdb // TODO: update when https://github.com/smartcontractkit/chainlink-cosmos/pull/356 is merged
