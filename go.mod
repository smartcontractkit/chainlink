...
require (
	...
	github.com/smartcontractkit/chainlink-solana v1.0.3-0.20240702133242-890d5a2d9d3d
	github.com/smartcontractkit/chainlink-starknet/relayer v0.0.1-beta-test.0.20240702142444-88ba387a1be0
