...
require (
	...
	github.com/smartcontractkit/chainlink-relay v0.1.7-0.20230428222931-4b2713b17361
	...
	github.com/smartcontractkit/wsrpc v0.7.2-0.20230426182712-1d7aa8ba3bae
