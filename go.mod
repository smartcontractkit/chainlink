...
require (
	...
	github.com/smartcontractkit/chainlink-solana v0.2.20-0.20220610230107-7a4ee8b6dba5 //TODO update to develop
	github.com/smartcontractkit/chainlink-terra v0.1.4-0.20220610230305-ad17126beeda
