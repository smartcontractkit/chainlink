...
// chainlink-ccip/chains/evm includes deployment-only TON deps in its module graph.
// Root Chainlink leaves TON ownership to deployment/go.mod.
exclude github.com/smartcontractkit/chainlink-ton v0.0.0-20260415120434-cecc380f8d87
