...
require (
	...
	github.com/smartcontractkit/por_mock_ocr3plugin v0.0.0-20250627193309-2ff496c274dc
...
require (
	...
	github.com/smartcontractkit/por_mock_ocr3plugin v0.0.0-20250611023616-2ff496c274dc
