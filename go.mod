...
require (
	...
	github.com/smartcontractkit/chainlink-solana v0.2.20-0.20220512211114-e0c7294d7230
	github.com/smartcontractkit/chainlink-terra v0.1.4-0.20220513134930-b90a7b0333b0
