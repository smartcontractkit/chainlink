...
require (
	...
	github.com/smartcontractkit/chainlink-solana v1.0.3-0.20231205041407-c90fe4d6f696
	github.com/smartcontractkit/chainlink-starknet/relayer v0.0.1-beta-test.0.20231205042215-976232e40c59
