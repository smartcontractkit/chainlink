...
require (
	...
	github.com/smartcontractkit/chainlink-aptos v0.0.0-20260316114633-6b1d6694544a
	...
	github.com/smartcontractkit/chainlink-common v0.10.1-0.20260316102152-0f8d36473a0b
