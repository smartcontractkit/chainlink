...
require (
	...
	github.com/smartcontractkit/chainlink-ccip v0.1.0-solana.0.20250729085331-dfa21fe17ac3
	...
	github.com/smartcontractkit/cre-sdk-go/capabilities/scheduler/cron v0.2.0
