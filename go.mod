...
require (
	...
	github.com/smartcontractkit/chainlink-relay v0.1.7-0.20230307143724-0298f0e913fe
	...
	github.com/smartcontractkit/wsrpc v0.6.2-0.20230307143712-d7d5168ad8b7
