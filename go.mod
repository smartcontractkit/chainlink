...
require (
	...
	github.com/smartcontractkit/chainlink-solana v1.0.3-0.20231219011313-a8bde3eca885
	github.com/smartcontractkit/chainlink-starknet/relayer v0.0.1-beta-test.0.20231219005213-651154ac04a6
