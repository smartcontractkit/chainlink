...
require (
	...
	github.com/smartcontractkit/por_mock_ocr3plugin v0.0.0-00010101000000-000000000000
...
replace github.com/smartcontractkit/por_mock_ocr3plugin => ../por_mock_ocr3plugin
