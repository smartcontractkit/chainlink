...
func SetupTestEnvironment(
	...
	jdStartedFuture := queue.SubmitAny(func() (any, error) {
		jdOutput, startJDErr := StartJD(testLogger, *input.JdInput, input.InfraInput)
		if startJDErr != nil {
	...
	donsStartedFuture := queue.SubmitAny(func() (any, error) {
		nodeSetOutput, startDonsErr := StartDONs(ctx, testLogger, topology, input.InfraInput, startBlockchainsOutput.RegistryChain().BlockchainOutput, updatedNodeSets)
		if startDonsErr != nil {
