...
func TestToV2ConfigureInput(t *testing.T) {
	...
	if result.ContractAddress != "0x1234567890abcdef" { //nolint:staticcheck // won't migrate
		t.Errorf("expected ContractAddress 0x1234567890abcdef, got %s", result.ContractAddress) //nolint:staticcheck // won't migrate
	}
