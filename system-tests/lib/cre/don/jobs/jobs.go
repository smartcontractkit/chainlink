...
// TODO: remove the general Create and leave this one?
func CreateForDON(ctx context.Context, offChainClient cldf_offchain.Client, don *cre.DON, jobSpecs cre.DonJobs) error {
	if len(jobSpecs) == 0 {
		return nil
	}
