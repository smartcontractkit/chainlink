...
var CronJobSpecFactoryFn = func(cronBinaryPath string) cre.JobSpecFactoryFn {
...
func GenerateJobSpecs(donTopology *cre.DonTopology, cronBinaryPath string) (cre.DonsToJobSpecs, error) {
	if donTopology == nil {
