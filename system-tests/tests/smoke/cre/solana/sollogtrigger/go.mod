...
require (
	...
	github.com/smartcontractkit/cre-sdk-go/capabilities/blockchain/solana v0.1.1-0.20260225232352-b5913a8834c3
...
require (
	...
	github.com/smartcontractkit/chainlink-protos/cre/go v0.0.0-20260225200009-1450f741ef1c // indirect
