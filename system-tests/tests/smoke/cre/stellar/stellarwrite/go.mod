module github.com/smartcontractkit/chainlink/system-tests/tests/smoke/cre/stellar/stellarwrite
...
require (
	...
	github.com/smartcontractkit/cre-sdk-go/capabilities/blockchain/stellar v0.0.0-20260702162048-608baab0b466
