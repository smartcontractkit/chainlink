...
require (
	github.com/smartcontractkit/cre-sdk-go v1.16.0-capdev.1
...
require (
	...
	github.com/smartcontractkit/chainlink-protos/cre/go v0.0.0-20260707195416-ca350beacd4b // indirect
