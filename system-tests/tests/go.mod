...
require (
	...
	github.com/smartcontractkit/chainlink-confidential-compute/tests/testhelpers v0.0.0-20260811154131-b9926f013215
	...
	github.com/smartcontractkit/chainlink/core/scripts v0.0.0-20260812035138-673d7e955a68
