...
*/
func createWorkflowArtifacts[T WorkflowConfig](t *testing.T, testLogger zerolog.Logger, testEnv *ttypes.TestEnvironment, workflowName string, workflowDONs []*cre.Don, workflowConfig *T, workflowFileLocation, artifactDir string) (string, string) {
	t.Helper()
...
func CompileAndDeployWorkflow[T WorkflowConfig](t *testing.T,
	...
	compressedWorkflowWasmPath, workflowConfigPath := createWorkflowArtifacts(t, testLogger, testEnv, workflowName, workflowDONs, workflowConfig, workflowFileLocation, artifactDir)
