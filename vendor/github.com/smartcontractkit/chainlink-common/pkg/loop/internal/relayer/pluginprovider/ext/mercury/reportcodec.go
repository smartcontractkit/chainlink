...
func (r *reportCodecV4Client) BuildReport(fields mercury_v4_types.ReportFields) (ocr2plus_types.Report, error) {
	return r.impl.BuildReport(fields)
}

func (r *reportCodecV4Client) MaxReportLength(n int) (int, error) {
	return r.impl.MaxReportLength(n)
}

func (r *reportCodecV4Client) ObservationTimestampFromReport(report ocr2plus_types.Report) (uint32, error) {
