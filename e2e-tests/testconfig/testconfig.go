...
import (
	...
	a_config "github.com/smartcontractkit/chainlink/e2e-tests/testconfig/automation"
	f_config "github.com/smartcontractkit/chainlink/e2e-tests/testconfig/functions"
	keeper_config "github.com/smartcontractkit/chainlink/e2e-tests/testconfig/keeper"
	lp_config "github.com/smartcontractkit/chainlink/e2e-tests/testconfig/log_poller"
	ocr_config "github.com/smartcontractkit/chainlink/e2e-tests/testconfig/ocr"
	ocr2_config "github.com/smartcontractkit/chainlink/e2e-tests/testconfig/ocr2"
	vrf_config "github.com/smartcontractkit/chainlink/e2e-tests/testconfig/vrf"
	vrfv2_config "github.com/smartcontractkit/chainlink/e2e-tests/testconfig/vrfv2"
...
func GetConfig(configurationName string, product Product) (TestConfig, error) {
	...
	if err != nil {
		logger.Error().
			Msg("Error validating test config. You might want refer to e2e-tests/testconfig/README.md for more information.")
