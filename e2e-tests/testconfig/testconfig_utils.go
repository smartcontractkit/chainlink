...
Please refer to e2e-tests/testconfig/README.md for more information.
`
	...
	if imgStr != "" && versionStr != "" {
		extraInfo := `
Or if you want to run your tests right now add following content to e2e-tests/testconfig/overrides.toml:
[ChainlinkImage]
`
