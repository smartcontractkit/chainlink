module github.com/smartcontractkit/chainlink/integration-tests/v2
...
require (
	...
	github.com/smartcontractkit/chainlink-testing-framework/framework v0.0.0-20241021104510-54d3868c1d6d
